...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pagareparagua SET moneda_pagare=%s, monto_pagare=%s, moneda_convenio=%s, monto_convenio=%s, doc_1=%s, doc_2=%s, doc_3=%s, doc_4=%s, doc_5=%s, fecha_suscripcion_pagare=%s, fecha_suscripcion_convenio=%s, aval_rut_1=%s, aval_nom_1=%s, aval_rut_2=%s, aval_nom_2=%s, aval_rut_3=%s, aval_nom_3=%s, aval_rut_4=%s, aval_nom_4=%s, producto=%s, observacion=%s, estado=%s, fecha_actualizacion=%s, registro_ingreso=%s, sucursal=%s, ultimafecha=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR PAGARE PARAGUA - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr align="left" valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo6">Modificar Pagar&eacute;</span></td>
    </tr>
    <tr valign="middle">
...
<td align="center" valign="middle"><label>
  <select name="sucursal" class="etiqueta12" id="sucursal">
    ...
    <tr valign="middle">
      <td colspan="4" align="center" valign="middle"><input name="Enviar" type="submit" class="boton" value="Actualizar Registro Pagar&eacute; Paragua"></td>
    </tr>
  </table>

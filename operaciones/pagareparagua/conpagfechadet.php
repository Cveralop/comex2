...
$query_DetailRS1 = sprintf("SELECT * FROM pagareparagua WHERE fecha_ingreso between %s and %s", GetSQLValueString($colname_DetailRS1, "date"),GetSQLValueString($colname1_DetailRS1, "date"));

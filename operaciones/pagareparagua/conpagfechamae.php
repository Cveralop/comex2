...
$query_modificar = sprintf("SELECT * FROM pagareparagua WHERE fecha_ingreso between %s and %s", GetSQLValueString($colname_modificar, "date"),GetSQLValueString($colname1_modificar, "date"));

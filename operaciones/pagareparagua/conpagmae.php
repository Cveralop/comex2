...
if (isset($_GET['estado'])) {
  $colname_modificar = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM pagareparagua WHERE estado = %s", GetSQLValueString($colname_modificar, "text"));
...
<br>
<form name="form1" method="get" action="conpagdet.php">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Consultar Pagar&eacute; por Estado</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Estado:</td>

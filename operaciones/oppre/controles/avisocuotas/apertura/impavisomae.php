...
$query_impaviso = sprintf("SELECT * FROM oppre nolock WHERE evento = %s and nro_operacion = %s", GetSQLValueString($colname_impaviso, "text"),GetSQLValueString($colname2_impaviso, "text"));

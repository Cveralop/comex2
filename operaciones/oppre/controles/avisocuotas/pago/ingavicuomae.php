...
$query_ingvarios = sprintf("SELECT * FROM oppre nolock WHERE nro_operacion = %s and evento = %s ORDER BY date_curse DESC", GetSQLValueString($colname_ingvarios, "text"),GetSQLValueString($colname1_ingvarios, "text"));
...
<title>Ingreso Aviso Cuota - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">INGRESO AVISO CUOTA - MAESTRO </td>
...
<form name="form2" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Aviso Cuota</span></td>
    </tr>
    <tr valign="middle">
...
<table width="100%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td><a href="ingavicuodet.php?recordID=<?php echo $row_ingvarios['id']; ?>"> <img src="../../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO oppre (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, operador, nro_operacion, moneda_operacion, monto_operacion, sub_estado, date_visa, date_asig, tipo_operacion, estado_visacion, visador) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Ingreso Tecnica - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">INGRESO TECNICA - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingresar Tecnica
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="nro_operacion2" type="text" disabled="disabled" class="etiqueta12" id="nro_operacion2" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="operador" class="etiqueta12" id="operador">
        ...
        <option value="MPARRA">Maricel Parra</option>
        <option value="PPRE1">Practica Prestamo 1</option>
        <option value="PPRE2">Practica Prestamo 2</option>
        <option value="PPRE3">Practica Prestamo 3</option>
      </select></td>
    </tr>
    <tr valign="middle">
  ...
  <input name="estado" type="hidden" id="estado" value="Pendiente." size="32">
  ...
  <input name="nro_operacion" type="hidden" class="etiqueta12" id="nro_operacion" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="ingtecnicamae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

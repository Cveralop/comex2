...
$query_operador = sprintf("SELECT oppre.*,(usuarios.nombre)as ne FROM oppre, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s and fuera_horario = %s and (oppre.especialista_curse = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_operador, "text"),GetSQLValueString($colname1_operador, "text"),GetSQLValueString("%" . $colname4_operador . "%", "text"),GetSQLValueString($colname5_operador, "text"),GetSQLValueString($colname6_operador, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT oppre.*,(usuarios.nombre)as ne FROM oppre, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s and (oppre.especialista_curse = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"),GetSQLValueString("%" . $colname4_urgente . "%", "text"),GetSQLValueString($colname5_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT oppre.*,(usuarios.nombre)as ne FROM oppre, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and fuera_horario = %s and (oppre.especialista_curse = usuarios.usuario) and urgente <> %s ORDER BY date_asig ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString("%" . $colname4_fuerahorario . "%", "text"),GetSQLValueString($colname5_fuerahorario, "text"),GetSQLValueString($colname6_fuerahorario, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="10" align="left" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total de Operaciones Asignadas <?php echo $totalRows_operador ?> Curse Normal      
        </div>
    </span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="altaopdet.php?recordID=<?php echo $row_operador['id']; ?>"><img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0" align="absmiddle"></a>      </div></td>
    ...
    <td align="left"><?php echo $row_operador['tipo_operacion']; ?></div></td>
    <td align="left"><?php echo strtoupper($row_operador['rut_cliente']); ?></td>
    <td align="left"><?php echo strtoupper($row_operador['nombre_cliente']); ?> </td>
...
<?php if ($totalRows_fuerahorario > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="10" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total de Operaciones Asignadas <?php echo $totalRows_fuerahorario ?> Curse Fuera Horario</span></td>
    </tr>
    <tr>
      <td align="center" valign="middle" class="titulocolumnas">Cursar</td>
      <td align="center" valign="middle" class="titulocolumnas">Evento</td>

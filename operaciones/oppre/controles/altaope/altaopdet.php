...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE oppre SET evento=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, nro_operacion_relacionada=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, nro_cuotas=%s, pagare=%s, sub_estado=%s, tasa_variable=%s, cuota_int=%s, periodisidad=%s, cancelacion_total=%s, dus=%s, vcto_operacion=%s, date_oper=%s, tipo_operacion=%s, reparo_obs=%s, pago_automatico=%s, date_sol_vitacora=%s WHERE id=%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('nro_operacion','','R','fecha_curse','','R','nro_cuotas','','RinRange1:40');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="8" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Operadores </span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldMinCharsMsg">No se cumple el m�nimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span><span class="rojopequeno">F &oacute; K000000<span class="etiqueta12"> / </span>
    ...
    <tr valign="middle">
      ...
      <td align="right">Sub Estado:</div></td>
      <td align="center">
      ...
      <td align="center" class="etiqueta12"><label>
        <select name="pago_automatico" class="rojopequeno" id="pago_automatico">
...
<span class="textfieldInvalidFormatMsg">Formato no v�lido.</span></span><span class="rojopequeno">(aaaa-mm-dd)</span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span><span class="textfieldMinValueMsg">El valor introducido es inferior al m�nimo permitido.</span><span class="textfieldMaxValueMsg">El valor introducido es superior al m�ximo permitido.</span></span><span class="rojopequeno">max. 999</span> </div>        </td>
      <td align="right">Cuota Int.:</td>
      <td align="center">
        <input name="cuota_int" type="checkbox" class="etiqueta12" id="cuota_int" value="Y">
      ...
      <td align="center">
        <select name="pagare" class="etiqueta12" id="pagare">
          ...
          <option value="Pagare Cobex.">Pagare Cobex</option>
          <option value="Pagare SGR.">Pagare SGR</option>
          <option value="Sol. Pagare Paragua.">Sol. Pagare Paragua</option>
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="tasa_variable" type="checkbox" class="etiqueta12" id="tasa_variable" value="Y">
      ...
      <td align="center">
      <input name="cancelacion_total" type="checkbox" class="etiqueta12" id="cancelacion_total" value="Y">
      <span class="rojopequeno">(Si)</span></div></td>
      <td colspan="3" align="right">Declaraci&oacute;n de Exportaci&oacute;n:</td>
      <td align="center">
        <input name="dus" type="checkbox" class="etiqueta12" id="dus" value="Y">
      <span class="rojopequeno">(Si)</span></div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Moneda <span class="rojopequeno">/</span> Monto Operaci&oacute;n:</td>
...
<option value="Cambio Tasa." <?php if (!(strcmp("Cambio Tasa.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Cambio Tasa</option>
    ...
    <tr valign="middle">
      ...
      <td colspan="7" align="left"><span id="sprytextarea2"><span id="sprytextarea3">
        <textarea name="reparo_obs" cols="80" rows="6" class="etiqueta12" id="reparo_obs"></textarea>
        <span class="rojopequeno"><span id="countsprytextarea3">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span></span><span class="rojopequeno"><span class="rojopequeno"><span id="countsprytextarea2">&nbsp;</span></span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span></span>
        <span class="rojopequeno">
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
      <td colspan="8" align="center"><input type="submit" class="boton" value="Alta Operador"></td>
    </tr>
  </table>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {minChars:1, maxChars:7, hint:"0"});
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "integer", {minValue:1, maxValue:999, validateOn:["blur", "change"], useCharacterMasking:true, hint:"1"});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "date", {format:"yyyy-mm-dd", isRequired:false, validateOn:["blur"]});
//-->
</script>
</body>
</html>

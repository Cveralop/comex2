...
$query_compraventa = sprintf("SELECT * FROM oppre nolock WHERE fecha_ingreso = %s and compraventa = %s and tipocambio > %s", GetSQLValueString($colname_compraventa, "text"),GetSQLValueString($colname1_compraventa, "text"),GetSQLValueString($colname2_compraventa, "int"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Compra Venta de Divisas</span></td>
    </tr>
    <tr valign="middle">
      <td width="20%" align="right" class="respuestacolumna">Fecha Ingreso:</div></td>
      <td width="80%" align="left"><span class="Estilo8">
    ...
    <tr valign="middle">
      <td align="right" class="respuestacolumna">Compra Venta: </div></td>
      <td align="left"><select name="compraventa" class="etiqueta12 Estilo8" id="compraventa">
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle">
    <td colspan="4" align="right"><span class="Estilo5"><?php
...
echo strftime("Santiago, %d de %B de %Y");?>
  ...
  <tr valign="middle">
    ...
    <td align="center"><strong>T/C</strong></div></td>
    <td align="center"><strong>Valor en Pesos </strong></div></td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="left"><?php echo $row_compraventa['nombre_cliente']; ?></td>
    <td align="center"><?php echo strtoupper($row_compraventa['moneda_operacion']); ?> <?php echo number_format($row_compraventa['monto_operacion'], 2, ',', '.'); ?></td>
    <td align="center"><?php echo number_format($row_compraventa['tipocambio'], 2, ',', '.'); ?></td>
    <td align="center"><?php echo number_format(($row_compraventa['monto_operacion'] * $row_compraventa['tipocambio']), 0, ',', '.') ; ?> </td>
  </tr>

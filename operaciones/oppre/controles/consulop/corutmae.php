...
$query_consulta = sprintf("SELECT * FROM oppre nolock WHERE rut_cliente = %s ORDER BY id DESC", GetSQLValueString($colname_consulta, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Consulta por Rut</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="10" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Rut Cliente <span class="Estilo9"><?php echo $row_consulta['rut_cliente']; ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Nro Cuotas
      </div>
    </td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_consulta['nro_operacion']; ?></span>      </div></td>
    ...
    <td align="center"><?php echo $row_consulta['operador']; ?> </div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consulta['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consulta['monto_operacion'], 2, ',', '.'); ?></strong></div>        </div></td>
    <td align="center"><?php echo $row_consulta['nro_cuotas']; ?></div></td>
    <td align="center"><?php echo $row_consulta['tipo_operacion']; ?></div></td>
  </tr>

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="4" align="left"><p><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Operaciones por Rut </span></p>
    </td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_DetailRS1['asignador']; ?> </div></td>
    <td align="right">Operador:</div></td>
    <td align="center"><?php echo $row_DetailRS1['operador']; ?></div></td>
  </tr>
  <tr valign="middle">
    <td align="right">Nro Operaci&oacute;n:</div></td>
    <td align="center"><?php echo $row_DetailRS1['nro_operacion']; ?> <span class="rojopequeno">F &oacute; K000000</span> / </div><?php echo $row_DetailRS1['nro_operacion_relacionada']; ?> <span class="respuestacolumna_rojo">L000000</span></td>
  ...
  <tr valign="middle">
    <td align="right">Monto Apertura:</div></td>
    <td align="center"><span class="Estilo7"><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?></span> <strong><?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>
    <td align="right">Folio:</div></td>
    <td align="center"><?php echo $row_DetailRS1['folio']; ?></div></td>
  </tr>
  <tr valign="middle">
    <td align="right">Currier</div></td>
    <td colspan="3" align="left"><?php echo $row_DetailRS1['currier']; ?> </div>      </div>        </div></td>
  </tr>
</table>
<br>
<br>

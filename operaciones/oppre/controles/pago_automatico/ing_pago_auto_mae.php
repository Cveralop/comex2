...
$query_Recordset1 = sprintf("SELECT * FROM oppre nolock WHERE nro_operacion = %s", GetSQLValueString($colname_Recordset1, "text"));
...
<title>Ingreso Pago Automatico - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">INGRESO PAGO AUTOMATICO - MAESTRO</td>
...
<form id="form1" name="form1" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="subtitulopaguina">Ingreso Pago Automatico</span></td>
    </tr>
    <tr>
      <td width="18%" align="right" valign="middle">Numero Operación:</td>
...
<?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr class="titulocolumnas">
      <td bgcolor="#999999" class="titulocolumnas">Nro Registro</td>
      <td bgcolor="#999999" class="titulocolumnas">Rut Cliente</td>
      <td bgcolor="#999999" class="titulocolumnas">Nombre Cliente</td>
      <td bgcolor="#999999" class="titulocolumnas">Nro Operacion</td>
    </tr>
    <?php do { ?>
      <tr>
        <td><a href="ing_pago_auto_det.php?recordID=<?php echo $row_Recordset1['id']; ?>"><img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0" /></a></td>
        <td><?php echo $row_Recordset1['rut_cliente']; ?></td>
        <td><?php echo $row_Recordset1['nombre_cliente']; ?></td>
        <td><?php echo $row_Recordset1['nro_operacion']; ?></td>
      </tr>
  ...
  <br />
  Registros <span class="respuestacolumna_azul"><?php echo ($startRow_Recordset1 + 1) ?></span> a <span class="respuestacolumna_azul"><?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?></span> de <span class="respuestacolumna_azul"><?php echo $totalRows_Recordset1 ?></span> <br />

...
$query_DetailRS1 = sprintf("SELECT * FROM oppre nolock WHERE id = %s", $colname_DetailRS1);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE oppre SET fecha_ingreso=%s, moneda_operacion=%s, monto_operacion=%s, reparo_obs=%s, estado=%s, sub_estado=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">MODIFICACI&Oacute;N REPARO - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','moneda_reparo','','R','monto_reparo','','RisNum','reparo_espe','','R','reparo_obs','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Detalle Reparo</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      </div> <span class="respuestacolumna_rojo">/</span>      <input name="monto_operacion" type="text" class="etiqueta12" id="monto_operacion" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="17" maxlength="15"></td>
    ...
    <span class="rojopequeno"><span id="countsprytextarea1">&nbsp;</span></span><span class="textareaRequiredMsg">Se necesita un valor.</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span><span class="rojopequeno"><br>
        </span></td>
    </tr>
    <tr valign="middle">

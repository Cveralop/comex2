...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Visaci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS1['estado_mandato']; ?>" size="30" maxlength="25" readonly></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        ...
        <option value="Prestamo LCI.">Prestamo LCI</option>
      </select></td>
    ...
    <tr valign="middle">
      <td colspan="4" align="left" bgcolor="#999999"><img src="../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"><span class="titulodetalle">Excepci&oacute;n Operaci&oacute;n
        <label></label>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle"></div>        Resp. Excepci&oacute;n:</td>
    ...
    <tr valign="middle">
      <td align="right">Observaci&oacute;n Reparo:</div></td>

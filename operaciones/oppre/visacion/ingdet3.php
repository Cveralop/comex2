...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingresar Visaci&oacute;n </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <span class="rojopequeno"> K &oacute; L000000</span></td>
      <td align="right" valign="middle">Mandato:</td>
      <td align="center" valign="middle"><input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS2['estado_mandato']; ?>" size="30" maxlength="25" readonly></td>
    </tr>
    <tr valign="middle">
...
No</label></td>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea2">
        ...
        <span class="rojopequeno"><span id="countsprytextarea2">&nbsp;</span></span><span class="textareaMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span></div>
      </td>
    </tr>
    <tr valign="middle">
  ...
  <input name="visador" type="hidden" class="etiqueta12" id="visador" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20" readonly>
</form>
<br>
<table width="95%"  border="0" align="center">
  <tr>

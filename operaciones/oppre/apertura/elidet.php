...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ELIMINAR PR&Eacute;STAMOS - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Eliminar Pr&eacute;stamo Apertura</span></div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Nro Registro:</td>
      <td align="center"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?></span>
      </div></td>
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="evento" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['evento']; ?>" size="20" maxlength="20"></td>
      <td align="right">Estado:</div></td>
      <td align="center"><input name="estado" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['estado']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right">Asignador:</div></td>
      <td align="center"><input name="asignador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20" maxlength="20"></td>
      <td align="right">Operador:</div></td>
      <td align="center"><input name="operador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center"><input name="fecha_ingreso" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_ingreso']; ?>" size="12" maxlength="10">
      <span class="rojopequeno">(dd-mm-aaaa)</span></td>
    </tr>
    <tr valign="middle">
      <td align="right">Moneda / <br>
      Monto Operaci&oacute;n:</div></td>
      <td align="center"><input name="moneda_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['moneda_operacion']; ?>" size="5" maxlength="3"> 
      ...
      <td align="center"><input name="tipo_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="30" maxlength="30"></td>
    </tr>
    <tr valign="middle">

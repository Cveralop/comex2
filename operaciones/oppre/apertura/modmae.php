...
$colname2_modificar = "xxx";
if (isset($_GET['nro_operacion'])) {
  $colname2_modificar = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM oppre nolock WHERE rut_cliente LIKE %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificar . "%", "text"),GetSQLValueString($colname2_modificar . "%", "text"));
...
<title>Modificar Prestamos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">MODIFICAR EVENTOS DE PR&Eacute;STAMOS - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Eventos de Pr&eacute;stamo</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="left"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="17" maxlength="7">
      <span class="rojopequeno">K/L o F000000</span></td>
    </tr>
    <tr valign="middle">
...
<td align="center" class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['nro_operacion']); ?></td>
<td align="center"><?php echo $row_modificar['evento']; ?></td>
    <td align="center"><?php echo $row_modificar['estado']; ?> </div></td>
    <td align="center"><?php echo strtoupper($row_modificar['operador']); ?> </div></td>

...
if (isset($_GET['nro_operacion'])) {
  $colname2_eliminar = $_GET['nro_operacion'];
}
...
$query_eliminar = sprintf("SELECT * FROM oppre nolock WHERE rut_cliente LIKE %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname2_eliminar . "%", "text"));
...
<title>Eliminar Prestamos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ELIMINAR PR&Eacute;STAMOS - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Emilinar Pr&eacute;stamo</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="left"><label>
        ...
        <span class="rojopequeno">K/L o F000000</span></label></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center" class="respuestacolumna_rojo"><?php echo $row_eliminar['nro_operacion']; ?></td>
    <td align="center"><?php echo $row_eliminar['evento']; ?></td>

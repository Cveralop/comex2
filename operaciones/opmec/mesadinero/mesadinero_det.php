...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><select name="operador" class="etiqueta12" id="operador">
        ...
        <option value="NMORAT" <?php if (!(strcmp("NMORAT", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Natalia Mora Toledo</option>
        <option value="JAGURTO" <?php if (!(strcmp("JAGURTO", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Jacqueline Agurto Lillo</option>

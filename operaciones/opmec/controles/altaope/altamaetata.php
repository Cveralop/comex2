...
$colname4_alta = "zzz";
if (isset($_GET['id'])) {
  $colname4_alta = $_GET['id'];
}
$colname5_alta = "rut_cliente";
if (isset($_GET['rut_cliente'])) {
  $colname5_alta = $_GET['rut_cliente'];
}
$colname3_alta = "TATA";
if (isset($_GET['operador'])) {
  $colname3_alta = $_GET['operador'];
}
...
$query_alta = sprintf("SELECT * FROM opmec WHERE estado = %s and sub_estado = %s and operador LIKE %s and id LIKE %s and rut_cliente LIKE %s ORDER BY nro_operacion ASC", GetSQLValueString($colname_alta, "text"),GetSQLValueString($colname2_alta, "text"),GetSQLValueString("%" . $colname3_alta . "%", "text"),GetSQLValueString("%" . $colname4_alta . "%", "text"),GetSQLValueString("%" . $colname5_alta . "%", "text"));
...
<title>Alta Operaciones Supervisor TATA - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ALTA OPERACIONES SUPERVISOR TATA - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Supervisor - TATA</span></td>
    </tr>
    <tr>
      <td width="22%" align="right" valign="middle">Nro Folio:</div></td>
      <td width="78%" align="left" valign="middle"><input name="id" type="text" class="etiqueta12" id="id" size="10" maxlength="10"></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Folio
      </div>
    </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="altadettata.php?recordID=<?php echo $row_alta['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"> </a> </div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_alta['id']; ?></span>      </div></td>
    <td align="center"><?php echo $row_alta['nro_operacion']; ?></td>
    <td align="center"><?php echo $row_alta['date_espe']; ?></td>
    <td align="center"><?php echo $row_alta['evento']; ?> </div>      </div></td>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_alta < $totalPages_alta) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_alta=%d%s", $currentPage, $totalPages_alta, $queryString_alta); ?>">�ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>

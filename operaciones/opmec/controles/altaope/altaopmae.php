...
<?php
session_start();
$MM_authorizedUsers = "ADM,OPE,TATA";
...
$colname6_operador = "No";
if (isset($_GET['fuera_horario'])) {
  $colname6_operador = $_GET['fuera_horario'];
}
$colname4_operador = "1";
if (isset($_GET['id'])) {
  $colname4_operador = $_GET['id'];
}
$colname5_operador = "No";
if (isset($_GET['urgente'])) {
  $colname5_operador = $_GET['urgente'];
}
...
$query_operador = sprintf("SELECT opmec.*,(usuarios.nombre)as ne FROM opmec, usuarios WHERE operador = %s and sub_estado = %s and opmec.id >=  %s and urgente = %s and fuera_horario = %s and (opmec.especialista_curse = usuarios.usuario) ORDER BY id ASC", GetSQLValueString($colname_operador, "text"),GetSQLValueString($colname1_operador, "text"),GetSQLValueString($colname4_operador, "int"),GetSQLValueString($colname5_operador, "text"),GetSQLValueString($colname6_operador, "text"));
...
$colname4_urgente = "1";
if (isset($_GET['id'])) {
  $colname4_urgente = $_GET['id'];
}
$colname5_urgente = "Si";
if (isset($_GET['urgente'])) {
  $colname5_urgente = $_GET['urgente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT opmec.*,(usuarios.nombre)as ne FROM opmec, usuarios WHERE operador = %s and sub_estado = %s and opmec.id >= %s and urgente = %s and (opmec.especialista_curse = usuarios.usuario) ORDER BY id ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"),GetSQLValueString($colname4_urgente, "int"),GetSQLValueString($colname5_urgente, "text"));
...
$colname4_fuerahorario = "1";
if (isset($_GET['id'])) {
  $colname4_fuerahorario = $_GET['id'];
}
$colname5_fuerahorario = "Si";
if (isset($_GET['fuera_horario'])) {
  $colname5_fuerahorario = $_GET['fuera_horario'];
}
$colname6_fuerahorario = "Si";
if (isset($_GET['urgente'])) {
  $colname6_fuerahorario = $_GET['urgente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT opmec.*,(usuarios.nombre)as ne FROM opmec, usuarios WHERE operador = %s and sub_estado = %s and opmec.id >= %s and fuera_horario = %s and (opmec.especialista_curse = usuarios.usuario) and urgente <> %s ORDER BY id ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString($colname4_fuerahorario, "int"),GetSQLValueString($colname5_fuerahorario, "text"),GetSQLValueString($colname6_fuerahorario, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="22%" align="right" valign="middle">Nro Folio:</td>
      <td width="78%" align="left" valign="middle"><input name="id" type="text" class="etiqueta12" id="id" size="10" maxlength="15">
...
<br>
  <table width="95%"  border="0" align="center">
    <tr>
      <td align="right" valign="middle"><a href="../../meco.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image31" width="80" height="25" border="0" id="Image31"></a></div></td>
    </tr>
  </table>
  <br>
  <br>
  <?php if ($totalRows_urgente > 0) { // Show if recordset not empty ?>
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
      <tr>
        <td colspan="10" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
      </tr>
      <tr>
        ...
        <td align="center" valign="middle" class="titulocolumnas">Nro Operaci&oacute;n / Nro Op. Exterior</td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_urgente['nro_operacion']); ?></span> / <span class="respuestacolumna_rojo"><?php echo strtoupper($row_urgente['nro_operacion_exterior']); ?></span></td>
...
<br>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="10" align="left" valign="middle" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_operador ?> Curse Normal</span></td>
    </tr>
    <tr bgcolor="#999999">
    ...
    <?php do { ?>
    <tr>
      <td align="center" valign="middle"><a href="altaopdet.php?recordID=<?php echo $row_operador['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0" align="absmiddle"></a></td>
      <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_operador['id']; ?></span>        </div>        </div></td>
      <td align="center" valign="middle"><?php echo $row_operador['evento']; ?></td>
      <td align="center" valign="middle"><?php echo $row_operador['fecha_ingreso']; ?></td>
      <td align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_operador['nro_operacion']); ?></span> / <span class="respuestacolumna_rojo"><?php echo strtoupper($row_operador['nro_operacion_exterior']); ?></span>        </div></td>
      <td align="center" valign="middle"><?php echo strtoupper($row_operador['rut_cliente']); ?></td>
      <td align="left" valign="middle"><?php echo strtoupper($row_operador['nombre_cliente']); ?> </div></td>
      <td align="right" valign="middle">&nbsp; <strong class="respuestacolumna_azul"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_operador['moneda_operacion']); ?> </span><?php echo number_format($row_operador['monto_operacion'], 2, ',', '.'); ?></strong></td>
      <td align="left" valign="middle"><?php echo strtoupper($row_operador['ne']); ?></td>
      <td align="center" valign="middle"><?php if ($row_operador['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
        <span class="Rojo2"><?php echo $row_operador['urgente']; ?></span>
        <?php } // Show if not first page ?>
        <?php if ($row_operador['urgente'] <> $row_colores['rojosi']) { // Show if not first page ?>
        <span class="Verde2"><?php echo $row_operador['urgente']; ?></span>
...
<?php } // Show if recordset not empty ?>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="10" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_fuerahorario ?> Fuera Horario</span></td>
    </tr>
    <tr>
      <td align="center" valign="middle" class="titulocolumnas">Cursar</td>
      <td align="center" valign="middle" class="titulocolumnas">Nro Folio</td>
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_fuerahorario['nro_operacion']); ?></span> / <span class="respuestacolumna_rojo"><?php echo strtoupper($row_fuerahorario['nro_operacion_exterior']); ?></span></td>

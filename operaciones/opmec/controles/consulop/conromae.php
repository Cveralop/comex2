...
if (isset($_GET['tipo_operacion'])) {
  $colname1_consultanro = (get_magic_quotes_gpc()) ? $_GET['tipo_operacion'] : addslashes($_GET['tipo_operacion']);
}
...
$query_consultanro = sprintf("SELECT * FROM opmec WHERE nro_operacion = '%s' and tipo_operacion LIKE '%%%s%%' ORDER BY id DESC", $colname_consultanro,$colname1_consultanro);
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td width="78%" align="left" valign="middle">        <input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="20" maxlength="15">      </td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="7" align="left" valign="middle"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo11"><?php echo strtoupper($row_consultanro['nro_operacion']); ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consultanro['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consultanro['monto_operacion'], 2, ',', '.'); ?></strong></div>       </div></td>
  </tr>

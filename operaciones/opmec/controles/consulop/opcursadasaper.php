...
if (isset($_GET['fecha_ingreso'])) {
  $colname2_cursada = (get_magic_quotes_gpc()) ? $_GET['fecha_ingreso'] : addslashes($_GET['fecha_ingreso']);
}
$colname1_cursada = "1";
...
$query_cursada = sprintf("SELECT * FROM opmec WHERE evento LIKE '%%%s%%' and estado LIKE '%%%s%%' and fecha_ingreso LIKE '%%%s%%' ORDER BY id DESC", $colname_cursada,$colname1_cursada,$colname2_cursada);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS (OP ENVIADAS - OP RECIBIDAS - MSG-Swift) </td>
...
<table border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda Operaci&oacute;n</div>
    </td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><strong class="respuestacolumna_azul"><?php echo number_format($row_cursada['monto_operacion'], 2, ',', '.'); ?></strong></td>
  </tr>

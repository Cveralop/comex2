...
$query_consulta = sprintf("SELECT * FROM opmec WHERE rut_cliente = '%s' ORDER BY id DESC", $colname_consulta);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="7" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Rut Cliente <span class="Estilo9"><?php echo $row_consulta['rut_cliente']; ?> <span class="Estilo12">Nombre Cliente</span> <?php echo $row_consulta['nombre_cliente']; ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">

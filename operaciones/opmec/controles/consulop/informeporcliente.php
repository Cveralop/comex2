...
$query_opporcliente = sprintf("SELECT * FROM opmec WHERE rut_cliente = '%s' and fecha_curse LIKE '%%%s%%' and evento LIKE '%%%s%%' and estado LIKE '%%%s%%' ORDER BY id ASC", $colname_opporcliente,$colname1_opporcliente,$colname2_opporcliente,$colname3_opporcliente);
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../meco.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image4" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>

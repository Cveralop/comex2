...
<title>Ingreso Tracer OP Recibida</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO TRACER OP RECIBIDA</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="date_ingreso" type="text" class="etiqueta12" id="date_ingreso" value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10" readonly="readonly">
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Ingresar Tracer OP Recibida">
      </div></td>
    </tr>
  </table>

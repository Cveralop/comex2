...
$colname1_eliminar = "OP Enviada.";
if (isset($_GET['evento'])) {
  $colname1_eliminar = $_GET['evento'];
}
$colname_eliminar = "1";
if (isset($_GET['rut_cliente'])) {
  $colname_eliminar = $_GET['rut_cliente'];
}
$colname2_eliminar = "1";
if (isset($_GET['id'])) {
  $colname2_eliminar = $_GET['id'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opmec WHERE rut_cliente LIKE %s and evento = %s and id LIKE %s ORDER BY id DESC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"),GetSQLValueString($colname2_eliminar . "%", "text"));
...
<title>Eliminar Registro - Maestro</title>
<style type="text/css">
<!--
...
.Estilo8 {color: #FFFFFF; font-weight: bold; font-size: 12px; }
.Estilo9 {
	color: #FF0000;
	font-weight: bold;
}
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR REGISTRO - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo8"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Eliminar Registro Instruci&oacute;n</span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Liq. Forward.">Liq. Forward</option>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda / Monto Operac&oacute;n</td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_eliminar['rut_cliente']); ?> </div></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_eliminar['nombre_cliente']); ?></td>
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_eliminar['operador']); ?></td>
    <td align="right" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>
...
<br>
Registros del <strong><?php echo ($startRow_eliminar + 1) ?></strong> al <strong><?php echo min($startRow_eliminar + $maxRows_eliminar, $totalRows_eliminar) ?></strong> de un total de <strong><?php echo $totalRows_eliminar ?><br>
</strong>

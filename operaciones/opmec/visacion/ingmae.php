...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opasignadas = "SELECT evento,operador,count(operador)as cantidad,(usuarios.nombre)as nombre FROM opmec, usuarios WHERE date_asig >= curdate() and (opmec.operador = usuarios.usuario) GROUP BY evento,operador ORDER BY operador ASC";
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Visaci&oacute;n Mercado de Corredores </span></td>
    </tr>
    <tr>
...
<table width="95%" border="0" align="center">
  <tr>
    <td><div id="CollapsiblePanel1" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">Operaciones Aignadas</div>
      <div class="CollapsiblePanelContent">
        ...
        <table width="85%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
          ...
          <?php do { ?>
            <tr>
              <td valign="middle" bgcolor="#CCCCCC"><?php echo $row_opasignadas['evento']; ?>&nbsp; </a></td>

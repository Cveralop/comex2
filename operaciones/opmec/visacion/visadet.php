...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opmec SET evento=%s, estado=%s, asignador=%s, operador=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, nro_cuotas=%s, valuta=%s, cantidad=%s, sub_estado=%s, date_visa=%s, date_asig=%s, reparo_obs=%s, estado_visacion=%s, visador=%s, mandato=%s, impedido_operar=%s, excepcion=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, responsable_excepcion=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
<option value="Abono MT 910." <?php if (!(strcmp("Abono MT 910.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Abono MT 910</option>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextfield2"><span class="textfieldRequiredMsg">Si esta en Blanco ingrese nuevamnete al Sistema.</span></span>
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Mandato / Imp. Operar:</td>
      <td align="center" valign="middle"><input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS1['mandato']; ?>" size="30" maxlength="25" readonly="readonly"> 
      / 
        <label>
    ...
    <tr valign="baseline">
      ...
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span><span class="textfieldMinCharsMsg">No se cumple el m�nimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Resp. Excepci&oacute;n:
      </td>
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Fecha Soluci&oacute;n Excepcion:</div></td>
...
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "integer", {validateOn:["blur"], minChars:1, maxChars:999});

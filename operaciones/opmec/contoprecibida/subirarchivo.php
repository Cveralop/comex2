...
<title>Subir Archivo Ordenes de Pago Recibidas</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">SUBIR ARCHIVO DE ORDENES DE PAGO RECIBIDAS</td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right"><a href="cargaoprecibida.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen2" width="80" height="25" border="0" id="Imagen2" /></a></td>
  </tr>
</table>
<br />
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form action="subirarchivo.php" method="post" enctype="multipart/form-data" name="archivos" target="_blank" id="archivos">
...
<?php
    ...
    $directorio="D:\\comercioexterior\\oprecibidas\\"; 

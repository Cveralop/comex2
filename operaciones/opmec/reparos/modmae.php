...
if (isset($_GET['evento'])) {
  $colname_modrep = $_GET['evento'];
}
$colname3_modrep = "Pendiente.";
if (isset($_GET['sub_estado'])) {
  $colname3_modrep = $_GET['sub_estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modrep = sprintf("SELECT * FROM opmec WHERE evento LIKE %s and rut_cliente LIKE %s and id LIKE %s and sub_estado <> %s ORDER BY id DESC", GetSQLValueString("%" . $colname_modrep . "%", "text"),GetSQLValueString($colname1_modrep . "%", "text"),GetSQLValueString("%" . $colname2_modrep . "%", "text"),GetSQLValueString($colname3_modrep, "text"));
...
<title>Modificaci&oacute;n Reparo - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N REPARO - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificaci&oacute;n Reparo</span></td>
    </tr>
    <tr valign="middle">
      <td width="17%" align="right" valign="middle">Nro Folio:</td>
      <td width="83%" align="left" valign="middle"><input name="id" type="text" class="etiqueta12" id="id" size="12" maxlength="10"></td>
    </tr>
    <tr valign="middle">
...
<br>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
    <tr>
      <td align="center" valign="middle"><a href="moddet.php?recordID=<?php echo $row_modrep['id']; ?>"> <img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
      <td align="center" valign="middle"><?php echo $row_modrep['fecha_ingreso']; ?></td>
      <td align="center" valign="middle"><?php echo strtoupper($row_modrep['rut_cliente']); ?></td>
      <td align="left" valign="middle"><?php echo strtoupper($row_modrep['nombre_cliente']); ?></td>
      <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_modrep['id']; ?></td>
      <td align="center" valign="middle"><?php echo $row_modrep['evento']; ?> </td>
      <td align="center" valign="middle"><?php echo strtoupper($row_modrep['operador']); ?></td>
      <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modrep['moneda_operacion']); ?></span> <span class="respuestacolumna_azul"><?php echo number_format($row_modrep['monto_operacion'], 2, ',', '.'); ?></span></td>
    </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="top"><a href="../meco.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a> <a href="../visacion/principal.php"><img src="../../../imagenes/Botones/visacion_1.jpg" width="80" height="25" border="0"></a></td>
  </tr>
</table>
</body>
</html>

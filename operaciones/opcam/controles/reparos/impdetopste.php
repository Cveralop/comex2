...
$query_DetailRS1 = sprintf("SELECT * FROM opste  WHERE id = $recordID", $colname_cartareparo);
...
<table width="90%"  border="0" align="center">
  <tr bordercolor="#CCCCCC">
    ...
    <td width="82%" align="left" valign="middle" class="Estilo12">Aviso de reparo, <strong><?php echo $row_DetailRS1['evento']; ?></strong> de Stand By Emitidas - <strong><?php echo $row_DetailRS1['tipo_operacion']; ?></strong></td>
  </tr>
  <tr bordercolor="#CCCCCC">

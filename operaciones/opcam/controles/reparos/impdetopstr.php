...
$query_DetailRS1 = sprintf("SELECT * FROM opstr WHERE id = $recordID", $colname_cartareparo);
...
<table width="90%"  border="0" align="center">
  <tr>
    <td align="left" valign="middle" bgcolor="#FFFFFF"><img src="../../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61"></td>
  </tr>
  <tr>
    <td width="100%" align="left" valign="middle"><span class="AA">Departamento Cambio</span></td>
  </tr>
  <tr>
...
<table width="90%"  border="0" align="center">
  <tr bordercolor="#CCCCCC">
    ...
    <td width="82%" align="left" valign="middle" class="Estilo12">Aviso de reparo, <strong><?php echo $row_DetailRS1['evento']; ?></strong> de Stand By Recibidas - <strong><?php echo $row_DetailRS1['tipo_operacion']; ?></strong></td>
  </tr>
  <tr bordercolor="#CCCCCC">
  ...
  <tr bordercolor="#CCCCCC">
    ...
    <td align="left" valign="middle" class="Estilo13"><strong><?php echo $row_DetailRS1['rut_cliente']; ?></strong></td>
  </tr>
  <tr bordercolor="#CCCCCC">
...
<table width="90%"  border="0" align="center">
  ...
  <tr>
    <td align="left" valign="middle"><strong>Solicitamos vuestra gesti&oacute;n con el fin de dar curse a la brevedad. Sin otro particular nos es grato saludarle muy atentamente, </div>
    </strong></td>
  </tr>
  <tr>
    <td align="left" valign="middle">&nbsp;</td>
  ...
  <tr>
    <td height="22"><strong>Banco Santander</strong></div></td>
  </tr>
  <tr>
    <td><SPAN class=265052114-13052009 Estilo15><strong>Departamento Cambios</strong></SPAN></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>

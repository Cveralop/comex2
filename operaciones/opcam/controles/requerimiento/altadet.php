...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, tipo_error=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s, reparo_obs=%s, estado_visacion=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['tipo_error'], "text"),
                       GetSQLValueString($_POST['estado'], "text"),
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opstr WHERE id = %s ORDER BY evento ASC", GetSQLValueString($colname_DetailRS1, "int"));
...
$query_DetailRS1 = sprintf("SELECT * FROM opstr  WHERE id = $recordID", $colname_DetailRS1);
...
<title>Alta Requerimiento - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ALTA REQUERIMIENTO SUPERVISOR - DETALLE</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Requerimiento Supervisor Stand By Recibidas</span></div></td>
    </tr>
    <tr valign="middle">
      <td width="16%" align="right">Nro Operaci&oacute;n:</td>
      <td width="27%" align="center"><span id="sprytextfield1">
      ...
      <td width="17%" align="right">Rut Cliente:</div></td>
    ...
    <tr align="center" valign="middle">
      <td colspan="4" align="left" bgcolor="#999999"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0">Detalle Tipo Requerimiento</span></td>
    </tr>
    <tr align="center" valign="middle">
      <td align="right">Tipo Error:</td>
      <td colspan="3" align="left"><span id="spryradio1">
      <label>
        <input name="tipo_error" type="radio" id="tipo_error_0" value="Requerimiento." checked>
        Requerimiento</label>
      <label>
        <input type="radio" name="tipo_error" value="Error Comercial." id="tipo_error_1">
        Error Comercial</label>
      <label>
        <input type="radio" name="tipo_error" value="Error Operativo." id="tipo_error_2">
        Error Operativo</label>
      <br>
      <span class="radioRequiredMsg">Realice una selecci&oacute;n.</span></span></td>
    </tr>
    <tr align="center" valign="middle">
      <td align="right">Observaci&oacute;n Req.:</td>
...
var spryradio1 = new Spry.Widget.ValidationRadio("spryradio1", {validateOn:["change"], emptyValue:"N/A"});

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opbga SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, tipo_error=%s, autorizador=%s, reparo_obs=%s, estado_visacion=%s WHERE id=%s",
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Requerimiento Supervisor Boleta de Garant&iacute;a</div>
      </span></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="right"><input name="rut_cliente" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="17" maxlength="15" readonly="readonly">
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="fecha_curse" type="text" class="etiqueta12" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10" readonly="readonly">

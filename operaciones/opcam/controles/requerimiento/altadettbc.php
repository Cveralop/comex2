...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE optbc SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, tipo_error=%s, autorizador=%s, reparo_obs=%s WHERE id=%s",
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Requerimiento Supervisor III B5        
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><span id="spryradio1">
        <label>
          <input type="radio" name="tipo_error" value="Requerimiento." id="tipo_error_0">
          Requerimiento</label>
        <label>
    ...
    <tr valign="middle">
      <td align="right">Observaci&oacute;n Req.:</div></td>
      <td colspan="3" align="left"><span id="sprytextarea1">
      <textarea name="reparo_obs" cols="80" rows="4" class="etiqueta12" id="reparo_obs"><?php echo $row_DetailRS1['reparo_obs']; ?></textarea>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcex SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, estado_visacion=%s WHERE id=%s",
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulocolumnas"><span class="titulodetalle">Alta Requerimiento Supervisor Otros Productos
        </div>
      </span></span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr align="center" valign="middle">
      <td align="right">Observacion Req.:</td>

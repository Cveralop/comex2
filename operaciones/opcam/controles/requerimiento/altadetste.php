...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, tipo_error=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s, reparo_obs=%s WHERE id=%s",
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Requerimiento Supervisor Stand By Emitidas        
        </div>
      </span></td>
    </tr>
    <tr valign="middle">

...
$colname4_alta = "Reparada.";
if (isset($_GET['sub_estado'])) {
  $colname4_alta = $_GET['sub_estado'];
}
...
$query_alta = sprintf("SELECT * FROM opstr WHERE estado_visacion = %s and (sub_estado = %s or sub_estado = %s) and nro_operacion LIKE %s and estado = %s ORDER BY nro_operacion ASC", GetSQLValueString($colname_alta, "text"),GetSQLValueString($colname1_alta, "text"),GetSQLValueString($colname4_alta, "text"),GetSQLValueString("%" . $colname3_alta . "%", "text"),GetSQLValueString($colname2_alta, "text"));
...
$colname4_opste = "Reparada.";
if (isset($_GET['sub_estado'])) {
  $colname4_opste = $_GET['sub_estado'];
}
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opste = sprintf("SELECT * FROM opste WHERE estado_visacion = %s and (sub_estado = %s or sub_estado = %s) and nro_operacion LIKE %s and estado = %s", GetSQLValueString($colname_opste, "text"),GetSQLValueString($colname1_opste, "text"),GetSQLValueString($colname4_opste, "text"),GetSQLValueString("%" . $colname3_opste . "%", "text"),GetSQLValueString($colname2_opste, "text"));
...
if (isset($_GET['sub_estado'])) {
  $colname4_optbc = $_GET['sub_estado'];
}
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_optbc = sprintf("SELECT * FROM optbc WHERE estado_visacion = %s and (sub_estado = %s or sub_estado = %s) and nro_operacion LIKE %s and estado = %s ORDER BY urgente DESC", GetSQLValueString($colname_optbc, "text"),GetSQLValueString($colname1_optbc, "text"),GetSQLValueString($colname4_optbc, "text"),GetSQLValueString("%" . $colname3_optbc . "%", "text"),GetSQLValueString($colname2_optbc, "text"));
...
$colname4_opcrext = "Reparada.";
if (isset($_GET['sub_estado'])) {
  $colname4_opcrext = $_GET['sub_estado'];
}
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opcrext = sprintf("SELECT * FROM opcex WHERE estado_visacion = %s and (sub_estado = %s or sub_estado = %s) and nro_operacion LIKE %s and estado = %s ORDER BY urgente DESC", GetSQLValueString($colname_opcrext, "text"),GetSQLValueString($colname1_opcrext, "text"),GetSQLValueString($colname4_opcrext, "text"),GetSQLValueString("%" . $colname3_opcrext . "%", "text"),GetSQLValueString($colname2_opcrext, "text"));
...
if (isset($GET['sub_estado'])) {
  $colname4_opbga = $GET['sub_estado'];
}
$colname3_opbga = "zzz";
if (isset($_GET['nro_operacion'])) {
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opbga = sprintf("SELECT * FROM opbga WHERE estado_visacion = %s and (sub_estado = %s or sub_estado = %s) and nro_operacion LIKE %s and estado = %s ORDER BY urgente DESC", GetSQLValueString($colname_opbga, "text"),GetSQLValueString($colname1_opbga, "text"),GetSQLValueString($colname4_opbga, "text"),GetSQLValueString("%" . $colname3_opbga . "%", "text"),GetSQLValueString($colname2_opbga, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="21%" align="right" valign="middle" class="respuestacolumna">Evento:</div></td>
      <td width="79%" align="left" valign="middle">        <select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Dev Boleta.">Dev Boleta</option>
      </select>
      </td>
    </tr>
    <tr>
      <td align="right" valign="middle" class="respuestacolumna">Nro Operaci&oacute;n:</div></td>
      <td align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="17" maxlength="17">        </td>
    </tr>
    <tr>

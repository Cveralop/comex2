...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, banco=%s, rut_banco=%s, pais=%s, referencia=%s, tipo_operacion=%s, estado_comision=%s, vcto_operacion=%s, otros_ben=%s, ordenante=%s, plazo=%s, gastos=%s, vcto_boleta=%s, moneda_contra=%s, monto_contra=%s, periodisidad=%s, inicio_periodo=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s, estado_visacion=%s, mandato=%s, excepcion_comision=%s, fuera_horario=%s WHERE id=%s",
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="6" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Supervisor Stand By Recibidas</span></div></td>
    </tr>
    <tr valign="middle">
...
(aaaa-mm-dd)</span></td>
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="folio_boleta" type="text" class="destadado" id="folio_boleta" value="<?php echo $row_DetailRS1['folio_boleta']; ?>" size="15" maxlength="15">
      </div></td>
      ...
      <td align="center">
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['excepcion_comision'],"Si"))) {echo "checked=\"checked\"";} ?> name="excepcion_comision" type="radio" class="etiqueta12" id="excepcion_comision_0" value="Si">
          Si</label>
        <label>
    ...
    <tr valign="middle">
      ...
      <td align="right"><select name="moneda_contra" class="etiqueta12" id="moneda_contra">
	...
	<option value="U.F." <?php if (!(strcmp("U.F.", $row_DetailRS1['moneda_contra']))) {echo "SELECTED";} ?>>U.F.</option>
      </select>
        <span class="rojopequeno">/</span>
      <input name="monto_contra" type="text" class="etiqueta12" id="monto_contra" value="<?php echo $row_DetailRS1['monto_contra']; ?>" size="17" maxlength="15"></td>
    ...
    <tr valign="middle">
      <td align="right">Nombre Ordenante:</td>
...
No</label></td>
    ...
    <tr valign="middle">
      <td align="right">Otro Beneficiario:</div></td>

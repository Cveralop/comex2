...
header("Content-Disposition: attachment;filename=opstr_excepciones.xls"); 
...
$query_excepciones = sprintf("SELECT opstr.*,(usuarios.nombre)as ne ,timestampdiff(day,solucion_excepcion,current_timestamp)as dias FROM opstr, usuarios WHERE estado_excepcion = %s and excepcion = %s and estado = %s and (opstr.especialista_curse = usuarios.usuario) ORDER BY dias ASC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"));
...
<table width="95%" border="1" align="center">
  <tr valign="middle">
    ...
    <td align="center">Tipo Compromiso</td>
    <td align="center">Fecha Curse</td>
    <td align="center">Fecha Compromiso</td>
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle">Cambios Stand BY Recividas</td>

...
$colname1_consultanro = "zzzxxx";
if (isset($_GET['estado_boleta'])) {
  $colname1_consultanro = (get_magic_quotes_gpc()) ? $_GET['estado_boleta'] : addslashes($_GET['estado_boleta']);
}
$colname_consultanro = "xxxzzz";
if (isset($_GET['folio_boleta'])) {
  $colname_consultanro = (get_magic_quotes_gpc()) ? $_GET['folio_boleta'] : addslashes($_GET['folio_boleta']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_consultanro = sprintf("SELECT * FROM opbga WHERE folio_boleta LIKE '%%%s%%' and estado_boleta LIKE '%%%s%%' ORDER BY folio_boleta DESC", $colname_consultanro,$colname1_consultanro);
...
<title>Consulta Operaciones por Numero Stand BY Recibidas - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA FOLIO BOLETAS DE GARANT&Iacute;A - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Consulta por Numero Folio o Estado Boleta de Garant&iacute;a </span></td>
    </tr>
    <tr valign="middle">
      <td width="22%" align="right" valign="middle">Folio Boleta:</td>
      <td width="78%" align="left" valign="middle"><input name="folio_boleta" type="text" class="etiqueta12" id="folio_boleta" size="15" maxlength="15">        </td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Estado Boleta:</div></td>
      <td align="left" valign="middle"><select name="estado_boleta" class="etiqueta12" id="estado_boleta">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td align="center"><span class="titulocolumnas">Consultar</span>      </div></td>
    ...
    <td align="center" class="titulocolumnas">Monbre Beneficiario
      </div>
    </td>
    <td align="center" class="titulocolumnas">Vcto Operaci&oacute;n</div>
    </td>
    <td align="center" class="titulocolumnas">Folio Boleta
      </div>
    </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="bgafoliodet.php?recordID=<?php echo $row_consultanro['id']; ?>"> <img src="../../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>
    <td align="center"><?php echo $row_consultanro['fecha_curse']; ?> </div></td>
    <td align="left"><?php echo $row_consultanro['nombre_cliente']; ?> </td>
    <td align="left"><?php echo $row_consultanro['beneficiario']; ?> </div></td>
    <td align="center"><?php echo $row_consultanro['vcto_operacion']; ?> </div></td>
    <td align="center"><?php echo $row_consultanro['folio_boleta']; ?></div></td>

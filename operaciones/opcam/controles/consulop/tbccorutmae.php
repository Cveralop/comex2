...
$query_consulta = sprintf("SELECT * FROM optbc WHERE rut_cliente = '%s' ORDER BY id DESC", $colname_consulta);
...
<title>Consulta Operaciones Rut III B5 - Maestro</title>
<style type="text/css">
<!--
...
<table width="96%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA OPERACIONES POR RUT III B5 - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Consulta por Rut III B5 </span></span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Rut Banco:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="tbccorutdet.php?recordID=<?php echo $row_consulta['id']; ?>"> <img src="../../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consulta['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consulta['monto_operacion'], 2, ',', '.'); ?></strong></td>
  </tr>

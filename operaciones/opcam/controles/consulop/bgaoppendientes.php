...
$query_pendientes = sprintf("SELECT * FROM opbga WHERE evento LIKE '%%%s%%' and estado = '%s' ORDER BY id ASC", $colname_pendientes,$colname1_pendientes);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES PENDIENTES BOLETAS DE GARNAT&Iacute;A </td>

...
$query_pendientes = sprintf("SELECT * FROM opstr WHERE evento LIKE '%%%s%%' and estado = '%s' ORDER BY id ASC", $colname_pendientes,$colname1_pendientes);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_pendientes['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_pendientes['monto_operacion'], 2, ',', '.'); ?></strong>
      </div></td>

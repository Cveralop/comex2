...
if (isset($_GET['cancelacion_total'])) {
  $colname2_tasavariable = (get_magic_quotes_gpc()) ? $_GET['cancelacion_total'] : addslashes($_GET['cancelacion_total']);
}
$colname_tasavariable = "Otorgamiento.";
...
if (isset($_GET['tasa_variable'])) {
  $colname1_tasavariable = (get_magic_quotes_gpc()) ? $_GET['tasa_variable'] : addslashes($_GET['tasa_variable']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_tasavariable = sprintf("SELECT * ,adddate(fecha_curse_inicial,periodisidad)as fecha_reprecio FROM optbc WHERE evento = '%s' and tasa_variable = '%s' and cancelacion_total <> '%s' ORDER BY fecha_reprecio ASC", $colname_tasavariable,$colname1_tasavariable,$colname2_tasavariable);
...
<body onLoad="MM_preloadImages('../../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">OPERACIONES CON TASA VARIABLE </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Fecha Control Reprecio
      </div>
    </td>
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="tbctasavariabledet.php?recordID=<?php echo $row_tasavariable['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_tasavariable['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_tasavariable['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="center" valign="middle"><?php echo $row_tasavariable['sucursal']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_tasavariable['periodisidad']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_tasavariable['fecha_reprecio']; ?></div></td>

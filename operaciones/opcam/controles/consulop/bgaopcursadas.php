...
$query_cursada = sprintf("SELECT * FROM opbga WHERE evento LIKE '%%%s%%' and estado LIKE '%%%s%%' and fecha_curse LIKE '%%%s%%' and tipo_operacion LIKE '%%%s%%' ORDER BY id DESC", $colname_cursada,$colname1_cursada,$colname2_cursada,$colname3_cursada);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS BOLETAS DE GARANT&Iacute;A </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="8" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Estado Operaciones Boletas de Garant&iacute;a </span></td>
    </tr>
    <tr>

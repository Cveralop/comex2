...
header("Content-Disposition: attachment;filename=opste_excepciones.xls"); 
...
$query_excepciones = sprintf("SELECT opste.*,(usuarios.nombre)as ne ,timestampdiff(day,solucion_excepcion,current_timestamp)as dias FROM opste, usuarios WHERE estado_excepcion = %s and excepcion = %s and estado = %s and (opste.especialista_curse = usuarios.usuario) ORDER BY dias ASC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"));
...
<table width="95%" border="1" align="center">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle">Cambios Stand By Emitida</td>

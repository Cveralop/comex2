...
$query_tasavariable = sprintf("SELECT * ,adddate(inicio_periodo,periodisidad)as vcto_comision FROM optbc WHERE evento = '%s' and estado_comision = '%s' ORDER BY vcto_comision ASC", $colname_tasavariable,$colname1_tasavariable);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES COMISIONES PERIODICAS III B5 </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="tbccomisiondet.php?recordID=<?php echo $row_tasavariable['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    <td align="center" valign="middle"><?php echo $row_tasavariable['fecha_curse']; ?></div></td>
    <td align="left" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_tasavariable['nro_operacion']); ?></span>      </div></td>

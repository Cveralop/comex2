...
if (isset($_GET['tipo_operacion'])) {
  $colname3_cursada = (get_magic_quotes_gpc()) ? $_GET['tipo_operacion'] : addslashes($_GET['tipo_operacion']);
}
$colname2_cursada = "1";
...
$query_cursada = sprintf("SELECT * FROM opste WHERE evento LIKE '%%%s%%' and estado LIKE '%%%s%%' and fecha_curse LIKE '%%%s%%' and tipo_operacion LIKE '%%%s%%' ORDER BY id DESC", $colname_cursada,$colname1_cursada,$colname2_cursada,$colname3_cursada);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS STAND BY EMITIDAS </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="8" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Estado Operaciones Stand By Emitidas</span></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Fecha Curse: </div></td>
      ...
      <td align="left" valign="middle">Evento:</div></td>
      <td align="left" valign="middle">
      ...
      <td align="left" valign="middle">Estado:</div></td>
      <td align="left" valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="10" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Total Operaciones <span class="Estilo10"><?php echo $totalRows_cursada ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <?php do { ?>
  <tr>
    <td height="46" align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['nro_operacion']); ?></span>  </div></td>
    ...
    <td align="center" valign="middle"><?php echo $row_cursada['tipo_operacion']; ?></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_cursada['especialista_curse']); ?></div></td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opbga SET obs=%s, estado_comision=%s, periodisidad=%s, inicio_periodo=%s WHERE id=%s",
  ...
  $updateGoTo = "stdrcomisionmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DetailRS1 = sprintf("SELECT * FROM opbga  WHERE id = $recordID", $colname_tasavariable);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES  COMISIONES PERIODICAS BOLETAS DE GARANT&Iacute;A - MANTENCI&Oacute;N</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Detalle Operaci&oacute;n con Tasa Variable </div>
      </span></td>
    </tr>
    <tr valign="baseline">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="stdrcomisionmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

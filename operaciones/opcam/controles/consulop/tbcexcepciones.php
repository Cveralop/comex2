...
header("Content-Disposition: attachment;filename=optbc_excepciones.xls"); 
...
$query_excepciones = sprintf("SELECT optbc.*,(usuarios.nombre)as ne ,timestampdiff(day,solucion_excepcion,current_timestamp)as dias FROM optbc, usuarios WHERE estado_excepcion = %s and excepcion = %s and estado = %s and (optbc.especialista_curse = usuarios.usuario) ORDER BY solucionado ASC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"));
...
<table width="95%" border="1" align="center">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle">Cambios III B5</td>

...
header("Content-Disposition: attachment;filename=opbga_excepciones.xls"); 
...
$query_excepciones = sprintf("SELECT opbga.*,(usuarios.nombre)as ne ,timestampdiff(day,solucion_excepcion,current_timestamp)as dias FROM opbga, usuarios WHERE estado_excepcion = %s and excepcion = %s and estado = %s and (opbga.especialista_curse = usuarios.usuario) ORDER BY solucionado ASC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"));
...
<table width="95%" border="1" align="center">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle">Cambios Boletas de Garant&iacute;as</td>

...
$query_DetailRS1 = sprintf("SELECT * FROM optbc WHERE fecha_curse = '%s' and tipo_operacion = '%s' and  pagare <> '%s' ORDER BY nro_operacion ASC", $colname_DetailRS1,$colname1_DetailRS1,$colname2_DetailRS1);
...
<table width="95%"  border="0" align="center">
  <tr>
    <td valign="middle"><img src="../../../../imagenes/JPEG/logo_carta.JPG" alt="" width="219" height="61" align="left"></td>
  </tr>

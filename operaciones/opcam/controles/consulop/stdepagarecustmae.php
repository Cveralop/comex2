...
$query_letcus = sprintf("SELECT * FROM opste WHERE fecha_curse = '%s' and pagare <> '%s'", $colname1_letcus,$colname2_letcus);
...
<br>
<form name="form1" method="get" action="stdepagarecustdet.php">

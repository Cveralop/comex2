...
$query_pendientes = sprintf("SELECT * FROM opcex WHERE evento LIKE '%%%s%%' and estado = '%s' ORDER BY id ASC", $colname_pendientes,$colname1_pendientes);
...
<title>Control Operaciones Pendientes Otros Productos</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES PENDIENTES OTROS PRODUCTOS </td>

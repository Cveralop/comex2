...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET obs=%s, estado_comision=%s, periodisidad=%s, inicio_periodo=%s WHERE id=%s",
                       GetSQLValueString($_POST['obs'], "text"),
                       GetSQLValueString($_POST['estado_comision'], "text"),
                       GetSQLValueString($_POST['periodisidad'], "text"),
                       GetSQLValueString($_POST['inicio_periodo'], "date"),
                       GetSQLValueString($_POST['id'], "int"));
  mysqli_select_db($comercioexterior, $database_comercioexterior);
  $Result1 = mysqli_query($comercioexterior, $updateSQL) or die(mysqli_error($comercioexterior));
  $updateGoTo = "stdecomisionmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DetailRS1 = sprintf("SELECT * FROM opste  WHERE id = $recordID", $colname_tasavariable);
...
<title>Control Operaciones Comisiones Periodicas Stand BY Emitidas</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES  COMISIONES PERIODICAS STAND BY EMITIDAS - MANTENCI&Oacute;N</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo9">Detalle Operaci&oacute;n Comisiones Periodicas </span></div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Rut Banco:</div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="17" maxlength="17">
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="vcto_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['vcto_operacion']; ?>" size="12" maxlength="10">
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Inicio Nuevo Periodo:</div></td>
      <td align="center" valign="middle">
        <input name="inicio_periodo" type="text" class="etiqueta12" id="inicio_periodo" value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10">
        <span class="rojopequeno">(aaaa-mm-dd)</span>
      </div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Estado Comisi&oacute;n:</td>
      <td colspan="3" align="left" valign="middle"><select name="estado_comision" class="etiqueta12" id="estado_comision">
        <option value="Pendiente." selected>Vigente</option>
        <option value="Pagada.">Pagada</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Actualizar Cobro Comisi&oacute;n">
      </div></td>
    </tr>
  </table>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="stdecomisionmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

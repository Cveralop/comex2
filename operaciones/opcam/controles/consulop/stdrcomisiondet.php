...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET obs=%s, estado_comision=%s, periodisidad=%s, inicio_periodo=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opstr  WHERE id = $recordID", $colname_tasavariable);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES  COMISIONES PERIODICAS STAND BY RECIBIDAS - MANTENCI&Oacute;N</td>

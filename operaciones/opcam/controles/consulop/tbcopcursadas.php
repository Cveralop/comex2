...
$query_cursada = sprintf("SELECT * FROM optbc WHERE evento LIKE '%%%s%%' and estado LIKE '%%%s%%' and fecha_curse LIKE '%%%s%%' ORDER BY id DESC", $colname_cursada,$colname1_cursada,$colname2_cursada);
...
-->
</style><title>Operaciones Cursadas III B5</title>
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS III B5</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Estado Operaciones Cursadas III B5 </span></span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle">
      <span class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['moneda_operacion']); ?></span><span class="Estilo6"><span class="respuestacolumna_azul"> <?php echo number_format($row_cursada['monto_operacion'], 2, ',', '.'); ?></span></span></tr>

...
$query_modificar = sprintf("SELECT * FROM opste WHERE nro_operacion LIKE %s and evento LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_modificar . "%", "text"),GetSQLValueString("%" . $colname1_modificar . "%", "text"));
...
<title>Modificar Otros Eventos Stand BY Emitida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR OTROS EVENTOS STAND BY EMITIDA - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><span class="Estilo5"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></td>
    ...
    <td align="right" valign="middle"><span class="Estilo5"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span><br>
          <strong><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong> </td>
  </tr>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET evento=%s, operador=%s, nro_operacion=%s, obs=%s, especialista=%s, ejecutivo=%s, moneda_operacion=%s, monto_operacion=%s, referencia=%s, tipo_operacion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opste  WHERE id = $recordID", $colname_modificar);
...
<title>Modificar Otros Eventos Stand BY Emitida - Detalle</title>
<style type="text/css">
<!--
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Pago Comision." <?php if (!(strcmp("Pago Comision.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Pago Comision</option>
      </select></td>

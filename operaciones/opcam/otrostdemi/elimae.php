...
$query_eliminar = sprintf("SELECT * FROM opste WHERE nro_operacion LIKE %s and evento = %s ORDER BY nro_operacion ASC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Otros Eventos Stand BY Emitida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR OTROS EVENTOS STAND BY EMITIDA - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Rut Ordenante 
      </div>
    </td>
    <td align="center" valign="middle" class="titulocolumnas">Nombre Ordenante
      </div>
    </td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE optbc SET evento=%s, operador=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, urgente=%s, fuero_horario=%s WHERE id=%s",
...
<title>Modificar Prestamo - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR PRESTAMO  - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Prestamo</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="asignador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20" maxlength="20">
      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="17" maxlength="7"> 
        <span class="rojopequeno">F000000</span></td>
      <td align="right" valign="middle">Espacialista:</div></td>
      <td align="center" valign="middle"><input name="especialista" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['especialista']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Tipo Operacion:</div></td>
      <td align="center" valign="middle">        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        <option value="Confirming." <?php if (!(strcmp("Confirming.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Confirming</option>
        <option value="Credito Comercial." <?php if (!(strcmp("Credito Comercial.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Credito Comercial</option>
        <option value="Finan. Contado." <?php if (!(strcmp("Finan. Contado.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Finan. Contado</option>
        <option value="Forfaiting." <?php if (!(strcmp("Forfaiting.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Forfaiting</option>
        <option value="PAE." <?php if (!(strcmp("PAE.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>PAE</option>
            <option value="PAE Cobex." <?php if (!(strcmp("PAE Cobex.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>PAE Cobex</option>
      </select>
      </div></td>
    </tr>
    <tr valign="baseline">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../opcam/prestamos.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

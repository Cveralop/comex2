...
$query_eliminar = sprintf("SELECT * FROM optbc WHERE rut_cliente LIKE %s and evento = %s", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Prestamo - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR PRESTAMO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Emilinar Prestamo</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda / Monto Operaci&oacute;n </span>      </div></td>
    <td align="center" valign="middle" class="titulocolumnas">Tipo Operaci&oacute;n </td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td height="26" align="center" valign="middle"><a href="elidet.php?recordID=<?php echo $row_eliminar['id']; ?>"> <img src="../../../imagenes/ICONOS/papelero.jpg" width="20" height="21" border="0"></a></td>
    ...
    <td align="center" valign="middle"><?php echo $row_eliminar['operador']; ?> </td>
    <td align="right" valign="middle"><span class="Estilo6"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span> <strong><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>

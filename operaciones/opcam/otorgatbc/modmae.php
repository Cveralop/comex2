...
$query_modificar = sprintf("SELECT * FROM optbc WHERE rut_cliente LIKE %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificar Prestamo - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR PRESTAMO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Prestamo</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><span class="Estilo8"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span>&nbsp; <strong><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>

...
if (isset($_GET['rut_cliente'])) {
  $colname_ingpre = (get_magic_quotes_gpc()) ? $_GET['rut_cliente'] : addslashes($_GET['rut_cliente']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingpre = sprintf("SELECT * FROM cliente WHERE rut_cliente LIKE '%s%%' ORDER BY rut_cliente ASC", $colname_ingpre);
$query_limit_ingpre = sprintf("%s LIMIT %d, %d", $query_ingpre, $startRow_ingpre, $maxRows_ingpre);
$ingpre = mysqli_query($comercioexterior, $query_limit_ingpre) or die(mysqli_error());
...
<title>Ingreso Prestamo - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO PRESTAMO  - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Busqueda de Cliente</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Ingresar Prestamo</div></td>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_ingpre < $totalPages_ingpre) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_ingpre=%d%s", $currentPage, $totalPages_ingpre, $queryString_ingpre); ?>">�ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>

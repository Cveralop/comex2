...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET operador=%s, obs=%s, especialista=%s, ejecutivo=%s, moneda_operacion=%s, monto_operacion=%s, banco=%s, rut_banco=%s, pais=%s, referencia=%s, tipo_operacion=%s, vcto_operacion=%s, otros_ben=%s, ordenante=%s, plazo=%s, gastos=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
<title>Modificaci&oacute;n Stand BY Recibida - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N STAND BY RECIBIDA - DETALLE </td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Registro Stand BY Recibida</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <td align="center" valign="middle"><input name="fecha_ingreso" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_ingreso']; ?>" size="12" maxlength="10">
      ...
      <td align="center" valign="middle"><select name="evento" disabled="disabled" class="etiqueta12" id="evento">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="17" maxlength="17"></td>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="center" valign="middle"><input name="banco" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['banco']; ?>" size="122" maxlength="120"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Rut Ordenante:</td>
    <td align="center" valign="middle"><input name="rut_banco" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_banco']; ?>" size="15" maxlength="12">
          <span class="rojopequeno">Sin puntos ni Guion</span></td>
      <td align="right" valign="middle">Pais:</td>
      <td align="center" valign="middle"><input name="pais" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['pais']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Referencia:</td>
      <td align="center" valign="middle"><input name="referencia" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['referencia']; ?>" size="50" maxlength="50"></td>
    ...
    <td colspan="3" align="left" valign="middle"><input name="vcto_operacion" type="text" class="etiqueta12" id="vcto_operacion" value="<?php echo $row_DetailRS1['vcto_operacion']; ?>" size="12" maxlength="10">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">&nbsp;Otro Ordenante:</td>
      <td colspan="3" align="left" valign="middle"><input name="ordenante" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['ordenante']; ?>" size="122" maxlength="120"></td>
    </tr>
    <tr valign="baseline">
      ...
      Beneficiario</label>
          <label>
          <input  <?php if (!(strcmp($row_DetailRS1['gastos'],"APL"))) {echo "CHECKED";} ?> name="gastos" type="radio" class="etiqueta12" value="APL">
      Aplicante</label></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
          <input type="submit" class="boton" value="Modificar Registro Stand BY Recibida">
      </div></td>
    </tr>
  </table>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="modmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

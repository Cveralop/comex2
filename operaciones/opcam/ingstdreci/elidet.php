...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET estado=%s, asignador=%s, operador=%s, obs=%s, sub_estado=%s, date_oper=%s, visador=%s WHERE id=%s",
...
<title>Eliminar Stand BY Recibidas - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR STAND BY RECIBIDAS - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Stand BY Recibida</span></div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="rut_cliente" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="15" maxlength="12"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="fecha_ingreso" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_ingreso']; ?>" size="12" maxlength="10"></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="operador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="baseline">
...
Monto Operaci&oacute;n:</td>
      ...
      <td align="right" valign="middle">Nro Operaci&oacute;n:</td>
      <td align="center" valign="middle"><input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="17" maxlength="15"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Eliminar Registro Stand BY Recibidas">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="id" value="<?php echo $row_DetailRS1['id']; ?>">
  <input type="hidden" name="MM_update" value="form1">
  <input name="estado" type="hidden" class="etiqueta12" value="Eliminada." size="20" maxlength="20">

...
$colname_elimiar = "zzzxxx";
if (isset($_GET['nombre_cliente'])) {
  $colname_elimiar = $_GET['nombre_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_elimiar = sprintf("SELECT * FROM opstr WHERE nombre_cliente LIKE %s ORDER BY nombre_cliente ASC", GetSQLValueString($colname_elimiar . "%", "text"));
...
<title>Eliminar Stand BY Recibidas - Maestro</title>
<style type="text/css">
<!--
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Eliminar Stand BY Recibida </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Eliminar</td>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_elimiar < $totalPages_elimiar) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_elimiar=%d%s", $currentPage, $totalPages_elimiar, $queryString_elimiar); ?>">�ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>

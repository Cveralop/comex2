...
$query_modificacion = sprintf("SELECT * FROM opstr WHERE nombre_cliente LIKE %s and evento = %s ORDER BY nombre_cliente ASC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"));
...
<title>Modificaci&oacute;n Stand BY Recibida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N STAND BY RECIBIDA - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificaci&oacute;n Stand BY Recibida</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nombre Banco:</div></td>

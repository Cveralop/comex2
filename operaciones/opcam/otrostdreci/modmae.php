...
$query_modificar = sprintf("SELECT * FROM opstr WHERE nro_operacion LIKE %s and evento LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificar . "%", "text"),GetSQLValueString("%" . $colname1_modificar . "%", "text"));
...
<title>Modificar Otros Eventos Stand BY Recibida - Maestro</title>
<style type="text/css">
<!--
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo8">Modificar Eventos</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><?php echo $row_modificar['rut_cliente']; ?></td>
    <td align="left" valign="middle"><?php echo $row_modificar['nombre_cliente']; ?></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></td>
    <td align="center" valign="middle"><?php echo $row_modificar['fecha_ingreso']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificar['evento']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificar['estado']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificar['tipo_operacion']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificar['vcto_operacion']; ?></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span><br>
          <strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong> </td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="../cambio.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

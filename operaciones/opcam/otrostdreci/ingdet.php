...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opstr (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, obs, especialista, ejecutivo, moneda_operacion, monto_operacion, banco, rut_banco, referencia, tipo_operacion, date_asig, estado_visacion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM opstr  WHERE id = $recordID",$colname_DetailRS1); //$colname_ingreso
...
<title>Ingresar Otros Eventos Stand BY Recibida - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESAR OTROS EVENTOS  STAND BY RECIBIDA - MAESTRO</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="referencia" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['referencia']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
  ...
  <input name="banco" type="hidden" id="banco" value="<?php echo $row_DetailRS1['banco']; ?>">
  <input name="rut_banco" type="hidden" id="rut_banco" value="<?php echo $row_DetailRS1['rut_banco']; ?>">

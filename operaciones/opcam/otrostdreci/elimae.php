...
$query_eliminar = sprintf("SELECT * FROM opstr WHERE nro_operacion LIKE %s and evento = %s ORDER BY nro_operacion ASC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"));
$query_limit_eliminar = sprintf("%s LIMIT %d, %d", $query_eliminar, $startRow_eliminar, $maxRows_eliminar);
$eliminar = mysqli_query($comercioexterior, $query_limit_eliminar) or die(mysqli_error($comercioexterior));
...
<title>Eliminar Otros Eventos Stand BY Recibida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR OTROS EVENTOS STAND BY RECIBIDA - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Otros Eventos </span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Aviso Vcto.">Aviso Vcto</option>
      </select></td>
    </tr>
    <tr align="center">
      <td colspan="2" align="center" valign="middle"><input name="Submit" type="submit" class="boton" value="Buscar"></td>
    </tr>
  </table>
</form>
<br>
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Eliminar</span>      </div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_eliminar['fecha_ingreso']; ?> </td>
    <td align="center" valign="middle"><?php echo $row_eliminar['evento']; ?></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['estado']; ?></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['tipo_operacion']; ?> </td>
    <td align="center" valign="middle"><?php echo $row_eliminar['vcto_operacion']; ?> </td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong></td>
  </tr>
...
<br>
Registros del <strong><?php echo ($startRow_eliminar + 1) ?></strong> al <strong><?php echo min($startRow_eliminar + $maxRows_eliminar, $totalRows_eliminar) ?></strong> de un total de <strong><?php echo $totalRows_eliminar ?></strong> <br>
<br>

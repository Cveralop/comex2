...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opstr SET estado=%s, obs=%s, sub_estado=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opstr  WHERE id = $recordID", $colname_eliminar);
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><label>
        <input name="operador" type="text" disabled class="etiqueta12" id="operador" value="<?php echo $_SESSION['login'];?>">
      </label></td>
    </tr>
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        ...
        <span class="etiqueta12" id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></label>
</span></td>
    </tr>
    <tr valign="baseline">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="elimae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

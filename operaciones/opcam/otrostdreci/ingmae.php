...
$query_ingreso = sprintf("SELECT * FROM opstr WHERE nro_operacion LIKE %s and evento = %s", GetSQLValueString($colname_ingreso . "%", "text"),GetSQLValueString($colname1_ingreso, "text"));
$query_limit_ingreso = sprintf("%s LIMIT %d, %d", $query_ingreso, $startRow_ingreso, $maxRows_ingreso);
$ingreso = mysqli_query($comercioexterior, $query_limit_ingreso) or die(mysqli_error($comercioexterior));
...
<title>Ingresar Otros Eventos Stand BY Recibida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3">INGRESAR OTROS EVENTOS  STAND BY RECIBIDA - MAESTRO</td>

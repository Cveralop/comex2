...
if (isset($_GET['nro_operacion'])) {
  $colname2_modificar = (get_magic_quotes_gpc()) ? $_GET['nro_operacion'] : addslashes($_GET['nro_operacion']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM opbga WHERE nro_operacion LIKE '%s%%' ORDER BY id DESC", $colname2_modificar);
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="21%" align="right" valign="middle">Numero Operaci&oacute;n:</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="Estilo7"><?php echo $row_modificar['nro_operacion']; ?></span></td>

...
$query_ingreso = sprintf("SELECT * FROM opbga WHERE nro_operacion LIKE '%s%%' ORDER BY rut_cliente ASC", $colname_ingreso);
...
<title>Evento Boleta - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">EVENTO BOLETA - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Evento Boleta </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Ingresar Registro </div></td>
...
<br>
Registros del <strong><?php echo ($startRow_ingreso + 1) ?></strong> al de un total de <strong><?php echo min($startRow_ingreso + $maxRows_ingreso, $totalRows_ingreso) ?></strong> de <strong><?php echo $totalRows_ingreso ?></strong>

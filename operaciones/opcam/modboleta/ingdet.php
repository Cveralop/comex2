...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opbga (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, obs, especialista, ejecutivo, moneda_operacion, monto_operacion, date_asig, tipo_operacion, estado_visacion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM opbga  WHERE id = $recordID", $colname_ingreso);
...
<title>Evento Boleta - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">EVENTO BOLETA - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Evento Boleta </span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
            ...
            <span class="rojopequeno">/</span>            <input name="monto_operacion" type="text" class="etiqueta12" id="monto_operacion" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="17" maxlength="15">
          </div>

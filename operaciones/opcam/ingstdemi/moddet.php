...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET operador=%s, nro_operacion=%s, obs=%s, especialista=%s, ejecutivo=%s, moneda_operacion=%s, monto_operacion=%s, banco=%s, rut_banco=%s, pais=%s, referencia=%s, tipo_operacion=%s, vcto_operacion=%s, otros_ben=%s, ordenante=%s, plazo=%s, gastos=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
$query_DetailRS1 = "SELECT * FROM opste WHERE id = $recordID";
...
<title>Modificaci&oacute;n Stand BY Emitida - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N STAND BY EMITIDA - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Registro Stand BY Emitida</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="rut_banco" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_banco']; ?>" size="15" maxlength="12">          </td>
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Beneficiario(s):</td>
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
          <input type="submit" class="boton" value="Modificar Registro Stand BY Emitida">
      </div></td>
    </tr>
  </table>

...
if (isset($_GET['rut_cliente'])) {
  $colname1_stbr = $_GET['rut_cliente'];
}
$colname_stbr = "1";
if (isset($_GET['nombre_cliente'])) {
  $colname_stbr = $_GET['nombre_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_stbr = sprintf("SELECT * FROM cliente WHERE nombre_cliente LIKE %s and rut_cliente LIKE %s ORDER BY id ASC", GetSQLValueString($colname_stbr . "%", "text"),GetSQLValueString($colname1_stbr . "%", "text"));
...
<title>Ingreso Stand BY Emitida - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO STAND BY EMITIDA - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso Stand BY Emitida</span></td>
    </tr>
    <tr>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_stbr < $totalPages_stbr) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_stbr=%d%s", $currentPage, $totalPages_stbr, $queryString_stbr); ?>">&Uacute;ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>

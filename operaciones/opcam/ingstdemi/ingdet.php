...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opste (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, obs, especialista, ejecutivo, moneda_operacion, monto_operacion, tipo_operacion, despacho_doctos, sucursal, segmento, date_asig, estado_visacion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Ingreso Stand BY Emitida - Detalle</title>
<style type="text/css">
<!--
...
function MM_validateForm() { //v4.0
  ...
  } if (errors) alert('El(los) siguiente(s) error(es) han ocurrido:\n'+errors);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO STAND BY EMITIDA - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','rut_cliente','','R','nombre_cliente','','R','asignador','','R','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso Stand BY Emitida</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Ingresar Stand BY Emitida">
      </div></td>
    </tr>
  </table>

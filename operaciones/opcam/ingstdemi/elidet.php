...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET estado=%s, asignador=%s, operador=%s, obs=%s, sub_estado=%s, date_oper=%s, visador=%s WHERE id=%s",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Stand BY Emitida</span></div></td>
    </tr>
    <tr valign="baseline">
...
Monto Operaci&oacute;n:</td>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        ...
        <span class="textareaFlashState" id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></label>
</span></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Eliminar Apertura Stand BY Emitida">
      </div></td>
    </tr>
  </table>

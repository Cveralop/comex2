...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opbga SET evento=%s, fecha_curse=%s, date_curse=%s, asignador=%s, operador=%s, nro_operacion=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, pagare=%s, beneficiario=%s, sub_estado=%s, vcto_operacion=%s, date_visa=%s, date_asig=%s, date_oper=%s, tipo_operacion=%s, reparo_obs=%s, estado_visacion=%s, visador=%s, mandato=%s, excepcion=%s, excepcion_comision=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, responsable_excepcion=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3">VISACI&Oacute;N - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">Mandato:</td>
...
No</label>
    ...
    <tr valign="baseline">
      <td colspan="6" align="left" valign="middle" bgcolor="#999999"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"></span></div> <span class="Estilo5"><span class="titulodetalle">Curse Operaci&oacute;n </span></span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Pagare Cutodia:</td>
      <td colspan="5" align="left" valign="middle"><input name="pagare" type="checkbox" class="etiqueta12" id="pagare" value="Y">
      <span class="rojopequeno">(Si)</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Beneficiario:</td>
      <td colspan="5" align="left" valign="middle"><input name="beneficiario" type="text" class="etiqueta12" id="beneficiario" size="122" maxlength="120"></td>
    </tr>
    <tr valign="baseline">

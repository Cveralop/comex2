...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">CAMBIOS - STAND BY EMITIDAS</td>
  </tr>
</table>
<br>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="titulodetalle">Visaci&oacute;n Operaci&oacute;n Stand BY Emitidas</div>
      </span></td>
    </tr>
    <tr valign="baseline">
...
<option value="Dev Comisiones." <?php if (!(strcmp("Dev Comisiones.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Dev Comisiones</option>
    ...
    <tr valign="baseline">
      <td colspan="6" align="left" valign="middle" bgcolor="#999999"><img src="../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"><span class="titulodetalle">Excepci&oacute;n Operaci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Excepci&oacute;n: </td>
      <td align="center" valign="middle"><label>
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Excepci&oacute;n Comisi&oacute;n:</td>
      <td align="center" valign="middle"><label>
...
No</label>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2" align="center" valign="middle"><input name="vcto_operacion" type="text" class="etiqueta12" id="vcto_operacion" value="0000-00-00" size="12" maxlength="10">
      <span class="rojopequeno">(aaaa-mm-dd)</span></td>
      <td align="right" valign="middle">Periodisidad:</td>
      <td colspan="2" align="center" valign="middle"><span class="rojopequeno">
...
(aaaa-mm-dd)</span></td>
      <td align="right" valign="middle">Pagar&eacute;:</td>
      <td colspan="2" align="center" valign="middle"><select name="pagare" class="etiqueta12" id="pagare">
    ...
    <tr valign="baseline">
      ...
      Monto Operaci&oacute;n:</td>
      <td colspan="2" align="center" valign="middle"><select name="moneda_contra" class="etiqueta12" id="moneda_contra">
      ...
      <td colspan="2" align="center" valign="middle"><select name="estado_comision" class="etiqueta12" id="estado_comision">
    ...
    <tr valign="baseline">
      ...
      <td colspan="2" align="center" valign="middle"><input name="rut_banco" type="text" class="etiqueta12" id="rut_banco" value="<?php echo $row_DetailRS1['rut_banco']; ?>" size="15" maxlength="12"></td>
      <td align="right" valign="middle">Referencia:</td>
      <td colspan="2" align="center" valign="middle"><input name="referencia" type="text" class="etiqueta12" id="referencia" value="<?php echo $row_DetailRS1['referencia']; ?>" size="50" maxlength="50"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="center" valign="middle"><input name="pais" type="text" class="etiqueta12" id="pais" value="<?php echo $row_DetailRS1['pais']; ?>" size="20" maxlength="20"></td>
    ...
    <tr valign="baseline">
      ...
      <span class="rojopequeno" id="countsprytextarea3">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="6" align="center" valign="middle">
          <input type="submit" class="boton" value="Visar / Cursar Operaci&oacute;n">
      </div>        </div>        </div></td>
    </tr>
  </table>

...
$colname1_modificacion = "Otorgamiento.";
...
$query_modificacion = sprintf("SELECT * FROM optbc WHERE nro_operacion = %s and evento = %s", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"));
...
-->
</style><title>Ingreso Modificaci&oacute;n Prestamos Varios - Maestro</title>
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO MODIFICACI&Oacute;N PRESTAMOS VARIOS - MAESTRO</td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Ingreso Modificaci&oacute;n Prestamos Varios </span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nro Operacion:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="8" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo11"><?php echo strtoupper($row_modificacion['nro_operacion']); ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Ingresar</span>      </div></td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Nro Cuotas 
      </div>
    </td>
    <td align="center" valign="middle" class="titulocolumnas">Pagar&eacute;</div>
    </td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td align="left" valign="middle"><?php echo $row_modificacion['nombre_cliente']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificacion['estado']; ?></div>       </div></td>
    <td align="right" valign="middle"><span class="Estilo9"><?php echo strtoupper($row_modificacion['moneda_operacion']); ?></span> <strong><?php echo number_format($row_modificacion['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificacion['nro_cuotas']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificacion['pagare']; ?> </div></td>
  </tr>

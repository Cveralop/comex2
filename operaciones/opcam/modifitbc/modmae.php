...
$query_modificar = sprintf("SELECT * FROM optbc WHERE nro_operacion LIKE %s and evento = %s and rut_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar, "text"),GetSQLValueString("%" . $colname2_modificar . "%", "text"));
...
<title>Modificar Prestamos Varios - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR  PRESTAMOS VARIOS - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar  Prestamos Varios</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="10" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Numero Operaci&oacute;n <span class="Estilo10"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></span></div></td>
  </tr>
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center" valign="middle"><span class="Estilo8"><span class="titulocolumnas">Modificar</span></span></td>
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><?php echo $row_modificar['fecha_ingreso']; ?> </div>
        </div></td>
    ...
    <td align="center" valign="middle"><?php echo $row_modificar['evento']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['estado']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['operador']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['tipo_operacion']; ?></div></td>
    <td align="right" valign="middle"><span class="Estilo9"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span> <strong><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['nro_cuotas']; ?></div></td>
  </tr>

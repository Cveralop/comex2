...
$query_DetailRS1 = sprintf("SELECT * FROM optbc  WHERE id = $recordID", $colname_eliminar);
...
<title>Eliminar Modificaci&oacute;n Prestamos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR MODIFICACI&Oacute;N PRESTAMOS - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Modificaci&oacute;n Prestamo </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><input name="operador" type="text" disabled class="etiqueta12" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Obaservaci&oacute;n:</td>
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Eliminar Registro">
      </div></td>
    </tr>
  </table>

...
if (isset($_GET['rut_cliente'])) {
  $colname2_eliminar = $_GET['rut_cliente'];
}
$colname1_eliminar = "1";
...
$query_eliminar = sprintf("SELECT * FROM optbc WHERE nro_operacion LIKE %s and evento = %s and rut_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"),GetSQLValueString("%" . $colname2_eliminar . "%", "text"));
...
<title>Eliminar Modificaci&oacute;n Prestamos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR MODIFICACI&Oacute;N PRESTAMOS - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Eliminar Modificaci&oacute;n Prestamo</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_eliminar['nro_cuotas']; ?> </div></td>
  </tr>

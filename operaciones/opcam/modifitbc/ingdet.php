...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO optbc (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, obs, especialista, moneda_operacion, monto_operacion, nro_cuotas, sucursal, fecha_curse_inicial, date_asig, tipo_operacion, estado_visacion, urgente, fuero_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM optbc  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion);
...
-->
</style><title>Ingreso Modificaci&oacute;n Prestamos Varios - Detalle</title>
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO MODIFICACI&Oacute;N PRESTAMOS VARIOS - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','nro_cuotas','','RinRange1:40','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Ingreso Prestamos Varios</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="nro_cuotas" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_cuotas']; ?>" size="5" maxlength="3">
    ...
    <tr valign="baseline">
      ...
      <span class="rojopequeno" id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span></p></td>
    </tr>
    <tr valign="baseline">

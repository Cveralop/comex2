...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opbga SET fecha_ingreso=%s, evento=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",

...
$query_eliminar = sprintf("SELECT * FROM opbga WHERE rut_cliente = %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_eliminar, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><?php echo $row_eliminar['nombre_cliente']; ?></td>

...
$query_ingreso = sprintf("SELECT * FROM cliente WHERE rut_cliente = %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_ingreso, "text"));
...
<title>Ingreso Otros Productos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO OTROS PRODUCTOS - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Otros Productos</span></td>
    </tr>
    <tr>

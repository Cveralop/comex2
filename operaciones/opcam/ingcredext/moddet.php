...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcex SET evento=%s, operador=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcex  WHERE id = $recordID", $colname_modificar);
...
<title>Modificaci&oacute;n Otros Productos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo7">MODIFICAR OTROS PRODUCTOS - MAESTRO</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td valign="middle"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?></span>        </div></td>
    ...
    <tr valign="baseline">
      ...
      <td valign="middle"><select name="operador" class="etiqueta12" id="operador">

...
$colname_eliminar = "xxx";
if (isset($_GET['rut_cliente'])) {
  $colname_eliminar = $_GET['rut_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opcex WHERE rut_cliente = %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_eliminar, "text"));
...
<title>Eliminar Otros Productos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR OTROS PRODUCTOS - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Eliminar Operaci&oacute;n</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><span class="Estilo8"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span> <strong><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['nro_inscripcion']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['tipo_plazo']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['tipo_tasa']; ?></div></td>
  </tr>

...
$query_modificar = sprintf("SELECT * FROM opcex WHERE rut_cliente LIKE %s and nombre_cliente LIKE %s and monto_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar . "%", "text"),GetSQLValueString($colname2_modificar . "%", "double"));
...
<title>Modificaci&oacute;n Otros Productos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR OTROS PRODUCTOS - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo6">Modificar Otros Productos</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Nro Inscripci&oacute;n </div>
    </td>
    <td align="center" valign="middle" class="titulocolumnas">Tipo Plazo 
      </div>
    </td>
    <td align="center" valign="middle" class="titulocolumnas">Tipo Tasa 
      </div>
    </td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td align="right" valign="middle"><?php echo $row_modificar['nombre_cliente']; ?> </td>
    <td align="right" valign="middle"><span class="Estilo7"><?php echo $row_modificar['moneda_operacion']; ?></span> <strong><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['fecha_ingreso']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['nro_inscripcion']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['tipo_plazo']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_modificar['tipo_tasa']; ?> </div></td>
  </tr>

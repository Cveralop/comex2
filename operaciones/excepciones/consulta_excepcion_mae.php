...
$consulta_excepciones = mysql_query($query_consulta_excepciones, $comercioexterior) or die(mysqli_error());
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">CONSULTA EXCEPCIONES  - MAESTRO</td>
...
<?php if ($totalRows_consulta_excepciones > 0) { // Show if recordset not empty ?>
  <table border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="13" align="left" bgcolor="#999999" class="titulodetalle"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" />Rut ClienteNombre Cliente <span class="tituloverde"><?php echo $row_consulta_excepciones['nombre_cliente']; ?></span></td>
    </tr>
    <tr>
      <td class="titulocolumnas">Ver Excepción</td>
      <td class="titulocolumnas">Ejecuti<span class="titulodetalle"><span class="tituloverde"><?php echo $row_consulta_excepciones['rut_cliente']; ?></span></span>vo Ni</td>
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><a href="consulta_excepcion_det.php?recordID=<?php echo $row_consulta_excepciones['id']; ?>"><img src="../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0" /></a></td>

...
$query_iteraciones = sprintf("SELECT evento,operador,iteraciones,tipo_operacion,sum(iteraciones)as total,(usuarios.nombre)as nombre FROM oppre, usuarios WHERE date_curse between %s and %s and estado = %s and (oppre.operador = usuarios.usuario) and iteraciones > %s GROUP BY operador, evento ORDER BY total desc", GetSQLValueString($colname2_iteraciones, "date"),GetSQLValueString($colname3_iteraciones, "date"),GetSQLValueString($colname1_iteraciones, "text"),GetSQLValueString($colname4_iteraciones, "int"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../estadistica/estadistica.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="left" valign="middle"> <span class="respuestacolumna"><?php echo strtoupper($row_iteraciones['nombre']); ?></span>      </td>
    <td valign="middle" class="respuestacolumna"><?php echo strtoupper($row_iteraciones['tipo_operacion']); ?></td>
    <td valign="middle">&nbsp;<span class="respuestacolumna"><?php echo strtoupper($row_iteraciones['evento']); ?></span>      </td>
    <td valign="middle"><strong class="respuestacolumna"><?php echo $row_iteraciones['total']; ?></strong></td>
    </tr>

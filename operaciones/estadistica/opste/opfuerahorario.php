...
$query_flujo = sprintf("SELECT opste.*,count(opste.id)as cantidad,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opste, usuarios WHERE date_curse between %s and %s and (opste.especialista_curse = usuarios.usuario) and estado = %s and fuera_horario = %s GROUP BY nombre asc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"),GetSQLValueString($colname5_flujo, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" valign="middle">
    ...
    <td valign="middle">STAND BY EMITIDA <span class="respuestacolumna"><?php echo strtoupper($row_flujo['tipo_operacion']); ?></span></td>

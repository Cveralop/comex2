...
$query_flujo = sprintf("SELECT opste.*,(usuarios.nombre)as nombre,count(opste.id)as cantidad,(usuarios.segmento)as seg FROM opste, usuarios WHERE date_ingreso between %s and %s and (opste.especialista_curse = usuarios.usuario) and estado = %s GROUP BY nombre,tipo_operacion,evento ORDER BY cantidad desc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="titulocolumnas"><span class="subtitulopaguina">STAND BY EMITIDAS</span></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" valign="middle">
    ...
    <td>STAND BY EMITIDA <span class="respuestacolumna"><?php echo $row_flujo['tipo_operacion']; ?></span></td>

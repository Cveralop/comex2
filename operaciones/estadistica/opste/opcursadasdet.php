...
header("Content-Disposition: attachment;filename=opste_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opste.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opste, usuarios WHERE date_ingreso between %s and %s and (opste.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));

...
$query_flujo = sprintf("SELECT autorizador,tipo_operacion,nro_operacion,evento,date_supe,min(date_supe)as minimo,max(date_supe)as maximo,count(opste.id)as cantidad,(usuarios.nombre)as nombre FROM opste, usuarios WHERE date_curse between %s and %s and estado = %s and (opste.autorizador = usuarios.usuario) GROUP BY autorizador,tipo_operacion,evento ORDER BY autorizador asc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname1_flujo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td height="18" align="left" valign="middle" bgcolor="#FF0000" class="subtitulopaguina">STAND BY EMITIDAS</td>
  </tr>
</table>
<br>

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td valign="middle">STAND BY EMITIDA <?php echo strtoupper($row_iteraciones['tipo_operacion']); ?></td>

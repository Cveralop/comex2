...
header("Content-Disposition: attachment;filename=opcce_reparadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opcce.*,(usuarios.nombre)as ne, (usuarios.segmento)as seg FROM opcce, usuarios WHERE date_curse between %s and %s and (opcce.especialista_curse = usuarios.usuario) and estado = %s", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"),GetSQLValueString($colname4_DetailRS1, "text"));

...
header("Content-Disposition: attachment;filename=opcce_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opcce.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opcce, usuarios WHERE date_ingreso between %s and %s and (opcce.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));

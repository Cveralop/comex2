...
$query_flujo = sprintf("SELECT optbc.*,count(optbc.id)as cantidad,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM optbc, usuarios WHERE date_curse between %s and %s and (optbc.especialista_curse = usuarios.usuario) and estado = %s and fuero_horario = %s GROUP BY nombre asc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"),GetSQLValueString($colname5_flujo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="subtitulopaguina">IIIB5</div></td>
  </tr>
</table>
<br>

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td valign="middle">&nbsp;<span class="respuestacolumna">III B5</span>      </div></td>
    <td valign="middle"> <span class="respuestacolumna"><?php echo $row_iteraciones['evento']; ?></span>      </div></td>

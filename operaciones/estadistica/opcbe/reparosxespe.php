...
$query_flujo = sprintf("SELECT opcbe.*,(usuarios.nombre)as nombre,count(opcbe.id)as cantidad,(usuarios.segmento)as seg FROM opcbe, usuarios WHERE date_ingreso between %s and %s and (opcbe.especialista_curse = usuarios.usuario) and estado = %s GROUP BY nombre,evento ORDER BY cantidad desc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="titulocolumnas"><span class="subtitulopaguina">COBRANZA EXTRANJERA DE EXPORTACI&Oacute;N</span></td>
  </tr>
</table>
<br>

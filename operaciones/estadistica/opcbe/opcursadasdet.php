...
header("Content-Disposition: attachment;filename=opcbe_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opcbe, usuarios WHERE date_ingreso between %s and %s and (opcbe.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));

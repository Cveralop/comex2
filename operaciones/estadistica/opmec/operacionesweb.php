...
$query_flujo = sprintf("SELECT * FROM opmec nolock WHERE fecha_curse LIKE %s and estado = %s and via_web = %s", GetSQLValueString("%" . $colname_flujo . "%", "date"),GetSQLValueString($colname1_flujo, "text"),GetSQLValueString($colname2_flujo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000"><span class="subtitulopaguina">MERCADO DE CORREDORES</span></td>
  </tr>
</table>
<br>

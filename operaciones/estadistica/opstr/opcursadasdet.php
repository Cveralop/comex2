...
header("Content-Disposition: attachment;filename=opstr_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opstr.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opstr, usuarios WHERE date_ingreso between %s and %s and (opstr.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));
...
<table width="95%" border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle">STAND BY RECIBIDAS <?php echo strtoupper($row_DetailRS1['tipo_operacion']); ?></td>

...
$query_cursada = sprintf("SELECT operador,evento,tipo_operacion,count(opcbi.id)as cursada,(usuarios.nombre)as nombre FROM opcbi,usuarios WHERE date_curse between %s and %s and estado = %s and (opcbi.operador = usuarios.usuario) GROUP BY tipo_operacion,evento ORDER BY tipo_operacion ASC", GetSQLValueString($colname2_cursada, "date"),GetSQLValueString($colname3_cursada, "date"),GetSQLValueString($colname1_cursada, "text"));
...
<title>Estadistica por Fecha - Operaciones Cursadas</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">ESTADISTICA POR FECHA OPERACIONES CURSADAS</span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><span class="respuestacolumna"><?php echo strtoupper($row_cursada['tipo_operacion']); ?></span></div></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_cursada['evento']); ?></td>

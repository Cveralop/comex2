...
header("Content-Disposition: attachment;filename=opcci_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opcci.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opcci, usuarios WHERE date_ingreso between %s and %s and (opcci.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));

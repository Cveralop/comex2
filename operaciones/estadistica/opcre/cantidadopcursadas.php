...
$query_cursada = sprintf("SELECT operador,tipo_operacion,count(operador)as cursada,(usuarios.nombre)as nombre FROM opcex,usuarios WHERE date_curse between %s and %s and estado = %s and (opcex.operador = usuarios.usuario) GROUP BY tipo_operacion ORDER BY tipo_operacion ASC", GetSQLValueString($colname2_cursada, "date"),GetSQLValueString($colname3_cursada, "date"),GetSQLValueString($colname1_cursada, "text"));

...
$colname4_flujo = "Cursada.";
if (isset($_GET['estado'])) {
  $colname4_flujo = $_GET['estado'];
}
$colname5_flujo = "Si";
if (isset($_GET['fuera_horario'])) {
  $colname5_flujo = $_GET['fuera_horario'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_flujo = sprintf("SELECT opcex.*,count(opcex.id)as cantidad,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opcex, usuarios WHERE date_curse between %s and %s and (opcex.especialista_curse = usuarios.usuario) and estado = %s and fuera_horario = %s GROUP BY nombre asc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"),GetSQLValueString($colname5_flujo, "text"));
...
<title>Operaciones Fuera Horario</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">OPERACIONES CURSADAS FUERA HORARIO</span></td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo3">Cursadas Fuera de Horario</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td valign="middle" class="titulocolumnas">Segmento</td>
    <td valign="middle" class="titulocolumnas">Tipo Operaci&oacute;n</td>
    <td valign="middle" class="titulocolumnas">Evento</td>
    <td valign="middle" class="titulocolumnas">Cantidad</td>
  </tr>
  <?php do { ?>
  <tr align="center" valign="middle">
    <td valign="middle"><span class="respuestacolumna"><?php echo strtoupper($row_flujo['ne']); ?> </span></td>
    <td valign="middle"><span class="respuestacolumna"><?php echo strtoupper($row_flujo['seg']); ?></span></td>
    <td valign="middle" class="respuestacolumna"><?php echo strtoupper($row_flujo['tipo_operacion']); ?></td>
    <td valign="middle"><span class="respuestacolumna"><?php echo strtoupper($row_flujo['evento']); ?></span></td>
    <td valign="middle" class="respuestacolumna"><?php echo $row_flujo['cantidad']; ?></td>
  </tr>

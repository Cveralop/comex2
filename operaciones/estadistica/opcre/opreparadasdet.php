...
header("Content-Disposition: attachment;filename=opcex_reparadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opcex.*,(usuarios.nombre)as ne, (usuarios.segmento)as seg FROM opcex, usuarios WHERE date_curse between %s and %s and (opcex.especialista_curse = usuarios.usuario) and estado = %s", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"),GetSQLValueString($colname4_DetailRS1, "text"));

...
$colname4_flujo = "Reparada.";
if (isset($_GET['estado'])) {
  $colname4_flujo = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_flujo = sprintf("SELECT opbga.*,(usuarios.nombre)as nombre,count(opbga.id)as cantidad,(usuarios.segmento)as seg FROM opbga, usuarios WHERE date_ingreso between %s and %s and (opbga.especialista_curse = usuarios.usuario) and estado = %s GROUP BY nombre,tipo_operacion,evento ORDER BY cantidad desc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"));
...
<title>Reparos por Especialista</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">REPAROS POR ESPECIALISTA</span></td>
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="titulocolumnas"><span class="subtitulopaguina">BOLETA DE GARANT&Iacute;A</span></td>
  </tr>
</table>
<br>
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo3">Reparos</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Fecha Ingreso:</td>
      <td width="79%" align="left" valign="middle">Desde
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" valign="middle">
    ...
    <td><?php echo strtoupper($row_flujo['seg']); ?></td>
    <td class="respuestacolumna">BOLETA DE GARIANTIA <?php echo strtoupper($row_flujo['tipo_operacion']); ?></td>

...
if (isset($_GET['evento'])) {
  $colname4_flujo = $_GET['evento'];
}
$colname5_flujo = "Si";
if (isset($_GET['urgente'])) {
  $colname5_flujo = $_GET['urgente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_flujo = sprintf("SELECT opbga.*,(usuarios.nombre)as nombre,count(urgente)as cantidad,(usuarios.segmento)as seg FROM opbga, usuarios WHERE date_ingreso between %s and %s and (opbga.especialista_curse = usuarios.usuario) and estado = %s and urgente = %s GROUP BY nombre,tipo_operacion,evento ORDER BY cantidad desc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname4_flujo, "text"),GetSQLValueString($colname5_flujo, "text"));
...
<title>Operaciones Urgentes Cursadas</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">OPERACIONES URGENTES CURSADAS</span></td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo3">Operaciones Urgentes Cursadas</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td class="titulocolumnas">Segmento</td>
  ...
  <tr align="center" valign="middle">
    ...
    <td class="respuestacolumna"><?php echo strtoupper($row_flujo['seg']); ?></td>
    <td class="respuestacolumna">BOLETA DE GARNATIA <?php echo strtoupper($row_flujo['tipo_operacion']); ?></td>

...
$query_flujo = sprintf("SELECT autorizador,nro_operacion,evento,date_supe,min(date_supe)as minimo,max(date_supe)as maximo,count(opbga.id)as cantidad,(usuarios.nombre)as nombre FROM opbga, usuarios WHERE date_curse between %s and %s and estado = %s and (opbga.autorizador = usuarios.usuario) GROUP BY autorizador,tipo_operacion,evento ORDER BY autorizador asc", GetSQLValueString($colname2_flujo, "date"),GetSQLValueString($colname3_flujo, "date"),GetSQLValueString($colname1_flujo, "text"));
...
<title>Flujo por Supervisor V/S Evento</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">FLUJO POR SUPERVISOR V/S EVENTO</span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td class="titulocolumnas">Supervisor</td>
  ...
  <tr align="center" valign="middle">
    ...
    <td class="respuestacolumna">BOLETA DE GARANTIA  <?php echo strtoupper($row_flujo['tipo_operacion']); ?></td>

...
header("Content-Disposition: attachment;filename=opbga_fuerahorario.xls"); 
...
$colname4_DetailRS1 = "Si";
if (isset($_GET['fuera_horario'])) {
  $colname4_DetailRS1 = $_GET['fuera_horario'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT opbga.*,(usuarios.nombre)as ne, (usuarios.segmento)as seg FROM opbga, usuarios WHERE date_ingreso between %s and %s and (opbga.especialista_curse = usuarios.usuario) and fuera_horario = %s", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"),GetSQLValueString($colname4_DetailRS1, "text"));
...
<title>Op Fuera Horario - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center">
  <tr>
    <td colspan="8" align="left" valign="middle">Operaciones Ingresadas Fuera de Horario por Especialistas <?php echo $totalRows_DetailRS1 ?></td>
  </tr>
  <tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle">BOLETA DE GARANTIA <?php echo strtoupper($row_DetailRS1['tipo_operacion']); ?></td>

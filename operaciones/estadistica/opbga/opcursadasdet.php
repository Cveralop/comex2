...
header("Content-Disposition: attachment;filename=opbga_cursadas.xls"); 
...
$query_DetailRS1 = sprintf("SELECT opbga.*,(usuarios.nombre)as ne,(usuarios.segmento)as seg FROM opbga, usuarios WHERE date_ingreso between %s and %s and (opbga.especialista_curse = usuarios.usuario) ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));

...
header("Content-Disposition: attachment;filename=opbga_reparadas.xls"); 
...
$colname4_DetailRS1 = "Rechazada.";
if (isset($_GET['estado'])) {
  $colname4_DetailRS1 = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT opbga.*,(usuarios.nombre)as ne, (usuarios.segmento)as seg FROM opbga, usuarios WHERE date_curse between %s and %s and (opbga.especialista_curse = usuarios.usuario) and estado = %s", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"),GetSQLValueString($colname4_DetailRS1, "text"));
...
<table width="95%" border="1" align="center">
  <tr>
    <td colspan="9" align="left" valign="middle">Operaciones Reparadas e Ingresadas  por Especialistas <?php echo $totalRows_DetailRS1 ?></td>
  </tr>
  <tr>

...
<title>Eliminar Cesi&oacute;n de Derecho o Pago Anticipado - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Cesi&oacute;n o Pago Anticipado </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><input name="operador" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="baseline">

...
$colname_modificar = "Otorgamiento.";
if (isset($_GET['evento'])) {
  $colname_modificar = $_GET['evento'];
}
$colname1_modificar = "zzz";
if (isset($_GET['nro_operacion_relacionada'])) {
  $colname1_modificar = $_GET['nro_operacion_relacionada'];
}
$colname2_modificar = "zzz";
if (isset($_GET['nro_operacion'])) {
  $colname2_modificar = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM opcdpa nolock WHERE evento = %s and nro_operacion_relacionada LIKE %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificar, "text"),GetSQLValueString($colname1_modificar . "%", "text"),GetSQLValueString($colname2_modificar . "%", "text"));
...
<title>Modificar Cesi&oacute;n de Derecho o Pago Anticipado - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR  CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar  Cesi&oacute;n de Derecho y/o Pago Anticipado </span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="9" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Numero Operaci&oacute;n <span class="Estilo10"><?php echo strtoupper($row_modificar['nro_operacion']); ?> </span>Operaci&oacute;n Relacionada<span class="Estilo10"> <?php echo strtoupper($row_modificar['nro_operacion_relacionada']); ?></span></span></div></td>
  </tr>
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center"><span class="Estilo8"><span class="titulocolumnas">Modificar</span></span></td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_modificar['fecha_ingreso']; ?> </div>
        </div></td>
    <td align="center"><?php echo $row_modificar['rut_cliente']; ?> </div></td>
    ...
    <td align="center"><?php echo $row_modificar['operador']; ?> </div></td>
    <td align="center"><?php echo $row_modificar['tipo_operacion']; ?></div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>

...
$colname1_eliminar = "Otorgamiento.";
if (isset($_GET['evento'])) {
  $colname1_eliminar = $_GET['evento'];
}
$colname2_eliminar = "zzz";
if (isset($_GET['nro_operacion_relacionada'])) {
  $colname2_eliminar = $_GET['nro_operacion_relacionada'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opcdpa nolock WHERE nro_operacion LIKE %s and evento = %s and nro_operacion_relacionada LIKE %s ORDER BY id DESC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"),GetSQLValueString($colname2_eliminar . "%", "text"));
...
<title>Eliminar Cesi&oacute;n de Derecho o Pago Anticipado - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Eliminar Cesi&oacute;n de Derecho y/o Pago Anticipado</span></td>
    </tr>
    <tr valign="middle">
      <td height="16" align="right" valign="middle">Nro Operaci&oacute;n Relacionada:</td>
    ...
    <tr valign="middle">
      <td width="21%" height="16" align="right" valign="middle">Nro operaci&oacute;n:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="7" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Numero Operaci&oacute;n <span class="Estilo10"><?php echo strtoupper($row_eliminar['nro_operacion']); ?> </span>Operaci&oacute;n Relacionada<span class="Estilo10"> <?php echo strtoupper($row_eliminar['nro_operacion_relacionada']); ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_eliminar['nro_operacion']; ?> </div></td>
<td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong></div>       </div></td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="../cedeypaant.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image4" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

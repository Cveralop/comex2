...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcdpa (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion_relacionada, obs, especialista, moneda_operacion, monto_operacion, sucursal, fecha_curse_inicial, date_visa, date_asig, tipo_operacion) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','nro_cuotas','','RinRange1:40','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Ingreso Cesi&oacute;n o Pago Anticipado </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle">
        <input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" size="15" maxlength="7"> 
          <span class="rojopequeno">F000000</span> 
          <input name="nro_operacion_relacionada" type="text" disabled="disabled" class="etiqueta12" id="nro_operacion_relacionada" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
       &nbsp; <span class="rojopequeno">E000000</span>
        </div></td>
    </tr>
    <tr valign="baseline">
...
Monto Operaci&oacute;n:</td>
      ...
      <td align="center" valign="middle">
        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
          <option value="Cesion de Derecho.">Cesi&oacute;n de Derecho</option>
...
<td colspan="4" align="center" valign="middle">
  ...
  <input name="nro_operacion_relacionada" type="hidden" class="etiqueta12" id="nro_operacion_relacionada" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
</form>

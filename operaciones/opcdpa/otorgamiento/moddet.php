...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcdpa SET evento=%s, asignador=%s, operador=%s, producto=%s, nro_operacion=%s, nro_operacion_relacionada=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s WHERE id=%s",
...
<title>Modificar Cesi&oacute;n de Derecho o Pago Anticipado - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR  CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO  - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('nro_cuotas','','RinRange1:40','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Cesi&oacute;n de Derecho y/o Pago Anticipado</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        <option value="Otorgamiento." selected <?php if (!(strcmp("Otorgamiento.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Otorgamiento</option>
      </select></td>
...
<option value="PCCI3" <?php if (!(strcmp("PCCI3", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Practiva CCI 3</option>
    ...
    <tr valign="baseline">
      ...
      <input name="nro_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
          <span class="rojopequeno">F000000 
  ...
  E000000</span></div></td>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><textarea name="obs" cols="80" rows="4" class="etiqueta12"><?php echo (isset($row_DetailRS1['obs'])?$row_DetailRS1['obs']:""); ?></textarea></td>
    </tr>
    <tr valign="baseline">
...
?>
      </select>        <span class="rojopequeno">/</span>        <input name="monto_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="17" maxlength="15"></td>
      ...
      <td align="center" valign="middle"><select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        <option value="Cesion de Derecho." <?php if (!(strcmp("Cesion de Derecho.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Cesion de Derecho</option>

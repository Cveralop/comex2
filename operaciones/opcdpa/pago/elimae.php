...
$colname1_eliminar = "Pago.";
if (isset($_GET['evento'])) {
  $colname1_eliminar = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opcdpa nolock WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_eliminar, "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Pago Cesi&oacute;n de Derecho o Pago Anticipado - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR PAGO CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Eliminar Pago Cesi&oacute;n y/o Pago Anticipado</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nro Operaci&oacute;n:</div></td>
      <td width="79%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="15" maxlength="7">        <span class="rojopequeno">F000000</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo10"><?php echo strtoupper($row_eliminar['nro_operacion']); ?> <span class="Estilo12"> Operaci&oacute;n Relacionada</span> <?php echo strtoupper($row_eliminar['nro_operacion_relacionada']); ?></span></span></td>
  </tr>
  <tr align="center" valign="middle">
    <td align="center" valign="middle" bgcolor="#999999"><span class="Estilo9"><span class="titulocolumnas">Eliminar</span></span></td>
...
<td align="left" valign="middle"><?php echo $row_eliminar['nombre_cliente']; ?> </div></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_operacion']); ?></span>
&nbsp;<strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>
    <td align="center" valign="middle"><?php echo $row_eliminar['tipo_operacion']; ?> </div></td>
  </tr>

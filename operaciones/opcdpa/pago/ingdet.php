...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcdpa (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, nro_operacion_relacionada, obs, especialista, moneda_operacion, monto_operacion, nro_cuotas, sucursal, compraventa, tipocambio, fecha_curse_inicial, date_asig, tipo_operacion) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['fecha_curse_inicial'], "text"),
...
<title>Ingreso Pago Cesi&oacute;n de Derecho o Pago Anticipado - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO PAGO  CESI&Oacute;N DE DERECHO O PAGO ANTICIPADO - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('nro_cuotas','','RinRange1:40');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Ingreso Pago Cesi&oacute;n o Pago Anticipado</span></div></td>
    </tr>
    <tr valign="baseline">
...
?>
      ...
      <td align="center" valign="middle">
        <input name="nro_cuotas" type="text" class="etiqueta12" value="1" size="5" maxlength="2">
     &nbsp; <span class="rojopequeno">max. 40</span> </div></td>
    </tr>
    <tr valign="middle">
...
Venta</label>
      ...
      <td align="center" valign="middle">
        <input name="tipocambio" type="text" class="etiqueta12" id="tipocambio" size="10" maxlength="10">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="etiqueta12" value="Ingresar Registro">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="id">
  <input type="hidden" name="date_ingreso" value="<?php echo $row_DetailRS1['date_ingreso']; ?>" size="32">
  <input type="hidden" name="date_asig" value="<?php echo $row_DetailRS1['date_asig']; ?>" size="32">
  ...
  <input name="nro_operacion_relacionada" type="hidden" id="nro_operacion_relacionada" value="<?php echo $row_DetailRS1['nro_operacion_relacionada']; ?>">
</form>
<br>

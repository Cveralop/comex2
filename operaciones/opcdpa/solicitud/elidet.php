...
$query_DetailRS1 = sprintf("SELECT * FROM opcdpa nolock WHERE id = %s", $colname_DetailRS1);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcdpa SET estado=%s, asignador=%s, operador=%s, obs=%s, sub_estado=%s, date_oper=%s WHERE id=%s",
...
<title>Eliminar Solicitud - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR SOLICITUD - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Eliminar Solicitud </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="operador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="tipo_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="30" maxlength="30"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Obserbaci&oacute;n:</td>
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input name="Enviar" type="submit" class="boton" value="Anular Operaci&oacute;n">
      </div></td>
    </tr>
  </table>

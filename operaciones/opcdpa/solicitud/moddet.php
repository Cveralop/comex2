...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcdpa SET evento=%s, operador=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s WHERE id=%s",
...
<title>Modificar Solicitud - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR SOLICITUD  - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Solicitud </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        
        <select name="evento" class="etiqueta12" id="evento">
          <option value="Solicitud." selected <?php if (!(strcmp("Solicitud.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Solicitud</option>
          </select>
      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        <option value="Cecion de Derecho" <?php if (!(strcmp("Cecion de Derecho", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Cecion de Derecho.</option>
      </select>
      </div></td>
    </tr>
    <tr valign="baseline">

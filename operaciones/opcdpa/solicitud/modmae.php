...
if (isset($_GET['nro_operacion_relacionada'])) {
  $colname_modificar = $_GET['nro_operacion_relacionada'];
}
$colname1_modificar = "Solicitud.";
if (isset($_GET['evento'])) {
  $colname1_modificar = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM opcdpa nolock WHERE nro_operacion_relacionada = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_modificar, "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificar Solicitud - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR SOLICITUD - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Solicitud </span></td>
    </tr>
    <tr valign="middle">
      <td width="21%" align="right">Nro Operaci&oacute;n Relacionada:</div></td>
      <td width="79%" align="left"><input name="nro_operacion_relacionada" type="text" class="etiqueta12" id="nro_operacion_relacionada" size="15" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="8" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Nro Operaci&oacute;n <span class="Estilo11"><?php echo $row_modificar['nro_operacion']; ?></span> </span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_modificar['fecha_ingreso']; ?> </div></td>
...
<td align="left" valign="middle"><?php echo $row_modificar['nombre_cliente']; ?> </td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>

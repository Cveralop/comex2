...
$query_consultanro = sprintf("SELECT * FROM opcdpa nolock WHERE nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname_consultanro, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" nowrap class="Estilo3">CONSULTA OPERACIONES POR NUMERO - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle"><p class="titulocolumnas">Fecha Ingreso</p></td>
  ...
  <?php do { ?>
  <tr>
    <td valign="middle"><a href="conrodet.php?recordID=<?php echo $row_consultanro['id']; ?>"> <img src="../../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>
    <td valign="middle"><?php echo $row_consultanro['fecha_ingreso']; ?> </div></td>
<td align="left" valign="middle"><?php echo $row_consultanro['nombre_cliente']; ?></td>
    <td valign="middle"><?php echo $row_consultanro['evento']; ?> </div></td>
    <td valign="middle"><?php echo $row_consultanro['estado']; ?> </div></td>
    <td valign="middle"><?php echo $row_consultanro['fecha_curse']; ?></div></td>

...
$query_cursada = sprintf("SELECT * FROM opcdpa nolock WHERE evento LIKE %s and estado LIKE %s and fecha_curse LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_cursada . "%", "text"),GetSQLValueString("%" . $colname1_cursada . "%", "text"),GetSQLValueString("%" . $colname2_cursada . "%", "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"> <span class="Estilo11"><?php echo strtoupper($row_cursada['nro_operacion']); ?></span>  </div></td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcdpa SET evento=%s, estado=%s, sub_estado=%s, reparo_obs=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" height="26" align="left" valign="middle" nowrap class="Estilo3">MODIFICACI&Oacute;N REPARO - DETALLE</td>
  ...
  <tr>
    <td align="left" valign="middle" nowrap class="Estilo4">CESI&Oacute;N DE DERECHO Y PAGO ANTICIPADO</td>
  </tr>
</table>
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','moneda_reparo','','R','monto_reparo','','RisNum','reparo_espe','','R','reparo_obs','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Detalle Reparo
        </div>
      </span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
          <span class="rojopequeno">F000000</span></div>
          <label>
             <input name="nro_operacion_relacionada" type="text" disabled class="etiqueta12" id="nro_operacion_relacionada" value="<?php echo $row_DetailRS1['nro_operacion_relacionada']; ?>" size="15" maxlength="7">
          <span class="rojopequeno">E000000</span></label></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="moneda_reparo" type="text" disabled class="etiqueta12" id="moneda_reparo" value="<?php echo $row_DetailRS1['moneda_reparo']; ?>" size="5" maxlength="3">
      </div> / 
      <input name="monto_reparo" type="text" disabled class="etiqueta12" id="monto_reparo" value="<?php echo $row_DetailRS1['monto_reparo']; ?>" size="17" maxlength="15"></td>
...
<td colspan="4" align="center" valign="middle">
          <input type="submit" class="boton" value="Actualizar Reparo">
      </div></td>
    </tr>
  </table>

...
$query_modrep = sprintf("SELECT * FROM opcdpa nolock WHERE rut_cliente LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString("%" . $colname1_modrep . "%", "text"),GetSQLValueString("%" . $colname2_modrep . "%", "text"));

...
$colname1_modificar = "Confirmacion.";
...
$query_modificar = sprintf("SELECT * FROM opcce WHERE evento = %s and nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname1_modificar, "text"),GetSQLValueString($colname2_modificar, "text"));
...
<title>Modificar Confirmaci&oacute;n Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR CONFIRMACI&Oacute;N EXPORTACIONES - MAESTRO </td>
...
<form name="form1" method="post" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo13"><strong>Confirmar LCE </strong></span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="Estilo13"><span class="respuestacolumna_rojo"> <?php echo strtoupper($row_modificar['nro_operacion']); ?></span></span></div></td>

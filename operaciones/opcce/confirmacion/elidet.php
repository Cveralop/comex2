...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET estado=%s, asignador=%s, operador=%s, obs=%s, sub_estado=%s, date_oper=%s WHERE id=%s",
...
<title>Eliminar Confirmaci&oacute;n Exportaciones - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR CONFIRMACI&Oacute;N EXPORTACIONES - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Eliminar Confirmaci&oacute;n Exportaciones </div>
      </span></td>
    </tr>
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="rut_cliente" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="15" maxlength="10">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle">      <input name="nro_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">      
      <span class="rojopequeno">E000000</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Confirmaci&oacute;n:</td>
      <td align="center" valign="middle">
        <input name="confirmacion" type="text" disabled class="etiqueta12" id="confirmacion" value="<?php echo $row_DetailRS1['confirmacion']; ?>" size="20" maxlength="20">
      </div></td>
      <td align="right" valign="middle">Moneda / Monto Operaci&oacute;n:</div></td>
      <td align="center" valign="middle">
        <input name="moneda_operacion2" type="text" disabled class="etiqueta12" id="moneda_operacion2" value="<?php echo $row_DetailRS1['moneda_operacion']; ?>" size="5" maxlength="3">
          <span class="rojopequeno">/</span>        
          <input name="monto_operacion" type="text" disabled class="etiqueta12" id="monto_operacion" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Observaci&oacute;n:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        <textarea name="obs" cols="80" rows="4" class="mayuscula" id="obs"></textarea>

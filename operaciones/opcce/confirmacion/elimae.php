...
$colname1_eliminar = "confirmacion.";
...
<title>Eliminar Confirmaci&oacute;n Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR CONFIRMACI&Oacute;N EXPORTACIONES - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Eliminar Confirmaci&oacute;n Exportaciones</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nombre Cliente:</td>
      <td width="79%" align="left" valign="middle"><input name="nombre_cliente" type="text" class="etiqueta12" id="nombre_cliente" size="80" maxlength="80">
      </td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="Estilo11"><span class="respuestacolumna_rojo"> <?php echo strtoupper($row_eliminar['nro_operacion']); ?></span></span></div></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo $row_eliminar['monto_documentos']; ?></strong></div></td>
  </tr>

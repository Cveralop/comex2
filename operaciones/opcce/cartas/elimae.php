...
if (isset($_GET['evento'])) {
  $colname_reparo = (get_magic_quotes_gpc()) ? $_GET['evento'] : addslashes($_GET['evento']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_reparo = sprintf("SELECT * FROM opcce WHERE evento = '%s'", $colname_reparo);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR CONFIRMACI&Oacute;N CARTA DE CR&Eacute;DITO DE EXPORTACIONES - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="21%" align="right" valign="middle">Evento Confirmaci&oacute;n:</div></td>

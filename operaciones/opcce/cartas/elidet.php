...
$query_DetailRS1 = sprintf("SELECT * FROM opcce  WHERE id = $recordID", $colname_reparo);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR  CONFIRMACI&Oacute;N CARTA DE CR&Eacute;DITO DE EXPORTACIONES - DETALLE </td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo7">Eliminar Confirmaci&oacute;n</span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="evento" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['evento']; ?>" size="30" maxlength="30">
      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="referencia" type="text" disabled class="etiqueta12" id="referencia" value="<?php echo $row_DetailRS1['referencia']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <input name="monto_operacion" type="text" disabled class="mayuscula" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="17" maxlength="15">
        </div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Eliminar Carta">
      </div></td>
    </tr>
  </table>

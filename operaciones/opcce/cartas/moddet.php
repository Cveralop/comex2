...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET fecha_ingreso=%s, nro_operacion=%s, moneda_operacion=%s, monto_operacion=%s, pais=%s, banco_destino=%s, referencia=%s, confirmacion=%s, tipo_confirmacion=%s, reparo_espe=%s, reparo_obs=%s WHERE id=%s",
...
if (isset($_GET['rut_cliente'])) {
  $colname1_DetailRS1 = (get_magic_quotes_gpc()) ? $_GET['rut_cliente'] : addslashes($_GET['rut_cliente']);
}
$colname_DetailRS1 = "1";
...
<title>Modificaci&oacute;n Carta de Cr&eacute;dito de Exportaciones - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N CONFIRMACI&Oacute;N CARTA DE CR&Eacute;DITO EXPORTACIONES - DETALLE</td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('nro_operacion','','R','moneda_operacion','','R','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Detalle Carta de Cr&eacute;dito de Exportaciones</div>
      </span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Nro Registro: </td>
      <td colspan="3" align="center" valign="middle"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?></span>        </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <input name="evento" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['evento']; ?>" size="35" maxlength="35">
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="monto_operacion" type="text" class="etiqueta12" id="monto_operacion" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="17" maxlength="15">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Solicitud:</td>
      <td colspan="5" align="left" valign="middle"><input name="reparo_espe" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['reparo_espe']; ?>" size="100" maxlength="100"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          <option value="Confirmacion y Pago Anticipado." selected <?php if (!(strcmp("Confirmacion y Pago Anticipado.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Confirmacion y Pago Anticipado</option>
          <option value="Confirmacion y Financiamiento." <?php if (!(strcmp("Confirmacion y Financiamiento.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Confirmacion y Financiamiento</option>
          <option value="Financiamiento." <?php if (!(strcmp("Financiamiento.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Financiamiento</option>
          <option value="Cesion de Derechos." <?php if (!(strcmp("Cesion de Derechos.", $row_DetailRS1['evento']))) {echo "SELECTED";} ?>>Cesion de Derechos</option>
        </select>
      </div></td>
      <td align="right" valign="middle">Referencia:</td>
      <td align="center" valign="middle">
        <input name="referencia" type="text" class="etiqueta12" id="referencia" value="<?php echo $row_DetailRS1['referencia']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td colspan="2" align="center" valign="middle">
        <input name="banco_destino" type="text" class="etiqueta12" id="banco_destino" value="<?php echo $row_DetailRS1['banco_destino']; ?>" size="55" maxlength="50">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="6" align="center" valign="middle">
        <input type="submit" class="boton" value="Actualizar Carta">
      </div></td>
    </tr>
  </table>

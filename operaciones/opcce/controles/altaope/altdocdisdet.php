...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET referencia=%s, moneda_documentos=%s, monto_documentos=%s, tipo_negociacion=%s, date_supe=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcce  WHERE id = $recordID", $colname_altadocdis);
...
<title>Alta Doctos Embarque Exportaciones  - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ALTA DOCTOS CON DISCREPANCIAS EXPORTACIONES - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('referencia','','RisNum');return document.MM_returnValue">
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Alzamiento Documentos con Discrepancias Exportaciones</span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Moneda / Monto Apertura:</td>
      <td align="center" valign="middle">
...
<td colspan="4" align="center" valign="middle">
        <input name="Enviar" type="submit" class="boton" value="Actuallizar Registro">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1">
  <input name="tipo_negociacion" type="hidden" id="tipo_negociacion" value="Limpia.">

...
$query_alta = sprintf("SELECT opcce.*,(usuarios.nombre)as op FROM opcce, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente = %s and fuera_horario = %s and (opcce.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_alta, "text"),GetSQLValueString($colname2_alta, "text"),GetSQLValueString("%" . $colname3_alta . "%", "text"),GetSQLValueString($colname4_alta, "text"),GetSQLValueString($colname5_alta, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opasignadas = "SELECT *,SUM(nro_cuotas_cursadas)as cursada FROM asignacion_operaciones WHERE producto = 'Carta de Credito Export' GROUP BY operador,evento ORDER BY evento ASC";
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT opcce.*,(usuarios.nombre)as op FROM opcce, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente = %s and (opcce.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname2_urgente, "text"),GetSQLValueString("%" . $colname3_urgente . "%", "text"),GetSQLValueString($colname4_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuera_horario = sprintf("SELECT opcce.*,(usuarios.nombre)as op FROM opcce, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente <> %s and fuera_horario = %s and (opcce.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_fuera_horario, "text"),GetSQLValueString($colname2_fuera_horario, "text"),GetSQLValueString("%" . $colname3_fuera_horario . "%", "text"),GetSQLValueString($colname4_fuera_horario, "text"),GetSQLValueString($colname5_fuera_horario, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Supervisores Exportaciones </span></td>
    </tr>
    <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="../../carcreexp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image31" width="80" height="25" border="0" align="right" id="Image31"></a></div></td>
  </tr>
</table>
<br>
<table width="95%" border="0" align="center">
  <tr>
    <td><div id="CollapsiblePanel1" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">Asignacion Operaciones</div>
...
<?php if ($totalRows_urgente > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td height="21" colspan="11" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones por Operador <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
    </tr>
    <tr>
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><a href="altadet.php?recordID=<?php echo $row_urgente['id']; ?>"><img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0" align="middle"></a></td>
        ...
        <td align="left" valign="middle"><?php echo $row_urgente['op']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="11" align="left" valign="middle" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Cursada por Operador  <?php echo $totalRows_alta ?> Curse Normal</span></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><?php echo strtoupper($row_alta['rut_cliente']); ?></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_alta['moneda_documentos']); ?></span>  <strong class="respuestacolumna_azul"><?php echo number_format($row_alta['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
...
<?php if ($totalRows_fuera_horario > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="11" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Cursada por Operador <?php echo $totalRows_fuera_horario ?> Curse Fuera Horario</span></td>
    </tr>
    <tr>
      <td align="center" valign="middle" class="titulocolumnas">Cursar</td>
      <td align="center" valign="middle" class="titulocolumnas">Evento</td>
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><a href="altadet.php?recordID=<?php echo $row_fuera_horario['id']; ?>"><img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0" align="middle"></a></td>
        <td align="center" valign="middle"><?php echo $row_fuera_horario['evento']; ?></td>
        <td align="center" valign="middle"><?php echo $row_fuera_horario['fecha_ingreso']; ?></td>
        <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_fuera_horario['nro_operacion']; ?></td>
        <td align="center" valign="middle"><?php echo $row_fuera_horario['sub_estado']; ?></td>
        <td align="center" valign="middle"><?php echo $row_fuera_horario['rut_cliente']; ?></td>
        ...
        <td align="left" valign="middle"><?php echo $row_fuera_horario['op']; ?></td>

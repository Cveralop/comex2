...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, referencia=%s, tipo_negociacion=%s, segmento=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s, convenio=%s WHERE id=%s",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcce WHERE id = %s ORDER BY evento ASC", $colname_DetailRS1);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Operaciones Exportaciones 
        </div>
      </span></td>
    </tr>
    <tr valign="baseline">
    ...
    <label>          </label>
            <label>
            <input name="tipo_negociacion" type="radio" value="Limpia." checked>
  Limpia</label>
            <label>
            <input type="radio" name="tipo_negociacion" value="Discrepancia.">
  Discrepancia</label>
            <label>
            <input type="radio" name="tipo_negociacion" value="Reparada.">
            Reparada</label>
            <br>
        </div>
          <label>          </label>

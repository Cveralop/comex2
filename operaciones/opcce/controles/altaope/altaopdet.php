...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, referencia=%s, currier=%s, sub_estado=%s, date_oper=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcce  WHERE id = $recordID", $colname_operador);
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('nro_operacion','','R','fecha_curse','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Operadores Exportaciones </span></div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <input name="currier" type="text" class="etiqueta12" id="currier" size="20" maxlength="20">
        </div></td>

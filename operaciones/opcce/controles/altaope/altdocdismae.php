...
$colname_altadocdis = "zzz";
if (isset($_GET['nro_operacion'])) {
  $colname_altadocdis = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_altadocdis = sprintf("SELECT * FROM opcce WHERE nro_operacion = %s and tipo_negociacion = %s ORDER BY id DESC", GetSQLValueString($colname_altadocdis, "text"),GetSQLValueString($colname1_altadocdis, "text"));
...
<title>Alta Doctos Embarque Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
.Estilo10 {color: #0000FF; font-weight: bold; }
.Estilo13 {
	font-size: 12px;
	font-weight: bold;
}
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ALTA DOCTOS CON DISCREPANCIAS Y REPARADAS EXPORTACIONES - MAESTRO </td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Alta Documentos con Discrepancia Exportaciones</span></td>
    </tr>
    <tr>
...
<?php if ($totalRows_altadocdis > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="7" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo13"><span class="Estilo15">Nro Operaci&oacute;n</span> <span class="Estilo14"><?php echo strtoupper($row_altadocdis['nro_operacion']); ?></span></span></div></td>
    </tr>
    <tr bgcolor="#999999">
      <td align="center" valign="middle" class="titulocolumnas">Alzar </div></td>
    ...
    <?php do { ?>
    <tr>
      <td align="center" valign="middle"><a href="altdocdisdet.php?recordID=<?php echo $row_altadocdis['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
      <td align="center" valign="middle"><?php echo $row_altadocdis['fecha_ingreso']; ?> </div></td>
      <td align="center" valign="middle"><?php echo $row_altadocdis['evento']; ?></div></td>
      <td align="center" valign="middle"><?php echo $row_altadocdis['rut_cliente']; ?> </div></td>
      <td align="left" valign="middle"><?php echo $row_altadocdis['nombre_cliente']; ?> </td>
      <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_altadocdis['moneda_operacion']); ?> </span><span class="respuestacolumna_azul"><?php echo number_format($row_altadocdis['monto_operacion'], 2, ',', '.'); ?></span></div></td>
      <td align="right" valign="middle">
          <span class="respuestacolumna_rojo"><?php echo strtoupper($row_altadocdis['moneda_documentos']); ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_altadocdis['monto_documentos'], 2, ',', '.'); ?></strong>
          </div></td>
    </tr>

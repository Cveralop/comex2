...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA OPERACIONES POR RUT EXPORTACIONES - DETALLE </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="4" align="left" valign="middle"><p><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Operaciones por Rut Exportaciones </span></p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_DetailRS1['fecha_ingreso']; ?> </div></td>
    <td align="right" valign="middle">Fecha Curse:</td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['fecha_curse']; ?></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" valign="middle"> <?php echo strtoupper($row_DetailRS1['nro_operacion']); ?> <span class="rojopequeno">E000000</span> </div></td>
  ...
  <tr>
    <td align="right" valign="middle">Momeda / Monto Operaci&oacute;n:</div></td>
    ...
    <td align="right" valign="middle">Pa&iacute;s:</div></td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['pais']; ?></div></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Banco Emisor: </div></td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['banco_destino']; ?> </div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_DetailRS1['currier']; ?></div></td>
    <td align="right" valign="middle">Moneda / Monto Documentos: </div></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Confirmaci&oacute;n:</div></td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['convenio']; ?> </div></td>
    <td align="right" valign="middle">Tipo Negociaci&oacute;n: </div></td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['tipo_negociacion']; ?></div></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Referencia:</div></td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['referencia']; ?></div></td>

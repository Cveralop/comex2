...
$query_pendientes = sprintf("SELECT * FROM opcce WHERE estado = %s and urgente = %s and fuera_horario = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_pendientes, "text"),GetSQLValueString($colname1_pendientes, "text"),GetSQLValueString($colname2_pendientes, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT * FROM opcce WHERE estado = %s and urgente = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM opcce WHERE estado = %s and fuera_horario = %s and urgente <> %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString($colname2_fuerahorario, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES PENDIENTES EXPORTACIONES</td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td valign="middle"><a href="../../carcreexp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0" align="right"></a></div></td>
  </tr>
</table>
<br>
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="12" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
  </tr>
  <tr>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Momeda / Monto Documentos</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="12" align="left" valign="middle" bgcolor="#00CC00" ><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_pendientes ?> Curse Normal</span></td>
  </tr>
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio </td>
    <td align="center" valign="middle" class="titulocolumnas">Evento</td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda / Monto Operaciones
      </div>
    </td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_pendientes['fecha_ingreso']; ?></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_pendientes['moneda_documentos']); ?></span> &nbsp;<strong class="respuestacolumna_azul"><?php echo number_format($row_pendientes['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
    ...
    <td align="center" valign="middle"><?php echo $row_pendientes['date_espe']; ?></div></td>
<td align="center" valign="middle"><?php echo $row_pendientes['urgente']; ?></div></td>
  </tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="12" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_fuerahorario ?> Curse Fuera Horario</span></td>
  </tr>
  <tr>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio</td>
    <td align="center" valign="middle" class="titulocolumnas">Evento</td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Operador</td>
    <td align="center" valign="middle" class="titulocolumnas">Especialiata Curse</td>
    <td align="center" valign="middle" class="titulocolumnas">Hora Ing. Espe.</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><?php echo strtoupper($row_fuerahorario['nombre_cliente']); ?></td>

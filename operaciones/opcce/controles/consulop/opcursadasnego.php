...
$query_cursada = sprintf("SELECT * FROM opcce WHERE evento LIKE %s and estado LIKE %s and date_curse between %s and %s ORDER BY id DESC", GetSQLValueString("%" . $colname_cursada . "%", "text"),GetSQLValueString("%" . $colname1_cursada . "%", "text"),GetSQLValueString($colname2_cursada, "text"),GetSQLValueString($colname3_cursada, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS (Negociaci&oacute;n - Alzamiento - Pago) EXPORTACIONES</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Estado Operaciones Negociaci&oacute;n - Alzamiento - Pago Exportaciones</span></td>
    </tr>
    <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../carcreexp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0" align="right"></a></div></td>
  </tr>
</table>
<br>
  ...
  <table border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="13" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Total Operaciones <span class="Estilo10"><?php echo $totalRows_cursada ?></span></span></td>
    </tr>
    <tr bgcolor="#999999">
      ...
      <td align="center" valign="middle" class="titulocolumnas">Tipo Negociaci&oacute;n</div>
      </td>
      <td align="center" valign="middle" class="titulocolumnas">Segmento
        </div>
      </td>
      <td align="center" valign="middle" class="titulocolumnas">Moneda / Monto Documentos
        </div>
      </td>
      <td align="center" valign="middle" class="titulocolumnas">Confirmaci&oacute;n</div>
      </td>
    ...
    <?php do { ?>
    <tr>
      <td align="center" valign="middle"> <strong class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['nro_operacion']); ?></strong>  </div></td>
      ...
      <td align="center" valign="middle"><?php echo $row_cursada['especialista']; ?></td>
      <td align="center" valign="middle"><?php echo $row_cursada['tipo_negociacion']; ?></td>
      <td align="center" valign="middle"><?php echo $row_cursada['segmento']; ?></td>
      <td align="right" valign="middle"><strong><span class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['moneda_documentos']); ?> </span><span class="respuestacolumna_azul"><?php echo number_format($row_cursada['monto_documentos'], 2, ',', '.'); ?></span></strong>        </div></td>
      <td align="center" valign="middle"><?php echo $row_cursada['convenio']; ?></div></td>

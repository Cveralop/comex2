...
$colname1_registrodoctos = "Negociacion.";
...
$query_registrodoctos = sprintf("SELECT * FROM opcce WHERE tipo_negociacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_registrodoctos, "text"),GetSQLValueString($colname1_registrodoctos, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL DOCTOS CON DISCREPANCIAS Y REPARAS DE EXPORTACIONES </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="7" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Total Operaciones <span class="Estilo14"><?php echo $totalRows_registrodoctos ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_registrodoctos['nro_operacion']); ?></span>      </div></td>
    <td align="center" valign="middle"><?php echo $row_registrodoctos['fecha_ingreso']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_registrodoctos['tipo_negociacion']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_registrodoctos['rut_cliente']; ?> </div></td>
    <td align="left" valign="middle"><span class="respuestacolumna"><?php echo $row_registrodoctos['nombre_cliente']; ?> </span></td>
    <td align="center" valign="middle"><?php echo $row_registrodoctos['especialista']; ?></div></td>
    <td align="right" valign="middle"><strong><span class="respuestacolumna_rojo"><?php echo strtoupper($row_registrodoctos['moneda_documentos']); ?></span> <span class="respuestacolumna_azul"><?php echo number_format($row_registrodoctos['monto_documentos'], 2, ',', '.'); ?></span></strong>      </div></td>
  </tr>

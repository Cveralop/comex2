...
$query_currier = sprintf("SELECT * FROM opcce WHERE currier LIKE '%s%%' ORDER BY id DESC", $colname_currier);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA OPERACIONES POR CURRIER EXPORTACIONES </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Consulta por   Currier Exportaciones</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle"> Currier:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="5" align="left" valign="middle"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Numero Currier <span class="Estilo11"><?php echo $row_currier['currier']; ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle" class="respuestacolumna"><?php echo $row_currier['fecha_ingreso']; ?> </td>
    <td align="center" valign="middle"><?php echo strtoupper($row_currier['nro_operacion']); ?></div></td>
    <td align="center" valign="middle"><?php echo $row_currier['rut_cliente']; ?> </td>
    <td align="left" valign="middle"><?php echo $row_currier['nombre_cliente']; ?> </td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_currier['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_currier['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

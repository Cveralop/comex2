...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA OPERACIONES POR NUMERO EXPORTACIONES - DETALLE </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="4" align="left" valign="middle"><p><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Operaciones por Numero Exportaciones</span></p>
    </td>
  </tr>
  <tr>
    <td align="right" valign="middle">Nro Registro:</td>
    <td align="center" valign="middle"><?php echo $row_DetailRS1['id']; ?> </div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="Estilo6"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><?php echo $row_DetailRS1['referencia']; ?></td>
  </tr>
</table>
<br>

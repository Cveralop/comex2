...
$query_cartareparo = sprintf("SELECT * FROM opcce WHERE rut_cliente LIKE %s and id LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_cartareparo . "%", "text"),GetSQLValueString($colname1_cartareparo . "%", "text"),GetSQLValueString($colname2_cartareparo . "%", "text"));
$query_limit_cartareparo = sprintf("%s LIMIT %d, %d", $query_cartareparo, $startRow_cartareparo, $maxRows_cartareparo);
$cartareparo = mysqli_query($comercioexterior, $query_limit_cartareparo) or die(mysqli_error());
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="20%" align="right" valign="middle">Nro Operacion:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td valign="middle" class="titulocolumnas">Imprimir</div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_cartareparo['fecha_ingreso']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_cartareparo['rut_cliente']; ?></div></td>
    <td align="left" valign="middle"><?php echo $row_cartareparo['nombre_cliente']; ?></td>
    <td align="center" valign="middle"><?php echo $row_cartareparo['evento']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_cartareparo['especialista']; ?></div></td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../carcreexp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div>

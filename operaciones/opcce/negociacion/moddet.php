...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET asignador=%s, operador=%s, obs=%s, especialista=%s, referencia=%s, currier=%s, moneda_documentos=%s, monto_documentos=%s, tipo_negociacion=%s, convenio=%s WHERE id=%s",
...
<title>Modificaci&oacute;n Negociaci&oacute;n Exportaciones - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N NEGOCIACI&Oacute;N EXPORTACIONES - DETALLE</td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','folio','','R','currier','','R','moneda_documentos','','R','monto_documentos','','NisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"> <span class="titulodetalle">Modificar Negociaci&oacute;n Exportaciones</span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <select name="evento" disabled="disabled" class="etiqueta12" id="evento">
          <option value="Negociacion." selected>Negociacion</option>
        </select>
      </div></td>
      <td align="right" valign="middle">Estado:</div></td>
      <td colspan="3" align="center" valign="middle">        <select name="estado" disabled="disabled" class="etiqueta12" id="estado">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Convenio Rec&iacute;proco:</td>
      <td align="center" valign="middle">      
          <input name="convenio" type="checkbox" class="etiqueta12" id="convenio" value="HK" <?php if (!(strcmp($row_DetailRS1['convenio'],"HK"))) {echo "checked";} ?>>
      Si</div></td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        <align="center" class="etiqueta12">
          <label>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcce (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, asignador, operador, obs, moneda_operacion, monto_operacion, pais, banco_destino, referencia, sub_estado, date_visa, date_asig, reparo_obs, convenio, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcce WHERE rut_cliente = '%s'", $colname_DetailRS1);
...
/ Monto Operaci&oacute;n:</td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="banco_destino" type="text" class="etiqueta12" size="55" maxlength="50"></td>
      <td align="right" valign="middle">Convenio:</td>
      <td align="center" valign="middle"><input name="convenio" type="checkbox" id="convenio" value="Si"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Referencia:</td>
      <td align="center" valign="middle"><input name="referencia" type="text" class="etiqueta12" id="referencia" size="20" maxlength="20"></td>
      <td align="right" valign="middle">Pais:</td>
      <td align="center" valign="middle"><input name="pais" type="text" class="etiqueta12" size="25" maxlength="20"></td>
    </tr>
    <tr valign="baseline">

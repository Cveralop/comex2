...
$query_DetailRS1 = sprintf("SELECT * FROM opcce WHERE estado_visacion = %s and rut_cliente LIKE %s and nro_operacion LIKE %s and asignador = %s and id LIKE %s and estado = %s ORDER BY urgente DESC", GetSQLValueString($colname_DetailRS1, "text"),GetSQLValueString($colname1_DetailRS1 . "%", "text"),GetSQLValueString($colname2_DetailRS1 . "%", "text"),GetSQLValueString($colname4_DetailRS1, "text"),GetSQLValueString($colname5_DetailRS1 . "%", "text"),GetSQLValueString($colname3_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr align="left">
    <td valign="middle" class="Estilo4">CARTAS DE CR&Eacute;DITO DE EXPORTACI&Oacute;N</td>
  </tr>
</table>
<br>

...
$query_modificar = sprintf("SELECT * FROM opcce WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_modificar, "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificar Enmienda Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR  ENMIENDA EXPORTACIONES- MAESTRO</td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificaci&oacute;n Enmienda Exportaciones</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="5" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Rut </span><span class="Estilo8"><?php echo $row_modificar['rut_cliente']; ?></span><span class="Estilo5"> Nombre Cliente </span><span class="Estilo8"><?php echo $row_modificar['nombre_cliente']; ?></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span>      </div> </td>

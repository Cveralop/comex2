...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcce (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, obs, especialista, moneda_operacion, monto_operacion, pais, banco_destino, referencia, confirmacion, date_asig, convenio) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = "SELECT * FROM cliente WHERE id = $recordID ORDER BY nombre_cliente ASC";
...
<title>Ingreso Apertura Exportaciones  - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO APERTURA EXPORTACIONES  - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','rut_cliente','','R','nombre_cliente','','R','asignador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum','pais','','R','banco_destino','','R','referencia','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso Apertura Exportaciones </span></div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td width="16%" align="right" valign="middle">Rut Cliente:</div></td>
      <td width="48%" colspan="3" align="center" valign="middle">
    ...
    <tr valign="baseline">
      ...
      <input name="monto_operacion" type="text" class="etiqueta12" value="" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="pais" type="text" class="etiqueta12" value="" size="25" maxlength="20">
      </div></td>
      <td align="right" valign="middle">Banco Emisor:</td>
      <td colspan="3" align="center" valign="middle">
        <input name="banco_destino" type="text" class="etiqueta12" value="" size="55" maxlength="50">
      </div></td>
    </tr>
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <align="center">
          <label>
          <input name="confirmacion" type="radio" value="No" checked>
  Sin Confirmar</label> 
    <label>
            <input type="radio" name="confirmacion" value="Si">
      Confirmada</label>
       </td>
    ...
    <tr valign="middle">
      ...
      <td colspan="5" align="left" valign="middle">
        <input name="segmento" type="text" class="etiqueta12" id="segmento" value="<?php echo $row_DetailRS1['segmento']; ?>" size="30" maxlength="30">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="6" align="center" valign="middle">
        <input name="Enviar" type="submit" class="boton" value="Ingresar Operaci&oacute;n">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="id" value="" size="32">
  <input type="hidden" name="evento" value="Apertura." size="32">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="ingmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image1" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

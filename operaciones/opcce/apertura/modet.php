...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, pais=%s, banco_destino=%s, referencia=%s, confirmacion=%s, convenio=%s WHERE id=%s",
...
$query_DetailRS1 = "SELECT * FROM opcce WHERE id = $recordID ORDER BY id DESC";
...
<title>Modificaci&oacute;n Apertura Exportaciones - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N APERTURA EXPORTACIONES - DETALLE</td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum','pais','','R','banco_destino','','R','referencia','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Actualizar Apertura Exportaciones</span></td>
    </tr>
    <tr valign="baseline">
...
?>
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Banco Emisor:</div></td>
      <td colspan="3" align="center" valign="middle">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <label>
          <input <?php if (!(strcmp($row_DetailRS1['confirmacion'],"No"))) {echo "CHECKED";} ?> name="confirmacion" type="radio" value="No" checked>
  Sin Confirmar</label>
          <label>

...
if (isset($_GET['nombre_cliente'])) {
  $colname_ingreso = $_GET['nombre_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingreso = sprintf("SELECT * FROM cliente WHERE nombre_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_ingreso . "%", "text"));
...
<title>Ingreso Apertura Exportaciones - Maestro</title>
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO APERTURA  EXPORTACIONES - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso Apertura Exportaciones</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_ingreso['especialista']); ?> </div></td>
  </tr>

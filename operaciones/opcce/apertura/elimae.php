...
$colname1_eliminar = "Apertura.";
if (isset($_GET['evento'])) {
  $colname1_eliminar = $_GET['evento'];
}
$colname_eliminar = "zzz";
if (isset($_GET['nombre_cliente'])) {
  $colname_eliminar = $_GET['nombre_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opcce WHERE nombre_cliente LIKE %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Apertura Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3">ELIMINAR APERTURA EXPORTACIONES - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo8"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Eliminar Apertura Exportaciones </span></td>
    </tr>
    <tr>
      <td width="22%" align="right" valign="middle">Nombre Cliente</div>:</td>
      <td width="78%" align="left" valign="middle"><input name="nombre_cliente" type="text" class="etiqueta12" id="nombre_cliente" size="80" maxlength="80">        </td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['nro_operacion']); ?></span>      </div></td>

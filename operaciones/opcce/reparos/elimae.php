...
if (isset($_GET['nro_operacion'])) {
  $colname1_reparo = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_reparo = sprintf("SELECT * FROM opcce WHERE evento = %s and nro_operacion = %s and sub_estado = 'Reparada.'", GetSQLValueString($colname_reparo, "text"),GetSQLValueString($colname1_reparo, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Ingreso Reparo </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td valign="middle" class="titulocolumnas">Eliminar</div></td>
  ...
  <?php do { ?>
  <tr>
    <td valign="middle"><a href="elidet.php?recordID=<?php echo $row_reparo['id']; ?>"> <img src="../../../imagenes/ICONOS/papelero.jpg" width="20" height="21" border="0"></a></div></td>
    <td valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_reparo['nro_operacion']); ?></span>      </div></td>
    <td valign="middle"><?php echo $row_reparo['rut_cliente']; ?></div></td>
    <td valign="middle"><?php echo $row_reparo['fecha_ingreso']; ?></div></td>
    <td valign="middle"><?php echo $row_reparo['evento']; ?></div></td>
  </tr>

...
if (isset($_GET['nro_operacion'])) {
  $colname1_modrep = $_GET['nro_operacion'];
}
$colname2_modrep = "zzz";
if (isset($_GET['rut_cliente'])) {
  $colname2_modrep = $_GET['rut_cliente'];
}
$colname_modrep = "1";
if (isset($_GET['id'])) {
...
$query_modrep = sprintf("SELECT * FROM opcce WHERE id LIKE %s and nro_operacion LIKE %s and rut_cliente LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_modrep . "%", "text"),GetSQLValueString($colname1_modrep . "%", "text"),GetSQLValueString($colname2_modrep . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingresar o Modificar Reparo</span></td>
    </tr>
    <tr>
...
<br>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_modrep['nro_operacion']); ?></span>&nbsp; </div></td>
      <td align="center" valign="middle"><?php echo $row_modrep['rut_cliente']; ?>&nbsp; </div></td>
      <td align="center" valign="middle"><?php echo $row_modrep['fecha_ingreso']; ?>&nbsp; </div></td>
      <td align="center" valign="middle"><?php echo $row_modrep['evento']; ?>&nbsp; </div></td>
    </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../carcreexp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div>
    <a href="../visacion/principal.php"><img src="../../../imagenes/Botones/visacion_1.jpg" width="80" height="25" border="0"></a></td>
  </tr>
</table>
</body>
</html>

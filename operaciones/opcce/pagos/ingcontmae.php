...
$query_ingreso = sprintf("SELECT * FROM opcce WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_ingreso, "text"),GetSQLValueString($colname1_ingreso, "text"));
...
<title>Ingreso Pago / Liquidaci&oacute;n Exportaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO PAGO - LIQUIDACI&Oacute;N EXPORTACIONES - MAESTRO </td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"> Pago - Liquidaci&oacute;n Exportaciones </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="7" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Numero Operaci&oacute;n <span class="Estilo9"><?php echo strtoupper($row_ingreso['nro_operacion']); ?></span></span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="ingcontdet.php?recordID=<?php echo $row_ingreso['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
    <td align="center" valign="middle"><?php echo $row_ingreso['fecha_ingreso']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_ingreso['rut_cliente']; ?> </div></td>
    <td align="left" valign="middle"><?php echo $row_ingreso['nombre_cliente']; ?> </td>
    <td align="center" valign="middle"><?php echo $row_ingreso['evento']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_ingreso['estado']; ?> </div></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingreso['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_ingreso['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
  </tr>

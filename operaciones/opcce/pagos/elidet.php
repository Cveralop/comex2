...
<title>Eliminar Alzamiento Exportaciones - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR PAGO / ALZAMIENTO EXPORTACIONES - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"> <span class="titulodetalle">Eliminar Registro Exportaciones
        </div>
      </span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="tipo_negociacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['tipo_negociacion']; ?>" size="20" maxlength="20">
      </div></td>
      <td align="right" valign="middle">Moneda / Monto Documentos:</div></td>
      <td align="center" valign="middle">
          <input name="moneda_documentos" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['moneda_documentos']; ?>" size="5" maxlength="3"> 
        / 
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Eliminarr Registro">
      </div></td>
    </tr>
  </table>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcce (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, obs, especialista, referencia, moneda_documentos, monto_documentos, tipo_negociacion, date_asig) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "../controles/altaope/altdocdismae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingreso Alzamiento Exportaciones - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO ALZAMIENTO EXPORTACIONES - DETALLE</td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','rut_cliente','','R','nombre_cliente','','R','asignador','','R','especialista','','R','moneda_documentos','','R','monto_documentos','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="6" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Alzamiento Exportaciones</span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td colspan="5" align="center" valign="middle"><input name="nombre_cliente" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nombre_cliente']; ?>" size="122" maxlength="120"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Evento:</td>
      <td align="center" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          <option value="Alzamiento." selected>Alzamiento</option>
        </select>
          </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input <?php if (!(strcmp(ucwords($row_DetailRS1['convenio']),"Si"))) {echo "checked";} ?> name="convenio" type="checkbox" id="convenio" value="Si">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="6" align="center" valign="middle">
          <input name="Enviar" type="submit" class="boton" value="Ingresar Alzamiento">
        </div>        </div>        </div></td>
    </tr>
  </table>
  ...
  <input name="tipo_negociacion" type="hidden" id="tipo_negociacion" value="<?php echo $row_DetailRS1['tipo_negociacion']; ?>" size="32">  

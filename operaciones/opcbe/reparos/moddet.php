...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET estado=%s, operador=%s, moneda_operacion=%s, monto_operacion=%s, sub_estado=%s, date_oper=%s, reparo_obs=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_DetailRS1,$colname1_DetailRS1); //$colname_modrep,$colname1_modrep
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','moneda_reparo','','R','monto_reparo','','RisNum','reparo_espe','','R','reparo_obs','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <input name="especialista_curse" type="text" disabled="disabled" class="etiqueta12" id="especialista_curse" value="<?php echo $row_DetailRS1['especialista']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="baseline">

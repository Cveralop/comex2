...
$query_reparo = sprintf("SELECT * FROM opcbe WHERE rut_cliente LIKE %s and id LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_reparo . "%", "text"),GetSQLValueString($colname1_reparo . "%", "text"),GetSQLValueString($colname2_reparo . "%", "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_reparo['id']; ?></td>
    <td align="center" valign="middle"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_reparo['nro_operacion']); ?></span>      </div></td>
    <td align="center" valign="middle"><?php echo $row_reparo['rut_cliente']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_reparo['fecha_ingreso']; ?></div></td>

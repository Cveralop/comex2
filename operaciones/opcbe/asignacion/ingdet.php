...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET evento=%s, asignador=%s, operador=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_asig=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">COBRANZA EXTRANJERA DE EXPORTACION</td>
  </tr>
</table>
<br>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Pago." selected <?php if (!(strcmp("Pago.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Pago</option>
        <option value="LIQ.RET." <?php if (!(strcmp("LIQ.RET.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Liquidaci&oacute;n de Retorno</option>
        <option value="LBTR." <?php if (!(strcmp("LBTR.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>LBTR</option>
        <option value="EMI.PLA." <?php if (!(strcmp("EMI.PLA.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Emisi&oacute;n Planilla</option>
        <option value="Aceptacion MT412." <?php if (!(strcmp("Aceptacion MT412.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Aceptacion MT412</option>

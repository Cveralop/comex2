...
$colname3_controldoctos = "Apertura.";
if (isset($_GET['evento'])) {
  $colname3_controldoctos = $_GET['evento'];
}
$colname1_controldoctos = "CBE.";
if (isset($_GET['tipo_operacion'])) {
  $colname1_controldoctos = $_GET['tipo_operacion'];
}
$colname2_controldoctos = "Pendiente.";
if (isset($_GET['estado_aceptacion'])) {
  $colname2_controldoctos = $_GET['estado_aceptacion'];
}
$colname_controldoctos = "1";
if (isset($_GET['aceptacion'])) {
  $colname_controldoctos = $_GET['aceptacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_controldoctos = sprintf("SELECT * FROM opcbe WHERE aceptacion LIKE %s and tipo_operacion = %s and estado_aceptacion = %s and evento = %s ORDER BY id ASC", GetSQLValueString("%" . $colname_controldoctos . "%", "text"),GetSQLValueString($colname1_controldoctos, "text"),GetSQLValueString($colname2_controldoctos, "text"),GetSQLValueString($colname3_controldoctos, "text"));
  ...
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td width="81%" align="left" valign="middle">        <select name="aceptacion" class="etiqueta12" id="aceptacion">
        <option value="CA." selected>Contra Aceptaci&oacute;n</option>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="left" valign="middle">
    ...
    <td align="left" valign="middle"><?php echo $row_controldoctos['obs']; ?> </td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../cobexport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image4" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

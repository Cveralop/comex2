...
$query_currier = sprintf("SELECT * FROM opcbe WHERE currier LIKE '%%%s%%' ORDER BY id DESC", $colname_currier);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Valor Negociaci&oacute;n</div>
    </td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_currier['moneda_operacion']); ?> </span><strong class="respuestacolumna_azul"><?php echo number_format($row_currier['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>

...
$query_cursada = sprintf("SELECT * FROM opcbe WHERE evento LIKE %s and estado LIKE %s and fecha_curse LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_cursada . "%", "text"),GetSQLValueString("%" . $colname1_cursada . "%", "text"),GetSQLValueString("%" . $colname2_cursada . "%", "text"));
...
<body onLoad="MM_preloadImages('../../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS COBRANZAS DE EXPORTACI&Oacute;N </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle">
      <span class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['moneda_operacion']); ?></span>
      <span class="respuestacolumna_azul"><span class="Estilo6"><span class="Estilo12"><?php echo number_format($row_cursada['monto_operacion'], 2, ',', '.'); ?></span></span>
      </span>
      </div>      
      </div></td>
  </tr>

...
$query_pendientes = sprintf("SELECT * FROM opcbe WHERE estado = %s and urgente = %s and fuera_horario = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_pendientes, "text"),GetSQLValueString($colname1_pendientes, "text"),GetSQLValueString($colname2_pendientes, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT * FROM opcbe WHERE estado = %s and urgente = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM opcbe WHERE estado = %s and fuera_horario = %s and urgente <> %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString($colname2_fuerahorario, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_pendientes['nro_operacion']); ?></span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Operador</td>
    <td align="center" valign="middle" class="titulocolumnas">Especialista Curse</td>
    <td align="center" valign="middle" class="titulocolumnas">Fecha Ing. Espe.</td>

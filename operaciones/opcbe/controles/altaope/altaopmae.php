...
$query_operador = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne FROM opcbe , usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s  and fuera_horario = %s and (opcbe.especialista_curse = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_operador, "text"),GetSQLValueString($colname1_operador, "text"),GetSQLValueString("%" . $colname2_operador . "%", "text"),GetSQLValueString($colname3_operador, "text"),GetSQLValueString($colname4_operador, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne FROM opcbe, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s  and (opcbe.especialista_curse = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"),GetSQLValueString("%" . $colname2_urgente . "%", "text"),GetSQLValueString($colname3_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne FROM opcbe, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente <> %s and fuera_horario = %s and (opcbe.especialista_curse = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString("%" . $colname2_fuerahorario . "%", "text"),GetSQLValueString($colname3_fuerahorario, "text"),GetSQLValueString($colname4_fuerahorario, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td width="79%" align="left"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="17" maxlength="15">
...
<?php if ($totalRows_urgente > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="9" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
    </tr>
    <tr>
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><a href="altaopdet.php?recordID=<?php echo $row_urgente['id']; ?>"><img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="9" align="left" valign="middle" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_operador ?> Curse Normal</span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="altaopdet.php?recordID=<?php echo $row_operador['id']; ?>"><img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0" align="absmiddle"></a>      </div></td>
...
<?php if ($totalRows_fuerahorario > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="9" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_fuerahorario ?> Curse Fuera Horario</span></td>
    </tr>
    <tr>
      <td align="center" valign="middle" class="titulocolumnas">Cursar</td>
      <td align="center" valign="middle" class="titulocolumnas">Evento</td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, reparo_obs=%s, aceptacion=%s, protesto=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s WHERE id=%s",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcbe WHERE id = %s ORDER BY evento ASC", $colname_DetailRS1);
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_DetailRS1);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Operaciones Supervisor
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="estado" class="etiqueta12" id="estado">
...
Contra Aceptaci&oacute;n
        </label>
        <label>
          <input name="aceptacion" type="radio" class="etiqueta12" value="CP."  <?php if (!(strcmp($row_DetailRS1['aceptacion'],"CP."))) {echo "CHECKED";} ?>>
          Contra Pago</label></div>
      </td>
      <td align="right">Protesto:</td>
      <td align="center"><label>
        <input <?php if (!(strcmp($row_DetailRS1['protesto'],"Si."))) {echo "CHECKED";} ?> type="radio" name="protesto" value="Si.">
        Si</label>
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['protesto'],"No."))) {echo "CHECKED";} ?> name="protesto" type="radio" value="No.">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        ...
        <option value="LIQ.RET." <?php if (!(strcmp("LIQ.RET.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Liquidaci&oacute;n de Retorno</option>
      </select></td>
    </tr>
    <tr valign="middle">

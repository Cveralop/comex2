...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, reparo_obs=%s, aceptacion=%s, protesto=%s, sub_estado=%s, date_oper=%s WHERE id=%s",
                       GetSQLValueString($_POST['fecha_curse'], "text"),
		       GetSQLValueString($_POST['date_curse'], "text"),
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_operador);
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('nro_operacion','','R','fecha_curse','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alta Operaciones Operadores 
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">   
          <label>
          <input name="aceptacion" type="radio" value="CA." checked>
  Contra Aceptaci&oacute;n</label><label>
  <input type="radio" name="aceptacion" value="CP.">
  Contra Pago</label>
      </div></td>
      <td align="right">Protesto:</td>
      <td align="center">       
          <label>
          <input type="radio" name="protesto" value="Si.">
  Si</label>
          <label>
          <input name="protesto" type="radio" value="No." checked>
  No</label>      </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      <td colspan="4" align="center"><input type="submit" class="boton" value="Alta Operador"></td>
    </tr>
  </table>

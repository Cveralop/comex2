...
$query_cartareparo = sprintf("SELECT * FROM opcbe WHERE rut_cliente LIKE %s and id LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_cartareparo . "%", "text"),GetSQLValueString("%" . $colname1_cartareparo . "%", "text"),GetSQLValueString($colname2_cartareparo . "%", "text"));

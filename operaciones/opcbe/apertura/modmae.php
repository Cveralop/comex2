...
$query_modificar = sprintf("SELECT * FROM opcbe WHERE rut_cliente LIKE %s and evento = %s ORDER BY id DESC", GetSQLValueString("%" . $colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificar Apertura CBE - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">MODIFICAR APERTURA  COBRANZA DE EXPORTACI&Oacute;N OPI - MAESTRO</td>
    <td width="7%" rowspan="2" align="left" class="Estilo3"><img src="../../../imagenes/GIF/erde016.gif" width="43" height="43"></td>
  </tr>
  <tr valign="middle">
    <td align="left" class="Estilo4">COBRANZA EXTRANJERA DE EXPORTACI&Oacute;N</td>
  </tr>
</table>
<br>
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Registro Cob de Export</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="left"><label>
        <input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="17" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">    Moneda / Monto</td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_modificar['fecha_ingreso']; ?></td>
    <td align="center"><?php echo $row_modificar['rut_cliente']; ?></td>
    <td align="left"><?php echo $row_modificar['nombre_cliente']; ?></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></td>
    <td align="center"><?php echo $row_modificar['evento']; ?></td>
    <td align="center"><?php echo $row_modificar['estado']; ?></td>
    <td align="center"><?php echo $row_modificar['operador']; ?></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span><strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong></td>
    <td align="center">&nbsp;      <?php echo $row_modificar['tipo_operacion']; ?>      </div></td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../cobexport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET estado=%s, obs=%s, sub_estado=%s WHERE id=%s",
...
if (isset($_GET['nombre_cliente'])) {
  $colname_DetailRS1 = (get_magic_quotes_gpc()) ? $_GET['nombre_cliente'] : addslashes($_GET['nombre_cliente']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID",$colname_DetailRS1);//$colname_eliminaraper
...
<title>Eliminar Apertura Cobranza - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR APERTURA COBRANZA DE EXPORTACI&Oacute;N  - DETALLE</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Eliminar Apertura</span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="operador" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Nro Operaci&oacute;n:</td>
      <td colspan="3" align="left"><input name="nro_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="10"> 
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="tipo_operacion" type="text" disabled class="destadado" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="5">
      </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      <td colspan="4" align="center">
          <input type="submit" class="boton" value="Actualizar Registro">
      </div></td>
    </tr>
  </table>
...
<!--
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {minChars:0, maxChars:255, counterId:"countsprytextarea1", counterType:"chars_remaining", isRequired:false, validateOn:["blur"]});
//-->
</script>
</body>
</html><?php

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, folio=%s, currier=%s, tipo_operacion=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID",$colname_DetailRS1, $colname1_DetailRS1); //$colname1_modificar, $colname_modificar
...
<title>Modificar Apertura CBE - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR APERTURA EXPORTACI&Oacute;N - DETALLE
    </td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','nombre_cliente','','R','fecha_ingreso','','R','fecha_curse','','R','asignador','','R','operador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo6">Modificar Apertura CBE </span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">        <select name="evento" disabled="disabled" class="etiqueta12" id="evento">
    ...
    <tr valign="middle">
      ...
      <td align="center">                
        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
          <option value="CBE." selected <?php if (!(strcmp("CBE.", $row_DetailRS1['tipo_operacion']))) {echo "SELECTED";} ?>>Cobranza Exportaci&oacute;n</option>
        </select>
      </div></td>
    </tr>
    <tr valign="middle">
  ...
  <input name="asignador" type="hidden" class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20" maxlength="20">
</form>
<br>

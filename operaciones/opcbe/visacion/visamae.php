...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" class="Estilo3">VISACI&Oacute;N</td>
    <td width="7%" rowspan="2" class="Estilo3"><img src="../../../imagenes/GIF/erde016.gif" width="43" height="43"></td>
  </tr>
  <tr align="left">
    <td class="Estilo4">COBRANZA EXTRANJERA DE EXPORTACI&Oacute;N</td>
  </tr>
</table>
<br>
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="21%" align="right">Folio:</div></td>
    ...
    <tr>
      ...
      <td align="left"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="15" maxlength="7">
        <span class="texeti"><span class="respuestacolumna_rojo">O000000</span></span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="10" align="left" valign="middle"><span class="Estilo12"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"> <span class="Estilo13">Hay <span class="Estilo16"><?php echo $totalRows_DetailRS1 ?></span> para visaci&oacute;n</span></span></td>
  </tr>
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Visar</div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_DetailRS1['id']; ?></td>

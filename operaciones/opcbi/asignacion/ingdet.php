...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, asignador=%s, operador=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_visa=%s, date_asig=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Modificacion." <?php if (!(strcmp("Modificacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Modificaci&oacute;n</option>
        <option value="Aceptacion." <?php if (!(strcmp("Aceptacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Aceptaci&oacute;n</option>
        ...
        <option value="Visacion." <?php if (!(strcmp("Visacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Visaci&oacute;n (DI)</option>
        <option value="Portesto." <?php if (!(strcmp("Portesto.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Protesto</option>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="nro_operacion2" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">

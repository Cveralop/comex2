...
<title>Eliminar Pago - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR PAGO - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo11">Eliminar Pago CBI - OPI </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="8" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"> <span class="Estilo11">Numero Operaci&oacute;n <span class="Estilo12"><?php echo strtoupper($row_eliminar['nro_operacion']); ?></span></span></td>
  </tr>
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center" valign="middle"><span class="Estilo8"><span class="titulocolumnas">Eliminar</span></span></td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda / Moneda Operaci&oacute;n </td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_eliminar['id']; ?></td>

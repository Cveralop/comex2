...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, compraventa=%s, tipocambio=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_pago,$colname1_pago);
...
<title>Modificar Pago - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR PAGO -  DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Modificar Pago CBI - OPI </span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left" valign="middle"><input name="nombre_cliente" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nombre_cliente']; ?>" size="122" maxlength="120">        
      </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        ...
        <span id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span>        
      </div></td>
    </tr>
    <tr valign="middle">
...
?>
      ...
      <td align="center" valign="middle">
        <input name="tipo_operacion" type="text" disabled="disabled" class="destadado" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3">
      </div></td>
    </tr>
    <tr valign="middle">
...
Venta</label>
      ...
      <td align="right" valign="middle">Tipo Cambio:</div></td>
      <td align="center" valign="middle">

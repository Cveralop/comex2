...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_eliminaraper);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR APERTURA COBRANZA DE IMPORTACI&Oacute;N Y OPI - DETALLE</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Eliminar Apertura</span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left" valign="middle"><input name="nro_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="10"> 
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="tipo_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="5">
      </div></td>
    </tr>
    <tr valign="middle">

...
$query_asignar = sprintf("SELECT * FROM opcbi WHERE evento = '%s' ORDER BY id ASC", $colname_asignar);
...
if (!empty($_SERVER['QUERY_STRING'])) {
  ...
  foreach ($params as $param) {
    if (
      stristr($param, "pageNum_asignar") == false &&
...
<head>
  ...
  <title>Asignar Documentos CBI - Maestro</title>
  <style type="text/css">
    <!--
    .Estilo3 {
      font-size: 18px;
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')">
  <table width="95%" border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
    <tr>
      <td width="93%" align="left" valign="middle" class="Estilo3">ASIGNAR DOCUMENTOS COBRANZA DE IMPORTACI&Oacute;N - MAESTRO</td>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">  
    <tr valign="middle" bgcolor="#999999">
      ...
      <td align="center" class="titulocolumnas">Moneda / Monto</div></td>
    </tr>
  ...
  <table border="0" width="50%" align="center">
    <tr>
      ...
      <td width="23%" align="center"><?php if ($pageNum_asignar < $totalPages_asignar) { // Show if not last page 
                                      ?>
          <a href="<?php printf("%s?pageNum_asignar=%d%s", $currentPage, $totalPages_asignar, $queryString_asignar); ?>">Último</a>
        <?php } // Show if not last page 
        ?>
      </td>
    </tr>
  ...
  <table width="95%" border="0" align="center">
    <tr>
      <td align="right" valign="middle"><a href="../cobimport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div>
      </td>
    </tr>
  </table>
</body>

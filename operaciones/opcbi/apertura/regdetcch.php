...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, operador, especialista, moneda_operacion, monto_operacion, folio, currier, tipo_operacion, despacho_doctos, sucursal, segmento) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM cliente  WHERE id = $recordID", $colname_regdoctos);
...
<title>Cheque en Cobro - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">REGISTRO CHEQUE EN COBRO - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','fecha_ingreso','','R','nombre_cliente','','R','operador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum','folio','','R','currier','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Registro Cheque en Cobro</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="currier" type="text" class="etiqueta12" value="N/A" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Tipo Operaci&oacute;n: </div></td>
      <td align="center"><label>
  <input name="tipo_operacion" type="radio" value="CCH" checked>  
    Cobranza de Cheque</label>
          <br>
        </div></td>
    ...
    <tr valign="middle">
      <td colspan="4" align="center">
        <input type="submit" class="boton" value="Ingresar Cheque en Cobro">
      </div></td>
    </tr>
  </table>
  ...
  <input name="evento" type="hidden" class="etiqueta12" value="Reg_Cheque." size="20" maxlength="20">

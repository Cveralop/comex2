...
$colname_asignar = "Reg_Cheque.";
if (isset($_GET['evento'])) {
  $colname_asignar = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_asignar = sprintf("SELECT * FROM opcbi WHERE evento = %s ORDER BY id ASC", GetSQLValueString($colname_asignar, "text"));
...
<title>Asignar Cheque en Cobro CCH - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ASIGNAR  CHEQUE EN COBRO - MAESTRO</td>

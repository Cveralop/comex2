...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, folio=%s, currier=%s, valija=%s, tipo_operacion=%s, despacho_doctos=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['valija'], "text"),
...
if (isset($_GET['estado'])) {
  $colname1_DetailRS1 = (get_magic_quotes_gpc()) ? $_GET['estado'] : addslashes($_GET['estado']);
}
$colname_DetailRS1 = "1";
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_modificar,$colname1_modificar);
...
<title>Modificar Apertura CBI - OPI - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR APERTURA CBI Y OPI - DETALLE
    </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','nombre_cliente','','R','fecha_ingreso','','R','fecha_curse','','R','asignador','','R','operador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="6" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo6">Modificar Apertura Cobranza y OPI </span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <td colspan="3" align="center">
        ...
        <span class="rojopequeno">Sin puntos ni Guion
      </span> </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="center">        <select name="evento" disabled="disabled" class="etiqueta12" id="evento">
        <option value="Apertura." selected <?php if (!(strcmp("Apertura.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Apertura</option>
        <option value="Cheque en Cobro." <?php if (!(strcmp("Cheque en Cobro.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Cheque en Cobro</option>
      </select>
      </div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Estado:</td>
      <td align="center">        <select name="estado" disabled="disabled" class="etiqueta12" id="estado">
      ...
      <td colspan="3" align="center">
        <input name="fecha_curse" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_curse']; ?>" size="12" maxlength="10">
      <span class="rojopequeno">(dd-mm-aaaa)</span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <td colspan="3" align="center"></div>
        <select name="operador" class="etiqueta12" id="operador">
          ...
          <option value="ELARA" <?php if (!(strcmp("EVALENZU", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Eliza Valenzuela</option>
          ...
          <option value="FFARINAS" <?php if (!(strcmp("FFARINAS", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Francisco Fari&ntilde;as</option>
...
?>
      ...
      <td align="center">                <input name="tipo_operacion" type="text" class="etiqueta12" id="tipo_operacion" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3">
      </div></td>
      <td align="right" valign="middle">Entrega Documentos:</td>
      <td align="center"><label>
        <input <?php if (!(strcmp($row_DetailRS1['despacho_doctos'],"N/A"))) {echo "checked=\"checked\"";} ?> name="despacho_doctos" type="radio" class="etiqueta12" id="despacho_doctos_0" value="N/A">
        N/A</label>
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['despacho_doctos'],"NI."))) {echo "checked=\"checked\"";} ?> type="radio" name="despacho_doctos" value="NI." id="despacho_doctos_1">
          NI</label>
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['despacho_doctos'],"BMG."))) {echo "checked=\"checked\"";} ?> type="radio" name="despacho_doctos" value="BMG." id="despacho_doctos_2">
          BMG</label>
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['despacho_doctos'],"Red Sucursales."))) {echo "checked=\"checked\"";} ?> type="radio" name="despacho_doctos" value="Red Sucursales." id="despacho_doctos_3">
      Red Sucursales</label></td>
    </tr>
    <tr valign="middle">
      <td align="right">Folio:</td>
      <td align="center">
        <input name="folio" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['folio']; ?>" size="20" maxlength="20">
      </div></td>
      <td align="right">Currier:</div></td>
      <td align="center">
        <input name="currier" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['currier']; ?>" size="20" maxlength="20">
      </div></td>
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="tipo_operacion2" class="etiqueta12" id="tipo_operacion2">
        <option value="OPI." selected <?php if (!(strcmp("OPI.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Orden de Pago Import.</option>
        <option value="CBI." <?php if (!(strcmp("CBI.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Cobranza Import.</option>
      </select></td>
      <td align="right">Tipo Cambio:</div></td>
      <td align="center"><input name="tipocambio" type="text" class="etiqueta12" id="tipocambio" value="<?php echo $row_DetailRS1['tipocambio']; ?>" size="10" maxlength="10"></td>
      <td align="right">Valija:</td>
      <td align="center"><label>
        <input name="valija" type="text" class="etiqueta12" id="valija" value="<?php echo $row_DetailRS1['valija']; ?>" size="20" maxlength="20">
      </label></td>
    </tr>
    <tr valign="middle">

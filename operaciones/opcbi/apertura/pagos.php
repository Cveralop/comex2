...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO opcbi (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, obs, especialista, moneda_operacion, monto_operacion, tipo_operacion, compraventa, tipocambio, date_asig) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$colname_DetailRS1 = "OPI";
if (isset($_GET['tipo_operacion'])) {
  $colname_DetailRS1 = (get_magic_quotes_gpc()) ? $_GET['tipo_operacion'] : addslashes($_GET['tipo_operacion']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcbi WHERE tipo_operacion = '%s' ORDER BY id DESC", $colname_DetailRS1);
...
<title>Ingreso Cobertura OPI</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO COBERTURA ORDEN DE PAGO IMPORTACI&Oacute;N - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" onSubmit="MM_validateForm('rut_cliente','','R','fecha_ingreso','','R','nombre_cliente','','R','asignador','','R','especialista','','R','moneda_operacion','','R','monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Cobertura OPI 
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">        
        <input name="tipo_operacion" type="text" disabled="disabled" class="destadado" id="tipo_operacion" value="OPI" size="10" maxlength="5">
      </div></td>
    </tr>
    <tr valign="middle">
  ...
  <input name="tipo_operacion" type="hidden" id="tipo_operacion" value="OPI" size="10" maxlength="5">

...
if (isset($_GET['rut_cliente'])) {
  $colname2_modificar = $_GET['rut_cliente'];
}
...
if (isset($_GET['nombre_cliente'])) {
  $colname_modificar = $_GET['nombre_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM opcbi WHERE nombre_cliente LIKE %s and evento = %s and rut_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar, "text"),GetSQLValueString("%" . $colname2_modificar, "text"));
...
<title>Modificar Apertura CBI - OPI - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR APERTURA  COBRANZA DE IMPORTACI&Oacute;N OPI - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Apertura CBI - OPI </span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nombre Cliente:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span>      </div></td>
    ...
    <td align="center"><?php echo $row_modificar['tipo_operacion']; ?></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../cobimport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_modificar);
...
<title>Modificar Modificaci&oacute;n - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> MODIFICAR MODIFICACI&Oacute;N -  MSG Swift - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Modificar Modificaci&oacute;n - MSG-Swift</span></div></td>
    </tr>
    <tr valign="middle">
...
?>
      ...
      <td align="center">          
        <input name="tipo_operacion" type="text" disabled="disabled" class="destadado" id="tipo_operacion" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3">
      </div></td>
    </tr>
    <tr valign="middle">

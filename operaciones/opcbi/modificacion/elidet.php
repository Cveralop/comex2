...
<title>Eliminar Modificaci&oacute;n - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR MODIFICACI&Oacute;N - MSG Swift - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Eliminar Modificaci&oacute;n - MSG Swift</span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="tipo_operacion" type="text" disabled class="destadado" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3">
      </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      <td colspan="4" align="center"><input type="submit" class="boton" value="Eliminar Operaci&oacute;n">
      </div></td>
    </tr>
  </table>

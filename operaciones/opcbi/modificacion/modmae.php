...
$query_modificar = sprintf("SELECT * FROM opcbi WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_modificar, "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificar Modificaci&oacute;n - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR MODIFICACI&Oacute;N -  MSG Swift - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso <span class="Estilo12"><span class="Estilo13">Modificaci&oacute;n - MSG-Swift</span></span></span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="6" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Nro Operaci&oacute;n <span class="Estilo8"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificar['moneda_operacion']); ?></span>&nbsp;<br>
    <strong class="respuestacolumna_azul"><?php echo number_format($row_modificar['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>

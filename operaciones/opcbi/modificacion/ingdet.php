...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, asignador, operador, nro_operacion, obs, especialista, moneda_operacion, monto_operacion, tipo_operacion, date_asig) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Ingreso Modificaci&oacute;n - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO MODIFICACI&Oacute;N -  MSG Swift - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Modificaci&oacute;n - MSG Swift </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left">
          <input name="nro_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="10" readonly="readonly">
...
?>
      ...
      <td align="center">
        <input name="tipo_operacion" type="text" class="destadado" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3">
      </div></td>
    </tr>
    <tr valign="middle">
  ...
  <input name="estado" type="hidden" class="etiqueta12" value="Pendiente." size="20" maxlength="20">

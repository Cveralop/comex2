...
if (isset($_GET['compraventa'])) {
  $colname1_compraventa = (get_magic_quotes_gpc()) ? $_GET['compraventa'] : addslashes($_GET['compraventa']);
}
$colname_compraventa = "1";
if (isset($_GET['fecha_ingreso'])) {
  $colname_compraventa = (get_magic_quotes_gpc()) ? $_GET['fecha_ingreso'] : addslashes($_GET['fecha_ingreso']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_compraventa = sprintf("SELECT *,sum(tipocambio)as maximo FROM opcbi WHERE fecha_ingreso = '%s' and compraventa = '%s' GROUP BY tipocambio", $colname_compraventa,$colname1_compraventa);
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="4" align="right" valign="middle"></div>      
...
echo strftime("Santiago, %d de %B de %Y");?>
  ...
  <tr valign="middle">
    ...
    <td align="right" valign="middle"><?php echo strtoupper($row_compraventa['moneda_operacion']); ?> <?php echo number_format($row_compraventa['monto_operacion'], 2, ',', '.'); ?></td>

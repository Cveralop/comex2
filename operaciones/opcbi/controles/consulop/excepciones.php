...
header("Content-Disposition: attachment;filename=opcbi_excepciones.xls"); 
...
$query_excepciones = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne ,timestampdiff(day,solucion_excepcion,current_timestamp)as dias FROM opcbi, usuarios WHERE estado_excepcion = %s and excepcion = %s and estado = %s and (opcbi.especialista_curse = usuarios.usuario) ORDER BY solucionado ASC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"));
...
<table width="95%" border="1" align="center">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle">Cobranza Extranjera de Importaci&oacute;n</td>

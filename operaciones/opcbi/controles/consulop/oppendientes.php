...
$query_pendientes = sprintf("SELECT * FROM opcbi WHERE estado = %s and urgente = %s and fuera_horario = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_pendientes, "text"),GetSQLValueString($colname1_pendientes, "text"),GetSQLValueString($colname2_pendientes, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT * FROM opcbi WHERE estado = %s and urgente = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM opcbi WHERE estado = %s and fuera_horario = %s and urgente <> %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString($colname2_fuerahorario, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="11" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"></span><span class="NegrillaCartaReparo">Total Operaciones Pendidntes <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
  </tr>
  <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="11" align="left" valign="middle" bgcolor="#00CC00" class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total  Operaciones Pendientes <?php echo $totalRows_pendientes ?> Curse Normal</span></td>
  </tr>
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio</td>
    <td align="center" valign="middle" class="titulocolumnas">Evento</td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Rut Cliente</td>
    <td align="center" valign="middle" class="titulocolumnas">Nombre Cliente</td>
    <td align="center" valign="middle" class="titulocolumnas">Moneda Monto Apertura</td>
    <td align="center" valign="middle" class="titulocolumnas">Operador</td>
    <td align="center" valign="middle" class="titulocolumnas">Especialista Curse</td>
    <td align="center" valign="middle" class="titulocolumnas">Hora ing. Espe.</td>
    <td align="center" valign="middle" class="titulocolumnas">Urgente</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_pendientes['nro_operacion']); ?></span>      </div>      </div></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_pendientes['rut_cliente']); ?></div></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_pendientes['nombre_cliente']); ?>      </div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="11" align="left" valign="middle" bgcolor="#FFFF00"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"></span><span class="NegrillaCartaReparo">Total Operaciones Pendientes <?php echo $totalRows_fuerahorario ?> Curse Fuera Horario</span></td>
  </tr>
  <tr>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio</td>
    <td align="center" valign="middle" class="titulocolumnas">Evento</td>

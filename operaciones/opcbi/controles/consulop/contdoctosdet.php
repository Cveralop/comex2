...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET obs=%s, estado_aceptacion=%s, fecha_aceptacion=%s WHERE id=%s",
                       GetSQLValueString($_POST['obs'], "text"),
                       GetSQLValueString($_POST['estado_aceptacion'], "text"),
                       GetSQLValueString($_POST['fecha_aceptacion'], "text"),
                       GetSQLValueString($_POST['id'], "int"));
  mysqli_select_db($comercioexterior, $database_comercioexterior);
  $Result1 = mysqli_query($comercioexterior, $updateSQL) or die(mysqli_error($comercioexterior));
  $updateGoTo = "contdoctosmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['aceptacion'])) {
  $colname_DetailRS1 = (get_magic_quotes_gpc()) ? $_GET['aceptacion'] : addslashes($_GET['aceptacion']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_controldoctos);
$DetailRS1 = mysqli_query($comercioexterior, $query_DetailRS1) or die(mysqli_error($comercioexterior));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);
$totalRows_DetailRS1 = mysqli_num_rows($DetailRS1);
...
<title>Control Documentos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL DOCUMENTOS - DETALLE </td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Control Documentos Detalle</span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="rut_cliente" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="17" maxlength="15">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="estado" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['estado']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Asignado:</td>
      <td align="center" valign="middle"><input name="asignador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20" maxlength="20"></td>
      ...
      <td align="center" valign="middle"><select name="operador" class="etiqueta12" id="operador">
        ...
        <option value="ELARA" <?php if (!(strcmp("ELARA", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Elizabeth Lara Quinones</option>
        ...
        <option value="JJEREZ" <?php if (!(strcmp("JJEREZ", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Johana Jerez</option>
        <option value="SMELLAL" <?php if (!(strcmp("SMELLAL", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Susan Mella Liberona</option>
        ...
        <option value="PCBI1" <?php if (!(strcmp("PCBI1", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Practica CBI 1</option>
        <option value="PCBI2" <?php if (!(strcmp("PCBI2", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Practica CBI 2</option>
        <option value="PCBI3" <?php if (!(strcmp("PCBI3", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Practica CBI 3</option>
      </select></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="especialista" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['especialista']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Observaci&oacute;n:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        <textarea name="obs" cols="80" rows="3" class="etiqueta12"><?php echo (isset($row_DetailRS1['obs'])?$row_DetailRS1['obs']:""); ?></textarea>
    ...
    <tr valign="middle">
      <td align="right" valign="middle">Moneda / Monto<br>
Operaci&oacute;n:</td>
...
?>
      ...
      <td align="right" valign="middle">Estado Aceptaci&oacute;n:</td>
      <td align="center" valign="middle"><select name="estado_aceptacion" class="etiqueta12" id="estado_aceptacion">
        <option value="Pendiente." selected>Pendiente</option>
        <option value="Aceptado.">Aceptado</option>
      </select></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Fecha Aceptaci&oacute;n:</td>
      <td colspan="3" align="left" valign="middle">
        <input name="fecha_aceptacion" type="text" class="etiqueta12" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10">
        <span class="rojopequeno">(dd-mm-aaaa)</span></div></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Documento Entregado">
      </div></td>
    </tr>
  </table>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="contdoctosmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<script type="text/javascript">
<!--
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {isRequired:false, validateOn:["blur"], minChars:0, maxChars:255, counterId:"countsprytextarea1", counterType:"chars_remaining"});
//-->
</script>
</body>
</html><?php

...
$query_currier = sprintf("SELECT * FROM opcbi WHERE currier LIKE '%%%s%%' ORDER BY id DESC", $colname_currier);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas"></div>      Fecha Ingreso</div></td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Valor Negociacion
      </div>
    </td>
  </tr>
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="../../../../cartadecredito/controles/untitled.php?recordID=<?php echo $row_currier['id']; ?>"> </a></div>      
      <?php echo $row_currier['fecha_ingreso']; ?> </div></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_currier['nro_operacion']; ?></span>      </div></td>
    <td align="center" valign="middle"><?php echo $row_currier['rut_cliente']; ?></div></td>
    <td align="left" valign="middle"><?php echo $row_currier['nombre_cliente']; ?> </td>
    <td align="right" valign="middle"><span class="Estilo5"><?php echo strtoupper($row_currier['moneda_operacion']); ?> </span><strong><?php echo number_format($row_currier['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>

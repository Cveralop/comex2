...
if (isset($_GET['nro_operacion'])) {
  $colname4_operador = $_GET['nro_operacion'];
}
...
$query_operador = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne FROM opcbi, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s and fuera_horario = %s and (opcbi.especialista_curse = usuarios.usuario) ORDER BY evento ASC", GetSQLValueString($colname_operador, "text"),GetSQLValueString($colname1_operador, "text"),GetSQLValueString("%" . $colname4_operador . "%", "text"),GetSQLValueString($colname5_operador, "text"),GetSQLValueString($colname6_operador, "text"));
...
$colname4_urgente = "I";
if (isset($_GET['nro_operacion'])) {
  $colname4_urgente = $_GET['nro_operacion'];
}
$colname5_urgente = "Si";
if (isset($_GET['urgente'])) {
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne FROM opcbi, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and urgente = %s and (opcbi.especialista_curse = usuarios.usuario) ORDER BY evento ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname1_urgente, "text"),GetSQLValueString("%" . $colname4_urgente . "%", "text"),GetSQLValueString($colname5_urgente, "text"));
...
$colname4_fuerahorario = "I";
if (isset($_GET['nro_operacion'])) {
  $colname4_fuerahorario = $_GET['nro_operacion'];
}
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne FROM opcbi, usuarios WHERE operador = %s and sub_estado = %s and nro_operacion LIKE %s and fuera_horario = %s and (opcbi.especialista_curse = usuarios.usuario) and urgente <> %s ORDER BY evento ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname1_fuerahorario, "text"),GetSQLValueString("%" . $colname4_fuerahorario . "%", "text"),GetSQLValueString($colname5_fuerahorario, "text"),GetSQLValueString($colname6_fuerahorario, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Operador</span></td>
    </tr>
    <tr valign="middle">
      <td width="22%" align="right" valign="middle">Nro Operaci&oacute;n:</td>
      <td width="78%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="17" maxlength="15">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../cobimport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a>
      </div></td>
  </tr>
</table>
<br>
<?php if ($totalRows_urgente > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="10" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Asignadas <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
    </tr>
    <tr>
      ...
      <td align="center" valign="middle" class="titulocolumnas">Tipo Operacion</td>
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" valign="middle"><?php echo strtoupper($row_urgente['tipo_operacion']); ?></td>
        <td align="center" valign="middle"><?php echo strtoupper($row_urgente['rut_cliente']); ?></td>
        <td align="center" valign="middle"><?php echo strtoupper($row_urgente['nombre_cliente']); ?></td>
        ...
        <td align="center" valign="middle"><?php echo strtoupper($row_urgente['ne']); ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="10" align="left" valign="middle" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Asignadas <?php echo $totalRows_operador ?> Curse Normal</span></td>
  </tr>
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Rut Cliente</td>
    <td align="center" valign="middle" class="titulocolumnas">Nombre Cliente</td>
    <td align="center" valign="middle" class="titulocolumnas">Monto Apertura</td>
    <td align="center" valign="middle" class="titulocolumnas">Especialista Curse</td>
    <td align="center" valign="middle" class="titulocolumnas">Urgente</td>
  </tr>
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="altaopdet.php?recordID=<?php echo $row_operador['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    ...
    <td align="left" valign="middle"><?php echo strtoupper($row_operador['rut_cliente']); ?></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_operador['nombre_cliente']); ?></td>
...
<?php if ($totalRows_fuerahorario > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="10" align="left" valign="middle" bgcolor="#FFFF00"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total Operaciones Asignadas <?php echo $totalRows_fuerahorario ?> Curse Fuera Horario</span></td>
    </tr>
    <tr>
      <td align="center" valign="middle" class="titulocolumnas">Cursar</td>
      <td align="center" valign="middle" class="titulocolumnas">Evento</td>
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" valign="middle"><?php echo strtoupper($row_fuerahorario['tipo_operacion']); ?></td>

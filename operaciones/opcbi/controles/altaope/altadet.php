...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET estado=%s, fecha_curse=%s, date_curse=%s, nro_operacion=%s, obs=%s, valija=%s, tipo_operacion=%s, aceptacion=%s, protesto=%s, despacho_doctos=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, autorizador=%s, reparo_obs=%s WHERE id=%s",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcbi WHERE id = %s ORDER BY evento ASC", GetSQLValueString($colname_DetailRS1, "int"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="right" valign="middle">Rut Cliente:
      <td align="right" valign="middle"><input name="rut_cliente" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="17" maxlength="15" readonly="readonly">
        <span class="rojopequeno">Sin puntos ni Guion</span>          </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="fecha_curse2" type="text" class="etiqueta12" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10" readonly="readonly">
    ...
    <tr valign="middle">
      <td align="right" valign="middle">Aceptaci&oacute;n:</td>
      <td align="center" valign="middle"></div>
        <select name="aceptacion" class="etiqueta12" id="aceptacion">
          <option value="CA." <?php if (!(strcmp("CA.", $row_DetailRS1['aceptacion']))) {echo "selected=\"selected\"";} ?>>Contra Aceptaci&oacute;n Pago</option>
          <option value="CP." <?php if (!(strcmp("CP.", $row_DetailRS1['aceptacion']))) {echo "selected=\"selected\"";} ?>>Contra Pago</option>
        </select>        
        </div>      
      </div></td>
      <td align="right" valign="middle">Protesto:        </div></td>
      <td align="center" valign="middle"><select name="protesto2" class="etiqueta12" id="protesto">
        <option value="No." <?php if (!(strcmp("No.", $row_DetailRS1['protesto']))) {echo "selected=\"selected\"";} ?>>No</option>
        <option value="Si." <?php if (!(strcmp("Si.", $row_DetailRS1['protesto']))) {echo "selected=\"selected\"";} ?>>Si</option>
        </select>
        <br>
      </div></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><label>
        <input <?php if (!(strcmp($row_DetailRS1['despacho_doctos'],"N/A"))) {echo "checked=\"checked\"";} ?> type="radio" name="despacho_doctos" value="N/A" id="despacho_doctos_0">
        N/A</label>
        <label>
      ...
      <td align="center" valign="middle"><select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        ...
        <option value="CBI." <?php if (!(strcmp("CBI.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Cobranza Importacion</option>
    ...
    <tr align="center" valign="middle">
      <td align="right" valign="middle">Valija:</td>
      <td colspan="3" align="left" valign="middle"><input name="valija" type="text" class="etiqueta12" id="valija" value="N/A" size="20" maxlength="20"></td>
    </tr>
    <tr align="center" valign="middle">
    ...
    <tr align="center" valign="middle">
      <td colspan="4" align="center" valign="middle"><input type="submit" class="boton" value="Alta Supervisor"></td>
    </tr>
  </table>

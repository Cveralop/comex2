...
<?php
session_start();
$MM_authorizedUsers = "ADM,SUP,GER";
...
$query_alta = sprintf("SELECT opcbi.*,(usuarios.nombre)as op FROM opcbi, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente = %s and fuera_horario = %s and (opcbi.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_alta, "text"),GetSQLValueString($colname2_alta, "text"),GetSQLValueString("%" . $colname3_alta . "%", "text"),GetSQLValueString($colname4_alta, "text"),GetSQLValueString($colname5_alta, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opasignadas = "SELECT *,SUM(nro_cuotas_cursadas)as cursada FROM asignacion_operaciones WHERE producto = 'Cobranza Extranjera de Import' GROUP BY operador,evento ORDER BY evento ASC";
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_urgente = sprintf("SELECT opcbi.*,(usuarios.nombre)as op FROM opcbi, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente = %s and (opcbi.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_urgente, "text"),GetSQLValueString($colname2_urgente, "text"),GetSQLValueString("%" . $colname3_urgente . "%", "text"),GetSQLValueString($colname4_urgente, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT opcbi.*,(usuarios.nombre)as op FROM opcbi, usuarios WHERE estado = %s and sub_estado <> %s and nro_operacion LIKE %s and urgente <> %s and fuera_horario = %s and (opcbi.operador = usuarios.usuario) ORDER BY date_asig ASC", GetSQLValueString($colname_fuerahorario, "text"),GetSQLValueString($colname2_fuerahorario, "text"),GetSQLValueString("%" . $colname3_fuerahorario . "%", "text"),GetSQLValueString($colname4_fuerahorario, "text"),GetSQLValueString($colname5_fuerahorario, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="18%" align="right" valign="middle">Nro Operaci&oacute;n:</div></td>
      <td width="82%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="15" maxlength="7"> 
...
<?php if ($totalRows_urgente > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td height="16" colspan="11" align="left" valign="middle" bgcolor="#FF0000"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total de Operaciones Cursadas por Operador <?php echo $totalRows_urgente ?> Curse Urgente</span></td>
    </tr>
    <tr>
      <td height="16" align="center" valign="middle" class="titulocolumnas">Cursar</td>
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_urgente['moneda_operacion']; ?> </span><span class="respuestacolumna_azul"><?php echo $row_urgente['monto_operacion']; ?></span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="11" align="left" valign="middle" bgcolor="#00CC00"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="NegrillaCartaReparo">Total de Operaciones  Cursadas por Operador <?php echo $totalRows_alta ?></div> Curse Normal</span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_alta['fecha_ingreso']; ?></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_alta['nro_operacion']); ?></span>      </div></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_alta['tipo_operacion']); ?></div></td>
    <td align="center" valign="middle"><?php echo $row_alta['sub_estado']; ?></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_alta['rut_cliente']); ?></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_alta['nombre_cliente']); ?></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_alta['moneda_operacion']); ?> </span><strong class="respuestacolumna_azul"><?php echo number_format($row_alta['monto_operacion'], 2, ',', '.'); ?></strong></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_alta['op']); ?>      </div></td>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="right" valign="middle" class="respuestacolumna_rojo"><?php echo $row_fuerahorario['moneda_operacion']; ?> <span class="respuestacolumna_azul"><?php echo $row_fuerahorario['monto_operacion']; ?></span></td>

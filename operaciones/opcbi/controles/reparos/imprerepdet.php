...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_cartareparo);
...
<table width="90%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><img src="../../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61" align="left"></td>
  </tr>
  <tr>
    <td width="100%" align="left" valign="middle">
      DEPARTAMENTO COBRANZA DE IMPORTACI&Oacute;N</div>
    </div></td>
  </tr>
  <tr>
...
<table width="90%"  border="0" align="center">
  <tr bordercolor="#CCCCCC">
    ...
    <td width="82%" align="left" valign="middle" class="Estilo10"><span class="Estilo12">Aviso de reparo, <strong class="NegrillaCartaReparo"><?php echo $row_DetailRS1['evento']; ?></strong> de Cobranza de Importaci&oacute;n.</span></td>
  </tr>
  <tr bordercolor="#CCCCCC">
    ...
    <td align="left" valign="middle" class="NegrillaCartaReparo"><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></td>
  </tr>
  <tr bordercolor="#CCCCCC">
    <td align="left" valign="middle" class="Estilo12">Cliente</span></td>
    <td align="center" valign="middle" class="Estilo10">:</div></td>
    <td align="left" valign="middle" class="Estilo10"><span class="NegrillaCartaReparo"><?php echo strtoupper($row_DetailRS1['nombre_cliente']); ?></span>      </div></td>
  </tr>
  <tr bordercolor="#CCCCCC">
    <td align="left" valign="middle" class="Estilo12">Rut</td>
    <td align="center" valign="middle" class="Estilo10">:</td>
    <td align="left" valign="middle" class="Estilo10"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['rut_cliente']; ?></span></td>
  </tr>
  <tr bordercolor="#CCCCCC">
    ...
    <td align="left" valign="middle" class="Estilo10"><span class="Estilo12"><strong class="NegrillaCartaReparo"><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?></strong> <strong class="NegrillaCartaReparo"><?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong> </span></td>
  </tr>
</table>
<br>
<table width="90%"  border="0" align="center">
  ...
  <tr>
    <td align="center" valign="middle"><SPAN class=265052114-13052009 Estilo15><span class="Estilo10"><strong>DEPTO COBRANZA DE IMPORTACI&Oacute;N</strong></span></SPAN></div></td>
  </tr>
  <tr>
    <td align="left" valign="middle">&nbsp;</td>
  </tr>

...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('asignador','','R','visador','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td width="33%" align="center" valign="middle"><input name="fecha_ingreso" type="text" class="etiqueta12" id="fecha_ingreso" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10" readonly="readonly">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextfield1">
        <input name="asignador" type="text" class="etiqueta12" id="asignador" value="Cob Imp y OPI." size="20" maxlength="20">

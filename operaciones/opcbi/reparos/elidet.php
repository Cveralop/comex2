...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_reparo);
...
<form method="get" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><input name="nombre_cliente" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nombre_cliente']; ?>" size="122"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <input name="nro_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="17" maxlength="15"> 
        </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
       <input name="monto_documentos" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['monto_documentos']; ?>" size="5" maxlength="3"> 
         <span class="rojopequeno">/</span>         
         <input name="moneda_documentos" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['moneda_documentos']; ?>" size="17" maxlength="15"> 
      </div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Convenio:</td>
      <td align="center" valign="middle">
        <input name="convenio" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['convenio']; ?>" size="5" maxlength="3">
      </div></td>

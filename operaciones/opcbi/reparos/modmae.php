...
$query_modrep = sprintf("SELECT * FROM opcbi WHERE id LIKE %s and rut_cliente LIKE %s and nro_operacion LIKE %s and sub_estado = %s ORDER BY date_curse DESC", GetSQLValueString("%" . $colname_modrep . "%", "text"),GetSQLValueString($colname1_modrep . "%", "text"),GetSQLValueString("%" . $colname2_modrep . "%", "text"),GetSQLValueString($colname3_modrep, "text"));
...
<br>
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td align="center" valign="middle"><?php echo strtoupper($row_modrep['rut_cliente']); ?></div></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../cobimport.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a> <a href="../visacion/principal.php"><img src="../../../imagenes/Botones/visacion_1.jpg" width="80" height="25" border="0"></a></td>
  </tr>
</table>
</body>
</html>

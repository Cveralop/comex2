...
$query_valija = sprintf("SELECT * FROM opcbi WHERE evento = %s and nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname_valija, "text"),GetSQLValueString($colname1_valija, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle"><span class="Estilo8">MODIFICACION VALIJA MAESTRO COBRANZA DE IMPORTACI&Oacute;N</span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Modificar Registro </div></td>
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="moddet.php?recordID=<?php echo $row_valija['id']; ?>"><img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"> </a> </div></td>
    ...
    <td align="center" valign="middle"><?php echo $row_valija['fecha_ingreso']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_valija['operador']; ?> </div></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_valija['nro_operacion']; ?></span>      </div></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_valija['moneda_documentos']); ?></span>  <span class="rojopequeno">/</span> <strong class="respuestacolumna_azul"><?php echo number_format($row_valija['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

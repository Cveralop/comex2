...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, fecha_curse, date_curse, operador, nro_operacion, moneda_operacion, monto_operacion, fecha_valija, nro_sobre, despacho_doctos, sucursal, encargado_sucursal, acuse_recibo, sub_estado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_valija);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle"><span class="Estilo8">INGRESO VALIJA DETALLE COBRANZA DE IMPORTACI&Oacute;N</span></td>

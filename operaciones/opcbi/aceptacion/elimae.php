...
$query_eliminar = sprintf("SELECT * FROM opcbi WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_eliminar, "text"),GetSQLValueString($colname1_eliminar, "text"));
...
.Estilo8 {font-size: 12px; color: #FFFFFF; font-weight: bold; }
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR ACEPTACI&Oacute;N O PROTESTO COBRANZA DE IMPORTACI&Oacute;N - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><strong class="titulodetalle">Eliminar Aceptaci&oacute;n Protesto CBI</strong></span></td>
    </tr>
    <tr valign="middle">
      <td width="20%" align="right" valign="middle">Nro Operaci&oacute;n:</div></td>
      <td width="80%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="15" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="8" align="left"><span class="Estilo8"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21">Numero  Operaci&oacute;n <span class="Estilo10"><?php echo strtoupper($row_eliminar['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center"><span class="titulocolumnas">Eliminar Operaci&oacute;n</span></div></td>
  ...
  <tr valign="middle">
    ...
    <td align="center" class="respuestacolumna_rojo"><?php echo $row_eliminar['id']; ?></td>
    <td align="center"><?php echo $row_eliminar['fecha_ingreso']; ?> </td>
    <td align="center"><?php echo $row_eliminar['rut_cliente']; ?></td>
    <td align="left"><?php echo $row_eliminar['nombre_cliente']; ?>
      </div></td>
...
<br>
Registros del <strong><?php echo ($startRow_eliminar + 1) ?></strong> al <strong><?php echo min($startRow_eliminar + $maxRows_eliminar, $totalRows_eliminar) ?></strong> de un toptal de <strong><?php echo $totalRows_eliminar ?></strong>

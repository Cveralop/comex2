...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, aceptacion=%s, protesto=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_aceptacion);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR ACEPTACI&Oacute;N O PROTESTO COBRANZA DE IMPORTACI&Oacute;N - DETALLE </td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo8">Modificar Aceptaci&oacute;n o Protesto CBI </span></div></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Nro Operaci&oacute;n:</td>
      <td align="center" valign="middle"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?></span></td>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        <option value="Aceptacion." selected <?php if (!(strcmp("Aceptacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Aceptacion</option>
        <option value="Carta Compromiso." <?php if (!(strcmp("Carta Compromiso.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Carta Compromiso</option>
<option value="Protesto." <?php if (!(strcmp("Protesto.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Protesto</option>
        <option value="Acuse Recibo." <?php if (!(strcmp("Acuse Recibo.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Acuse Recibo</option>
      </select></td>
...
?>
      ...
      <td align="center" valign="middle"><input name="tipo_operacion" type="text" disabled="disabled" class="destadado" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="5" maxlength="3"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Aceptacion:</td>
      <td align="center" valign="middle">
        <label>
        <input name="aceptacion" type="radio" class="etiqueta12" value="CA."  <?php if (!(strcmp($row_DetailRS1['aceptacion'],"CA."))) {echo "CHECKED";} ?>>
Contra Aceptaci&oacute;n</label>
        <label></label>
        <label>
        <input name="aceptacion" type="radio" class="etiqueta12" value="CP."  <?php if (!(strcmp($row_DetailRS1['aceptacion'],"CP."))) {echo "CHECKED";} ?>>
Contra Pago</label>
        <br>
     </td>
      <td align="right" valign="middle">Protesto:</td>
      <td align="center" valign="middle">
        <label>        
        <input name="protesto" type="radio" class="etiqueta12" value="Si." <?php if (!(strcmp($row_DetailRS1['protesto'],"Si."))) {echo "CHECKED";} ?>>
Si</label>
        <label>
        <input name="protesto" type="radio" class="etiqueta12" value="No." <?php if (!(strcmp($row_DetailRS1['protesto'],"No."))) {echo "CHECKED";} ?>>
No</label>
        <br>
      </td>
    </tr>

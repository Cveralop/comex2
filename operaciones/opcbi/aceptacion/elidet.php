...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_eliminar,$colname1_eliminar);
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR ACEPTACI&Oacute;N O PROTESTO COBRANZA DE IMPORTACI&Oacute;N - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="titulodetalle">Eliminar Aceptaci&oacute;n Protesto CBI</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" class="centro"><input name="fecha_ingreso" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_ingreso']; ?>" size="12" maxlength="10">
      <span class="rojopequeno">(dd-mm-aaaa)</span></td>
      <td align="right" >Evento:</td>
      <td align="center" class="centro"><input name="evento" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['evento']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" >Estado:</td>
      <td align="center" class="centro"><input name="estado" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['estado']; ?>" size="20" maxlength="20"></td>
      <td align="right" >Fecha Curse: </td>
      <td align="center" class="centro"><input name="fecha_curse" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_curse']; ?>" size="12" maxlength="10">
        <span class="rojopequeno">(dd-mm-aaaa)</span></td>
    </tr>
    <tr valign="middle">
      <td align="right" >Asignado:</td>
      <td align="center" class="centro"><input name="asignador" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20" maxlength="20"></td>
      <td align="right" >Operador:</td>
      <td align="center" class="centro"><input name="operador" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" >Nro Operaci&oacute;n:</td>
      <td colspan="3" align="left"><input name="nro_operacion" type="text" disabled class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, asignador, operador, nro_operacion, obs, especialista, moneda_operacion, monto_operacion, tipo_operacion, aceptacion, protesto, date_asig) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_aceptacion,$colname1_aceptacion);
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')"><table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO ACEPTACI&Oacute;N O PROTESTO COBRANZA DE IMPORTACI&Oacute;N - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"> <span class="Estilo5">Ingreso Aceptaci&oacute;n o Protesto CBI </span></div></td>
    </tr>
    <tr valign="middle">
      <td width="15%" align="right">Rut Cliente:</td>
      ...
      <td width="17%" align="right">Fecha Ingreso:</td>
    ...
    <tr valign="middle">
      ...
      <td align="center">        
        <select name="evento" class="etiqueta12" id="evento">
            <option value="Acuse Recibo." selected>Acuse Recibo</option>
        </select>
      </div></td>
  ...
  No</label>
    ...
    <tr valign="middle">
      <td colspan="4" align="center">
        <input name="Enviar" type="submit" class="etiqueta12" value="Ingresar Operaci&oacute;n">
      </div></td>
    </tr>
  </table>

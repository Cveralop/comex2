...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, estado=%s, asignador=%s, operador=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, valuta=%s, djo=%s, sub_estado=%s, date_visa=%s, date_asig=%s, reparo_obs=%s, estado_visacion=%s, visador=%s, mandato=%s, excepcion=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, responsable_excepcion=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['djo'], "text"),
                       GetSQLValueString($_POST['estado'], "text"),
...
$query_DetailRS1 = "SELECT * FROM opcbi WHERE id = $recordID";
$DetailRS1 = mysqli_query($comercioexterior, $query_DetailRS1) or die(mysqli_error($comercioexterior));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);
$totalRows_DetailRS1 = mysqli_num_rows($DetailRS1);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="rut_cliente" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['rut_cliente']; ?>" size="17" maxlength="12" readonly="readonly">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="Apertura y Pago." <?php if (!(strcmp("Apertura y Pago.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Apertura y Pago</option>
        <option value="Modificacion." <?php if (!(strcmp("Modificacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Modificacion</option>
        <option value="Aceptacion." <?php if (!(strcmp("Aceptacion.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Aceptacion</option>
...
<option value="Pago." <?php if (!(strcmp("Pago.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Pago</option>
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Tipo Operacion:</td>
    ...
    <tr valign="baseline">
      ...
      <td align="right" valign="middle">Dec. Jur. Original:</td>
      <td align="center" valign="middle"><select name="djo" class="etiqueta12" id="djo">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="valuta" class="etiqueta12" id="valuta">
        <option value="NA." <?php if (!(strcmp("NA.", $row_DetailRS1['valuta']))) {echo "selected=\"selected\"";} ?>>No Aplica</option>
        <option value="0." <?php if (!(strcmp(0., $row_DetailRS1['valuta']))) {echo "selected=\"selected\"";} ?>>Valuta 0</option>
        <option value="24." <?php if (!(strcmp(24., $row_DetailRS1['valuta']))) {echo "selected=\"selected\"";} ?>>Valuta 24</option>
        <option value="48." <?php if (!(strcmp(48., $row_DetailRS1['valuta']))) {echo "selected=\"selected\"";} ?>>Valuta 48</option>
      </select></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="autorizacion_operaciones" type="text" class="etiqueta12" size="30" maxlength="50"></td>
    </tr>
    <tr valign="baseline">

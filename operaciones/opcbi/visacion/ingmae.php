...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opasignadas = "SELECT evento,operador,count(operador)as cantidad,(usuarios.nombre)as nombre FROM opcbi, usuarios WHERE date_asig >= curdate() and (opcbi.operador = usuarios.usuario) GROUP BY evento,operador ORDER BY operador ASC";

...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">MODIFICAR CLIENTES COMERCIO EXTERIOR - MAESTRO </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td class="titulocolumnas">Modificar</td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td><a href="moddet.php?recordID=<?php echo $row_modificar['id']; ?>"> <img src="../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></td>
    <td class="respuestacolumna_rojo"><?php echo $row_modificar['rut_cliente']; ?></td>
    <td align="left"><?php echo $row_modificar['nombre_cliente']; ?></td>
    <td><?php echo $row_modificar['especialista']; ?></td>
  </tr>

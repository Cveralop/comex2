...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cliente (id, rut_cliente, nombre_cliente, especialista, ejecutivo, oficina, despacho_doctos, segmento, sucursal) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">CLIENTES COMERCIO EXTERIOR </td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','nombre_cliente','','R','especialista','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Ingreso Clientes</span></td>
    </tr>
    <tr valign="middle">
      <td align="right">Rut Cliente:</td>
      <td colspan="3" align="left"><input name="rut_cliente" type="text" class="etiqueta12" value="" size="17" maxlength="15">
      <span class="rojopequeno">(sin puntos ni guion) </span></td>
    </tr>
    <tr valign="middle">
      <td align="right">Nombre Cliente:</td>
      <td colspan="3" align="left"><input name="nombre_cliente" type="text" class="etiqueta12" value="" size="122" maxlength="120"></td>
    </tr>
    <tr valign="middle">
      <td align="right">Especialista:</td>
      <td align="center"><input name="especialista" type="text" class="etiqueta12" value="" size="35" maxlength="30"></td>
      <td align="right">Ejecutivo:</td>
      <td align="center"><input name="ejecutivo" type="text" class="etiqueta12" id="ejecutivo" size="55" maxlength="50"></td>
    </tr>
    <tr valign="middle">
      <td align="right">Oficina:</td>
      <td align="center"><input name="oficina" type="text" class="etiqueta12" id="oficina" size="50" maxlength="120"></td>
      <td align="right">Despacho Doctos:</td>
      <td align="center"><input name="despacho_doctos" type="text" class="etiqueta12" id="despacho_doctos" size="50" maxlength="120"></td>
    </tr>
    <tr valign="middle">
      <td align="right">Segmento:</td>
      <td align="center"><input name="segmento" type="text" class="etiqueta12" id="segmento" size="15" maxlength="10"></td>
      <td align="right">Sucursal:</td>
      <td align="center"><input name="sucursal" type="text" class="etiqueta12" id="sucursal" size="15" maxlength="10"></td>
    </tr>
    <tr valign="middle">
      <td colspan="4" align="center">
        <input type="submit" class="etiqueta12" value="Insertar Cliente">
      </td>
    </tr>
<br>
</table>

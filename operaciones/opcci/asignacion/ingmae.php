...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong></div>      </div></td>

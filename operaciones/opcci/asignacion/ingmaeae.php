...
$colname5_DetailRS1 = "Alzamiento Anticipado.";
if (isset($_GET['evento'])) {
  $colname5_DetailRS1 = $_GET['evento'];
}
$colname1_DetailRS1 = "Endoso Anticipado.";
if (isset($_GET['evento'])) {
  $colname1_DetailRS1 = $_GET['evento'];
}
$colname2_DetailRS1 = "zzzxxx";
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci WHERE estado_visacion = %s and (evento = %s or  evento = %s) and nro_operacion LIKE %s and estado = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_DetailRS1, "text"),GetSQLValueString($colname1_DetailRS1, "text"),GetSQLValueString($colname5_DetailRS1, "text"),GetSQLValueString($colname2_DetailRS1 . "%", "text"),GetSQLValueString($colname4_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO ASIGNACION ALZAMIENTO Y ENDOSO ANTICIPADO - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="11" align="left"><span class="Estilo10"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo11">Total Operaciones para Asignaci&oacute;n <span class="Estilo12"><?php echo $totalRows_DetailRS1 ?></span></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Asignar</div></td>
    <td align="center" class="titulocolumnas">Fecha Visaci&oacute;n</td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="ingdetae.php?recordID=<?php echo $row_DetailRS1['id']; ?>"> <img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET evento=%s, estado=%s, asignador=%s, operador=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, nro_cuotas=%s, pais=%s, banco_destino=%s, sub_estado=%s, date_asig=%s, forward=%s, reparo_obs=%s, fuera_horario=%s WHERE id=%s",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="forward" type="text" class="destadado" value="<?php echo $row_DetailRS1['forward']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="middle">
...
No</label></td>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><input name="nro_cuotas" type="text" class="etiqueta12" id="nro_cuotas" value="1" size="5" maxlength="4">

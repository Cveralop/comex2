...
$colname4_nominadoctos = "mdvilla";
if (isset($_GET['recibido_por'])) {
  $colname4_nominadoctos = $_GET['recibido_por'];
}
$colname5_nominadoctos = "efuentes";
if (isset($_GET['recibido_por'])) {
  $colname5_nominadoctos = $_GET['recibido_por'];
}
$colname6_nominadoctos = "johannam";
if (isset($_GET['recibido_por'])) {
  $colname6_nominadoctos = $_GET['recibido_por'];
}
$colname7_nominadoctos = "rsoto";
if (isset($_GET['recibido_por'])) {
  $colname7_nominadoctos = $_GET['recibido_por'];
}
$colname8_nominadoctos = "ameza";
if (isset($_GET['recibido_por'])) {
  $colname8_nominadoctos = $_GET['recibido_por'];
}
$colname9_nominadoctos = "jmarto1";
if (isset($_GET['recibido_por'])) {
  $colname9_nominadoctos = $_GET['recibido_por'];
}
...
$query_nominadoctos = sprintf("SELECT * FROM opcci WHERE estado_doc = %s and (recibido_por = %s or recibido_por = %s or recibido_por = %s or recibido_por = %s or recibido_por = %s or recibido_por = %s)", GetSQLValueString($colname1_nominadoctos, "text"),GetSQLValueString($colname4_nominadoctos, "text"),GetSQLValueString($colname5_nominadoctos, "text"),GetSQLValueString($colname6_nominadoctos, "text"),GetSQLValueString($colname7_nominadoctos, "text"),GetSQLValueString($colname8_nominadoctos, "text"),GetSQLValueString($colname9_nominadoctos, "text"));
...
<title>Arequeo Documentos Pendientes de Entrega BMG</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ARQUEO DOCUMENTOS PENDIENTES DE ENTREGA  BMG </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="8" align="left"><span class="Estilo9"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo12">Total de <span class="Estilo13"><?php echo $totalRows_nominadoctos ?></span> Negociaciones</span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Fecha Acuse Recibo Doctos 
      </div>      
      </div>      
      </div>
    </td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_nominadoctos['date_rec_doc_val']; ?>
      </div>      </div></td>
  </tr>

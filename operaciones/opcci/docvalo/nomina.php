...
$colname_nominadoctos = "2010-08-01";
if (isset($_GET['date_curse'])) {
  $colname_nominadoctos = $_GET['date_curse'];
}
$colname3_nominadoctos = "Negociacion.";
if (isset($_GET['evento'])) {
  $colname3_nominadoctos = $_GET['evento'];
}
$colname1_nominadoctos = "Pendiente.";
...
$query_nominadoctos = sprintf("SELECT * FROM opcci WHERE estado_doc = %s and estado = %s and evento = %s and date_curse > %s", GetSQLValueString($colname1_nominadoctos, "text"),GetSQLValueString($colname2_nominadoctos, "text"),GetSQLValueString($colname3_nominadoctos, "text"),GetSQLValueString($colname_nominadoctos, "date"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">NOMINA ESTADO DOCUMENTOS CCI</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="10" align="left"><span class="Estilo9"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo12">Total de <span class="Estilo13"><?php echo $totalRows_nominadoctos ?></span> Negociaciones</span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Fecha Entrega Doctos 
      </div>
    </td>
  </tr>
  <?php do { ?>
...
<td align="left"><?php echo strtoupper($row_nominadoctos['nombre_cliente']); ?></div></td>
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_nominadoctos['moneda_documentos']); ?></span>&nbsp;<strong class="respuestacolumna_azul"><?php echo number_format($row_nominadoctos['monto_documentos'], 2, ',', '.'); ?></strong>
      </div></td>

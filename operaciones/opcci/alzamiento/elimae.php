...
$query_eliminar = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_eliminar, "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Alzamiento - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR ALZAMIENTO - MAESTRO</td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Eliminar Alzamiento  o Contabilizaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="7" align="left"><span class="titulocolumnas"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Numero Operaci&oacute;n  </span><span class="tituloverde"><?php echo strtoupper($row_eliminar['nro_operacion']); ?></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas"><span class="titulocolumnas">Eliminar
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Fecha Ingreso 
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Rut Cliente 
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Nombre Cliente 
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Evento
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Estado
      </div>
    </span></td>
    <td align="center"><span class="titulocolumnas">Moneda / Monto Documentos
      </div>
    </span></td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="elidet.php?recordID=<?php echo $row_eliminar['id']; ?>"> <img src="../../../imagenes/ICONOS/papelero.jpg" width="20" height="21" border="0"></a></div></td>
    <td align="center"><?php echo $row_eliminar['fecha_ingreso']; ?> </div></td>
    <td align="center"><?php echo $row_eliminar['rut_cliente']; ?> </div></td>
    <td align="left"><?php echo $row_eliminar['nombre_cliente']; ?> </div></td>
    <td align="center"><?php echo $row_eliminar['evento']; ?> </div></td>
    <td align="center"><?php echo $row_eliminar['estado']; ?> </div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

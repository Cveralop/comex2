...
$colname2_ingreso = "Cursada.";
if (isset($_GET['estado'])) {
  $colname2_ingreso = $_GET['estado'];
}
$colname1_ingreso = "Alzamiento.";
if (isset($_GET['eveto'])) {
  $colname1_ingreso = $_GET['eveto'];
}
$colname_ingreso = "zzz";
...
$query_ingreso = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s and estado = %s ORDER BY id DESC", GetSQLValueString($colname_ingreso, "text"),GetSQLValueString($colname1_ingreso, "text"),GetSQLValueString($colname2_ingreso, "text"));
...
<title>Ingreso Contabilizacion - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO CONTABILIZACI&Oacute;N - MAESTRO </td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Alzamiento Contabilizaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="7" align="left"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Numero Operaci&oacute;n <span class="Estilo9"><?php echo strtoupper($row_ingreso['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="ingcontdet.php?recordID=<?php echo $row_ingreso['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
    <td align="center"><?php echo $row_ingreso['fecha_ingreso']; ?> </div></td>
    <td align="center"><?php echo strtoupper($row_ingreso['rut_cliente']); ?> </div></td>
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingreso['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_ingreso['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
  </tr>

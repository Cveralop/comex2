...
$colname2_ingreso = "Discrepancia.";
if (isset($_GET['tipo_negociacion'])) {
  $colname2_ingreso = $_GET['tipo_negociacion'];
}
$colname_ingreso = "zzz";
...
$query_ingreso = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and tipo_negociacion = %s ORDER BY id DESC", GetSQLValueString($colname_ingreso, "text"),GetSQLValueString($colname2_ingreso, "text"));
...
<title>Ingreso Alzamiento - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO ALZAMIENTO - MAESTRO</td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><span class="Estilo5"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Alzamiento Negociaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">

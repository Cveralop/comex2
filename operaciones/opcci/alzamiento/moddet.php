...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET fecha_ingreso=%s, evento=%s, asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_documentos=%s, monto_documentos=%s, forward=%s WHERE id=%s",
...
<title>Modificar Alzamiento - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR ALZAMIENTO - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','moneda_documentos','','R','monto_documentos','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Registro
        </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
          <select name="estado" class="etiqueta12" id="estado">
            ...
            <option value="Procesada." <?php if (!(strcmp("Procesada.", $row_DetailRS1['estado']))) {echo "SELECTED";} ?>>Procesada</option>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET estado=%s, sub_estado=%s, reparo_obs=%s, moneda_reparo=%s, monto_reparo=%s WHERE id=%s",
...
if (isset($_GET['rut_cliente'])) {
  $colname1_modrep = (get_magic_quotes_gpc()) ? $_GET['rut_cliente'] : addslashes($_GET['rut_cliente']);
}
$colname_modrep = "1";
if (isset($_GET['reparo_obs'])) {
  $colname_modrep = (get_magic_quotes_gpc()) ? $_GET['reparo_obs'] : addslashes($_GET['reparo_obs']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID", $colname_modrep,$colname1_modrep);

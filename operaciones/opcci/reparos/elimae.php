...
$query_reparo = sprintf("SELECT * FROM opcci WHERE rut_cliente LIKE %s and id LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_reparo . "%", "text"),GetSQLValueString($colname1_reparo . "%", "text"),GetSQLValueString($colname2_reparo . "%", "text"));

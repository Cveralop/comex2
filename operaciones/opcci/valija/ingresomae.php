...
$query_valija = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and fecha_curse = %s and evento = %s and estado = %s ORDER BY id DESC", GetSQLValueString($colname_valija, "text"),GetSQLValueString($colname1_valija, "text"),GetSQLValueString($colname2_valija, "text"),GetSQLValueString($colname3_valija, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle"><span class="Estilo8">INGRESO VALIJA MAESTRO CARTA DE CR&Eacute;DITO DE IMPORTACI&Oacute;N</span></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Ingreso Valija </div></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="ingresodet.php?recordID=<?php echo $row_valija['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
    <td align="center"><?php echo $row_valija['rut_cliente']; ?> </div></td>
    <td align="center"><?php echo $row_valija['nombre_cliente']; ?> </td>
    <td align="center"><?php echo $row_valija['estado']; ?></div></td>
    <td align="center"><?php echo $row_valija['fecha_curse']; ?> </div></td>

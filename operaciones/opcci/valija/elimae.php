...
$colname3_eliminar = "Despacho Doctos.";
if (isset($_GET['evento'])) {
  $colname3_eliminar = $_GET['evento'];
}
$colname_eliminar = "xxzz";
if (isset($_GET['nro_operacion'])) {
  $colname_eliminar = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_eliminar = sprintf("SELECT * FROM opcci WHERE nro_operacion LIKE %s and evento = %s ORDER BY nro_operacion DESC", GetSQLValueString("%" . $colname_eliminar . "%", "text"),GetSQLValueString($colname3_eliminar, "text"));
...
<title>Eliminar Valija - Maestro</title>
<style type="text/css">
<!--
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo13">Mantenci&oacute;n Valija (Eliminar)</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="elidet.php?recordID=<?php echo $row_eliminar['id']; ?>"> <img src="../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_eliminar['nro_operacion']; ?></span>      </div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo $row_eliminar['moneda_documentos']; ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_eliminar['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

...
$query_cartareparo = sprintf("SELECT * FROM opcci WHERE rut_cliente LIKE %s and id LIKE %s and nro_operacion LIKE %s and sub_estado = 'Reparada.' ORDER BY id DESC", GetSQLValueString($colname_cartareparo . "%", "text"),GetSQLValueString($colname1_cartareparo . "%", "text"),GetSQLValueString($colname2_cartareparo . "%", "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_cartareparo['nro_operacion']); ?></span>      </div></td>
    <td align="center"><?php echo $row_cartareparo['fecha_ingreso']; ?></div></td>
    <td align="center"><?php echo $row_cartareparo['rut_cliente']; ?></div></td>
    <td align="left"><?php echo strtoupper($row_cartareparo['nombre_cliente']); ?> </td>
    <td align="center"><?php echo $row_cartareparo['evento']; ?></div></td>
    <td align="center"><?php echo strtoupper($row_cartareparo['especialista']); ?></div></td>
  </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    ...
    <a href="../../visacion/principal.php"><img src="../../../../imagenes/Botones/visacion_1.jpg" width="80" height="25" border="0"> </a>
    </td>
  </tr>
</table>
</body>

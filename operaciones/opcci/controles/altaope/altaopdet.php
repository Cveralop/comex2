...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET fecha_curse=%s, date_curse=%s, nro_operacion=%s, nro_operacion_relacionada=%s, obs=%s, nro_cuotas=%s, tipo_negociacion=%s, fbco=%s, nro_factura=%s, seguimiento=%s, seg_obs=%s, reparo_obs=%s, sub_estado=%s, date_oper=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['fbco'], "text"),
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Operadores</span></td>
    </tr>
    <tr valign="middle">
  ...
  Discrepancia</label>
    ...
    <tr valign="baseline">
      ...
      <input name="fbco" type="text" class="etiqueta12" id="fbco" size="80" maxlength="100">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <label>
          <input type="radio" name="seguimiento" value="Si" id="seguimiento_0">
          Si</label>
        <label>
          <input name="seguimiento" type="radio" id="seguimiento_1" value="No" checked>
          No</label></td>
    ...
    <tr valign="baseline">
      ...
      <label>
        <textarea name="seg_obs" cols="80" rows="4" class="etiqueta12" id="seg_obs"></textarea>
        <span class="rojopequeno"><span id="countsprytextarea2">&nbsp;</span></span></label>
      <span class="rojopequeno"><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span></span></td>
    </tr>
    <tr valign="baseline">

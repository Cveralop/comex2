...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET rut_cliente=%s, nombre_cliente=%s, estado=%s, fecha_curse=%s, date_curse=%s, operador=%s, nro_operacion=%s, nro_operacion_relacionada=%s, obs=%s, nro_factura=%s, nro_cuotas=%s, tipo_negociacion=%s, seguimiento=%s, seg_obs=%s, reparo_obs=%s, segmento=%s, sub_estado=%s, vi=%s, iteraciones=%s, date_supe=%s, forward=%s, autorizador=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['nro_factura'], "text"),
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcci WHERE id = %s ORDER BY evento ASC", GetSQLValueString($colname_DetailRS1, "int"));
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID", $colname_DetailRS1);
...
<title>Alta Operaciones Supervisor - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Alta Operaciones Supervisor</span></div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Nro Registro: </td>
      <td align="center" valign="middle"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?></span>
      </div></td>
      <td align="right" valign="middle">Nro Operaci&oacute;n:</div></td>
      <td align="center" valign="middle"><span class="Estilo6">
        <input name="nro_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="7">
        <span class="rojopequeno">K000000</span></span>
      </div></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Nro Prestamo: </td>
      <td align="center" valign="middle"><input name="nro_operacion_relacionada" type="text" class="etiqueta12" id="nro_operacion_relacionada" value="<?php echo $row_DetailRS1['nro_operacion_relacionada']; ?>" size="15" maxlength="7">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        
        <select name="estado" class="etiqueta12" id="estado">
          <option value="Cursada." selected <?php if (!(strcmp("Cursada.", $row_DetailRS1['sub_estado']))) {echo "selected=\"selected\"";} ?>>Cursada</option>
          <option value="Reparada." <?php if (!(strcmp("Reparada.", $row_DetailRS1['sub_estado']))) {echo "selected=\"selected\"";} ?>>Reparada</option>
          <option value="Pendiente." <?php if (!(strcmp("Pendiente.", $row_DetailRS1['sub_estado']))) {echo "selected=\"selected\"";} ?>>Devuelta</option>
        </select>
      </div>        </div>              </div></td>
      <td align="right" valign="middle">Tipo Negociaci&oacute;n:</div></td>
      <td align="center" valign="middle">
          <label>
          <input <?php if (!(strcmp($row_DetailRS1['tipo_negociacion'],"Limpia."))) {echo "CHECKED";} ?> name="tipo_negociacion" type="radio" value="Limpia.">
  Limpia</label>
          <label>
  ...
  Discrepancia</label>
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Financiamiento Banco:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextfield1">
        <input name="fbco" type="text" class="etiqueta12" id="fbco" value="<?php echo $row_DetailRS1['fbco']; ?>" size="80" maxlength="100">
      <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Nro Factura:</td>
      <td colspan="3" align="left" valign="middle"><input name="nro_factura" type="text" class="etiqueta12" id="nro_factura" value="<?php echo $row_DetailRS1['nro_factura']; ?>" size="100" maxlength="100"></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Segmento:</td>
      <td align="center" valign="middle">
          <input name="segmento" type="text" class="etiqueta12" id="segmento" size="30" maxlength="30">
      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <input name="fecha_curse" type="text" class="etiqueta12" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10">
      <span class="rojopequeno">(dd-mm-aaaa)</span></div></td>
      <td align="right" valign="middle">Operador:</td>
      <td align="center" valign="middle"><label>
        <input name="operador" type="text" class="etiqueta12" id="operador" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20" readonly="readonly">
      </label></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Seguimiento:</td>
      <td align="center" valign="middle">
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['seguimiento'],"Si"))) {echo "checked=\"checked\"";} ?> type="radio" name="seguimiento" value="Si" id="seguimiento_0">
          Si</label>
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['seguimiento'],"No"))) {echo "checked=\"checked\"";} ?> type="radio" name="seguimiento" value="No" id="seguimiento_1">
          No</label></td>
      <td align="right" valign="middle">Nro Cuotas:</td>
      <td align="center" valign="middle"><input name="nro_cuotas" type="text" class="etiqueta12" id="nro_cuotas" value="<?php echo $row_DetailRS1['nro_cuotas']; ?>" size="5" maxlength="4"> 
        <span class="rojopequeno">1 a 9999</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Observaci&oacute;n Seguimiento:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea2">
        <label>
          <textarea name="seg_obs" cols="80" rows="4" class="etiqueta12" id="seg_obs"><?php echo $row_DetailRS1['seg_obs']; ?></textarea>
        <span class="rojopequeno"><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span><span id="countsprytextarea2">&nbsp;</span></span></label>
</span></td>
    </tr>
    <tr valign="baseline">
      <td colspan="4" align="left" valign="middle" bgcolor="#999999"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"></span><span class="Estilo5">Reparo</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Observaci&oacute;n Reparo:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea3">
...
var sprytextarea2 = new Spry.Widget.ValidationTextarea("sprytextarea2", {isRequired:false, validateOn:["blur"], counterId:"countsprytextarea2", counterType:"chars_remaining", maxChars:255});

...
$query_altadocdis = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and tipo_negociacion = %s ORDER BY id DESC", GetSQLValueString($colname_altadocdis, "text"),GetSQLValueString($colname1_altadocdis, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ALTA DOCTOS CON DISCREPANCIAS - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Alta Documentos con Discrepancia</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Alzar </div></td>

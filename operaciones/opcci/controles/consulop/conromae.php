...
$query_consultanro = sprintf("SELECT * FROM opcci WHERE nro_operacion = '%s' ORDER BY id DESC", $colname_consultanro);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td height="27" colspan="8" align="left"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo11"><?php echo strtoupper($row_consultanro['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">

...
$query_cursada = sprintf("SELECT opcci.*,(usuarios.nombre)as espe FROM opcci LEFT JOIN usuarios ON opcci.especialista_curse=usuarios.usuario WHERE evento LIKE %s and estado LIKE %s and date_ingreso between %s and %s ORDER BY opcci.id DESC", GetSQLValueString("%" . $colname_cursada . "%", "text"),GetSQLValueString("%" . $colname1_cursada . "%", "text"),GetSQLValueString($colname2_cursada, "date"),GetSQLValueString($colname3_cursada, "date"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle" class="Estilo3"> OPERACIONES CURSADAS (Apertura - Modificaci&oacute;n - MSG Swift - VTA Gtos - Requerimiento) </td>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          ...
          <option value="VTA-Gtos.">VTA-Gtos</option>
...
<table border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="18" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Total Operaciones <span class="Estilo10"><?php echo $totalRows_cursada ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Asignado
      </div>
    </td>
    ...
    <td align="center" class="titulocolumnas">Moneda
      </div>
    </td>
    <td align="center" class="titulocolumnas">Monto Operaci&oacute;n</div>
    </td>
    <td align="center" class="titulocolumnas">Pa&iacute;s</div>
    </td>
    <td align="center" class="titulocolumnas">Banco Destino 
      </div>
    </td>
    <td align="center" class="titulocolumnas">Via Web
      </div>
    </td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php if ($row_cursada['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
        <span class="Rojo2"><?php echo $row_cursada['urgente']; ?> </span></span>        
		<?php } // Show if not first page ?>
		<?php if ($row_cursada['urgente'] <> $row_colores['rojosi']) { // Show if not first page ?>
        <span class="Verde2"><?php echo $row_cursada['urgente']; ?> </span></span>
    <?php } // Show if not first page ?> </td>
    <td align="center"><?php echo $row_cursada['evento']; ?></div></td>
    <td align="center"><?php echo $row_cursada['estado']; ?></div></td>
    <td align="center"><?php echo strtoupper($row_cursada['asignador']); ?> </div></td>
    <td align="center"><?php echo strtoupper($row_cursada['operador']); ?></div></td>
    <td align="left"><?php echo $row_cursada['obs']; ?> </td>
    <td align="center"><?php echo strtoupper($row_cursada['espe']); ?></div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_cursada['moneda_operacion']); ?></span>      </div></td>
    <td align="right"><strong class="respuestacolumna_azul"><?php echo number_format($row_cursada['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="center"><?php echo strtoupper($row_cursada['pais']); ?> </div></td>
    <td align="center"><?php echo strtoupper($row_cursada['banco_destino']); ?></div></td>
    <td align="center"><?php echo strtoupper($row_cursada['via_web']); ?></div></td>

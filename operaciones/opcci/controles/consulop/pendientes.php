...
if (isset($_GET['sub_estado'])) {
  $colname1_pendientes = $_GET['sub_estado'];
}
$colname_pendientes = "zzz";
if (isset($_GET['evento'])) {
  $colname_pendientes = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_pendientes = sprintf("SELECT * ,count(id)as cantidad FROM opcci WHERE evento LIKE %s and sub_estado = %s GROUP BY nombre_cliente,operador ORDER BY nombre_cliente ASC", GetSQLValueString("%" . $colname_pendientes . "%", "text"),GetSQLValueString($colname1_pendientes, "text"));
...
<title>Control Operaciones Pendientes por Operador</title>
<style type="text/css">
<!--
...
<style type="text/css">
<!--
.Estilo25 {font-size: 12px; font-weight: bold; }
-->
</style>
</head>
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL OPERACIONES PENDIENTES POR OPERADOR </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Busqueda por Evento </span></td>
    </tr>
    <tr valign="middle">
      <td width="22%" align="right" valign="middle">Evento:</td>
      <td width="78%" align="left" valign="middle"><select name="evento" class="etiqueta12" id="evento">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><a href="../../carcreimp.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="4" align="left"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Total de Operaciones Pendientes <span class="Estilo16"><?php echo $totalRows_pendientes ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Cliente</div></td>
    ...
    <td align="center" class="titulocolumnas">Cantidad
      </div>
    </td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="left"><span class="Estilo25"><?php echo $row_pendientes['nombre_cliente']; ?></span></td>
    <td align="center"><span class="Estilo25"><?php echo $row_pendientes['evento']; ?></span></div></td>
    <td align="center"><span class="Estilo25"><?php echo $row_pendientes['operador']; ?></span></div></td>
    <td align="center"><span class="Estilo25"><?php echo $row_pendientes['cantidad']; ?></span></div></td>
  </tr>

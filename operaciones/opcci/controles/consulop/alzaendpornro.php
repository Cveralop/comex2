...
$colname1_consultanro = "1";
if (isset($_GET['evento'])) {
  $colname1_consultanro = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_consultanro = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_consultanro, "text"),GetSQLValueString($colname1_consultanro, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONSULTA ALZAMIENTO - ENDOSOS POR NUMERO - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td height="27" colspan="5" align="left"><span class="Estilo6"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo11"><?php echo strtoupper($row_consultanro['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas"></div>
      Fecha Ingreso 
      </div>    </td>
  ...
  <tr valign="middle">
    ...
    <td align="left"><?php echo strtoupper($row_consultanro['nombre_cliente']); ?> </td>
    <td align="center"><?php echo $row_consultanro['evento']; ?></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consultanro['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consultanro['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consultanro['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consultanro['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

...
if (isset($_GET['rut_cliente'])) {
  $colname_consulta = (get_magic_quotes_gpc()) ? $_GET['rut_cliente'] : addslashes($_GET['rut_cliente']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_consulta = sprintf("SELECT * FROM opcci WHERE rut_cliente = '%s' ORDER BY id DESC", $colname_consulta);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="8" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Rut Cliente <span class="Estilo9"><?php echo $row_consulta['rut_cliente']; ?> <span class="Estilo12">Nombre Cliente</span> <?php echo $row_consulta['nombre_cliente']; ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Nro Operaciones 
      </div>
    </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="corutdet.php?recordID=<?php echo $row_consulta['id']; ?>"> <img src="../../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>
    <td align="center"><?php echo $row_consulta['fecha_ingreso']; ?> </div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consulta['nro_operacion']); ?></span>      </div> </td>
    <td align="center"><?php echo $row_consulta['evento']; ?> </div></td>
    <td align="center"><?php echo $row_consulta['estado']; ?> </div></td>
    <td align="center"><?php echo $row_consulta['fecha_curse']; ?> </div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consulta['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consulta['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_consulta['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_consulta['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (id, rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, estado, asignador, operador, nro_operacion, nro_operacion_relacionada, obs, moneda_operacion, monto_operacion, nro_cuotas, origen_fondos, tipo_operacion, date_preingreso, date_espe, date_visa, date_asig, reparo_obs, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('nro_operacion','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="operador" class="etiqueta12" id="operador">
        ...
        <option value="EVALENZU">Elisa Valenzuela</option>
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield1"><span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span></span>
      ...
      <span class="rojopequeno">K000000<span class="respuestacolumna_azul">/ 
      ...
      <span class="respuestacolumna_rojo">L000000</span></span></span></td>
    ...
    <tr valign="middle">
      ...
      <td align="center">
          <select name="moneda_operacion" class="etiqueta12" id="moneda_operacion">
            ...
            <option value="CNY" <?php if (!(strcmp("CNY", $row_DetailRS1['moneda_operacion']))) {echo "selected=\"selected\"";} ?>>CNY</option>
          </select>
...
<option value="MT910.">MT910</option>
    ...
    <tr valign="middle">
      <td align="right" bgcolor="#CCCCCC">Nro Cuotas:</td>
      <td colspan="3" align="left" bgcolor="#CCCCCC"><input name="nro_cuotas" type="text" class="etiqueta12" id="nro_cuotas" value="1" size="5" maxlength="4">        
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="autorizacion_operaciones" type="text" class="etiqueta12" id="autorizacion_operaciones" size="30" maxlength="50"></td>
    </tr>
    <tr valign="middle">

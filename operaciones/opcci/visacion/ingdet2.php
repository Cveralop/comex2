...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, asignador, operador, nro_operacion, obs, moneda_operacion, monto_operacion, nro_cuotas, pais, banco_destino, sub_estado, date_visa, date_asig, forward, reparo_obs, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, fuera_horario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID", $colname_ingvarios,$colname1_ingvarios);
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="right" valign="middle">Mandatro</td>
      <td align="center" valign="middle"><input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS2['mandato']; ?>"></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <label>        </label>
        <input name="forward" type="text" class="destadado" id="forward" size="20" maxlength="20">
        <br>
      </td>
    </tr>
    <tr valign="middle">
...
No</label></td>
    ...
    <tr valign="middle">
      <td align="right" valign="middle" bgcolor="#999999">Pais:</td>
      <td align="center" valign="middle" bgcolor="#999999"><input name="pais" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['pais']; ?>" size="25" maxlength="20"></td>
      <td align="right" valign="middle" bgcolor="#999999">Banco Destino:</td>
      <td align="center" valign="middle" bgcolor="#999999"><input name="banco_destino" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['banco_destino']; ?>" size="55" maxlength="50"></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea2">
        ...
        <span class="rojopequeno" id="countsprytextarea2">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n�mero m�ximo de caracteres.</span></span></div>
      </td>
    </tr>
    <tr valign="baseline">

...
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID"); //, $colname_eliminar (dentro del parentesis erroja error)
...
<title>Eliminar MSG/Vta Gtos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> ELIMINAR MSG SWIFT / VENTA GTOS  - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="operador" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['operador']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="middle">

...
$query_ingreso = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_ingreso, "text"),GetSQLValueString($colname1_ingreso, "text"));
...
<title>Ingreso MSG/Vta Gtos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">INGRESO MSG SWIFT / VENTA GTOS - MAESTRO</td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">MSG Swift / Venta Gtos</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo6">Numero Operaci&oacute;n <span class="Estilo9"> <?php echo strtoupper($row_ingreso['nro_operacion']); ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">

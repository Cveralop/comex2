...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET fecha_ingreso=%s, evento=%s, asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, forward=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID"); //, $colname_modificar (estaba dentro del parentesis y arrojaba error)
...
<title>Modificar MSG/Vta Gtos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3"> MODIFICAR  MSG SWIFT / VENTA GTOS - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">MSG Swift / Venta Gtos</span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">        <select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="VTA-Gtos." <?php if (!(strcmp("VTA-Gtos.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>VTA-Gtos</option>
        ...
        <option value="Anulacion Saldo." <?php if (!(strcmp("Anulacion Saldo.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Anulacion Saldo</option>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="asignador" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['asignador']; ?>" size="20">
      </div></td>
      ...
      <td align="center" valign="middle"><select name="operador" class="etiqueta12" id="operador">
        ...
        <option value="BSALGADO" <?php if (!(strcmp("BSALGADO", $row_DetailRS1['operador']))) {echo "selected=\"selected\"";} ?>>Bastian Salgado Menares</option>
...
?>
      ...
      <span class="rojopequeno">/</span>        <input name="monto_operacion" type="text" class="etiqueta12" id="monto_operacion" value="<?php echo $row_DetailRS1['monto_operacion']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Discrepancia:</td>
      <td align="center" valign="middle">
      <input <?php if (!(strcmp($row_DetailRS1['tipo_negociacion'],"Discrepancia."))) {echo "checked";} ?> name="tipo_negociacion" type="checkbox" class="etiqueta12" id="tipo_negociacion" value="Discrepancia.">
  Discrepancia</div></td>
...
Si</label>
        <label>
        <input name="excepcion" type="radio" value="No">
No</label></td>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle"><select name="tipo_excepcion" class="etiqueta12" id="tipo_excepcion">
        ...
        <option value="Art 85." <?php if (!(strcmp("Art 85.", $row_DetailRS1['tipo_excepcion']))) {echo "SELECTED";} ?>>Art 85</option>
        <option value="Sol Credito." <?php if (!(strcmp("Sol Credito.", $row_DetailRS1['tipo_excepcion']))) {echo "SELECTED";} ?>>Sol Credito</option>
        <option value="Pagare." <?php if (!(strcmp("Pagare.", $row_DetailRS1['tipo_excepcion']))) {echo "SELECTED";} ?>>Pagare</option>
      ...
      <td align="center" valign="middle"><input name="solucion_excepcion" type="text" class="etiqueta12" size="12" maxlength="10">

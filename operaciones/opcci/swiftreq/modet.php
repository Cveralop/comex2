...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET date_sol_seg=%s, seguimiento=%s, seg_obs=%s WHERE id=%s",
...
<title>Control Vitacora MSG-Swift y Requerimientos - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL BITACORA MSG-SWIFT y REQUERIMIENTOS - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','monto_operacion','','RisNum','pais','','R','banco_destino','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo9">Bitacora SWIFT y Requerimientos</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      <td align="right" valign="middle">Ultima Fecha Actualizaci&oacute;n:</td>
      <td align="center" valign="middle">
      <label>
        <input name="date_sol_seg" type="text" disabled class="etiqueta12" id="date_sol_seg" value="<?php echo $row_DetailRS1['date_sol_seg']; ?>" size="12" maxlength="12">
      </label></td>
      <td align="right" valign="middle">Nro Operaci&oacute;n:</td>
      <td align="center" valign="middle"><input name="nro_operacion" type="text" disabled class="mayuscula" id="nro_operacion" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="20" maxlength="20"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="top">Observacion Seguimiento:</td>
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea1">
        <textarea name="seg_obs" cols="80" rows="10" class="etiqueta12" id="seg_obs"><?php echo date("d-m-Y"); ?> // <?php echo $row_DetailRS1['seg_obs']; ?></textarea>
    ...
    <tr valign="baseline">
      <td colspan="4" align="center" valign="middle">
        <input type="submit" class="boton" value="Cerrar Seguimiento">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1">
  <input type="hidden" name="id" value="<?php echo $row_DetailRS1['id']; ?>">
  <input name="seguimiento" type="hidden" id="seguimiento" value="No">
</form>
<br>

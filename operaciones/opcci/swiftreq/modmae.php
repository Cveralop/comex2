...
$colname4_modificacion = "Si";
if (isset($_GET['seguimiento'])) {
  $colname4_modificacion = $_GET['seguimiento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificacion = sprintf("SELECT opcci.*,(usuarios.nombre)as ope, timestampdiff(day,date_ingreso,current_timestamp)as dias FROM opcci, usuarios WHERE evento = %s and nro_operacion LIKE %s  and seguimiento = %s and (opcci.operador = usuarios.usuario) ORDER BY id DESC", GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion . "%", "text"),GetSQLValueString($colname4_modificacion, "text"));
...
<title>Control Vitacora MSG-Swift y Requerimientos - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">CONTROL BITACORA MSG-SWIFT y REQUERIMIENTOS - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo9">Control Bitacora SWIFT y Requerimientos</span></td>
    </tr>
    <tr>
      <td width="22%" align="right" valign="middle">Nro Operaci&oacute;n:</div></td>
      <td width="78%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" size="15" maxlength="15">
    ...
    <tr>
      ...
      <td align="left" valign="middle">
        <label>
        <input name="evento" type="radio" id="evento_2" value="MSG-Swift." checked>
        MSG-Swift</label>
        <label>
          <input type="radio" name="evento" value="Requerimiento." id="evento_3">
          Requerimiento</label>
        <label>
          <input type="radio" name="evento" value="Anulacion." id="evento_4">
          Anulacion</label>
      <br>
      </td>
    </tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">&Uacute;ltima Actualizaci&oacute;n</td>
  </tr>
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="modet.php?recordID=<?php echo $row_modificacion['id']; ?>"> <img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    ...
    <td align="center" valign="middle"><?php echo $row_modificacion['rut_cliente']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificacion['nombre_cliente']; ?></td>
    ...
    <td align="center" valign="middle"><?php echo $row_modificacion['ope']; ?></td>
    <td align="center" valign="middle"><?php echo $row_modificacion['date_sol_seg']; ?></td>
  </tr>

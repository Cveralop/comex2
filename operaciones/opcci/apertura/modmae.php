...
$query_modificacion = sprintf("SELECT * FROM opcci WHERE rut_cliente LIKE %s and evento = %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion . "%", "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N APERTURA  - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo9">Modificar Apertura</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td class="titulocolumnas">Modificar</div></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td><a href="modet.php?recordID=<?php echo $row_modificacion['id']; ?>"> <img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    <td><?php echo $row_modificacion['fecha_ingreso']; ?> </div></td>
    <td><span class="Estilo7"> </span> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificacion['nro_operacion']); ?></span> </div></td>
    <td><?php echo $row_modificacion['rut_cliente']; ?> </div></td>
    <td align="left"><?php echo $row_modificacion['nombre_cliente']; ?> </td>
    <td align="right"> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_modificacion['moneda_operacion']); ?> </span><strong class="respuestacolumna_azul"> <?php echo number_format($row_modificacion['monto_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>

...
$query_eliminar = sprintf("SELECT * FROM opcci WHERE rut_cliente LIKE %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_eliminar . "%", "text"),GetSQLValueString($colname1_eliminar, "text"));
...
<title>Eliminar Apertura - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ELIMINAR APERTURA  - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><span class="Estilo8"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0">Eliminar Apertura</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td class="titulocolumnas">Eliminar</div></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td><a href="elidet.php?recordID=<?php echo $row_eliminar['id']; ?>"> <img src="../../../imagenes/ICONOS/papelero.jpg" width="20" height="21" border="0"></a></div></td>
    <td><?php echo $row_eliminar['fecha_ingreso']; ?> </div></td>
    <td> <span class="respuestacolumna_rojo"><?php echo strtoupper($row_eliminar['nro_operacion']); ?></span></div></td>
    <td><?php echo $row_eliminar['rut_cliente']; ?> </div></td>

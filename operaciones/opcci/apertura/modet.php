...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_operacion=%s, monto_operacion=%s, pais=%s, banco_destino=%s, forward=%s, excepcion=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s WHERE id=%s",
...
<title>Modificaci&oacute;n Apertura - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N APERTURA - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','monto_operacion','','RisNum','pais','','R','banco_destino','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="especialista" type="text" class="mayuscula" value="<?php echo $row_DetailRS1['especialista']; ?>" size="20" maxlength="20">
      </div></td>
...
?>
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="pais" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['pais']; ?>" size="25" maxlength="20">
      </div></td>
      <td align="right" valign="middle">Banco Destino:</div></td>
      <td align="center" valign="middle">
        <input name="banco_destino" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['banco_destino']; ?>" size="55" maxlength="50">
      </div></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center" valign="middle">          
          <input name="nro_operacion" type="text" disabled="disabled" class="etiqueta12" id="nro_operacion" value="<?php echo $row_DetailRS1['nro_operacion']; ?>" size="15" maxlength="10">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
        <input name="despacho_doctos" type="text" class="etiqueta12" id="despacho_doctos" value="<?php echo $row_DetailRS1['despacho_doctos']; ?>" size="25" maxlength="120">
      </div></td>
    </tr>
    <tr valign="middle">
...
No</label></td>
    ...
    <tr valign="middle">
      ...
      <td rowspan="2" align="center" valign="middle"><label>
        <input <?php if (!(strcmp($row_DetailRS1['excepcion'],"Si"))) {echo "CHECKED";} ?> type="radio" name="excepcion" value="Si">
Si</label>
        <label>
        <input <?php if (!(strcmp($row_DetailRS1['excepcion'],"No"))) {echo "CHECKED";} ?> name="excepcion" type="radio" value="No">
No</label></td>

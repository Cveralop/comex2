...
$query_modificar = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento =  %s ORDER BY id DESC", GetSQLValueString($colname2_modificar, "text"),GetSQLValueString($colname1_modificar, "text"));
...
<title>Modificaci&oacute;n Negociacion - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACION NEGOCIACION - MAESTRO </td>
...
<form action="" method="get" name="form1">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Negociaci&oacute;n o Vcto Plazo Proveedor</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="8" align="left"><span class="Estilo9"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo12">Numero Operaci&oacute;n <span class="Estilo13"><?php echo strtoupper($row_modificar['nro_operacion']); ?></span></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_modificar['nro_operacion_relacionada']; ?></span></td>

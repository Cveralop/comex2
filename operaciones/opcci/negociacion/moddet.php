...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET asignador=%s, operador=%s, obs=%s, especialista=%s, folio=%s, currier=%s, moneda_documentos=%s, monto_documentos=%s, convenio=%s, tipo_negociacion=%s, forward=%s WHERE id=%s",
...
<title>Modificaci&oacute;n Negociaci&oacute;n - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICACI&Oacute;N NEGOCIACION - DETALLE</td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','folio','','R','currier','','R','moneda_documentos','','R','monto_documentos','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Negociaci&oacute;n </div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">        <select name="estado" disabled="disabled" class="etiqueta12" id="estado">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">
          <select name="moneda_documentos" class="etiqueta12" id="moneda_documentos">
            ...
            <option value="CNY" <?php if (!(strcmp("CNY", $row_DetailRS1['moneda_documentos']))) {echo "SELECTED";} ?>>CNY</option>
            <?php
do {  
?>

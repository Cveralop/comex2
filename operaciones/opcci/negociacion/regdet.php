...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, nro_operacion, obs, especialista, folio, currier, moneda_documentos, monto_documentos, despacho_doctos, sucursal, segmento, forward, visador) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Registro Documentos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">REGISTRO DOCUMENTOS - DETALLE </td>
...
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','fecha_ingreso','','R','nombre_cliente','','R','operador','','R','nro_operacion','','R','moneda_documentos','','R','monto_documentos','','RisNum','folio','','R','currier','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Registro Documento</span></div></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="vinculos">Sin puntos ni Guion</span></div></td>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="center" valign="middle"><input name="nombre_cliente" type="text" disabled="disabled" class="etiqueta12" value="<?php echo $row_DetailRS1['nombre_cliente']; ?>" size="122" maxlength="120"></td>
    </tr>
    <tr valign="middle">
      <td align="right" valign="middle">Visado Por:</td>
      <td align="center" valign="middle">
        <input name="visador" type="text" class="etiqueta12" id="visador" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20">
      </div></td>
...
?>
          ...
          <input name="monto_documentos" type="text" class="mayuscula" value="<?php echo $row_DetailRS1['monto_documentos']; ?>" size="20" maxlength="20">
      </div></td>
    </tr>
    <tr valign="middle">
...
<td colspan="4" align="center" valign="middle">
  ...
  <input type="hidden" name="evento" value="Reg_Doctos." size="32">
  <input type="hidden" name="estado" value="Pendiente." size="32">
  <input name="forward" type="hidden" id="forward" value="<?php echo $row_DetailRS1['forward']; ?>">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="regmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html><?php

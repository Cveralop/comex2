...
$maxRows_asignar = 5000;
$pageNum_asignar = 0;
if (isset($_GET['pageNum_asignar'])) {
  $pageNum_asignar = $_GET['pageNum_asignar'];
}
$startRow_asignar = $pageNum_asignar * $maxRows_asignar;
$colname2_asignar = "zzz";
if (isset($_GET['nro_operacion'])) {
  $colname2_asignar = $_GET['nro_operacion'];
}
$colname_asignar = "Reg_Doctos.";
if (isset($_GET['evento'])) {
  $colname_asignar = $_GET['evento'];
}
$colname1_asignar = "Pendiente.";
if (isset($_GET['estado'])) {
  $colname1_asignar = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_asignar = sprintf("SELECT * FROM opcci WHERE evento = %s and estado = %s and nro_operacion LIKE %s ORDER BY nro_operacion ASC", GetSQLValueString($colname_asignar, "text"),GetSQLValueString($colname1_asignar, "text"),GetSQLValueString("%" . $colname2_asignar . "%", "text"));
...
<title>Asignar Documentos -  Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ASIGNAR DOCUMENTOS- MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo8">Buscar Numero de Operaci&oacute;n </span></td>
    </tr>
    <tr valign="middle">
      <td width="24%" align="right" valign="middle">Nro de Operaci&oacute;n:</div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="6" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo8">Total de Documentos para Asignar <span class="Estilo9"><?php echo $totalRows_asignar ?></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Asignar</td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="asidet.php?recordID=<?php echo $row_asignar['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"> </a> </div></td>
    <td align="center"><?php echo $row_asignar['fecha_ingreso']; ?> </div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_asignar['nro_operacion']); ?></span>      </div></td>
    <td align="center"><?php echo $row_asignar['rut_cliente']; ?> </div></td>
    <td align="left"><?php echo $row_asignar['nombre_cliente']; ?> </td>
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_asignar['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_asignar['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
  </tr>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_asignar < $totalPages_asignar) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_asignar=%d%s", $currentPage, $totalPages_asignar, $queryString_asignar); ?>">�ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>
<br>
Registros del <strong><?php echo ($startRow_asignar + 1) ?></strong> al <strong><?php echo min($startRow_asignar + $maxRows_asignar, $totalRows_asignar) ?></strong> de un total de <strong><?php echo $totalRows_asignar ?></strong> <br>

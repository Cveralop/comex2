...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET fecha_ingreso=%s, date_ingreso=%s, evento=%s, asignador=%s, operador=%s, obs=%s, especialista=%s, moneda_documentos=%s, monto_documentos=%s, convenio=%s, date_asig=%s, forward=%s WHERE id=%s",
...
<title>Asignar Documentos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ASIGNAR DOCUMENTOS - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('fecha_ingreso','','R','asignador','','R','especialista','','R','moneda_documentos','','R','monto_documentos','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Asignar Documentos</span></div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center" valign="middle">      
          <input name="convenio" type="checkbox" class="etiqueta12" id="convenio" value="HK">
      HK</div></td>

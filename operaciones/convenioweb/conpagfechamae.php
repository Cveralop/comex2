...
if (isset($_GET['date_ini'])) {
  $colname_modificar = $_GET['date_ini'];
}
$colname1_modificar = "-1";
if (isset($_GET['date_fin'])) {
  $colname1_modificar = $_GET['date_fin'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM convenioweb nolock WHERE fecha_ingreso between %s and %s", GetSQLValueString($colname_modificar, "date"),GetSQLValueString($colname1_modificar, "date"));
...
<title>Consulta Convenio WEB - Maestro</title>
<style type="text/css">
<!--
...
<br>
<form name="form1" method="get" action="conpagfechadet.php">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Consultar Convenio WEB</span></td>
    </tr>
    <tr>

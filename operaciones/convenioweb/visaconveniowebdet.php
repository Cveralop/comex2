...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "visaconveniowebmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr align="left" valign="middle" bgcolor="#999999">
      ...
      <input name="doc_1" type="checkbox" id="doc_1" value="Pagare." <?php if (!(strcmp($row_DetailRS1['doc_1'],"Pagare."))) {echo "checked=\"checked\"";} ?> <?php //if (!(strcmp($row_DetailRS1['pagare'],"Pagare."))) {echo "checked=\"checked\"";} ?>>Pagare
      <input name="doc_2" type="checkbox" id="doc_2" value="Convenio." <?php if (!(strcmp($row_DetailRS1['doc_2'],"Convenio."))) {echo "checked=\"checked\"";} ?>> Convenio
      <input name="doc_3" type="checkbox" id="doc_3" value="Anexo." <?php if (!(strcmp($row_DetailRS1['doc_3'],"Anexo."))) {echo "checked=\"checked\"";} ?>> Anexo Convenio Portal Comex
      <input name="doc_6" type="checkbox" id="doc_6" value="Solicitud Portal Comex." <?php if (!(strcmp($row_DetailRS1['doc_6'],"Solicitud Portal Comex."))) {echo "checked=\"checked\"";} ?>> Solicitud Portal Comex</td>
    </tr>
    <tr align="left" valign="middle" bgcolor="#999999">
...
Creditos Externos</td>
    ...
    <tr align="left" valign="middle" bgcolor="#999999">
      <td align="right" valign="middle" bgcolor="#CCCCCC">Obs. Reparo:</td>
      <td colspan="3" align="left" valign="middle" bgcolor="#CCCCCC"><textarea name="obs_reparo" cols="80" rows="4" class="etiqueta12" id="obs_reparo"></textarea></td>
    </tr>
    <tr valign="middle">
...
<select name="rol6" class="etiqueta12" id="rol6">
  ...
  <option value="Usuario." <?php if (!(strcmp("Usuario.", $row_DetailRS1['rol6']))) {echo "selected=\"selected\"";} ?>>Usuario</option>
    ...
    <tr valign="middle">
      <td colspan="4" align="center" valign="middle"><input name="Enviar" type="submit" class="boton" value="Visar Convenio WEB"></td>
    </tr>
  </table>

...
$colname_ingreso = "Pendiente.";
if (isset($_GET['estado'])) {
  $colname_ingreso = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingreso = sprintf("SELECT * FROM convenioweb nolock WHERE estado = %s ORDER BY id ASC", GetSQLValueString($colname_ingreso, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td class="titulocolumnas">Nro Registro</td>
    <td><span class="Estilo9">Rut Cliente</span></td>
    <td><span class="titulocolumnas">Nombre Cliente</span></td>
    <td class="titulocolumnas">Fecha Ingreso</td>
    </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="visaconveniowebdet.php?recordID=<?php echo $row_ingreso['id']; ?>"> <img src="../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></td>
    <td align="center"><?php echo $row_ingreso['id']; ?></td>
    ...
    <td align="center"><?php echo $row_ingreso['date_ingreso']; ?></td>
    </tr>

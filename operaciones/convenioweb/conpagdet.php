...
$query_DetailRS1 = sprintf("SELECT * FROM convenioweb nolock WHERE estado = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
<title>Consulta Convenio WEB - Detalle</title>
<style type="text/css">
<!--

...
$query_opbga = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as nroop, MIN(date_curse)as fini, MAX(date_curse)as ffin FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY segmento_comercial ORDER BY nroop DESC", GetSQLValueString($colname_opbga, "date"),GetSQLValueString($colname1_opbga, "date"),GetSQLValueString($colname2_opbga, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumbga = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumbga, "date"),GetSQLValueString($colname1_sumbga, "date"),GetSQLValueString($colname2_sumbga, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumcce = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumcce, "date"),GetSQLValueString($colname1_sumcce, "date"),GetSQLValueString($colname2_sumcce, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumcci = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumcci, "date"),GetSQLValueString($colname1_sumcci, "date"),GetSQLValueString($colname2_sumcci, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumcbe = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumcbe, "date"),GetSQLValueString($colname1_sumcbe, "date"),GetSQLValueString($colname2_sumcbe, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumcbi = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumcbi, "date"),GetSQLValueString($colname1_sumcbi, "date"),GetSQLValueString($colname2_sumcbi, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumtbc = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumtbc, "date"),GetSQLValueString($colname1_sumtbc, "date"),GetSQLValueString($colname2_sumtbc, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumcex = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumcex, "date"),GetSQLValueString($colname1_sumcex, "date"),GetSQLValueString($colname2_sumcex, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumste = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumste, "date"),GetSQLValueString($colname1_sumste, "date"),GetSQLValueString($colname2_sumste, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumstr = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumstr, "date"),GetSQLValueString($colname1_sumstr, "date"),GetSQLValueString($colname2_sumstr, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_summec = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_summec, "date"),GetSQLValueString($colname1_summec, "date"),GetSQLValueString($colname2_summec, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_sumpre = sprintf("SELECT *,COUNT(DISTINCT rut_cliente)as total FROM cm_clientesxseg WHERE date_curse BETWEEN %s AND %s AND producto = %s AND segmento_comercial <> 'Sin Dato' GROUP BY producto", GetSQLValueString($colname_sumpre, "date"),GetSQLValueString($colname1_sumpre, "date"),GetSQLValueString($colname2_sumpre, "text"));
...
<title>Nro Clientes por Segmento</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="79%" align="left" valign="middle"><span class="Estilo3"> </span><span class="Estilo3">NRO CLIENTES POR SEGMENTO</span></td>
...
<form id="form1" name="form1" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999" class="titulodetalle"><img src="../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" />Busqueda por Rango de Fecha</td>
    </tr>
    <tr>
      <td width="20%" align="right" valign="middle">Fecha Curse:</td>
      <td width="80%" align="left" valign="middle"><span class="rojopequeno">Desde</span>

...
$query_DetailRS1 = sprintf("SELECT * FROM openvpro WHERE rut_cliente = %s order by id desc", GetSQLValueString($colname_DetailRS1, "int"));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center"><strong class="Estilo9"><?php echo strtoupper($row_DetailRS1['id']); ?></strong></td>
  ...
  <tr valign="middle">
    ...
    <td align="center" class="NegrillaCartaReparo"><input type="checkbox" name="checkbox2" id="checkbox2" /></td>
  </tr>
  <tr valign="middle">
    <td colspan="3" align="right">Esta el V° B° y Timbre del Ejecutivo:</td>
    <td align="center" class="NegrillaCartaReparo"><input type="checkbox" name="checkbox3" id="checkbox3" /></td>
  </tr>
</table>
<br />
<table width="95%" border="1" align="center" bordercolor="#000000">

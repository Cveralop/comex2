...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="respuestacolumna_azul"><?php if ($row_DetailRS1['tasa_dif'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <td colspan="2" align="left" valign="middle">Si operacion tiene mas de una tasa debe solicitar el dato a Post Venta.</td>
  </tr>
</table>
<br />
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">

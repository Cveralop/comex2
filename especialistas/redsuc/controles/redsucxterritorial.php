...
if (isset($_GET['territorial'])) {
  $colname_reparos = $_GET['territorial'];
}
$colname1_reparos = "-1";
...
if (isset($_GET['date_fin'])) {
  $colname2_reparos = $_GET['date_fin'];
}
$colname3_reparos = "-1";
if (isset($_GET['estado'])) {
  $colname3_reparos = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_reparos = sprintf("SELECT * FROM opcci nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_reparos, "text"),GetSQLValueString($colname1_reparos, "date"),GetSQLValueString($colname2_reparos, "date"),GetSQLValueString("%" . $colname3_reparos . "%", "text"));
...
$colname2_meco = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_meco = $_GET['date_fin'];
}
$colname3_meco = "-1";
if (isset($_GET['estado'])) {
  $colname3_meco = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_meco = sprintf("SELECT * FROM opmec nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_meco, "text"),GetSQLValueString($colname1_meco, "date"),GetSQLValueString($colname2_meco, "date"),GetSQLValueString("%" . $colname3_meco . "%", "text"));
...
$colname2_cbi = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_cbi = $_GET['date_fin'];
}
$colname3_cbi = "-1";
if (isset($_GET['estado'])) {
  $colname3_cbi = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbi = sprintf("SELECT * FROM opcbi nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbi, "text"),GetSQLValueString($colname1_cbi, "date"),GetSQLValueString($colname2_cbi, "date"),GetSQLValueString("%" . $colname3_cbi . "%", "text"));
...
$colname2_cce = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_cce = $_GET['date_fin'];
}
$colname3_cce = "-1";
if (isset($_GET['estado'])) {
  $colname3_cce = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cce = sprintf("SELECT * FROM opcce nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cce, "text"),GetSQLValueString($colname1_cce, "date"),GetSQLValueString($colname2_cce, "date"),GetSQLValueString("%" . $colname3_cce . "%", "text"));
...
$colname2_pre = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_pre = $_GET['date_fin'];
}
$colname3_pre = "-1";
if (isset($_GET['estado'])) {
  $colname3_pre = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_pre = sprintf("SELECT * FROM oppre nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_pre, "text"),GetSQLValueString($colname1_pre, "date"),GetSQLValueString($colname2_pre, "date"),GetSQLValueString("%" . $colname3_pre . "%", "text"));
...
$colname2_cbe = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_cbe = $_GET['date_fin'];
}
$colname3_cbe = "-1";
if (isset($_GET['estado'])) {
  $colname3_cbe = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbe = sprintf("SELECT * FROM opcbe nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbe, "text"),GetSQLValueString($colname1_cbe, "date"),GetSQLValueString($colname2_cbe, "date"),GetSQLValueString("%" . $colname3_cbe . "%", "text"));
...
$colname2_cdpa = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_cdpa = $_GET['date_fin'];
}
$colname3_cdpa = "-1";
if (isset($_GET['estado'])) {
  $colname3_cdpa = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cdpa = sprintf("SELECT * FROM opcdpa nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cdpa, "text"),GetSQLValueString($colname1_cdpa, "date"),GetSQLValueString($colname2_cdpa, "date"),GetSQLValueString("%" . $colname3_cdpa . "%", "text"));
...
$colname2_ste = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_ste = $_GET['date_fin'];
}
$colname3_ste = "-1";
if (isset($_GET['estado'])) {
  $colname3_ste = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ste = sprintf("SELECT * FROM opste nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_ste, "text"),GetSQLValueString($colname1_ste, "date"),GetSQLValueString($colname2_ste, "date"),GetSQLValueString("%" . $colname3_ste . "%", "text"));
...
$colname2_cex = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_cex = $_GET['date_fin'];
}
$colname3_cex = "-1";
if (isset($_GET['estado'])) {
  $colname3_cex = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cex = sprintf("SELECT * FROM opcex nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cex, "text"),GetSQLValueString($colname1_cex, "date"),GetSQLValueString($colname2_cex, "date"),GetSQLValueString("%" . $colname3_cex . "%", "text"));
...
$colname2_tbc = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_tbc = $_GET['date_fin'];
}
$colname3_tbc = "-1";
if (isset($_GET['estado'])) {
  $colname3_tbc = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_tbc = sprintf("SELECT * FROM optbc nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_tbc, "text"),GetSQLValueString($colname1_tbc, "date"),GetSQLValueString($colname2_tbc, "date"),GetSQLValueString("%" . $colname3_tbc . "%", "text"));
...
$colname2_bga = "-1";
if (isset($_GET['date_fin'])) {
  $colname2_bga = $_GET['date_fin'];
}
$colname3_bga = "-1";
if (isset($_GET['estado'])) {
  $colname3_bga = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_bga = sprintf("SELECT * FROM opbga nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_bga, "text"),GetSQLValueString($colname1_bga, "date"),GetSQLValueString($colname2_bga, "date"),GetSQLValueString("%" . $colname3_bga . "%", "text"));
...
<body onLoad="MM_preloadImages('../../../imagenes/Botones/boton_volver_2.jpg')">
        ...
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr bgcolor="#999999">
                <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19"
                        height="21"><span class="titulodetalle">Control de Operaciones Enviadas a Proceso</span></td>
            </tr>
            <tr valign="middle">
                <td width="21%" align="right" valign="middle">Territorial:</td>
                <td width="79%" align="left" valign="middle"><span class="rojopequeno">
                        <select name="territorial" class="etiqueta12" id="territorial">
                            <option value="N/A">Seleccione una Territorial</option>
                            <option value="Territorial Centro">Territorial Centro</option>
                            <option value="Territorial Centro Civico">Territorial Centro Civico</option>
                            <option value="Territorial Cordillera">Territorial Cordillera</option>
                            <option value="Territorial Costa">Territorial Costa</option>
                            <option value="Territorial Norte">Territorial Norte</option>
                            <option value="Territorial Octava">Territorial Octava</option>
                            <option value="Territorial Select">Territorial Select</option>
                            <option value="Territorial Quinta">Territorial Quinta</option>
                            <option value="Territorial Sur">Territorial Sur</option>
                            <option value="Banca Privada">Banca Privada</option>
                            <option value="Canales Especializados">Canales Especializados</option>
            ...
            <tr>
                ...
                <td align="left" valign="middle"><span class="respuestacolumna_rojo">Desde</span>
                    <input name="date_ini" type="text" class="etiqueta12" id="date_ini"
                        value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10">
                    <span class="rojopequeno">Hasta
                        <input name="date_fin" type="text" class="etiqueta12" id="date_fin"
                            value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10">
                        (dd-mm-aaaa)</span>
                </td>
            </tr>
            <tr>
                <td align="right" valign="middle">Estado Ope.:</div>
                </td>
    ...
    <table width="95%" border="0" align="center">
        <tr>
            <td align="right" valign="middle"><a href="../redsuc.php" onMouseOut="MM_swapImgRestore()"
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="17" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19"
                    height="21"><span class="Estilo5">Total Operaciones Enviadas a Curse </span><span
                    class="tituloverde"><?php echo $totalRows_reparos ?></span><span class="Estilo5"><span
                        class="Estilo8"> <span class="Estilo13">Cartas de Cr&eacute;dito
                            Importaci&oacute;n</span></span></span></td>
        </tr>
        <tr bgcolor="#999999">
        ...
        <tr>
            <td align="center" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo $row_reparos['id']; ?></span> </div>
            </td>
            <td align="center" valign="middle"><?php echo $row_reparos['date_espe']; ?></div>
            </td>
            <td align="center" valign="middle"><?php echo $row_reparos['rut_cliente']; ?></div>
            </td>
            <td align="left" valign="middle"><?php echo strtoupper($row_reparos['nombre_cliente']); ?></td>
            <td align="center" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_reparos['nro_operacion']); ?></span> </div>
            </td>
            <td align="center" valign="middle"><?php echo $row_reparos['evento']; ?></div>
            </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_reparos['moneda_operacion']); ?></span>
                <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_reparos['monto_operacion'], 2, ',', '.'); ?></strong>
                </div>
            </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_reparos['moneda_documentos']); ?></span><strong
                    class="respuestacolumna_azul"><?php echo number_format($row_reparos['monto_documentos'], 2, ',', '.'); ?></strong>
                </div>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_reparos['estado'] <> $row_colores['cursada'] and $row_reparos['estado'] <> $row_colores['pendiente'] and $row_reparos['estado'] <> $row_colores['solucionado'] and $row_reparos['estado'] <> $row_colores['preingresada'] and $row_reparos['estado'] <> $row_colores['eliminada'] and $row_reparos['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="left" valign="middle" class="respuestacolumna_rojo"><?php echo $row_reparos['reparo_obs']; ?>
            </td>
            <td align="center" valign="middle"><?php echo $row_reparos['date_supe']; ?></td>
            <td align="center" valign="middle">
                <?php if ($row_reparos['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_reparos['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="left" valign="middle"><?php echo $row_reparos['nombre_oficina']; ?></td>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="center" valign="middle" bgcolor="#999999">
            <td colspan="17" align="left"><span class="Estilo10"><img src="../../../imagenes/GIF/notepad.gif" width="19"
                        height="21"></span><span class="Estilo5">Total Operaciones Enviadas a Curse&nbsp;<span
                        class="tituloverde"><?php echo $totalRows_cbi ?></span> Cobranza Extranjera de
                    Importaci&oacute;n y OPI </span></div>
            </td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#999999">
        ...
        <tr valign="middle">
            <td align="center"><a
                    href="../../../espcomex/controles/untitled.php?recordID=<?php echo $row_cbi['id']; ?>"> </a><span
                    class="respuestacolumna_rojo"><?php echo $row_cbi['id']; ?></span> </div>
            </td>
            <td align="center"><?php echo $row_cbi['date_espe']; ?> </td>
            <td align="center"><?php echo $row_cbi['rut_cliente']; ?></td>
            <td align="left"><?php echo $row_cbi['nombre_cliente']; ?> </div>
            </td>
            <td align="center" class="respuestacolumna_rojo"><?php echo $row_cbi['nro_operacion']; ?></td>
            <td align="center"><?php echo $row_cbi['evento']; ?> </td>
            <td align="right"><span
                    class="respuestacolumna_rojo"><?php echo $row_cbi['moneda_operacion']; ?></span>&nbsp; <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_cbi['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center">
                <?php if ($row_cbi['estado'] <> $row_colores['cursada'] and $row_cbi['estado'] <> $row_colores['pendiente'] and $row_cbi['estado'] <> $row_colores['solucionado'] and $row_cbi['estado'] <> $row_colores['preingresada'] and $row_cbi['estado'] <> $row_colores['eliminada'] and $row_cbi['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center">
                <?php if ($row_cbi['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="left" bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo10"><img
                        src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></span><span
                    class="Estilo5">Total Operaciones Enviadas a Curse&nbsp;<span
                        class="tituloverde"><?php echo $totalRows_meco ?></span> Mercado de Corredores </span></td>
        </tr>
        ...
        <tr>
            ...
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_meco['moneda_operacion']); ?></span><br>
                <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_meco['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_meco['estado'] <> $row_colores['cursada'] and $row_meco['estado'] <> $row_colores['pendiente'] and $row_meco['estado'] <> $row_colores['solucionado'] and $row_meco['estado'] <> $row_colores['preingresada'] and $row_meco['estado'] <> $row_colores['eliminada'] and $row_meco['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_meco['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_meco['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo10"><img
                        src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></span><span
                    class="Estilo5">Total Operaciones Enviadas a Curse </span><span
                    class="tituloverde"><?php echo $totalRows_cce ?> </span><span class="Estilo5">Carta de
                    Cr&eacute;dito Exportaci&oacute;n</span></div>
            </td>
        </tr>
        <tr bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Nro Folio
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_cce['id']; ?></span>
                </div>
            </td>
            <td align="center" valign="middle"><?php echo $row_cce['date_espe']; ?></div>
            </td>
            <td align="center" valign="middle"><?php echo strtoupper($row_cce['rut_cliente']); ?></div>
            </td>
            <td align="left" valign="middle"><?php echo strtoupper($row_cce['nombre_cliente']); ?> </td>
            <td align="center" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_cce['nro_operacion']); ?></span> </div>
            </td>
            <td align="center" valign="middle"><?php echo $row_cce['evento']; ?> </div>
            </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_cce['moneda_operacion']); ?></span> <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_cce['monto_operacion'], 2, ',', '.'); ?></strong>
                </div>
                </div>
                </div>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_cce['estado'] <> $row_colores['cursada'] and $row_cce['estado'] <> $row_colores['pendiente'] and $row_cce['estado'] <> $row_colores['solucionado'] and $row_cce['estado'] <> $row_colores['preingresada'] and $row_cce['estado'] <> $row_colores['eliminada'] and $row_cce['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cce['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cce['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo13 Estilo10"><strong><img
                            src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></strong></span><span
                    class="Estilo13 Estilo5"><strong>Total Operaciones Enviadas a Curse </strong></span><span
                    class="Estilo13 Estilo15"><strong><span class="tituloverde"><?php echo $totalRows_pre ?>
                        </span></strong></span><span class="Estilo13 Estilo5"><strong>Pr&eacute;stamos</strong></span>
            </td>
        </tr>
        <tr bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Nro Folio
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_pre['id']; ?></span>
            </td>
            ...
            <td align="center" valign="middle" class="respuestacolumna_rojo">
                <?php echo strtoupper($row_pre['nro_operacion']); ?> </td>
            <td align="center" valign="middle"><?php echo $row_pre['evento']; ?> </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_pre['moneda_operacion']); ?></span> <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_pre['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_pre['estado'] <> $row_colores['cursada'] and $row_pre['estado'] <> $row_colores['pendiente'] and $row_pre['estado'] <> $row_colores['solucionado'] and $row_pre['estado'] <> $row_colores['preingresada'] and $row_pre['estado'] <> $row_colores['eliminada'] and $row_pre['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_pre['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_pre['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo13 Estilo10"><strong><img
                            src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></strong></span><span
                    class="Estilo13 Estilo5"><strong>Total Operaciones Enviadas a Curse </strong></span><span
                    class="Estilo13 Estilo15"><strong><span class="tituloverde"><?php echo $totalRows_cbe ?>
                        </span></strong></span><span class="Estilo13 Estilo5"><strong>Cobranza Extranjera de
                        Exportaci&oacute;n </strong></span></td>
        </tr>
        <tr bgcolor="#999999">
        ...
        <?php do { ?>
        <tr valign="middle">
            <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_cbe['id']; ?></span>
                </div>
            </td>
            ...
            <td align="center" valign="middle" class="respuestacolumna_rojo">
                <?php echo strtoupper($row_cbe['nro_operacion']); ?></td>
            <td align="center" valign="middle"><?php echo $row_cbe['evento']; ?></td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_cbe['moneda_operacion']); ?></span> <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_cbe['monto_operacion'], 2, ',', '.'); ?></strong>
                </div>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_cbe['estado'] <> $row_colores['cursada'] and $row_cbe['estado'] <> $row_colores['pendiente'] and $row_cbe['estado'] <> $row_colores['solucionado'] and $row_cbe['estado'] <> $row_colores['preingresada'] and $row_cbe['estado'] <> $row_colores['eliminada'] and $row_cbe['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cbe['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cbe['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="center" valign="middle" bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo13 Estilo10"><strong><img
                            src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></strong></span><span
                    class="Estilo13 Estilo5"><strong>Total Operaciones Enviadas a Curse </strong></span><span
                    class="Estilo13 Estilo15"><strong><span class="tituloverde"><?php echo $totalRows_cdpa ?>
                        </span></strong></span><span class="Estilo13 Estilo5"><strong>Cesi&oacute;n de Derecho o Pago
                        Anticipado </strong></span></div>
            </td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#999999">
            <td align="center" valign="middle"><span class="titulocolumnas">Nro Folio</span></div>
            </td>
            <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso
                </div>
            </td>
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_cdpa['id']; ?></span>
            </td>
            ...
            <td align="center" valign="middle" class="respuestacolumna_rojo">
                <?php echo strtoupper($row_cdpa['nro_operacion']); ?> </td>
            <td align="center" valign="middle"><?php echo $row_cdpa['evento']; ?> </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_cdpa['moneda_operacion']); ?></span>
                <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_cdpa['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_cdpa['estado'] <> $row_colores['cursada'] and $row_cdpa['estado'] <> $row_colores['pendiente'] and $row_cdpa['estado'] <> $row_colores['solucionado'] and $row_cdpa['estado'] <> $row_colores['preingresada'] and $row_cdpa['estado'] <> $row_colores['eliminada'] and $row_cdpa['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cdpa['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_cdpa['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19"
                    height="21" class="Estilo13"><span class="Estilo13 Estilo5"><strong>Total Operaciones Enviadas a
                        Curse <span class="tituloverde"><?php echo $totalRows_ste ?></span> Stand By Emitidas
                    </strong></span></td>
        </tr>
        <tr bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Nro Folio
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_ste['id']; ?></span>
            </td>
            ...
            <td align="center" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo $row_ste['nro_operacion']; ?></span></td>
            <td align="center" valign="middle"><?php echo $row_ste['evento']; ?></td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_ste['moneda_operacion']); ?></span> <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_ste['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_ste['estado'] <> $row_colores['cursada'] and $row_ste['estado'] <> $row_colores['pendiente'] and $row_ste['estado'] <> $row_colores['solucionado'] and $row_ste['estado'] <> $row_colores['preingresada'] and $row_ste['estado'] <> $row_colores['eliminada'] and $row_ste['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_ste['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_ste['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo10"><img
                        src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span
                        class="Estilo18">Total Operaciones Enviadas a Curse <span
                            class="tituloverde"><?php echo $totalRows_bga ?></span> Boletas de
                        Garant&iacute;a</span></span></td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Nro Folio </td>
            <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso </td>
        ...
        <tr>
            ...
            <td align="center" valign="middle" class="rojopequeno"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_bga['nro_operacion']); ?></span> </div>
            </td>
            <td align="center" valign="middle"><?php echo $row_bga['evento']; ?></td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_bga['moneda_operacion']); ?></span><br>
                <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_bga['monto_operacion'], 2, ',', '.'); ?></strong>
                </div>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_bga['estado'] <> $row_colores['cursada'] and $row_bga['estado'] <> $row_colores['pendiente'] and $row_bga['estado'] <> $row_colores['solucionado'] and $row_bga['estado'] <> $row_colores['preingresada'] and $row_bga['estado'] <> $row_colores['eliminada'] and $row_bga['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_bga['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_bga['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="center" valign="middle" bgcolor="#999999">
            <td colspan="17" align="left"><span class="Estilo13"><img src="../../../imagenes/GIF/notepad.gif" width="19"
                        height="21" border="0"></span><span class="titulodetalle">Total Operaciones Enviadas a Curse
                </span><span class="tituloverde"><?php echo $totalRows_cex ?></span><span class="titulodetalle"> Otros
                    Productos de Cambio
                    </div>
                </span></td>
        </tr>
        ...
        <tr valign="middle">
            ...
            <td align="right"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_cex['moneda_operacion']); ?></span> <strong
                    class="respuestacolumna_azul"><?php echo number_format($row_cex['monto_operacion'], 2, ',', '.'); ?></strong>
            </td>
            <td align="center">
                <?php if ($row_cex['estado'] <> $row_colores['cursada'] and $row_cex['estado'] <> $row_colores['pendiente'] and $row_cex['estado'] <> $row_colores['solucionado'] and $row_cex['estado'] <> $row_colores['preingresada'] and $row_cex['estado'] <> $row_colores['eliminada'] and $row_cex['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center">
                <?php if ($row_cex['fuera_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="left" valign="middle" bgcolor="#999999">
            <td colspan="16" align="left" valign="middle"><span class="Estilo10"><span class="Estilo13"><img
                            src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span
                            class="Estilo18">Total Operaciones Enviadas a Curse </span></span></span><span
                    class="tituloverde"><?php echo $totalRows_tbc ?></span><span class="Estilo10"><span
                        class="Estilo13"><span class="Estilo18"> Cr&eacute;ditos IIIB5</span></span></span></td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Nro Folio </td>
            <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso </td>
        ...
        <tr>
            ...
            <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_tbc['nro_operacion']; ?>
            </td>
            <td align="center" valign="middle"><?php echo $row_tbc['evento']; ?> </td>
            <td align="right" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo $row_tbc['moneda_operacion']; ?></span> <strong
                    class="respuestacolumna_azul"><?php echo $row_tbc['monto_operacion']; ?></strong></div>
            </td>
            <td align="center">
                <?php if ($row_tbc['estado'] <> $row_colores['cursada'] and $row_tbc['estado'] <> $row_colores['pendiente'] and $row_tbc['estado'] <> $row_colores['solucionado'] and $row_tbc['estado'] <> $row_colores['preingresada'] and $row_tbc['estado'] <> $row_colores['eliminada'] and $row_tbc['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
            ...
            <td align="center" valign="middle">
                <?php if ($row_tbc['fuero_horario'] <> $row_colores['verdeno']) { // Show if not first page ?>
                <span class="Rojo2"><?php echo $row_tbc['fuero_horario']; ?> </span>
                <?php } // Show if not first page ?>
                <?php if ($row_tbc['fuero_horario'] <> $row_colores['rojosi']) { // Show if not first page ?>
                <span class="Verde2"><?php echo $row_tbc['fuero_horario']; ?> </span>
                <?php } // Show if not first page ?>
            </td>
            <td align="center" valign="middle">
                <?php if ($row_tbc['urgente'] <> $row_colores['verdeno']) { // Show if not first page ?>

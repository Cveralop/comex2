...
$query_conrut = sprintf("SELECT * FROM opste nolock WHERE rut_cliente LIKE %s and evento LIKE %s ORDER BY id DESC", GetSQLValueString($colname_conrut . "%", "text"),GetSQLValueString("%" . $colname1_conrut . "%", "text"));

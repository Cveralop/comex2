...
header("Content-Disposition: attachment;filename=opera_pend_terr.xls"); 
...
if (isset($_GET['perfil'])) {
  $colname_opcci = $_GET['perfil'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opcci = sprintf("SELECT * FROM oppendientes WHERE perfil = %s ORDER BY date_espe ASC", GetSQLValueString($colname_opcci, "text"));
...
<table width="95%" border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="left" valign="middle"><?php echo strtoupper($row_opcci['perfil']); ?></td>
    </tr>

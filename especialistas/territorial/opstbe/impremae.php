...
$query_impresion = sprintf("SELECT * FROM opste WHERE especialista_curse = '%s' and fecha_ingreso = '%s' and rut_cliente = '%s' and evento = '%s' ORDER BY id DESC", $colname_impresion,$colname1_impresion,$colname2_impresion,$colname3_impresion);

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET mandato=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opste  WHERE id = $recordID", $colname_altadocdis);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <span class="rojopequeno">J000000</span></div></td>

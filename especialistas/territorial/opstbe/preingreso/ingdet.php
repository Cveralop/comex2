...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opste nolock WHERE rut_cliente = '%s'", $colname_DetailRS1);
...
$query_DetailRS1 = sprintf("SELECT * FROM cliente nolock WHERE id = $recordID",$colname_DetailRS1); //$colname_ingape - No inicializada
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Pre-Ingreso Instrucci&oacute;n</span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamenta a la aplicaci&oacute;n.</span></span>        </div> <span class="rojopequeno">/</span>

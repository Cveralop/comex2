...
$query_ingape = sprintf("SELECT * FROM opste WHERE rut_cliente LIKE %s and operador =  %s ORDER BY rut_cliente DESC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"));

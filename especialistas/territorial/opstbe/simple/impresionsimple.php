...
$query_DetailRS1 = sprintf("SELECT opste.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opste, usuarios WHERE especialista_curse = %s and (opste.especialista_curse = usuarios.usuario) order by opste.id desc", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="left" valign="middle"><img src="../../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61" align="left">
    </div>      </div></td>
  </tr>
  <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">CAMBIOS - STAND BY EMITIDAS</span></td>
  </tr>
  <tr>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['id']); ?></strong></td>
  ...
  <tr>
    <td align="right" valign="middle">Territorial:</div></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></td>
    <td align="right" valign="middle">Fuera Horario:</td>
    <td align="center" valign="middle" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['fuera_horario']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>

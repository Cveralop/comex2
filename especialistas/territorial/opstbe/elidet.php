...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET estado=%s, obs=%s, sub_estado=%s, estado_visacion=%s WHERE id=%s",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opste WHERE rut_cliente = '%s'", $colname_DetailRS1);
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulocolumnas"><span class="titulo_menu"><span class="titulodetalle">Anular  Instrucci&oacute;n</div>
      </span></span></span></td>
    </tr>
    <tr valign="baseline">

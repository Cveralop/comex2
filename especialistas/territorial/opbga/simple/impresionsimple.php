...
$query_DetailRS1 = sprintf("SELECT opbga.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opbga, usuarios WHERE especialista_curse = %s and (opbga.especialista_curse = usuarios.usuario) ORDER BY opbga.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="left" valign="middle"><img src="../../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61"></div>      </div></td>
  </tr>
  <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">CAMBIOS - BOLETA DE GARANT&Iacute;A</span></td>
  </tr>
  <tr>

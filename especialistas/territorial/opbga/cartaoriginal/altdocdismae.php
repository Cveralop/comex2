...
$query_altadocdis = sprintf("SELECT * FROM opbga WHERE nro_operacion LIKE %s and mandato = %s and rut_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_altadocdis, "text"),GetSQLValueString($colname1_altadocdis, "text"),GetSQLValueString("%" . $colname2_altadocdis, "text"));

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td height="40" align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_impresion['id']; ?></span>      </div></td>
    <td align="center" valign="middle"><?php echo $row_impresion['date_espe']; ?></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_impresion['rut_cliente']); ?></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_impresion['nombre_cliente']); ?></td>
    <td align="center" valign="middle"><?php echo $row_impresion['evento']; ?></td>
    <td align="center" valign="middle"><?php echo $row_impresion['valuta']; ?></td>
  ...
  <tr>
    <td height="28" align="center" valign="middle" bgcolor="#999999" class="titulo"><span class="titulo_menu"><span class="titulocolumnas"><span class="titulopaguina"><span class="titulocolumnas">Observaciones:</span></span></span></span></td>
    ...
    <td colspan="2" align="center" valign="middle"><?php echo $row_impresion['mandato']; ?> / <?php echo $row_impresion['impedido_operar']; ?> / <span class="respuestacolumna_rojo"><?php echo $row_impresion['cliente_passport']; ?></span></td>
    </tr>

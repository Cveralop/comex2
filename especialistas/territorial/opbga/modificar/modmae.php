...
$query_modificacion = sprintf("SELECT * FROM opbga WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <span class="rojopequeno">B000000</span></td>
    </tr>
    <tr>

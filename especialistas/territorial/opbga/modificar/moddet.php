...
$query_DetailRS1 = sprintf("SELECT * FROM opbga  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion);

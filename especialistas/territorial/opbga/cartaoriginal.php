...
$query_impresion = sprintf("SELECT *, time(date_espe)as esp FROM opbga WHERE especialista_curse = %s and fecha_ingreso = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_impresion, "text"),GetSQLValueString($colname1_impresion, "text"),GetSQLValueString($colname2_impresion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="8"><span class="Estilo10">BOLETA DE GARANT&Iacute;A</span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">

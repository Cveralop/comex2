...
$query_DetailRS1 = sprintf("SELECT oppre.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM oppre, usuarios WHERE oppre.id = $recordID and especialista_curse = %s and (oppre.especialista_curse = usuarios.usuario) ORDER BY oppre.id desc ", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td width="34%" align="center" valign="middle"><strong><?php echo $row_DetailRS1['id']; ?></strong></td>
    <td width="15%" align="right" valign="middle">Nro Folio Caratula:</td>
    <td width="31%" align="center" valign="middle"><strong><?php echo $row_DetailRS1['nro_folio']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="Estilo12"><?php echo $row_DetailRS1['fuera_horario']; ?></span></td>
  </tr>
</table>
<br>
  <br>

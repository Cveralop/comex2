...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET fecha_ingreso=%s, date_ingreso=%s, estado=%s, sub_estado=%s, date_espe=%s, date_visa=%s, nro_folio=%s, urgente=%s WHERE id=%s",

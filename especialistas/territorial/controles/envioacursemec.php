...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opmec SET fecha_ingreso=%s, date_ingreso=%s, estado=%s, obs=%s, sub_estado=%s, date_espe=%s, date_visa=%s, nro_folio=%s, urgente=%s WHERE id=%s",

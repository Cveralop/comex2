...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO oppre (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, nro_operacion, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, sub_estado, tipo_tasa, libor_tt, algo_tt, libor_tf, algo_tf, libor, tasa_final, spread, tt, date_espe, date_visa, tipo_operacion, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, fuera_horario, nro_folio) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['tt'], "double"),
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <label>
        ...
        Variable</label>
      <span class="radioRequiredMsg">Realice una selecci�n.</span></span></td>
      ...
      <td align="center" valign="middle"><p>
        ...
        <span class="rojopequeno">= Tasa Final</span><br>
      </p></td>
    </tr>
    <tr valign="baseline">
...
No</td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><span id="sprytextfield2"><span id="sprytextfield">

...
$query_DetailRS1 = sprintf("SELECT opcci.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opcci, usuarios WHERE opcci.id = $recordID and especialista_curse = %s and (opcci.especialista_curse = usuarios.usuario) ORDER BY opcci.id desc ", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td width="27%" align="center" valign="middle"><strong><?php echo $row_DetailRS1['id']; ?></strong></td>
    <td width="17%" align="right" valign="middle">Nro Folio Caratula:</td>
    <td width="36%" align="center" valign="middle"><strong><?php echo $row_DetailRS1['nro_folio']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><strong><?php echo $row_DetailRS1['moneda_operacion']; ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong>      </div>      </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?></td>
  </tr>
</table>
<br>
  <br>

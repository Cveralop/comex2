...
$colname_nrooperacion = "zzz";
if (isset($_GET['nro_operacion'])) {
  $colname_nrooperacion = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_nrooperacion = sprintf("SELECT * FROM opcbe WHERE nro_operacion = %s and evento = %s", GetSQLValueString($colname_nrooperacion, "text"),GetSQLValueString($colname1_nrooperacion, "text"));
...
<body
        ...
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr bgcolor="#999999">
                <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19"
                        height="21" border="0"><span class="titulodetalle">Ingreso Multiple Instrucci&oacute;n Cobranza
                        Extranjera de Exportaci&oacute;n </span></td>
            </tr>
            <tr>
                ...
                <td width="79%" align="left" valign="middle"><input name="rut_cliente" type="text" class="etiqueta12"
                        id="rut_cliente" size="17" maxlength="12">
    ...
    <form name="form2" method="get" action="">
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr bgcolor="#999999">
                <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19"
                        height="21" border="0"><span class="Estilo7"><span class="titulodetalle">Ingreso Multiple
                            Instrucciones Cobranza Extranjera de Exportaci&oacute;n</span></span></td>
            </tr>
            <tr>
                <td width="21%" align="right" valign="middle">Nro Operaci&oacute;n:</td>
                <td width="79%" align="left" valign="middle"><input name="nro_operacion" type="text" class="etiqueta12"
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Ingresar Apertura </div>
            </td>
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><a href="ingdet_m.php?recordID=<?php echo $row_ingape['id']; ?>"> <img
                        src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div>
            </td>
            <td align="center" valign="middle"><?php echo strtoupper($row_ingape['rut_cliente']); ?> </div>
            </td>
            <td align="left" valign="middle"><?php echo strtoupper($row_ingape['nombre_cliente']); ?> </td>
            <td align="center" valign="middle"><?php echo strtoupper($row_ingape['impedido_operar']); ?> / <span
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr bgcolor="#999999">
            <td align="center" valign="middle" class="titulocolumnas">Ingreso Operaciones </div>
            </td>
        ...
        <?php do { ?>
        <tr>
            <td align="center" valign="middle"><a href="ingdet2.php?recordID=<?php echo $row_nrooperacion['id']; ?>">
                    <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div>
            </td>
            <td align="center" valign="middle"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_nrooperacion['nro_operacion']); ?></span>
                </div>
            </td>
            <td align="center" valign="middle"><?php echo strtoupper($row_nrooperacion['rut_cliente']); ?> </div>
            </td>
    ...
    <table border="0" width="50%" align="center">
        <tr>
            <td width="23%" align="center"><?php if ($pageNum_nrooperacion > 0) { // Show if not first page ?>
                <a
                    href="<?php printf("%s?pageNum_nrooperacion=%d%s", $currentPage, 0, $queryString_nrooperacion); ?>">Primero</a>
                <?php } // Show if not first page ?>
            </td>
            ...
            <td width="23%" align="center">
                <?php if ($pageNum_nrooperacion < $totalPages_nrooperacion) { // Show if not last page ?>
                <a
    ...
    <br>
    Registros del <strong><?php echo ($startRow_nrooperacion + 1) ?></strong> al
    <strong><?php echo min($startRow_nrooperacion + $maxRows_nrooperacion, $totalRows_nrooperacion) ?></strong> de un
    total de <strong><?php echo $totalRows_nrooperacion ?></strong>
    <?php } // Show if recordset not empty ?> <br>
    <br>
    <table width="95%" border="0" align="center">
        <tr>
            <td align="right" valign="middle"><a href="../opcbe.php" onMouseOut="MM_swapImgRestore()"

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbe SET mandato=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_altadocdis);
...
<title>Control Operaciones Con Mandato - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">CONTROL OPERACIONES CON MANDATO - DETALLE</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Operaciones c on Mandato</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="madato" class="etiqueta12" id="madato">
        <option value="No">No</option>
      </select></td>
    </tr>
    <tr valign="middle">
      <td colspan="4" align="center">
        <input name="Enviar" type="submit" class="boton" value="Regularizar Mandato.">
      </div></td>
    </tr>
  </table>

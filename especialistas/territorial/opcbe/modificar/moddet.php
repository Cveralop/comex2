...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion);
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          ...
          <option value="EMI.PLA." <?php if (!(strcmp("EMI.PLA.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Emision Planilla</option>

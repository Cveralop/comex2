...
$query_modificacion = sprintf("SELECT * FROM opcbe WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5"><span class="titulodetalle">Modificar Instrucciones Cliente</span></span></td>
    </tr>
    <tr>

    ...
    <tr>
      ...
      <td align="left" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          ...
          <option value="Solucion Excepcion.">Solucion Excecpcion</option>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="9" align="center" valign="middle"><span class="Estilo10">COBRANZA EXTRANJERA DE EXPORTACI&Oacute;N </span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td colspan="2" align="center" valign="middle"><?php echo $row_impresion['mandato']; ?> / <?php echo $row_impresion['impedido_operar']; ?> / <?php echo $row_impresion['cliente_passport']; ?></td>
    </tr>

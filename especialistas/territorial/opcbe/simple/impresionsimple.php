...
$query_DetailRS1 = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opcbe, usuarios WHERE especialista_curse = %s and (opcbe.especialista_curse = usuarios.usuario) ORDER BY opcbe.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">COBRANZA EXTRANJERA DE EXPORTACI&Oacute;N</span></td>
  </tr>
  <tr>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?></span></td>
  </tr>
</table>
<p align="center"><br>
  <br>

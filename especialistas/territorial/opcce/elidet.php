...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET estado=%s, obs=%s, sub_estado=%s, estado_visacion=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcce WHERE id = $recordID", $colname_DetailRS1); //$colname_ingape

...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcce  WHERE id = $recordID",$colname_DetailRS1,$colname1_DetailRS1); // $colname_ingvarios,$colname1_ingvarios
...
<title>Ingreso Simple Multiple - Detalle</title>
<style type="text/css">
<!--
...
No</td>
    ...
    <tr valign="baseline">
      ...
      <td align="left" valign="middle"><input name="tipo_excepcion" type="text" class="etiqueta12" id="tipo_excepcion" value="N/A" size="30" maxlength="50">
        <span class="rojopequeno">Min 50 Caracteres</span></td>
      ...
      <td align="center" valign="middle"><span id="sprytextfield2">
        ...
        <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span><span id="sprytextfield3"> <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span> <span class="rojopequeno">(aaaa-mm-dd)</span></td>
    </tr>
    <tr valign="baseline">

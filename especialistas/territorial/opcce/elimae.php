...
if (isset($_GET['nro_operacion'])) {
  $colname2_ingape = $_GET['nro_operacion'];
}
$colname1_ingape = "0";
if (isset($_GET['operador'])) {
  $colname1_ingape = $_GET['operador'];
}
$colname_ingape = "zzz";
...
$query_ingape = sprintf("SELECT * FROM opcce WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s  ORDER BY id DESC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Anular Instrucci&oacute;n  Carta de Cr&eacute;dito de Exportaci&oacute;n</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td valign="middle" class="titulocolumnas">Ingresar Apertura </div></td>
    ...
    <td valign="middle" class="titulocolumnas">Moneda / Monto Operaci&oacute;n</div>
    </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td valign="middle"><a href="elidet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingape['nro_operacion']); ?></span></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    <td valign="middle"><?php echo strtoupper($row_ingape['rut_cliente']); ?> </div></td>

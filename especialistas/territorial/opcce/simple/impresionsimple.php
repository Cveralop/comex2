...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">CARTAS DE CR&Eacute;DITO DE EXPORTACI&Oacute;N</span></div></td>
  </tr>
  <tr>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong></div>      <div align="center" class="Estilo10"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>

...
$query_reparo = sprintf("SELECT * FROM opcce WHERE estado = %s or (estado = 'Rechazada.') ORDER BY id DESC", GetSQLValueString($colname_reparo, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">CARTAS DE CRÉDITO DE EXPORTACIONES</td>
  </tr>
</table>
<br />
<table width="95%" border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opcce.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen3" width="80" height="25" border="0" id="Imagen3" /></a></td>
  </tr>
</table>
<br />
...
<br />
Registros del <span class="respuestacolumna_azul"><?php echo ($startRow_reparo + 1) ?></span> al <span class="respuestacolumna_azul"><?php echo min($startRow_reparo + $maxRows_reparo, $totalRows_reparo) ?></span> de un total de <span class="respuestacolumna_azul"><?php echo $totalRows_reparo ?></span><br />
</body>
</html>
<?php

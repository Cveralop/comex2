...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      / 
      <input name="cliente_passport" type="text" class="respuestacolumna_rojo" id="cliente_passport" value="<?php echo $row_DetailRS2['cliente_passport']; ?>" size="3" maxlength="2">
      </label></td>
    </tr>
    <tr valign="baseline">
...
<option value="ZAR" <?php if (!(strcmp("ZAR", $row_DetailRS1['moneda_operacion']))) {echo "selected=\"selected\"";} ?>>ZAR</option>
  ...
  Si</label>
    ...
    <tr valign="baseline">
      <td align="right" valign="middle" bgcolor="#999999">Fuera Horario:</td>
      <td colspan="3" align="left" valign="middle" bgcolor="#999999"><label>

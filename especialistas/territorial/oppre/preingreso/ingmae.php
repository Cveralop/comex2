...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingvarios = sprintf("SELECT * FROM oppre nolock WHERE nro_operacion = %s", GetSQLValueString($colname_ingvarios, "text"));
...
$inglci = mysqli_query($comercioexterior, $query_limit_inglci) or die(mysqli_error());
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="Estilo12"><?php echo strtoupper($row_opcci['moneda_operacion']); ?> </span> <strong><?php echo number_format($row_opcci['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>

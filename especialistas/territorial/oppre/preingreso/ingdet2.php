...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Pre-Ingresar Instrucci&oacute;n Multiple</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamnete a la aplicaci&oacute;n.</span></span> <span class="rojopequeno"> / </span>

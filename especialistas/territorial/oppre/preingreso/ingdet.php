  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield9">
        <input name="especialista_curse" type="text" class="etiqueta12" id="especialista_curse" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20" readonly="readonly">
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span>        </div> <span class="rojopequeno">/</span>
      <input name="territorial" type="text" class="etiqueta12" id="territorial" value="<?php echo $row_DetailRS1['territorial']; ?>" size="30" maxlength="50" readonly="readonly">
      </span></td>
    </tr>
    <tr valign="middle">
...
No</td>
      <td align="right">Detino Fondos:</td>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><span id="sprytextfield2"><span id="sprytextfield4"><span id="sprytextfield5"><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="respuestacolumna_rojo">TT</span><span class="respuestacolumna_azul">
        <input name="tt" type="text" class="etiqueta12" id="tt" value="0.00" size="10" maxlength="10">
        </span></span><span class="textfieldRequiredMsg">Se necesita un valor.</span></span><span class="textfieldInvalidFormatMsg">Formato debe ser 00.000000</span><span class="textfieldRequiredMsg">e necesita un valor.</span></span><span class="rojopequeno"> SPREAD</span><span id="sprytextfield7">
        <input name="spread" type="text" class="etiqueta12" id="spread" value="0.00" size="10" maxlength="10">
        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span><span id="sprytextfield3"><span class="textfieldRequiredMsg">Se necesita un valor.</span></span><span class="respuestacolumna_azul"><span class="respuestacolumna_rojo"> TASA FINAL</span></span><span id="sprytextfield8">
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "none", {hint:"0.00", validateOn:["blur"]});
...
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "integer", {validateOn:["blur"], minChars:0, maxChars:10, minValue:0, maxValue:9999999999});
//-->
</script>
</body>
</html>

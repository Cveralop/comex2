...
$query_ingape = sprintf("SELECT * FROM oppre WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString("%" . $colname2_ingape . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <span class="rojopequeno">F - K &oacute; L000000</span></td>
    </tr>
    <tr valign="middle">

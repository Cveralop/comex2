...
$query_modificacion = sprintf("SELECT * FROM oppre WHERE rut_cliente LIKE %s and nro_operacion LIKE %s and operador = %s ORDER BY id DESC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname2_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"));

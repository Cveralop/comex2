...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO oppre (rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, sub_estado, destino_fondos, tipo_tasa, libor_tt, algo_tt, libor_tf, algo_tf, tasa_final, spread, tt, date_preingreso, date_espe, date_visa, tipo_operacion, reparo_obs, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, impedido_operar, fuera_horario, nro_folio, cliente_passport) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<select name="libor_tf" class="etiqueta12" id="libor_tf">
  ...
  <option value="360">Libor 360</option>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><span id="sprytextfield2"><span class="textfieldInvalidFormatMsg">Formato debe ser 00.000000</span><span class="textfieldRequiredMsg">e necesita un valor.</span></span> <span class="respuestacolumna_azul"><span class="respuestacolumna_rojo"> TT</span></span><span id="sprytextfield3">
        <label>

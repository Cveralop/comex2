...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="right">Nro Folio Caratula:</td>
    <td align="center"><strong><?php echo strtoupper($row_DetailRS1['nro_folio']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><span class="Estilo12"><?php echo strtoupper($row_DetailRS1['territorial']); ?></span></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><span class="Estilo12">Origen <?php echo $row_DetailRS1['origen_fondos']; ?> // Destino <?php echo $row_DetailRS1['destino_fondos']; ?></span></td>
  </tr>
  <tr valign="middle">
    ...
    <td align="center"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion_relacionada']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></span></td>
  </tr>
</table>
<p align="center"><br>
  <br>
...
<table width="50%" border="0" align="center">
  <tr>
    <td class="Estilo12"><?php echo strtoupper($row_DetailRS1['ne']); ?></td>
  </tr>
</table>
<p align="center"><br> 

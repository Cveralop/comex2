...
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion);
...
<option value="Requerimiento." <?php if (!(strcmp("Requerimiento.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Requerimiento</option>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['urgente'],"Si"))) {echo "checked=\"checked\"";} ?> type="radio" name="urgente" value="Si" id="urgente_1">
          Si</label>
        <input <?php if (!(strcmp($row_DetailRS1['urgente'],"No"))) {echo "checked=\"checked\"";} ?> name="urgente" type="radio" id="urgente_0" value="No">
No<br>
      </td>
      ...
      <td align="center" valign="middle"><label>
        ...
        Si</label>
        <input name="fuera_horario" type="radio" class="etiqueta12" id="campana_comex_0" value="No">
No<br>
      </td>
    </tr>
    <tr valign="baseline">

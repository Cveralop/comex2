...
$query_modificacion = sprintf("SELECT * FROM opcbi WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_modificacion . "%", "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion . "%", "text"));

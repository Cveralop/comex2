...
<table width="90%"  border="0" align="center">
  <tr valign="middle" bordercolor="#CCCCCC">
    ...
    <td width="82%" align="left" class="Estilo10"><span class="Estilo12">Aviso de reparo, <strong><?php echo $row_DetailRS1['evento']; ?></strong> de Cobranza de Importación y OPI.</span></td>
  </tr>
  <tr valign="middle" bordercolor="#CCCCCC">

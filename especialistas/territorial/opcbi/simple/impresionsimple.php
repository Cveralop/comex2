...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong></div>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>

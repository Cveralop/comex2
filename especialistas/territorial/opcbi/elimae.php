...
$query_ingape = sprintf("SELECT * FROM opcbi WHERE rut_cliente LIKE %s and operador = %s and nro_operacion LIKE %s ORDER BY rut_cliente ASC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape . "%", "text"));

  ...
  <tr>
    <td bordercolor="#000000"><br>
        <table width="90%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
          ...
          <tr>
            <td align="left" valign="middle"><img src="../../../imagenes/GIF/check.gif" alt="" width="13" height="12"><a href="../opiiib5/excepcion/mantenciotbcmae.php">Ingreso y Mantenci&oacute;n de Excepcion</a></td>
          </tr>
        </table>
  <br>
        <table width="90%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">

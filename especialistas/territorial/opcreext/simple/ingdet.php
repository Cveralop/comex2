...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcex (rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, tipo_operacion, sub_estado, date_preingreso, date_espe, date_visa, reparo_obs, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, impedido_operar, fuera_horario, nro_folio, cliente_passport) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM opcex nolock WHERE rut_cliente = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">CAMBIOS - CREDITOS EXTERNOS</td>
  </tr>
</table>
<br>
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Simple Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente 
      a la aplicaci&oacute;n.</span></span>        </div> <span class="rojopequeno">/</span>
    ...
    <tr valign="baseline">
      ...
      <td colspan="3" align="left" valign="middle"><span id="sprytextarea2">
        <textarea name="obs" cols="80" rows="4" class="etiqueta12"><?php //echo $row_DetailRS1['obs']; //no viene en la consulta?></textarea>
      <span class="rojopequeno" id="countsprytextarea2">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span><span class="rojopequeno" id="countsprytextarea1">&nbsp;</span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
          ...
          <option value="Capitulo XII." selected>Capitulo XII</option>
          <option value="Capitulo XIV.">Capilulo XIV</option>
          <option value="DL600.">DL600</option>
        </select>
        <br>
      </td>
    </tr>
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield"><span id="sprytextfield2">
        <input name="solucion_excepcion" type="text" class="etiqueta12" id="solucion_excepcion" value="<?php //echo $row_DetailRS1['solucion_excepcion']; //no viene en la consulta ?>" size="12" maxlength="10">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><span id="sprytextarea"><span id="sprytextarea3">
        <textarea name="reparo_obs" cols="80" rows="6" class="etiqueta12" id="reparo_obs"></textarea>
<span id="countsprytextarea3">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span><span class="rojopequeno"><span id="countsprytextarea3">&nbsp;</span></span><span class="textareaRequiredMsg">Se necesita un valor.</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span></td>
    </tr>
    <tr valign="baseline">

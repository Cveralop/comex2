...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcex SET evento=%s, estado=%s, obs=%s, territorial=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, sub_estado=%s, reparo_obs=%s, mandato=%s, excepcion=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, responsable_excepcion=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, fuera_horario=%s, nro_folio=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['madato'], "text"),
...
$query_DetailRS1 = sprintf("SELECT * FROM opcex  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion);
...
<option value="Compra." <?php if (!(strcmp("Compra.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Compra</option>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input <?php if (!(strcmp($row_DetailRS1['urgente'],"Si"))) {echo "CHECKED";} ?> name="urgente" type="radio" class="etiqueta12" value="Si">
Si
  <label>
    ...
    No</label></td>
      ...
      <td align="center" valign="middle">
        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
          <option value="Credito Externo." <?php if (!(strcmp("Credito Externo.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Credito Externo</option>
          <option value="Capitulo XII." <?php if (!(strcmp("Capitulo XII.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Capitulo XII</option>
          <option value="Capitulo XIV." <?php if (!(strcmp("Capitulo XIV.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Capilulo XIV</option>
          <option value="DL600." <?php if (!(strcmp("DL600.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>DL600</option>
        </select>
        <br>
      </td>
    </tr>

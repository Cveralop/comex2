...
$query_modificacion = sprintf("SELECT * FROM opcex WHERE rut_cliente = %s and operador = %s ORDER BY id DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"));

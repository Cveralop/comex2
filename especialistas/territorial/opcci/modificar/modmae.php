...
$query_modificacion = sprintf("SELECT * FROM opcci WHERE operador = %s and rut_cliente = %s ORDER BY id DESC", GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname_modificacion, "text"));

...
$query_ingape = sprintf("SELECT * FROM cliente nolock WHERE rut_cliente LIKE %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_ingape . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_opcci = sprintf("SELECT * FROM carteraopera nolock WHERE nro_operacion_relacionada_car = %s ORDER BY nro_operacion_car DESC", GetSQLValueString($colname_opcci, "text"));
...
<form name="form4" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucciones Pr&eacute;stamos (CCI)</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle">Nro Operaci&oacute;n Relacionada:</td>
      <td width="79%" align="left" valign="middle"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="15" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo strtoupper($row_opcci['fecha_vcto']); ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_inglci['moneda_operacion']; ?></span><span class="respuestacolumna_azul"><?php echo number_format($row_inglci['saldo_operacion'], 2, ',', '.'); ?></span></td>
  </tr>

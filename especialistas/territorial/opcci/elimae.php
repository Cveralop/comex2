...
if (isset($_GET['rut_cliente'])) {
  $colname2_ingape = $_GET['rut_cliente'];
}
$colname1_ingape = "0";
...
$query_ingape = sprintf("SELECT * FROM opcci WHERE operador = %s and rut_cliente = %s ORDER BY id DESC", GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape, "text"));

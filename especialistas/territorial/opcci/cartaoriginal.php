...
$query_impresion = sprintf("SELECT *, time(date_espe)as esp FROM opcci WHERE especialista_curse = %s and fecha_ingreso = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_impresion, "text"),GetSQLValueString($colname1_impresion, "text"),GetSQLValueString($colname2_impresion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td colspan="9" align="left"><?php echo $row_impresion['obs']; ?></td>
    </tr>

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingcci['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_ingcci['saldo_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>

...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" valign="middle"><span class="Estilo9">CARTAS DE CR&Eacute;DITO DE IMPORTACI&Oacute;N</span></div></td>
  </tr>
</table>
<table width="95%"  border="0" align="center">
  <tr>
...
Operaci�n Ingresada FUERA DE HORARIO </span>
  ...
  <tr>
    <td align="center" valign="middle"><?php if ($row_excepciones['plazo'] > 0) { // Show if not first page ?>
     Usted tiene Excepcion(es) Vencida(s) </span></span>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_folio']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong>
      <div align="center" class="Estilo10"></div></td>
    <td align="right" valign="middle">Nro Operaci&oacute;n Relacionada:</td>
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion_relacionada']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left" valign="middle"><span class="Estilo12"><?php echo strtoupper($row_DetailRS1['territorial']); ?></span></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    <td align="right" valign="middle">Tasas:</td>
    <td colspan="3" align="left" valign="middle"><span class="Estilo12">TT(Libor +)<?php echo $row_DetailRS1['tt']; ?> // SPREAD <?php echo $row_DetailRS1['spread']; ?> // TASA FINAL <?php echo $row_DetailRS1['tasa_final']; ?></span></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></td>
  </tr>
</table>
<br>
<p align="center"><br>

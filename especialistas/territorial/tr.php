...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td align="left" valign="middle"><span class="Estilo3"> </span><span class="Estilo3">ESPECIALISTAS TERRITORIAL</span></td>
    ...
    <td bordercolor="#000000"><br>
        <table width="90%"  border="0" align="center">
          ...
          <tr>
            ...
            <td valign="middle">&nbsp;</td>
            <td valign="middle"><a href="../controles_especialistas/clavebcos/clavebcos.php"><img src="../../imagenes/Botones/bcos_con_clave.jpg" width="150" height="40" border="0"></a></td>
          </tr>
          <tr>
            <td valign="middle">&nbsp;</td>
            <td valign="middle">&nbsp;</td>
          ...
          <tr>
            <td align="left" valign="middle"></div>
              <select name="menu1" class="etiqueta12" onChange="MM_jumpMenu('parent',this,1)">
                <option value="tr.php" selected>Seleccione Una Opci&oacute;n</option>
                <option value="controles/controlop.php">Control Operaciones</option>
                <option value="acuserecibocaratula/acuserecibomae.php">Acuse de Recibo</option>
                <option value="../../archivos/msgswift/msgswiftter.php">MSG Swift</option>
                ...
                <option value="../../archivos/carpeta_virtual/prestamo/ver_aviso_cuota_ter.php">Prestamos Avisos Cuotas</option>
                <option value="../../archivos/carpeta_virtual/cambio/cambio_ter.php">Avisos Cambios Internaciones</option>
                <option value="informes/impavisoplapro_mae.php">Avisos Plazo Proveedor</option>
                <option value="tr.php">--- Consultas ---</option>
                <option value="../controles_especialistas/devengo/interesesmae.php">Intereses Proyectados</option>
                <option value="../controles_especialistas/pagareparagua/modpagmae.php">Consulta Pagare Paragua</option>
                <option value="tr.php">--- Informes NI ---</option>
                ...
                <option value="tr.php">--- SAC ---</option>

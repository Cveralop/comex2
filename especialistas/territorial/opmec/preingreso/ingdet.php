...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opmec (rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, estado, asignador, operador, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, valuta, sub_estado, compraventa, tipocambio, date_preingreso, reparo_obs, estado_visacion, visador, mandato, excepcion, autorizacion_operaciones, autorizacion_especialista, responsable_excepcion, tipo_excepcion, solucion_excepcion, urgente, impedido_operar, fuera_horario, nro_folio, cliente_passport, op_web, verifico_mandato, hizo_llamada) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['rut_cliente'], "text"),
                       GetSQLValueString($_POST['nombre_cliente'], "text"),
					   ...
					   GetSQLValueString($_POST['hizo_llamado'], "text"));
  mysqli_select_db($comercioexterior, $database_comercioexterior);
  $Result1 = mysqli_query($comercioexterior, $insertSQL) or die(mysqli_error($comercioexterior));
...
<?php if ($totalRows_enviocv > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="7" align="left" bgcolor="#999999"><span class="titulocolumnas"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"></span><span class="titulodetalle">Compras y Ventas Enviadas a Curse</span></td>
    </tr>
    <tr>
      <td width="10%" align="center" bgcolor="#999999" class="titulocolumnas">Rut Cliente</td>
      <td width="20%" align="center" bgcolor="#999999" class="titulocolumnas">Nombre Cliente</td>
      <td width="10%" align="center" bgcolor="#999999" class="titulocolumnas">Fecha Ingreso</td>
      <td width="10%" align="center" bgcolor="#999999" class="titulocolumnas">Fecha Curse</td>
      <td width="10%" align="center" bgcolor="#999999" class="titulocolumnas">Evento</td>
      <td width="10%" align="center" bgcolor="#999999" class="titulocolumnas">Estado</td>
      <td width="30%" align="center" bgcolor="#999999" class="titulocolumnas">Moneda / Monto Operaci&oacute;n</td>
    </tr>
    <?php do { ?>
      <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="7" align="left" valign="middle" bgcolor="#999999"><span class="titulocolumnas"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"> <span class="titulo_menu"><span class="respuestacolumna"><span class="subtitulopaguina">Ordenes de Pago Enviadas a Curse</span></span></span></span></td>
  </tr>
  <tr>
    <td width="10%" valign="middle" bgcolor="#999999" class="titulocolumnas">Rut Cliente</td>
    <td width="20%" valign="middle" bgcolor="#999999" class="titulocolumnas">Nombre Cliente</td>
    <td width="10%" valign="middle" bgcolor="#999999" class="titulocolumnas">Fecha Ingreso</td>
    <td width="10%" valign="middle" bgcolor="#999999" class="titulocolumnas">Fecha Curse</td>
    <td width="10%" valign="middle" bgcolor="#999999" class="titulocolumnas">Evento</td>
    <td width="10%" valign="middle" bgcolor="#999999" class="titulocolumnas">Estado</td>
    <td width="30%" valign="middle" bgcolor="#999999" class="titulocolumnas">Moneda / Monto Operaci&oacute;n</td>
  </tr>
  <?php do { ?>
  <tr>
    <td valign="middle" class="respuestacolumna_rojo"><?php echo $row_envioop['rut_cliente']; ?></td>
    <td align="left" valign="middle"><?php echo $row_envioop['nombre_cliente']; ?></td>
    <td valign="middle"><?php echo $row_envioop['fecha_ingreso']; ?></td>
    <td valign="middle"><?php echo $row_envioop['fecha_curse']; ?></td>
    <td valign="middle"><?php echo $row_envioop['evento']; ?></td>
    <td align="center" valign="middle"><?php echo $row_envioop['estado']; ?></td>
...
No</td>
    ...
    <tr valign="middle">
      <td height="22" align="right">Observaci&oacute;n Reparo:</td>

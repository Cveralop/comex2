...
if (isset($_GET['sub_estado'])) {
  $colname1_ingape = $_GET['sub_estado'];
}
$colname_ingape = "zzz";
...
$query_ingape = sprintf("SELECT * FROM opmec WHERE rut_cliente LIKE %s and sub_estado = %s ORDER BY rut_cliente ASC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"));

...
$colname1_modificacion = "Enviar OP.";
if (isset($_GET['evento'])) {
  $colname1_modificacion = $_GET['evento'];
}
$colname2_modificacion = "Pendiente.";
if (isset($_GET['sub_estado'])) {
  $colname2_modificacion = $_GET['sub_estado'];
}
...
$query_modificacion = sprintf("SELECT * FROM opmec WHERE rut_cliente = %s and evento = %s and sub_estado = %s ORDER BY id DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion, "text"));
...
<title>Modificaci&oacute;n Instrucciones Envio OP - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" class="Estilo3">MODIFICAR  INSTRUCCIONES ENVIO OP - MAESTRO</td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="moddetop.php?recordID=<?php echo $row_modificacion['id']; ?>"> <img src="../../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>

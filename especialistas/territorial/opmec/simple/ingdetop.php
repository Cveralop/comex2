...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "impresionsimpleop.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="96%" align="left" class="Estilo3">INGRESO SIMPLE INSTRUCCION - DETALLE</td>
...
<?php if ($totalRows_envioop > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      <td width="10%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Rut Cliente</td>
      <td width="20%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Nombre Cliente</td>
      <td width="10%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Fecha Ingreso</td>
      <td width="10%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Fecha Curse</td>
      <td width="10%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Evento</td>
      <td width="10%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Estado</td>
      <td width="30%" align="center" valign="middle" bgcolor="#999999" class="titulocolumnas">Moneda / Monto Operaci&oacute;n</td>
    </tr>
    <?php do { ?>
      <tr>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum','nro_folio','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulocolumnas"><span class="titulodetalle">Ingreso Simple Instrucci&oacute;n</div>
      </span></span></td>
    </tr>
    <tr valign="middle">
...
<label>
        No</label>
        <input name="op_web" type="radio" id="op_web_1" value="No" checked>
        <br>
      </td>
    </tr>
    <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="ingmaeop.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

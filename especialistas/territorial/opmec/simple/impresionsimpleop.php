...
$query_DetailRS1 = sprintf("SELECT opmec.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opmec, usuarios WHERE especialista_curse = %s and (opmec.especialista_curse = usuarios.usuario) ORDER BY opmec.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
$colname_fuerahorario = "opmec";
if (isset($_GET['depto'])) {
  $colname_fuerahorario = $_GET['depto'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM fuerahorario_territorial nolock WHERE depto = %s", GetSQLValueString($colname_fuerahorario, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="left"></div></div><img src="../../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61" align="left"></td>
  </tr>
  <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">MERCADO DE CORREDORES</span></td>
  </tr>
  <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="ingmaeop.php"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td width="37%" align="center"><strong><?php echo strtoupper($row_DetailRS1['id']); ?></strong></td>
    <td width="15%" align="right">Nro Folio Caratula:</td>
    <td width="28%" align="center"><strong><?php echo strtoupper($row_DetailRS1['nro_folio']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><strong><?php echo $row_DetailRS1['date_espe']; ?></strong></div></td>
  </tr>
  <tr valign="middle">
    <td align="right">Evento:</div></td>
    <td align="left"><strong><?php echo $row_DetailRS1['evento']; ?></strong></td>
    <td align="right">OP Via WEB:</td>
    <td align="center"><strong><?php echo strtoupper($row_DetailRS1['op_web']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><strong><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['urgente']; ?></td>
  ...
  <tr valign="middle">
    <td align="right">Verifico Mandato:</td>
    <td align="center" class="NegrillaCartaReparo"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['verifico_mandato']; ?></span></td>
    <td align="right">Hizo LLamado:</td>
    <td align="center" class="NegrillaCartaReparo"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['hizo_llamada']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Valuta:</td>
    <td align="center" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['valuta']; ?></td>
    <td align="right" class="Estilo12">Tipo Cambio:</td>
    <td align="center" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['tipocambio']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>
...
<table width="50%" border="0" align="center">
  <tr>
    <td class="Estilo12"><strong><?php echo $row_DetailRS1['ne']; ?></strong></td>
  </tr>
</table>

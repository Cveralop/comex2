...
$query_swift_oprecibida = sprintf("SELECT * FROM swift_oprecibida WHERE date_ingreso between %s and %s and rut_beneficiario = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_swift_oprecibida, "date"),GetSQLValueString($colname1_swift_oprecibida, "date"),GetSQLValueString($colname2_swift_oprecibida, "text"));
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="right"><?php echo $row_swift_oprecibida['monto_operacion']; ?></td>

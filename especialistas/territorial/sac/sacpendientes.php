...
<table width="95%" border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../tr.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen2" width="80" height="25" border="0" id="Imagen2" /></a></td>
  </tr>
</table>
<br />
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td colspan="9" align="left" valign="middle" bgcolor="#999999"><span class="NegrillaCartas"><?php echo $totalRows_sac ?></span><span class="titulocolumnas"> SAC en total</span></td>
  </tr>
  <tr>
    <td align="center" valign="middle" class="titulocolumnas">Nro. Requerimiento</td>
    <td align="center" valign="middle" class="titulocolumnas">Fecha Carga Archivo</td>
  ...
  <?php do { ?>
    <tr>
      <td align="center" valign="middle"><?php echo $row_sac['nro_req']; ?><a href="untitled.php?recordID=<?php echo $row_sac['nro_req']; ?>"></a></td>
      ...
      <td align="left" valign="middle"><?php echo $row_sac['especialista']; ?></td>

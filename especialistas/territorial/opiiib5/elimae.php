...
$query_ingape = sprintf("SELECT * FROM optbc WHERE rut_cliente LIKE %s and operador = %s ORDER BY rut_cliente ASC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"));

...
$query_altadocdis = sprintf("SELECT * FROM optbc WHERE nro_operacion LIKE %s and mandato = %s and rut_cliente LIKE %s ORDER BY id DESC", GetSQLValueString("%" . $colname_altadocdis, "text"),GetSQLValueString($colname1_altadocdis, "text"),GetSQLValueString("%" . $colname2_altadocdis, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <span class="rojopequeno">000000</span></td>
    </tr>
    <tr valign="middle">

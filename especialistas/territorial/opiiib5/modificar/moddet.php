...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE optbc SET evento=%s, estado=%s, nro_operacion=%s, obs=%s, territorial=%s, moneda_operacion=%s, monto_operacion=%s, sub_estado=%s, date_preingreso=%s, reparo_obs=%s, mandato=%s, excepcion=%s, autorizacion_operaciones=%s, autorizacion_especialista=%s, responsable_excepcion=%s, tipo_excepcion=%s, solucion_excepcion=%s, urgente=%s, nro_folio=%s WHERE id=%s",

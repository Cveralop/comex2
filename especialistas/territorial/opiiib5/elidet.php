...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE optbc SET estado=%s, obs=%s, sub_estado=%s, estado_visacion=%s WHERE id=%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  ...
  Si</label>
    ...
    <tr align="center" valign="baseline">
      <td colspan="4" align="center" valign="middle" nowrap><input type="submit" class="boton" value="Anular Instrucci&oacute;n"></td>
    </tr>
  </table>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO intproyec (sistema, rut_cliente, nombre_cliente, oficina, nro_operacion, secuencia, moneda, capital_original, saldo_vigente, tasa_final_cliente, dife, fecha_vcto, fecha_desde, fecha_hasta) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="95%" border="0" align="center">
  <tr>
    <td align="right"><a href="../../ac_bei/ac_bei.php">Asistente Comercial BEI / Volver a BMG</a> / <a href="../../ni/ni.php">Volver a NI</a> /<a href="../../territorial/tr.php"> Volver a Territoriales</a> / <a href="../../redsuc/redsuc.php">Vover a Red de Sucursales</a></td>
  </tr>
</table>
<script type="text/javascript">
<!--

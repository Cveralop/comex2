...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="rut_cliente" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['rut_cliente'], ENT_COMPAT, ''); ?>" size="16" maxlength="16" readonly="readonly" />
      <span class="rojopequeno">Sin puntos ni Guion</span></td>
      <td align="right" valign="middle">Fecha Sistema:</td>
      <td align="center" valign="middle"><input name="date_ingreso" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['date_ingreso'], ENT_COMPAT, ''); ?>" size="23" maxlength="20" readonly="readonly" />
        <span class="rojopequeno">(aaaa-mm-dd hh:mm:ss)</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Nombre Cliente:</td>
      <td colspan="3" align="left" valign="middle"><input name="nombre_cliente" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['nombre_cliente'], ENT_COMPAT, ''); ?>" size="120" maxlength="100" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Especialista:</td>
      <td align="center" valign="middle"><input name="especialista" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['especialista'], ENT_COMPAT, ''); ?>" size="50" maxlength="50" readonly="readonly" /></td>
      <td align="right" valign="middle">Tipo Mandato:</td>
      <td align="center" valign="middle"><input name="tipo_mandato" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['tipo_mandato'], ENT_COMPAT, ''); ?>" size="3" maxlength="2" readonly="readonly" /> 
        <span class="rojopequeno">(N= Nuevo / A= Antiguo)</span></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Ingresado Por:</td>
      <td align="center" valign="middle"><input name="ing_operador" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['ing_operador'], ENT_COMPAT, ''); ?>" size="12" maxlength="10" readonly="readonly" /></td>
      <td align="right" valign="middle">Fecha Ingreso:</td>
      <td align="center" valign="middle"><input name="fecha_ingreso" type="text" class="etiqueta12" value="<?php echo htmlentities($row_DetailRS1['fecha_ingreso'], ENT_COMPAT, ''); ?>" size="12" maxlength="10" readonly="readonly" />

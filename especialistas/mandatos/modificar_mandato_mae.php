...
$colname1_ingmand = "Mandato OK";
if (isset($_GET['estado_mandato'])) {
  $colname1_ingmand = $_GET['estado_mandato'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingmand = sprintf("SELECT * FROM cliente nolock WHERE rut_cliente = %s and estado_mandato = %s", GetSQLValueString($colname_ingmand, "text"),GetSQLValueString($colname1_ingmand, "text"));
...
<title>Modificar Mandatos - Maestro</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR MANDATOS - MAESTRO</td>
...
<form id="form1" name="form1" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="titulodetalle">Modificar Mandato Operaciones</span></td>
    </tr>
    <tr>
...
<?php if ($totalRows_ingmand > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><a href="modificar_mandato_det.php?recordID=<?php echo $row_ingmand['id']; ?>"><img src="../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0" /></a></td>

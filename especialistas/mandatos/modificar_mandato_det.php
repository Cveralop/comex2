...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE cliente SET tipo_mandato=%s, ing_operador=%s, visador=%s, fecha_visacion=%s, estado_mandato=%s, contacto1=%s, contacto2=%s, nombre_e1=%s, email1=%s, nombre_e2=%s, email2=%s, nombre_e3=%s, email3=%s, nombre_e4=%s, email4=%s, nombre_e5=%s, email5=%s WHERE id=%s",
  ...
  $updateGoTo = "modificar_mandato_mae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Modificar Mandato - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR MANDATOS - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline">
      <td colspan="4" align="left" valign="middle" bgcolor="#999999"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="titulo_menu">Detalle Modificar Mandatos</span></td>
    </tr>
    <tr valign="baseline">
...
<input name="estado_mandato" type="radio" class="etiqueta12" id="estado_0" value="Mandato OK" checked="checked" />
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><input name="fecha_ingreso" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['fecha_ingreso']; ?>" size="12" maxlength="10" readonly="readonly" /></td>
    </tr>
    <tr valign="baseline">

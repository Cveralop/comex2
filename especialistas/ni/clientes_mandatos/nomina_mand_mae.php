...
$query_nominamandatos = sprintf("SELECT * FROM cliente nolock WHERE fecha_ingreso = %s and estado_mandato = %s", GetSQLValueString($colname_nominamandatos, "date"),GetSQLValueString($colname1_nominamandatos, "text"));

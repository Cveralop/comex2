...
$query_ingape = sprintf("SELECT * FROM opcex WHERE rut_cliente = %s and (estado_visacion = %s or estado_visacion = %s) ORDER BY id DESC", GetSQLValueString($colname_ingape, "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7"><span class="titulodetalle">Anular Instrucci&oacute;n Otros Productos</span></span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="7" align="left" valign="middle" class="titulocolumnas"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="titulo_menu">Rut Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['rut_cliente']); ?></span><span class="titulo_menu"> Nombre Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['nombre_cliente']); ?></span></td>
    </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><?php echo $row_ingape['tipo_operacion']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_ingape['fecha_ingreso']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_ingape['evento']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_ingape['estado']; ?></td>
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
    </tr>

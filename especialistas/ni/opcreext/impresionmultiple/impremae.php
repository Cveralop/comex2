...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo7"><span class="titulodetalle">Impresi&oacute;n Instrucci&oacute;n Cliente</span></span></td>
    </tr>
    <tr>
...
<?php if ($totalRows_impresion > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr align="center" valign="middle" bgcolor="#999999">
      <td colspan="9" align="center" valign="middle"><span class="Estilo10">CAMBIOS - OTROS PRODUCTOS</span></td>
    </tr>
    <tr bgcolor="#999999">
      ...
      <td align="center" valign="middle" class="titulocolumnas">Tipo Operaci&oacute;n
        </div></td>
      ...
      <td align="center" valign="middle" class="titulocolumnas">Moneda / Monto Operaci&oacute;n
        </div></td>
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_impresion['id']; ?></span>
          </div></td>
        <td align="center" valign="middle"><?php echo $row_impresion['date_espe']; ?>
          </div></td>
        <td align="center" valign="middle"><?php echo $row_impresion['tipo_operacion']; ?></td>
        <td align="center" valign="middle"><?php echo strtoupper($row_impresion['rut_cliente']); ?>
          </div></td>
      ...
      <tr>
        <td align="right" valign="middle" class="titulocolumnas">Mandato / Imp. Operar:</td>
        <td colspan="9" align="left" valign="middle"><?php echo $row_impresion['mandato']; ?> / <?php echo $row_impresion['impedido_operar']; ?></td>
      </tr>
...
<br>
Registros del <strong><?php echo ($startRow_impresion + 1) ?></strong> al <strong><?php echo min($startRow_impresion + $maxRows_impresion, $totalRows_impresion) ?></strong> de un total de <strong><?php echo $totalRows_impresion ?></strong><br>
</body>
</html>
<?php

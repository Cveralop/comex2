...
$query_conrut = sprintf("SELECT * FROM opcex nolock WHERE rut_cliente = %s and evento LIKE %s ORDER BY id DESC", GetSQLValueString($colname_conrut, "text"),GetSQLValueString("%" . $colname1_conrut . "%", "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opcreext.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_conrut['tipo_operacion']; ?></div></td>

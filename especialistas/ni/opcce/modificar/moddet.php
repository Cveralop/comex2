...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET evento=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, moneda_documentos=%s, monto_documentos=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s WHERE id=%s",

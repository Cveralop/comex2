    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
          <select name="moneda_operacion" class="etiqueta12" id="moneda_operacion">
            ...
            <option value="USD" selected <?php if (!(strcmp("USD", $row_DetailRS1['moneda_documentos']))) {echo "selected=\"selected\"";} ?>>USD</option>
...
<option value="ZAR" <?php if (!(strcmp("ZAR", $row_DetailRS1['moneda_documentos']))) {echo "selected=\"selected\"";} ?>>ZAR</option>
          ...
          <input name="monto_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['monto_documentos']; ?>" size="20" maxlength="20">
      </div></td>

...
$query_conrut = sprintf("SELECT * FROM opcce nolock WHERE rut_cliente LIKE %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_conrut . "%", "text"),GetSQLValueString($colname1_conrut . "%", "text"));

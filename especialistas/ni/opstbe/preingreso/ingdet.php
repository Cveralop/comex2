...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamenta a la aplicaci&oacute;n.</span></span>        </div></td>
    </tr>
    <tr valign="baseline">
...
No</td>
      ...
      <td align="center" valign="middle"><label>
        <input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS1['estado_mandato']; ?>" readonly="readonly">
      </label>
         / 

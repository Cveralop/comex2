...
$query_ingape = sprintf("SELECT * FROM opste WHERE rut_cliente = %s and (estado_visacion = %s or estado_visacion = %s) ORDER BY id DESC", GetSQLValueString($colname_ingape, "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="6" align="left" valign="middle" class="titulocolumnas"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="titulo_menu">Rut Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['rut_cliente']); ?></span><span class="titulo_menu"> Nombre Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['nombre_cliente']); ?></span></td>
    </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><span class="Estilo12"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong>      </div></td>
    </tr>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET evento=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s, campana_comex=%s WHERE id=%s",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      <td align="center" valign="middle">Campa&ntilde;a Comex:</td>
      <td align="center" valign="middle"><label>

        ...
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr valign="baseline" bgcolor="#999999">
                <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19"
                        height="21" border="0"><span class="titulodetalle">Ingreso Simple Instrucci&oacute;n</div>
                    </span></span></td>
            </tr>
            <tr valign="baseline">
                <td width="14%" align="right" valign="middle">Nro Folio:</td>
            ...
            <tr valign="baseline">
                ...
                <td width="18%" align="right" valign="middle">Fecha Ingreso:</div>
                </td>

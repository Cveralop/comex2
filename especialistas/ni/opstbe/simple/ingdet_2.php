...
$query_DetailRS1 = sprintf("SELECT * FROM opste nolock WHERE id = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_mandato = sprintf("SELECT cliente.* FROM opste INNER JOIN cliente on opste.rut_cliente = cliente.rut_cliente WHERE opste.id = %s", GetSQLValueString($colname_mandato, "text"));
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulocolumnas"><span class="titulodetalle">Ingreso Simple Instrucci&oacute;n</span></span></td>
    </tr>
    <tr valign="baseline">

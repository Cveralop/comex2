...
$query_DetailRS1 = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opcbi, usuarios WHERE especialista_curse = %s and (opcbi.especialista_curse = usuarios.usuario) ORDER BY opcbi.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
$DetailRS1 = mysqli_query($comercioexterior, $query_DetailRS1) or die(mysqli_error($comercioexterior));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);
$totalRows_DetailRS1 = mysqli_num_rows($DetailRS1);

$colname_fuerahorario = "opcbi";
if (isset($_GET['depto'])) {
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">COBRANZA EXTRANJERA DE IMPORTACION y OPI</span></td>
  </tr>
  <tr>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><strong><?php echo $row_DetailRS1['evento']; ?></strong>
      </div>
    <div align="center" class="Estilo10"></div></td>
    <td align="right" valign="middle">Tipo Operaci&oacute;n:</div></td>
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['tipo_operacion']); ?></strong></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['urgente']; ?></td>
    <td align="right" valign="middle">Mandato / Imp. Operar Passport:</td>
    <td align="center" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Condiciones Especiales:</td>
    <td colspan="3" align="left" valign="middle"><span class="Estilo12"><?php echo $row_DetailRS1['cond_espe']; ?></span></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Tipo Condiciones Especiales:</td>
    <td colspan="3" align="left" valign="middle"><span class="Estilo12"><?php echo $row_DetailRS1['tipo_cond_espe']; ?></span></td>
  </tr>
</table>
<p align="center"><br>
  <br>

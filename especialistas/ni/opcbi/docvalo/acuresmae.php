...
$colname1_entdoc = "Pendiente.";
if (isset($_GET['estado_doc'])) {
  $colname1_entdoc = $_GET['estado_doc'];
}
$colname2_entdoc = "Apertura.";
if (isset($_GET['evento'])) {
  $colname2_entdoc = $_GET['evento'];
}
$colname3_entdoc = "-1";
if (isset($_GET['nro_operacion'])) {
  $colname3_entdoc = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_entdoc = sprintf("SELECT * FROM opcbi nolock WHERE estado_doc = %s and evento = %s and nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname1_entdoc, "text"),GetSQLValueString($colname2_entdoc, "text"),GetSQLValueString($colname3_entdoc, "text"));
...
<title>Acuse Recibo Valorados - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ACUSE RECIBO VALORADOS  - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Acuse Recibo  Valorado</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td align="center"><span class="Estilo8">Tipo Aceptaci&oacute;n <br>
      (CA = Contra Aceptaci&oacute;n / CP = Contra Pago)</span></td>
    <td align="center"><span class="Estilo8">Moneda / MontoOperaci&oacute;n</span></td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="acuresdet.php?recordID=<?php echo $row_entdoc['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></td>
    <td align="center"><?php echo $row_entdoc['fecha_ingreso']; ?></td>
    <td align="center"><?php echo $row_entdoc['rut_cliente']; ?></td>
    <td align="left"><?php echo strtoupper($row_entdoc['nombre_cliente']); ?></td>
    <td align="center"><?php echo $row_entdoc['aceptacion']; ?></td>

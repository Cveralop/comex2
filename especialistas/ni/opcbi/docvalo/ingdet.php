...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET date_ent_doc_val=%s, estado_doc=%s, entregado_por=%s WHERE id=%s",
...
<title>Entrega Documentos Valorados - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ENTREGA DOCUMENTOS VALORADOS - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span class="Estilo9"><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?></span> <strong><?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong> </td>

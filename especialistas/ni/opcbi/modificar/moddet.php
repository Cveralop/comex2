...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcbi SET evento=%s, nro_operacion=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, tipo_operacion=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s, campana_comex=%s WHERE id=%s",
...
<option value="Requerimiento." <?php if (!(strcmp("Requerimiento.", $row_DetailRS1['evento']))) {echo "selected=\"selected\"";} ?>>Requerimiento</option>
    ...
    <tr valign="baseline">
      ...
      <span class="rojopequeno">I000000</span></div>      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
        <option value="OPI." <?php if (!(strcmp("OPI.", $row_DetailRS1['tipo_operacion']))) {echo "selected=\"selected\"";} ?>>Orden de Pago Import.</option>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">
        <label>
          ...
          No</label>
        <input <?php if (!(strcmp($row_DetailRS1['urgente'],"Si"))) {echo "checked=\"checked\"";} ?> name="urgente" type="radio" id="urgente_0" value="Si">
Si<br>
      </td>
      <td align="right" valign="middle">Campa&ntilde;a Comex:</td>
      <td align="center" valign="middle">
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['campana_comex'],"No"))) {echo "checked=\"checked\"";} ?> type="radio" name="campana_comex" value="No" id="campana_comex_1">
          No</label>
        <input <?php if (!(strcmp($row_DetailRS1['campana_comex'],"Si"))) {echo "checked=\"checked\"";} ?> name="campana_comex" type="radio" id="campana_comex_0" value="Si">
Si<br>
      </td>
    </tr>
    <tr valign="baseline">

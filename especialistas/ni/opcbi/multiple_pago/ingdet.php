...
<title>Ingreso Multiple Instruccion - Detalle</title>
<style type="text/css">
<!--
...
Si</label></td>
      ...
      <td align="center" valign="middle">
        <label>
          <input name="campana_comex" type="radio" id="campana_comex_1" value="No" checked>
          No</label>
        <input name="campana_comex" type="radio" id="campana_comex_0" value="Si">
Si<br>
     </td>
    </tr>
    <tr valign="baseline">

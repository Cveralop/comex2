...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingvarios = sprintf("SELECT * FROM opcbi nolock WHERE nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname_ingvarios, "text"));
...
<td align="center" valign="middle"><?php echo $row_ingvarios['evento']; ?></td>
<td align="center" valign="middle"><?php echo $row_ingvarios['estado']; ?></td>

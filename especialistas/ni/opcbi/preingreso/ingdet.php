...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (nro_folio, rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, tipo_operacion, sucursal, sub_estado, date_preingreso, estado_visacion, mandato, impedido_operar, urgente, campana_comex, cliente_passport) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="baseline">
      <td width="16%" align="right" valign="middle">Nro Folio:</td>
    ...
    <tr valign="baseline">
      ...
      <td width="16%" align="right" valign="middle">Fecha Ingreso:</div></td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        
        <select name="tipo_operacion" class="etiqueta12" id="tipo_operacion">
          <option value="OPI." selected>Orden de Pago Import.</option>
          <option value="CBI.">Cobranza Import.</option>
        </select>
      </td>
    </tr>
    <tr valign="baseline">
...
Si</label></td>
      ...
      <td align="center" valign="middle">
        <label>
            <input name="campana_comex" type="radio" class="etiqueta12" id="campana_comex_1" value="No" checked>
          No</label>
        <label>
          <input name="campana_comex" type="radio" class="etiqueta12" id="campana_comex_0" value="Si">
          Si</label>
        <label> </label>
        <br>
     </td>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle"><select name="cond_espe" class="etiqueta12" id="cond_espe">
        <option value="Si" <?php if (!(strcmp("Si", $row_DetailRS1['cond_espe']))) {echo "selected=\"selected\"";} ?>>Si</option>
        <option value="No" <?php if (!(strcmp("No", $row_DetailRS1['cond_espe']))) {echo "selected=\"selected\"";} ?>>No</option>
      </select></td>
    </tr>
    <tr valign="baseline">
      <td align="right" valign="middle">Tipo Condiciones Especiales:</td>
      <td colspan="3" align="left" valign="middle"><textarea name="tipo_cond_espe" cols="85" rows="4" class="etiqueta12" id="tipo_cond_espe"><?php echo $row_DetailRS1['tipo_cond_espe']; ?></textarea></td>
    </tr>
    <tr valign="baseline">

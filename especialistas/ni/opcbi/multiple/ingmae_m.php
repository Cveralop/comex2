...
$colname_nrooperacion = "xxx";
if (isset($_GET['nro_operacion'])) {
  $colname_nrooperacion = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_nrooperacion = sprintf("SELECT * FROM opcbi nolock WHERE nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname_nrooperacion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><?php echo $row_nrooperacion['evento']; ?></td>
      <td align="center" valign="middle"><?php echo $row_nrooperacion['estado']; ?></td>

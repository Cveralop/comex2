...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="subtitulopaguina">ESPECIALISTAS NI</td>
  </tr>
</table>
<br />
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td align="left" valign="middle"><select name="segmento" class="etiqueta12" id="segmento">
        <option value="...." selected="selected">Selecccione un Segmento....</option>
        <option value="BGEGRP2">Banca Grandes Empresas GRP2</option>

...
$query_modificacion = sprintf("SELECT * FROM optbc nolock WHERE rut_cliente = %s and (estado_visacion = %s or estado_visacion = %s) ORDER BY date_ingreso DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"),GetSQLValueString($colname2_modificacion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulocolumnas">Evento</span></td>
  ...
  <tr>
    ...
    <td align="right" valign="middle"><?php echo $row_modificacion['estado']; ?></td>

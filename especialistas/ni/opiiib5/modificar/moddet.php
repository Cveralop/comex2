...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE optbc SET evento=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s, campana_comex=%s WHERE id=%s",

...
//$query_DetailRS2 = sprintf("SELECT cliente.* FROM optbc INNER JOIN cliente WHERE id = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
<body
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="form1"
        ...
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr valign="baseline" bgcolor="#999999">
                <td colspan="4" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19"
                        height="21" border="0"><span class="titulodetalle">Ingreso Multiple Instrucci&oacute;n</span>
                </td>
            </tr>
            <tr valign="baseline">
            ...
            <tr valign="baseline">
                ...
                <td align="center" valign="middle"><span id="sprytextfield1">
                        ...
                        <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la
                            aplicaci&oacute;n.</span></span> </div>
                </td>
            </tr>
            <tr valign="baseline">
            ...
            <tr valign="baseline">
                ...
                <td align="center" valign="middle"><label>
                        ...
                        Si</label>
                    <input name="urgente" type="radio" class="etiqueta12" value="No" checked>No
                </td>
        ...
        <input name="territorial" type="hidden" class="etiqueta12" id="territorial"
            value="<?php echo $row_DetailRS1['territorial']; ?>" size="30" maxlength="50" readonly="readonly">
    ...
    <table width="95%" border="0" align="center">
        <tr>
            <td align="right" valign="middle"><a href="ingmae_m.php" onMouseOut="MM_swapImgRestore()"

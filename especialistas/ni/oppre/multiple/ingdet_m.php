...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      <td width="15%" align="right">Nro Folio:</td>
      <td colspan="3" align="left"><span id="sprytextfield10">
    ...
    <tr valign="middle">
      ...
      <td width="13%" align="right">Fecha Ingreso:</div></td>
...
No<br>
    ...
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span></span><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato debe ser 000.00</span></td>
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield2"><span id="sprytextfield4"><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="respuestacolumna_azul"><span class="respuestacolumna_rojo">TT</span></span></span><span class="textfieldInvalidFormatMsg">Formato debe ser 00.000000</span><span class="textfieldRequiredMsg">e necesita un valor.</span></span><span id="sprytextfield3">
        <label>
    ...
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span></span><span class="textfieldRequiredMsg"><span class="rojopequeno">Se necesita un valor.</span></span><span class="rojopequeno"><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span></td>
    </tr>
    <tr valign="middle">
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "integer", {hint:"1", validateOn:["blur"], minValue:1, maxValue:999});
...
var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "date", {format:"yyyy-mm-dd", validateOn:["blur", "change"], hint:"0000-00-00"});
var sprytextfield10 = new Spry.Widget.ValidationTextField("sprytextfield10", "integer", {minChars:0, maxChars:10, minValue:0, maxValue:9999999999, isRequired:false});
//-->
</script>
</body>
</html>

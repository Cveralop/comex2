...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      <td width="16%" align="right">Nro Folio:</td>
    ...
    <tr valign="middle">
      ...
      <td width="14%" align="right">Fecha Ingreso:</div></td>
...
No</label></td>
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield6">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield2"><span id="sprytextfield4"><span id="sprytextfield5"><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="respuestacolumna_rojo">TT</span><span class="respuestacolumna_azul">
...
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "integer", {hint:"1", validateOn:["blur"], minValue:1, maxValue:999});

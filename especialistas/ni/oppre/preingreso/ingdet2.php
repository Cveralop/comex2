...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="6" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Pre-Ingresar Instrucci&oacute;n Multiple </div>
      </span></td>
    </tr>
    <tr valign="middle">
...
<option value="ZAR" <?php if (!(strcmp("ZAR", $row_DetailRS1['moneda_operacion']))) {echo "selected=\"selected\"";} ?>>ZAR</option>
  ...
  Si</label>
    ...
    No</label>
      ...
      <td align="center"><input name="tipo_operacion" type="text" class="etiqueta12" id="tipo_operacion" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="35" maxlength="35" readonly="readonly">        </div></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamnete a la aplicaci&oacute;n.</span></span></td>
      <td align="right">Tipo Cambio:</td>
      <td align="center"></div>
      <input name="tipocambio" type="text" class="etiqueta12" id="tipocambio" value="0.00" size="10" maxlength="10"></td>

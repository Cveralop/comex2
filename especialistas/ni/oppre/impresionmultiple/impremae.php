...
$impresion = mysql_query($query_impresion, $comercioexterior) or die(mysqli_error());
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      <td width="20%" align="right">Especialista:</div></td>
      <td width="80%" align="left"><input name="especialista_curse" type="text" class="etiqueta12" id="especialista_curse" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20" readonly></td>
    </tr>
    <tr valign="middle">

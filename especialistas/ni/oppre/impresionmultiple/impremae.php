...
<body onLoad="MM_preloadImages('../../../../imagenes/Botones/boton_volver_2.jpg')">
    ...
    <form name="form1" method="get" action="">
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            <tr valign="middle" bgcolor="#999999">
                <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19"
                        height="21"><span class="Estilo7">Impresi&oacute;n Instrucci&oacute;n Cliente</span></td>
            </tr>
            <tr valign="middle">
                <td width="20%" align="right">Especialista:</div>
                </td>
                <td width="80%" align="left"><input name="especialista_curse" type="text" class="etiqueta12"
                        id="especialista_curse" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20"
                        readonly></td>
            </tr>
            <tr valign="middle">
                <td align="right">Fecha Ingreso:</div>
                </td>
                <td align="left"><input name="date_ingreso" type="text" class="etiqueta12" id="date_ingreso"
                        value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10"></td>
            </tr>
            <tr valign="middle">
                <td align="right">Rut Cliente:</div>
                </td>
                <td align="left">
    ...
    <table width="95%" border="0" align="center">
        <tr>
            <td align="right" valign="middle"><a href="../oppre.php" onMouseOut="MM_swapImgRestore()"
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="center" valign="middle" bgcolor="#999999">
            <td colspan="8" align="center"><span class="Estilo10">PR&Eacute;STAMOS</span></td>
        </tr>
        <tr valign="middle" bgcolor="#999999">
            <td align="center"><span class="Estilo6">Nro Folio</span></td>
        ...
        <?php do { ?>
        <tr valign="middle">
            <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_impresion['id']; ?></span> </div>
            </td>
            <td align="center"><?php echo $row_impresion['date_espe']; ?> </div>
            </td>
            <td align="center"><?php echo strtoupper($row_impresion['rut_cliente']); ?></div>
            </td>
            <td align="left"><?php echo strtoupper($row_impresion['nombre_cliente']); ?></td>
            <td align="center"><?php echo $row_impresion['evento']; ?> </div>
            </td>
            <td align="center"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['nro_operacion']); ?></span> /
                <span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['nro_operacion_relacionada']); ?></span>
            </td>
            <td align="right"><span class="Estilo8"><?php echo strtoupper($row_impresion['moneda_operacion']); ?></span>
                <strong><?php echo number_format($row_impresion['monto_operacion'], 2, ',', '.'); ?></strong></div>
            </td>
            <td colspan="2" align="center">
        ...
        <tr valign="middle">
            <td rowspan="3" align="left" valign="top" bgcolor="#999999" class="titulocolumnas">Observaciones:</td>
            <td colspan="3" rowspan="3" align="left" valign="top"><?php echo $row_impresion['obs']; ?></td>
            <td align="right" valign="top" bgcolor="#999999" class="titulocolumnas">Sucursal:</td>
            <td align="center" valign="top"><?php echo $row_impresion['sucursal']; ?></td>
            <td colspan="3" rowspan="3" align="left" valign="top">Tipo Cambio <span
                    class="respuestacolumna_azul"><?php echo $row_impresion['tipocambio']; ?></span> // Origen Fondos
                <span class="respuestacolumna_azul"><?php echo $row_impresion['origen_fondos']; ?></span>// Destino
                Fondos <span class="respuestacolumna_azul"><?php echo $row_impresion['destino_fondos']; ?></span>//
                Cuotas <span class="respuestacolumna_azul"><?php echo $row_impresion['cuotas']; ?></span> // Nro Cuotas
                <span class="respuestacolumna_azul"><?php echo $row_impresion['nro_cuotas']; ?></span> // TT <span
                    class="respuestacolumna_azul"><?php echo $row_impresion['tt']; ?></span> // SPREAD <span
                    class="respuestacolumna_azul"><?php echo $row_impresion['spread']; ?></span> // TASA FINAL <span
                    class="respuestacolumna_azul"><?php echo $row_impresion['tasa_final']; ?></span> // Periodisidad
                <span class="respuestacolumna_azul"><?php echo $row_impresion['periodisidad']; ?></span>
            </td>
        </tr>
        <tr valign="middle">
            <td align="right" valign="top" bgcolor="#999999" class="titulocolumnas">Mandato / Imp. Operar / Passport:
            </td>
            <td align="center" valign="top"><?php echo $row_impresion['mandato']; ?> /
                <?php echo $row_impresion['impedido_operar']; ?> / <span
                    class="respuestacolumna_rojo"><?php echo $row_impresion['cliente_passport']; ?></span></td>
        </tr>
        <tr valign="middle">
            <td align="right" valign="top" bgcolor="#999999" class="titulocolumnas">Vencimiento:</td>
            <td align="center" valign="top"><?php echo $row_impresion['vcto']; ?></td>
        </tr>
    ...
    <table border="0" width="50%" align="center">
        <tr>
            ...
            <td width="23%" align="center">
                <?php if ($pageNum_impresion < $totalPages_impresion) { // Show if not last page ?>
                <a
                    href="<?php printf("%s?pageNum_impresion=%d%s", $currentPage, $totalPages_impresion, $queryString_impresion); ?>">�ltimo</a>
                <?php } // Show if not last page ?>
            </td>
        </tr>
    </table>

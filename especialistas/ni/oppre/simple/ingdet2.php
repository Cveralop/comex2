...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="6" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingresar Simple Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="middle">
...
<option value="ZAR" <?php if (!(strcmp("ZAR", $row_DetailRS1['moneda_operacion']))) {echo "selected=\"selected\"";} ?>>ZAR</option>
  ...
  Si</label>
    ...
    No</label>
      ...
      <td align="center"></div>
      <input name="tipo_operacion" type="text" class="etiqueta12" id="tipo_operacion" value="<?php echo $row_DetailRS1['tipo_operacion']; ?>" size="35" maxlength="35" readonly="readonly"></td>
    </tr>
    <tr valign="middle">

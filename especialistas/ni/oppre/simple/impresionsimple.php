...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><strong><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong><strong></td>
  </tr>
  <tr valign="middle">

...
$pageNum_impresion = 0;
if (isset($_GET['pageNumimpresion'])) {
  $pageNum_impresion = $_GET['pageNumimpresion'];
}
...
$query_impresion = sprintf("SELECT *, time(date_espe)as esp FROM opcci nolock WHERE especialista_curse = %s and date_ingreso = %s and rut_cliente = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_impresion, "text"),GetSQLValueString($colname1_impresion, "date"),GetSQLValueString($colname3_impresion, "text"),GetSQLValueString($colname4_impresion, "text"));
...
<body onLoad="MM_preloadImages('../../../../imagenes/Botones/boton_volver_2.jpg')">
    <table width="95%" border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
        <tr valign="middle">
            <td align="left" class="Estilo3">IMPRESI&Oacute;N - MAESTRO</td>
    ...
    <form name="form1" method="get" action="">
        <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
            ...
            <tr valign="middle">
                <td width="21%" align="right">Especialista:</div>
                </td>
                <td width="79%" align="left"><input name="especialista_curse" type="text" class="etiqueta12"
    ...
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
        <tr align="center" valign="middle" bgcolor="#999999">
            <td colspan="9"><span class="Estilo10">CARTA DE CREDITO DE IMPORTACI&Oacute;N</span></td>
        </tr>
        <tr valign="middle" bgcolor="#999999">
            ...
            <td class="titulocolumnas">Moneda / Monto Negociaci&oacute;n</div>
            </td>
        ...
        <tr valign="middle">
            ...
            <td align="right"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['moneda_operacion']); ?></span><strong
                    class="respuestacolumna_azul">
                    <?php echo number_format($row_impresion['monto_operacion'], 2, ',', '.'); ?></strong></div>
            </td>
            <td align="right"><span
                    class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['moneda_documentos']); ?></span>
                <strong class="respuestacolumna_azul">
                    <?php echo number_format($row_impresion['monto_documentos'], 2, ',', '.'); ?></strong></div>
                </div>
            </td>
            <td colspan="2" align="center">
        ...
        <tr valign="middle">
            ...
            <td colspan="6" align="left"><?php echo $row_impresion['obs']; ?></td>
            <td align="right" class="titulocolumnas">Mandato / Imp. Operar / Passport:</td>
            <td colspan="2" align="center"><?php echo $row_impresion['mandato']; ?> /

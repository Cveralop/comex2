...
$query_negcondisc = sprintf("SELECT * FROM opcci nolock WHERE evento = %s and tipo_negociacion = %s", GetSQLValueString($colname_negcondisc, "text"),GetSQLValueString($colname1_negcondisc, "text"));
$negcondisc = mysqli_query($comercioexterior, $query_negcondisc) or die(mysqli_error());

...
<option value="ZAR" <?php if (!(strcmp("ZAR", $row_DetailRS1['moneda_operacion']))) {echo "selected=\"selected\"";} ?>>ZAR</option>
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_mandato['estado_mandato']; ?>" size="30" maxlength="25" readonly="readonly"> 
      / 

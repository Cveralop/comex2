...
<form name="form4" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="titulo_menu">Pre-Ingreso Instrucciones Prestamos (CCI)</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" valign="middle" bgcolor="#CCCCCC">Nro Operacion Relacionada:</td>
      <td width="79%" align="left" valign="middle" bgcolor="#CCCCCC"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="15" maxlength="7">
        <span class="rojopequeno">L000000</span></td>
    </tr>
    <tr>
      <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><input name="button" type="submit" class="boton" id="button" value="Enviar">
        <input name="button2" type="submit" class="boton" id="button2" value="Enviar"></td>
    </tr>
  </table>
</form>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo $row_ingvarios['moneda_operacion']; ?></span> <span class="respuestacolumna_azul"><?php echo number_format($row_ingvarios['monto_operacion'], 2, ',', '.'); ?></span></td>
  </tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right"><span class="Estilo12"><?php echo strtoupper($row_opcci['moneda_operacion']); ?></span><span class="respuestacolumna_azul"> <strong><?php echo number_format($row_opcci['saldo_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><a href="ingdet4.php?recordID=<?php echo $row_inglci['id']; ?>"><img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC" class="respuestacolumna_rojo"><?php echo $row_inglci['nro_operacion_relacionada_car']; ?></td>
    ...
    <td align="right" valign="middle" bgcolor="#CCCCCC"><span class="respuestacolumna_rojo"><?php echo $row_inglci['moneda_operacion']; ?></span><span class="respuestacolumna_azul"> <strong><?php echo number_format($row_inglci['saldo_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>

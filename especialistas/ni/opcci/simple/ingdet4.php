    ...
    <tr valign="middle">
      ...
      <td colspan="5" align="left"><label> <strong>
        <input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_mandato['estado_mandato']; ?>" size="30" maxlength="25" readonly="readonly" />
         ...
         / 
      <input name="cliente_passport" type="text" class="respuestacolumna_rojo" id="cliente_passport" value="<?php echo $row_mandato['cliente_passport']; ?>" size="3" maxlength="2" />         <br /></td>
    </tr>
    <tr valign="middle">

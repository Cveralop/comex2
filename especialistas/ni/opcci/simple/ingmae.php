...
$queryString_ingape = sprintf("&totalRowsingape=%d%s", $totalRows_ingape, $queryString_ingape);
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingvarios = sprintf("SELECT * FROM opcci nolock WHERE nro_operacion = %s and evento = %s", GetSQLValueString($colname_ingvarios, "text"),GetSQLValueString($colname1_ingvarios, "text"));
...
$queryString_ingvarios = sprintf("&totalRowsingvarios=%d%s", $totalRows_ingvarios, $queryString_ingvarios);
...
$pageNum_ingcci = 0;
if (isset($_GET['pageNum_ingape'])) {
  $pageNum_inglci = $_GET['pageNum_ingape'];
}
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingcci = sprintf("SELECT * FROM carteraopera nolock WHERE nro_operacion_relacionada_car = %s ORDER BY nro_operacion_car DESC", GetSQLValueString($colname_ingcci, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_inglci = sprintf("SELECT * FROM carteraopera nolock WHERE nro_operacion_car = %s", GetSQLValueString($colname_inglci, "text"));
$query_limit_ingape = sprintf("%s LIMIT %d, %d", $query_inglci, $startRow_inglci, $maxRows_inglci);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">INGRESO SIMPLE INSTRUCCIONES - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Simple Instrucci&oacute;n Apertura Carta de Cr&eacute;dito de Importaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<form name="form2" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Simple Instrucciones  Carta de Cr&eacute;dito de Importaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<form name="form4" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="titulo_menu">Ingreso Simple Instrucciones Prestamos (CCI)</span></td>
    </tr>
    <tr>
      <td width="21%" align="right" bgcolor="#CCCCCC">Nro Operacion Relacionada:</td>
      <td width="79%" align="left" bgcolor="#CCCCCC"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="17" maxlength="7">
        <span class="respuestacolumna_rojo">L000000</span></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#CCCCCC"><input name="button" type="submit" class="boton" id="button" value="Buscar">
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="31%" align="center"><?php if ($pageNum_ingape > 0) { // Show if not first page ?>
        <a href="<?php printf("%s?pageNum_ingvarios=%d%s", $currentPage, max(0, $pageNum_ingape - 1), $queryString_ingvarios); ?>">Anterior</a>
        <?php } // Show if not first page ?>
    </td>
    <td width="23%" align="center"><?php if ($pageNum_ingape < $totalPages_ingvarios) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_ingvarios=%d%s", $currentPage, min($totalPages_ingvarios, $pageNum_ingape + 1), $queryString_ingvarios); ?>">Siguiente</a>
        <?php } // Show if not last page ?>
    </td>
    <td width="23%" align="center"><?php if ($pageNum_ingape < $totalPages_ingvarios) { // Show if not last page ?>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    <td valign="middle" class="titulocolumnas">Ingresar Instrucci&oacute;n</td>
    <td valign="middle" class="titulocolumnas">Nro Operaci&oacute;n</td>
    ...
    <td valign="middle" class="titulocolumnas">Fecha Vencimiento</td>
    <td valign="middle" class="titulocolumnas">Moneda / Saldo Operaci&oacute;n</td>
  </tr>
  <?php do { ?>
  <tr>
    <td valign="middle"><a href="ingdet3.php?recordID=<?php echo $row_ingcci['id']; ?>"><img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></td>
    <td valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_ingcci['nro_operacion_relacionada_car']; ?></span></td>
    <td valign="middle"><?php echo $row_ingcci['nro_operacion_car']; ?></td>
    <td valign="middle"><?php echo $row_ingcci['rut_cliente']; ?></td>
    <td align="left" valign="middle"><?php echo $row_ingcci['nombre_cliente']; ?></td>
    <td valign="middle"><?php echo $row_ingcci['fecha_vcto']; ?></td>
    <td align="right" valign="middle" class="respuestacolumna_rojo"><?php echo $row_ingcci['moneda_operacion']; ?><span class="respuestacolumna_azul"> <?php echo number_format($row_ingcci['saldo_operacion'], 2, ',', '.'); ?></td>
  </tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_inglci['nro_operacion_relacionada_car']; ?></span></td>
    ...
    <td align="right" valign="middle" class="respuestacolumna_rojo"><?php echo $row_inglci['moneda_operacion']; ?> <span class="respuestacolumna_azul"><?php echo number_format($row_inglci['saldo_operacion'], 2, ',', '.'); ?></td>
  </tr>

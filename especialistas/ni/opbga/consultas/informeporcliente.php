...
$query_opporcliente = sprintf("SELECT * FROM opbga nolock WHERE rut_cliente = %s and date_ingreso between %s and %s and evento LIKE %s and estado LIKE %s ORDER BY id ASC", GetSQLValueString($colname_opporcliente, "text"),GetSQLValueString($colname1_opporcliente, "text"),GetSQLValueString($colname2_opporcliente, "text"),GetSQLValueString("%" . $colname3_opporcliente . "%", "text"),GetSQLValueString("%" . $colname4_opporcliente . "%", "text"));

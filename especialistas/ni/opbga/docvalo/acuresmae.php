...
$query_entdoc = sprintf("SELECT * FROM opbga nolock WHERE rut_cliente = %s and estado_boleta = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_entdoc, "text"),GetSQLValueString($colname1_entdoc, "text"),GetSQLValueString($colname2_entdoc, "text"));

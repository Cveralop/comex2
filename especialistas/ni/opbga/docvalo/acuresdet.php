...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opbga SET date_rec_doc_val=%s, recibido_por=%s, estado_boleta=%s WHERE id=%s",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Acuse Recibo Valorado</span></td>
    </tr>
    <tr valign="middle">
      <td width="20%" align="right">Nro Registro: </td>
      <td width="27%" align="center"><span class="Estilo8"><?php echo $row_DetailRS1['id']; ?></span></td>
      <td width="23%" align="right">Rut Cliente: </td>
      <td width="30%" align="center"><?php echo $row_DetailRS1['rut_cliente']; ?></td>
    </tr>
    <tr valign="middle">

...
$query_ingape = sprintf("SELECT * FROM opbga nolock WHERE rut_cliente = %s and (estado_visacion = %s or estado_visacion = %s) ORDER BY id DESC", GetSQLValueString($colname_ingape, "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape, "text"));
$ingape = mysql_query($query_ingape, $comercioexterior) or die(mysqli_error());
$row_ingape = mysqli_fetch_assoc($ingape);
$totalRows_ingape = mysqli_num_rows($ingape);$colname_ingape = "zzz";
if (isset($_GET['rut_cliente'])) {
  $colname_ingape = $_GET['rut_cliente'];
}
$colname1_ingape = "Pendiente.";
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Anular Instrucci&oacute;n</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="6" align="left" class="titulocolumnas"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21"><span class="titulo_menu">Rut Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['rut_cliente']); ?></span><span class="titulo_menu"> Nombre Cliente </span><span class="tituloverde"><?php echo strtoupper($row_ingape['nombre_cliente']); ?></span></td>
    </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_ingape['estado']; ?></td>
    <td align="right"><span class="Estilo12"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong></td>
    </tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opbga.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image6" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingsbte = sprintf("SELECT * FROM opbga nolock WHERE nro_operacion = %s ORDER BY date_ingreso DESC", GetSQLValueString($colname_ingsbte, "text"));
$ingsbte = mysql_query($query_ingsbte, $comercioexterior) or die(mysqli_error());
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Simple Instrucci&oacute;n Boleta de Garant&iacute;a </span></td>
    </tr>
    <tr>

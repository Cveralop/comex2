...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingvarios = sprintf("SELECT * FROM opcbe nolock WHERE nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname_ingvarios, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7"><span class="titulodetalle">Ingreso Simple Instrucci&oacute;n Cobranza Extranjera de Exportaci&oacute;n </span></span></td>
    </tr>
    <tr>
...
<form name="form2" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7"><span class="titulodetalle">Ingreso Simple Instrucciones Cobranza Extranjera de Exportaci&oacute;n </span></span></td>
    </tr>
    <tr>

...
$query_opporcliente = sprintf("SELECT * FROM opcbe nolock WHERE rut_cliente = %s and date_ingreso between %s and %s and evento LIKE %s and estado LIKE %s ORDER BY id DESC", GetSQLValueString($colname_opporcliente, "text"),GetSQLValueString($colname1_opporcliente, "date"),GetSQLValueString($colname2_opporcliente, "date"),GetSQLValueString("%" . $colname3_opporcliente . "%", "text"),GetSQLValueString("%" . $colname4_opporcliente . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5"><span class="titulodetalle">Operaciones por Cliente</span></span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle"><select name="evento" class="etiqueta12" id="evento">
        ...
        <option value="LIQ.RET.">Liquidacion Retorno</option>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opcbe.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image4" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="9" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Total de&nbsp;&nbsp;<span class="Estilo12"><?php echo $totalRows_opporcliente ?></span> Operaciones </span></td>
  </tr>
  <tr bgcolor="#999999">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_opporcliente['especialista_curse']); ?></td>
    <td align="center" valign="middle"><?php echo strtoupper($row_opporcliente['tipo_operacion']); ?></div></td>

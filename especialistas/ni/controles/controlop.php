...
$query_reparos = sprintf("SELECT * FROM opcci nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_reparos, "text"),GetSQLValueString($colname4_reparos, "date"),GetSQLValueString($colname5_reparos, "date"),GetSQLValueString("%" . $colname2_reparos . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_meco = sprintf("SELECT * FROM opmec nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_meco, "text"),GetSQLValueString($colname4_meco, "date"),GetSQLValueString($colname5_meco, "date"),GetSQLValueString("%" . $colname2_meco . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbi = sprintf("SELECT * FROM opcbi nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbi, "text"),GetSQLValueString($colname4_cbi, "date"),GetSQLValueString($colname5_cbi, "date"),GetSQLValueString("%" . $colname2_cbi . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cce = sprintf("SELECT * FROM opcce nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cce, "text"),GetSQLValueString($colname4_cce, "date"),GetSQLValueString($colname5_cce, "date"),GetSQLValueString("%" . $colname2_cce . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_pre = sprintf("SELECT * FROM oppre nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_pre, "text"),GetSQLValueString($colname4_pre, "date"),GetSQLValueString($colname5_pre, "date"),GetSQLValueString("%" . $colname2_pre . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbe = sprintf("SELECT * FROM opcbe nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbe, "text"),GetSQLValueString($colname4_cbe, "text"),GetSQLValueString($colname5_cbe, "date"),GetSQLValueString("%" . $colname2_cbe . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cdpa = sprintf("SELECT * FROM opcdpa nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cdpa, "text"),GetSQLValueString($colname4_cdpa, "date"),GetSQLValueString($colname5_cdpa, "date"),GetSQLValueString("%" . $colname2_cdpa . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ste = sprintf("SELECT * FROM opste nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_ste, "text"),GetSQLValueString($colname4_ste, "date"),GetSQLValueString($colname5_ste, "date"),GetSQLValueString("%" . $colname2_ste . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cex = sprintf("SELECT * FROM opcex nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cex, "text"),GetSQLValueString($colname4_cex, "date"),GetSQLValueString($colname5_cex, "date"),GetSQLValueString("%" . $colname2_cex . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_tbc = sprintf("SELECT * FROM optbc nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_tbc, "text"),GetSQLValueString($colname4_tbc, "date"),GetSQLValueString($colname5_tbc, "date"),GetSQLValueString("%" . $colname2_tbc . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_bga = sprintf("SELECT * FROM opbga nolock WHERE especialista_curse = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_bga, "text"),GetSQLValueString($colname4_bga, "date"),GetSQLValueString($colname5_bga, "date"),GetSQLValueString("%" . $colname2_bga . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_convenio = sprintf("SELECT * FROM convenioweb nolock WHERE especialista_curse = %s  and fecha_ingreso between %s and %s and estado LIKE %s ORDER BY id ASC", GetSQLValueString($colname_convenio, "text"),GetSQLValueString($colname4_convenio, "date"),GetSQLValueString($colname5_convenio, "date"),GetSQLValueString("%" . $colname2_convenio . "%", "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="controles_acb/controlop_acbei.php">&lt;&lt;Control Operaciones Asistentes Comerciales BEI &gt;&gt;</a> // <a href="../ni.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a>      </div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="left" bgcolor="#999999">
    <td colspan="18" align="left" valign="middle"><span class="Estilo10"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></span><span class="Estilo5">Total Operaciones Enviadas a Curse&nbsp;<span class="tituloverde"><?php echo $totalRows_meco ?></span> Mercado de Corredores</span></td>
  </tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><?php if ($row_meco['ok_curse'] <> 'No' and $row_meco['ok_curse'] <> 'N/A') { // Show if not first page ?>
        <span class="Verde2"><?php echo $row_meco['ok_curse']; ?> </span></span>        
		<?php } // Show if not first page ?>
		<?php if ($row_meco['ok_curse'] <> 'Si' and $row_meco['ok_curse'] <> 'N/A') { // Show if not first page ?>
        <span class="Rojo2"><?php echo $row_meco['ok_curse']; ?> </span></span>
    <?php } // Show if not first page ?>
    <?php if ($row_meco['ok_curse'] <> 'Si' and $row_meco['ok_curse'] <> 'No') { // Show if not first page ?>
        <span class="Gris2"><?php echo $row_meco['ok_curse']; ?> </span></span>
    <?php } // Show if not first page ?></td>

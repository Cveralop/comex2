...
if (isset($_SESSION['login'])) {
  $colname1_DetailRS1 = $_SESSION['login'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT oppre.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM oppre, usuarios WHERE oppre.id = %s and especialista_curse = %s and (oppre.especialista_curse = usuarios.usuario) ORDER BY oppre.id desc ", GetSQLValueString($colname_DetailRS1, "int"), GetSQLValueString($colname1_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><strong><?php echo $row_DetailRS1['date_espe']; ?></strong></td>
  </tr>
  <tr valign="middle">
    <td width="20%" align="right">Rut Cliente:</div></td>
    <td align="left"><strong><?php echo strtoupper($row_DetailRS1['rut_cliente']); ?></strong></td>
    <td align="right">Sucursal:</td>
    <td align="center"><strong><?php echo $row_DetailRS1['sucursal']; ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center"><strong><?php echo $row_DetailRS1['evento']; ?></strong></td>
    <td align="right">Tipo Operaci&oacute;n:</div></td>
    <td align="center"><strong><?php echo $row_DetailRS1['tipo_operacion']; ?></strong></div></td>
  </tr>
  <tr valign="middle">
    <td align="right">Moneda / Monto Operaci&oacute;n:</td>
    <td align="left"><strong><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></td>
    <td align="right">Vcto:</td>
    <td align="center"><strong><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['vcto']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Tipo Tasa:</td>
    <td colspan="3" align="left" class="Estilo12"><?php echo $row_DetailRS1['tipo_tasa']; ?></td>
  </tr>
  <tr valign="middle">
    <td align="right">Tasa Variable:</td>
    <td colspan="3" align="left"><span class="Estilo12">TT =</span> <span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['libor_tt']; ?></span> <span class="Estilo12">+</span> <span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['algo_tt']; ?></span> <span class="Estilo12">// Tasa Final =</span> <span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['libor_tf']; ?></span> <span class="Estilo12">+</span> <span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['algo_tf']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Tasa Fija:</td>
    <td colspan="3" align="left"><span class="Estilo12">TT <?php echo $row_DetailRS1['tt']; ?> // SPREAD <?php echo $row_DetailRS1['spread']; ?> // TASA FINAL <?php echo $row_DetailRS1['tasa_final']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Tipo Cambio:</td>
    <td align="center"><span class="Estilo12"><?php echo $row_DetailRS1['tipocambio']; ?></span></td>
    <td align="right">Fondos:</td>
    <td align="center"><span class="Estilo12">Origen <?php echo $row_DetailRS1['origen_fondos']; ?>// Destino <?php echo $row_DetailRS1['destino_fondos']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Nro Operaci&oacute;n:</td>
    <td colspan="3" align="left"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    <td align="right">Obsevaciones:</div></td>
    <td colspan="3" align="left"><strong><?php echo $row_DetailRS1['obs']; ?></strong></td>
  </tr>
  <tr valign="middle">
    ...
    <td align="center"><span class="Estilo12"><?php echo $row_DetailRS1['campana_comex']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right">Cr&eacute;dito en Cuotas</td>
    <td align="center" class="Estilo12"><?php echo $row_DetailRS1['cuotas']; ?></td>
    <td align="right">Nro Cuotas:</td>
    <td align="center" class="Estilo12"><?php echo $row_DetailRS1['nro_cuotas']; ?></td>
  </tr>
  <tr valign="middle">
    <td align="right">Mandato:</td>
    <td align="center" class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?></td>
    <td align="right">Periodisidad:</td>
    <td align="center" class="Estilo12"><?php echo $row_DetailRS1['periodisidad']; ?> D&iacute;as</td>
  </tr>
</table>
<p align="center"><br>
  <br>
  ...
  <br>
  <br>
  <span class="Estilo12"><?php echo $row_DetailRS1['ne']; ?></span><br>
_____________________________________<br> 
<strong>FIRMA ESPECIALISTA</strong>
</body>
</html>
<?php

...
$query_DetailRS1 = sprintf("SELECT * FROM opste nolock WHERE id = '%s'", $colname_DetailRS1);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET estado=%s, sub_estado=%s, estado_visacion=%s WHERE id=%s",
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">STAND BY EMITIDA </td>
  </tr>
</table>
<br>
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        
        <select name="estado" class="etiqueta12" id="estado">
            ...
            <option value="Dev. Ant. a Cliente.">Dev. Ant. a Cliente.</option>
        </select>
      </div></td>

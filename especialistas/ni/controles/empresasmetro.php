...
if (isset($_GET['fecha_ingreso'])) {
  $colname1_reparos = $_GET['fecha_ingreso'];
}
$colname2_reparos = "1";
...
$query_reparos = sprintf("SELECT * FROM opcci nolock WHERE territorial LIKE %s and fecha_ingreso LIKE %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString("%" . $colname_reparos . "%", "text"),GetSQLValueString("%" . $colname1_reparos . "%", "text"),GetSQLValueString("%" . $colname2_reparos . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_reparos = sprintf("SELECT * FROM opcci nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_reparos, "text"),GetSQLValueString($colname1_reparos, "date"),GetSQLValueString($colname3_reparos, "date"),GetSQLValueString("%" . $colname2_reparos . "%", "text"));
$reparos = mysqli_query($comercioexterior, $query_reparos) or die(mysqli_error($comercioexterior));
$row_reparos = mysqli_fetch_assoc($reparos);
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_meco = sprintf("SELECT * FROM opmec nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_meco, "text"),GetSQLValueString($colname1_meco, "date"),GetSQLValueString($colname3_meco, "date"),GetSQLValueString("%" . $colname2_meco . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbi = sprintf("SELECT * FROM opcbi nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbi, "text"),GetSQLValueString($colname1_cbi, "date"),GetSQLValueString($colname3_cbi, "date"),GetSQLValueString("%" . $colname2_cbi . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cce = sprintf("SELECT * FROM opcce nolcok WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cce, "text"),GetSQLValueString($colname1_cce, "date"),GetSQLValueString($colname3_cce, "date"),GetSQLValueString("%" . $colname2_cce . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_pre = sprintf("SELECT * FROM oppre nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_pre, "text"),GetSQLValueString($colname1_pre, "date"),GetSQLValueString($colname3_pre, "date"),GetSQLValueString("%" . $colname2_pre . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cbe = sprintf("SELECT * FROM opcbe nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cbe, "text"),GetSQLValueString($colname1_cbe, "date"),GetSQLValueString($colname3_cbe, "date"),GetSQLValueString("%" . $colname2_cbe . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cdpa = sprintf("SELECT * FROM opcdpa nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cdpa, "text"),GetSQLValueString($colname1_cdpa, "date"),GetSQLValueString($colname3_cdpa, "date"),GetSQLValueString("%" . $colname2_cdpa . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ste = sprintf("SELECT * FROM opste nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_ste, "text"),GetSQLValueString($colname1_ste, "date"),GetSQLValueString($colname3_ste, "date"),GetSQLValueString("%" . $colname2_ste . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cex = sprintf("SELECT * FROM opcex nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cex, "text"),GetSQLValueString($colname1_cex, "date"),GetSQLValueString($colname3_cex, "date"),GetSQLValueString("%" . $colname2_cex . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_tbc = sprintf("SELECT * FROM optbc nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_tbc, "text"),GetSQLValueString($colname1_tbc, "date"),GetSQLValueString($colname3_tbc, "date"),GetSQLValueString("%" . $colname2_tbc . "%", "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_bga = sprintf("SELECT * FROM opbga nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_bga, "text"),GetSQLValueString($colname1_bga, "date"),GetSQLValueString($colname3_bga, "date"),GetSQLValueString("%" . $colname2_bga . "%", "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">EMPRESAS METROPOLITANAS - CENTRO EMPRESAS</td>
  </tr>
</table>
<br>
  ...
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <select name="territorial" class="etiqueta12" id="territorial">
        <option value="N/A" selected>Seleccione una Territorial</option>
        <option value="Banca Empresas">Banca Empresas</option>
        <option value="Banca Empresas grp 2 (J.Martinez)">Banca Empresas grp 2 (J.Martinez)</option>
        <option value="Banca Empresas grp 3 (A. Leppes)">Banca Empresas grp 3 (A. Leppes)</option>
        <option value="Banca Empresas grp 4 (E. Rivera )">Banca Empresas grp 4 (E. Rivera )</option>
        <option value="Banca Empresas grp 5 (P.Gallardo)">Banca Empresas grp 5 (P.Gallardo)</option>
        <option value="Centro de Empresas Santiago Oriente">Centro de Empresas Santiago Oriente</option>
        <option value="Centro de Empresas Santiago Sur">Centro de Empresas Santiago Sur</option>
        <option value="Centro Empresas Cerrillos">Centro Empresas Cerrillos</option>
        <option value="Centro Empresas El Cortijo">Centro Empresas El Cortijo</option>
      </select>
      </span></td>
    </tr>
    <tr>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../ni.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><?php echo $row_cce['especilista_ni']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center"><?php if ($row_tbc['estado'] <> $row_colores['cursada'] and $row_tbc['estado'] <> $row_colores['pendiente'] and $row_tbc['estado'] <> $row_colores['solucionado'] and $row_tbc['estado'] <> $row_colores['preingresada'] and $row_tbc['estado'] <> $row_colores['eliminada']) { // Show if not first page ?>

...
$query_DetailRS1 = sprintf("SELECT optbc.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM optbc, usuarios WHERE optbc.id = %s and especialista_curse = %s and (optbc.especialista_curse = usuarios.usuario) ORDER BY optbc.id DESC", GetSQLValueString($colname_DetailRS1, "int"), GetSQLValueString($colname1_DetailRS1, "text"));

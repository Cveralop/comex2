...
$query_DetailRS1 = sprintf("SELECT opste.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opste, usuarios WHERE opste.id = %s and especialista_curse = %s and (opste.especialista_curse = usuarios.usuario) ORDER BY opste.id desc ", GetSQLValueString($colname_DetailRS1, "int"), GetSQLValueString($colname1_DetailRS1, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM fuerahorario_ni nolock WHERE depto = %s", GetSQLValueString($colname_fuerahorario, "int"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">STAND BY EMITIDAS</span></td>
  </tr>
  <tr>
...
<br>
  ...
  <table width="95%" border="0" align="center">
    <tr>
      <td><p><span class="Estilo12"><?php echo $row_DetailRS1['ne']; ?></span><br>
        _____________________________________</p></td>
    </tr>
    <tr>

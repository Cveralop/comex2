...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_cce = sprintf("SELECT * FROM opcce nolock WHERE territorial = %s and date_ingreso between %s and %s and estado LIKE %s ORDER BY date_espe ASC", GetSQLValueString($colname_cce, "text"),GetSQLValueString($colname1_cce, "date"),GetSQLValueString($colname3_cce, "date"),GetSQLValueString("%" . $colname2_cce . "%", "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">BANCA GRANDES EMPRESAS</td>
  </tr>
</table>
<br>
  ...
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <select name="territorial" class="etiqueta12" id="territorial">
        ...
        <option value="Banca Grandes Empresas grp 1 (R. Santiba&ntilde;ez)">Banca Grandes Empresas grp 1 (R. Santiba&ntilde;ez)</option>
        <option value="Banca Grandes Empresas grp 2 (P. Llanos)">Banca Grandes Empresas grp 2 (P. Llanos)</option>
        <option value="Banca Grandes Empresas grp 3 (E. Soto)">Banca Grandes Empresas grp 3 (E. Soto)</option>
        <option value="Banca Grandes Empresas grp 5 (S. Urrutia)">Banca Grandes Empresas grp 5 (S. Urrutia)</option>
      </select>
      </span></td>
    </tr>
    <tr>

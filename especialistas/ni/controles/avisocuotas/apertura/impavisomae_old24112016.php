...
$query_impaviso = sprintf("SELECT * FROM oppre nolock WHERE evento = %s and nro_operacion = %s and estado = %s", GetSQLValueString($colname_impaviso, "text"),GetSQLValueString($colname2_impaviso, "text"),GetSQLValueString($colname3_impaviso, "text"));
$impaviso = mysqli_query($comercioexterior, $query_limit_impaviso) or die(mysqli_error());
$row_impaviso = mysqli_fetch_assoc($impaviso);
$totalRows_impaviso = mysqli_num_rows($impaviso);
?>

...
$query_DetailRS1 = sprintf("SELECT opcdpa.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opcdpa, usuarios WHERE opcdpa.id = %s and especialista_curse = %s and (opcdpa.especialista_curse = usuarios.usuario) ORDER BY opcdpa.id desc ", GetSQLValueString($colname_DetailRS1, "int"), GetSQLValueString($colname1_DetailRS1, "text"));
$DetailRS1 = mysqli_query($comercioexterior, $query_DetailRS1) or die(mysqli_error($comercioexterior));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);
$totalRows_DetailRS1 = mysqli_num_rows($DetailRS1);

$colname_fuerahorario = "opcdpa";
if (isset($_GET['depto'])) {
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">CARTA DE CR&Eacute;DITO DE EXPORTACI&Oacute;N<br>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['nro_operacion']; ?></strong></div>
    ...
    <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['tipo_operacion']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"><span class="Estilo12"><?php echo $row_DetailRS1['especialista_curse']; ?></span></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Ejecutivo:</div></td>
    <td colspan="3" align="left" valign="middle"><strong><?php echo $row_DetailRS1['ejecutivo']; ?></strong></td>
  </tr>
  <tr>

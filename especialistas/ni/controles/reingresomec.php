...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opmec (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, obs, especialista, especialista_curse, ejecutivo, moneda_operacion, monto_operacion, valuta, despacho_doctos, sucursal, segmento, date_espe, estado_visacion, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",

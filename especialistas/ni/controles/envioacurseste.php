...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET fecha_ingreso=%s, date_ingreso=%s, estado=%s, obs=%s, sub_estado=%s, date_espe=%s, estado_visacion=%s WHERE id=%s",

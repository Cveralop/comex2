...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><strong><?php echo strtoupper($row_DetailRS1['id']); ?></strong></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><span class="NegrillaCartaReparo"><?php echo strtoupper($row_DetailRS1['ne']); ?></span></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['urgente']; ?></span></td>
    <td align="right">Mandato / Imp. Operar / Passport:</td>
    <td align="center"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></span></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="left" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['valuta']; ?></td>
...
<p align="center"><br>
  ...
  <br>
  <br>
  <span class="NegrillaCartaReparo"><?php echo strtoupper($row_DetailRS1['ne']); ?></span><br>

...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_enviocv = sprintf("SELECT enviocv.* FROM cliente INNER JOIN enviocv ON cliente.rut_cliente = enviocv.rut_cliente WHERE cliente.id = %s and (evento = %s or evento = %s) ORDER BY monto_operacion DESC", GetSQLValueString($colname2_enviocv, "text"),GetSQLValueString($colname_enviocv, "text"),GetSQLValueString($colname1_enviocv, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO enviocv (rut_cliente, nombre_cliente, evento, fecha_ingreso, moneda_operacion, monto_operacion) VALUES (%s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('monto_operacion','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulocolumnas"><span class="titulo_menu">Ingreso Simple Instrucci&oacute;n</div>
      </span></span></td>
    </tr>
    <tr valign="middle">
      <td width="17%" align="right">Nro Folio:</td>
    ...
    <tr valign="middle">
      ...
      <td width="18%" align="right">Fecha Ingreso:</div></td>
      <td width="24%">
...
<option value="Ventas." selected>Ventas</option>
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="compraventa" class="etiqueta12" id="compraventa">

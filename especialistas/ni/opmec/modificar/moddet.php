...
$query_DetailRS1 = sprintf("SELECT * FROM opmec nolock WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS2 = sprintf ("SELECT cliente.* FROM opmec INNER JOIN cliente ON opmec.rut_cliente = cliente.rut_cliente WHERE opmec.id = %s", GetSQLValueString($colname_DetailRS2, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opmec SET evento=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, valuta=%s, compraventa=%s, tipocambio=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s, campana_comex=%s, verifico_mandato=%s, hizo_llamada=%s WHERE id=%s",
...
No</label></td>
      ...
      <td align="center" valign="middle">
        <label>
          <input <?php if (!(strcmp($row_DetailRS1['campana_comex'],"Si"))) {echo "checked=\"checked\"";} ?> type="radio" name="campana_comex" value="Si" id="campana_comex_1">
          Si</label>
        <input <?php if (!(strcmp($row_DetailRS1['campana_comex'],"No"))) {echo "checked=\"checked\"";} ?> type="radio" name="campana_comex" value="No" id="campana_comex_0">
No<br>
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle">Se Verifico Mandato:</td>
      <td align="center" valign="middle"><select name="verifico_mandato" class="etiqueta12" id="verifico_mandato">
      ...
      <td align="right" valign="middle">Se Realizo Llamada:</td>
      <td align="center" valign="middle"><select name="hizo_llamada" class="etiqueta12" id="hizo_llamada">

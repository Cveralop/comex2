...
$query_DetailRS1 = sprintf("SELECT * FROM opmec nolock WHERE id = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opmec SET estado=%s, obs=%s, sub_estado=%s, estado_visacion=%s, date_espe=%s WHERE id=%s",

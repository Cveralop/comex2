...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td><a href="untitled.php?recordID=<?php echo $row_envioop['rut_cliente']; ?>"> <?php echo $row_envioop['rut_cliente']; ?>&nbsp; </a></td>
    ...
    <td align="right"><?php echo $row_envioop['estado']; ?></td>
...
/
  <input name="cliente_passport" type="text" class="respuestacolumna_rojo" id="cliente_passport" value="<?php echo $row_DetailRS1['cliente_passport']; ?>" size="3" maxlength="2"></td>
    ...
    <tr valign="middle">
      <td colspan="4" align="center"><input type="submit" class="boton" value="Ingresar Instrucci&oacute;n">        </div></td>
    </tr>
  </table>

...
$query_ingape = sprintf("SELECT * FROM opcci WHERE estado_visacion = %s and nro_operacion = %s ORDER BY id DESC", GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ANULAR INSTRUCCIONES - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Anular Instrucci&oacute;n  Carta de Cr&eacute;dito de Importaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="rojopequeno">K000000 o 0 si es una nueva operaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Ingresar Apertura 
      </div>
    </td>

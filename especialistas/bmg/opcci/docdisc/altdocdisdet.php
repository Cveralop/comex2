...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET tipo_negociacion=%s, date_supe=%s, forward=%s, nro_factura=%s WHERE id=%s",
  ...
  $updateGoTo = "../../../bmg/opcci/docdisc/ingdet.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><input name="nro_factura" type="text" class="etiqueta12" id="nro_factura" value="<?php echo $row_DetailRS1['nro_factura']; ?>" size="100" maxlength="100"></td>
    </tr>
    <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/docdisc/altdocdismae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html><?php

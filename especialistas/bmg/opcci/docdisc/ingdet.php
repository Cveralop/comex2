...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, nro_operacion, obs, especialista, especialista_curse, moneda_documentos, monto_documentos, convenio, date_preingreso, date_espe, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "../../../bmg/opcci/docdisc/impresionsimple.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">INGRESO ALZAMIENTO - DETALLE</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','fecha_ingreso','','R','nombre_cliente','','R','asignador','','R','especialista','','R','nro_operacion','','R','moneda_documentos','','R','monto_documentos','','RisNum');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Ingreso Alzamiento</span></td>
    </tr>
    <tr valign="middle">
...
Si</label>
<label><input name="urgente" type="radio" class="etiqueta12" value="No" checked>
  No</label>
      </td>
    </tr>
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><span id="sprytextarea1">
        <textarea name="obs" cols="85" rows="4" class="etiqueta12"><?php echo $row_DetailRS1['obs']; ?></textarea>
  ...
  <input name="mandato" type="hidden" id="mandato" value="<?php echo $row_DetailRS2['estado_mandato']; ?>">
</form>
<br>
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><span class="mayuscula"><span class="NegrillaCartaReparo">Si selecciona Volver no se grabara el registro de Alzamiento //</span></span> <a href="altdocdismae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a>      </div></td>
  </tr>
</table>

...
$MM_restrictGoTo = "../../../territorial/opcci/erroracceso.php";
...
$query_impavisoplapro = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s", GetSQLValueString($colname_impavisoplapro, "text"),GetSQLValueString($colname1_impavisoplapro, "text"));
$impavisoplapro = mysqli_query($comercioexterior, $query_impavisoplapro) or die(mysqli_error($comercioexterior));
...
<table width="95%" border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opcci.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen4','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen4" width="80" height="25" border="0" id="Imagen4" /></a></td>
  </tr>
</table>
<br />

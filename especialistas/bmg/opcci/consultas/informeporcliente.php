...
$query_opporcliente = sprintf("SELECT * FROM opcci WHERE rut_cliente = %s and fecha_curse LIKE %s and evento LIKE %s and estado LIKE %s ORDER BY id ASC", GetSQLValueString($colname_opporcliente, "text"),GetSQLValueString("%" . $colname1_opporcliente . "%", "text"),GetSQLValueString("%" . $colname2_opporcliente . "%", "text"),GetSQLValueString("%" . $colname3_opporcliente . "%", "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">OPERACIONES POR CLIENTE </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td width="83%" align="left"><input name="rut_cliente" type="text" class="etiqueta12" id="rut_cliente" size="17" maxlength="15">
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="13" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Total de&nbsp;&nbsp;<span class="tituloverde"><?php echo $totalRows_opporcliente ?></span> Operaciones</span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulodetalle"><span class="titulocolumnas">Numero Operaci&oacute;n </div>
    </span></td>
    ...
    <td align="center" class="titulocolumnas">Referencia Cliente</td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo strtoupper($row_opporcliente['especialista']); ?></td>
    <td align="right"><span class="Estilo8"><?php echo strtoupper($row_opporcliente['moneda_operacion']); ?> <span class="Estilo9"><?php echo number_format($row_opporcliente['monto_operacion'], 2, ',', '.'); ?></span></span></div></td>
    <td align="right"><span class="Estilo8"><?php echo strtoupper($row_opporcliente['moneda_documentos']);  ?></span> <strong><?php echo number_format($row_opporcliente['monto_documentos'], 2, ',', '.');  ?></strong></div></td>
    <td align="center"><?php echo strtoupper($row_opporcliente['pais']); ?></div></td>
    <td align="left"><?php echo strtoupper($row_opporcliente['banco_destino']); ?></td>
    <td align="center"><?php echo strtoupper($row_opporcliente['ref_cliente']); ?></td>

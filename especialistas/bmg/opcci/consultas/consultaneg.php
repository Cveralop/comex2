...
if (isset($_GET['nro_operacion'])) {
  $colname_conrut = $_GET['nro_operacion'];
}
$colname2_conrut = "Cursada.";
if (isset($_GET['estado'])) {
  $colname2_conrut = $_GET['estado'];
}
$colname1_conrut = "Negociacion.";
if (isset($_GET['evento'])) {
  $colname1_conrut = $_GET['evento'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_conrut = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s and estado = %s ORDER BY id DESC", GetSQLValueString($colname_conrut, "text"),GetSQLValueString($colname1_conrut, "text"),GetSQLValueString($colname2_conrut, "text"));
$conrut = mysqli_query($comercioexterior, $query_conrut) or die(mysqli_error($comercioexterior));
...
<title>Consulta Negociaciones CCI - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">CONSULTAS NEGOCIACIONES - MAESTRO</td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><span class="Estilo5"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="Estilo5">Consulta  Operaciones Negociadas</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/opcci.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="10" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="Estilo5">Total de <span class="tituloverde"><?php echo $totalRows_conrut ?><span class="Estilo12"> Operaciones</span></span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
    <td class="titulocolumnas">Rut Cliente </div></td>
    ...
    <td class="titulocolumnas">Estado
      </div>
    </td>
    <td class="titulocolumnas">Fecha Curse 
      </div>
    </td>
    <td class="titulocolumnas">Nro Operaci&oacute;n </div>
    </td>
    <td class="titulocolumnas">Moneda / Monto Apertura 
      </div>
    </td>
    <td class="titulocolumnas">Noneda / Monto Negociaci&oacute;n </div>
    </td>
    <td class="titulocolumnas">Tipo Negociaci&oacute;n </div>
    </td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_conrut['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_conrut['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>

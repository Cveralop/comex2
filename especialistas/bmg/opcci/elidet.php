...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET estado=%s, obs=%s, sub_estado=%s, date_espe=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci WHERE id = $recordID",$colname_DetailRS1); //$colname_ingape
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"> <span class="titulodetalle">Anular  Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center">                <input name="evento" type="text" class="etiqueta12" id="evento" value="<?php echo $row_DetailRS1['evento']; ?>" size="20" maxlength="20" readonly="readonly">
      </div></td>
  ...
  Si</label>
          <label>
          <input <?php if (!(strcmp($row_DetailRS1['urgente'],"No"))) {echo "CHECKED";} ?> name="urgente" type="radio" class="etiqueta12" value="No" checked>
    No</label>
      </td>
    </tr>
    <tr valign="middle">
...
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {minChars:0, maxChars:255, validateOn:["blur"], isRequired:false, counterType:"chars_remaining", counterId:"countsprytextarea1"});

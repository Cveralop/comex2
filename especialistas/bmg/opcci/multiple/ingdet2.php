...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">INGRESO SIMPLE INSTRUCCION - DETALLE </td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  ...
  Si</label>
    ...
    <tr valign="middle">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span></span><span id="sprytextfield1"><span class="textfieldRequiredMsg">be Colocar su Usuario (Se Recomienda Ingresar Nuevamente al Sistema).</span></span>        </div></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/multiple/ingmae_m.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

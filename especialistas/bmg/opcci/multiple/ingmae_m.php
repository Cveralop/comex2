...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_nrooperacion = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and evento = %s", GetSQLValueString($colname_nrooperacion, "text"),GetSQLValueString($colname1_nrooperacion, "text"));
...
$queryString_ingvarios = sprintf("&totalRows_ingvarios=%d%s",$totalRows_nrooperacion, $queryString_ingvarios); //$totalRows_ingvarios
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/opcci/multiple/ingdet_m.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
    <tr valign="middle">
      <td align="center"><a href="../../../bmg/opcci/multiple/ingdet2.php?recordID=<?php echo $row_nrooperacion['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>

...
$query_DetailRS1 = sprintf("SELECT opcci.*,(usuarios.nombre)as ne FROM opcci, usuarios WHERE especialista_curse = %s and (opcci.especialista_curse = usuarios.usuario) ORDER BY opcci.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  ...
  <tr>
    <td colspan="2" valign="middle"><?php if ($row_DetailRS1['especialista'] > $row_fuerahorario['fuera_horario']) { // Show if not first page ?>
      <span class="FueraHorario">Operaci&oacute;n Ingresada FUERA DE HORARIO </span>
    <?php } // Show if not first page ?></td>
  </tr>
  <tr>
    <td colspan="2" valign="middle"><?php if ($row_excepciones['plazo'] >= 0) { // Show if not first page ?>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/simple/ingmae.php"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['tipo_operacion']; ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left" valign="middle"><span class="Estilo12">Origen <?php echo $row_DetailRS1['origen_fondos']; ?></span></td>
  </tr>
  <tr valign="middle">
    <td align="right" valign="middle">Nro Operaci&oacute;n:</td>
    <td align="center" valign="middle"><strong><?php echo strtoupper($row_DetailRS1['nro_operacion']); ?></strong></td>
    <td align="right" valign="middle">Nro Operacion Relacionada:</td>
    <td align="center" valign="middle" class="Estilo12"><?php echo strtoupper($row_DetailRS1['nro_operacion_relacionada']); ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle" class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?></td>
  </tr>
</table>
<br>
<p align="center"><br>

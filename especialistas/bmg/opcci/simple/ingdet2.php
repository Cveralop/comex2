...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, nro_operacion, obs, especialista_curse, moneda_operacion, monto_operacion, date_preingreso, date_espe, estado_visacion, mandato, urgente, nro_factura) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcci WHERE id = $recordID",$colname_DetailRS1,$colname1_DetailRS1); //$colname_ingvarios,$colname1_ingvarios
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="subtitulopaguina">Ingresar Simple Instrucci&oacute;n</span>        </div></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <span class="rojopequeno" id="countsprytextarea2">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></span><span class="rojopequeno" id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacute;mero m&aacute;ximo de caracteres.</span></td>
    </tr>
    <tr valign="middle">
  ...
  Si</label>
    ...
    <tr valign="middle">
      ...
      <td align="center"></div>
        ...
        <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span></span><span id="sprytextfield1"><span id="sprytextfield2"><span class="textfieldRequiredMsg">car su Usuario (Se Recomienda Ingresar Nuevamente al Sistema).</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span>
        </div>
      </span>        </div></td>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><input name="nro_factura" type="text" class="etiqueta12" id="nro_factura" value="<?php echo $row_DetailRS1['nro_factura']; ?>" size="80" maxlength="80"></td>
    </tr>
    <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/simple/ingmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<script type="text/javascript">
<!--
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {validateOn:["blur"], isRequired:false, minChars:0, maxChars:255, counterId:"countsprytextarea1", counterType:"chars_remaining"});

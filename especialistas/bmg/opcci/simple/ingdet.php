...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, obs, especialista_curse, moneda_operacion, monto_operacion, date_preingreso, date_espe, estado_visacion, mandato, ref_cliente, urgente, via_web) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['ref_cliente'], "text"),
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT rut_cliente,nombre_cliente FROM opcci WHERE rut_cliente = '%s'", $colname_DetailRS1);
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="subtitulopaguina">Ingreso Simple Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield1">
        ...
        <span id="sprytextfield2"><span id="sprytextfield3"><span class="textfieldRequiredMsg">Si este campo esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span></span></span></span></td>
    </tr>
    <tr valign="middle">
      ...
      <span class="rojopequeno" id="countsprytextarea1">&nbsp;</span><span class="textareaMaxCharsMsg">Se ha superado el n&uacutemero m&aacute;ximo de caracteres.</span></span></td>
    </tr>
    <tr valign="middle">
  ...
  Si</label>
    ...
    <tr valign="middle">
      ...
      <td colspan="3" align="left"><input name="ref_cliente" type="text" class="etiqueta12" id="ref_cliente" value="Sin Dato." size="50" maxlength="50"></td>
    </tr>
    <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/simple/ingmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<script type="text/javascript">
<!--
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {isRequired:false, minChars:0, maxChars:255, counterId:"countsprytextarea1", counterType:"chars_remaining", validateOn:["blur"]});

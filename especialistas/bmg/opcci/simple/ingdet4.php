...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (id, rut_cliente, nombre_cliente, ejecutivo_cuenta, ejecutivo_ni, especialista_ni, nombre_oficina, fecha_ingreso, date_ingreso, evento, nro_operacion, nro_operacion_relacionada, obs, especialista_curse, territorial, moneda_operacion, monto_operacion, origen_fondos, tipo_operacion, tipocambio, date_preingreso, date_espe, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM carteraopera nolock WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
<title>Ingreso Simple Instrucción - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1" onsubmit="MM_validateForm('nro_operacion','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="6" align="left"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0" /><span class="titulodetalle">Ingresar Simple Instrucci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
      ...
      <td colspan="3" align="center"><input name="fecha_ingreso" type="text" class="etiqueta12" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10" />
        <span class="rojopequeno">(dd-mm-aaaa) </span>
        </div></td>
    </tr>
    <tr valign="middle">
      <td align="right">Nombre Cliente:</td>
      <td colspan="5" align="left"><input name="nombre_cliente" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['nombre_cliente']; ?>" size="122" maxlength="120" readonly="readonly" /></td>
    </tr>
    <tr valign="middle">
...
<option value="Cambio Tasa.">Cambio Tasa</option>
      ...
      <td colspan="3" align="center"><input name="nro_operacion" type="text" class="etiqueta12" id="nro_operacion" value="<?php echo $row_DetailRS1['nro_operacion_relacionada_car']; ?>" size="15" maxlength="7" />
    ...
    <tr valign="middle">
      ...
      <td align="center"><select name="moneda_operacion" class="etiqueta12" id="moneda_operacion">
        ...
        <input name="monto_operacion" type="text" class="etiqueta12" value="<?php echo $row_DetailRS1['saldo_operacion'] / 100; ?>" size="20" maxlength="20" />
        </div></td>
      <td align="right">Urgente:
        </div></td>
      <td align="center">
        <label>
      ...
      <td align="right">Tipo Operaci&oacute;n:
        </div></td>
    ...
    <tr valign="middle">
      ...
      <td align="right">Tipo Cambio:
        </div></td>
      <td align="center"><input name="tipocambio" type="text" class="etiqueta12" id="tipocambio" value="0.00" size="10" maxlength="10" />
        </div></td>
    ...
    <tr valign="middle">
      ...
      <td colspan="5" align="left"><label> <strong>
        <input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS2['estado_mandato']; ?>" size="30" maxlength="25" readonly="readonly" />
         ...
         / 
      <input name="cliente_passport" type="text" class="respuestacolumna_rojo" id="cliente_passport" value="<?php echo $row_DetailRS2['cliente_passport']; ?>" size="3" maxlength="2" />         <br /></td>
    </tr>
    <tr valign="middle">
      <td colspan="6" align="center"><input type="submit" class="boton" value="Ingresar Instrucción" />
        </div></td>
    </tr>
  </table>
  ...
  <input name="vcto" type="hidden" id="vcto" value="<?php echo $row_DetailRS1['fecha_vcto']; ?>" />
  <input name="territorial" type="hidden" class="etiqueta12" id="territorial" value="<?php echo $row_DetailRS2['territorial']; ?>" size="30" maxlength="50" readonly="readonly" />

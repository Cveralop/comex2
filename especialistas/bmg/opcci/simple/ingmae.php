...
<form name="form4" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td width="79%" align="left" bgcolor="#CCCCCC"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="15" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td align="center" class="titulocolumnas">Ingresar Apertura</td>
    <td align="center" class="titulocolumnas">Rut Cliente</td>
    <td align="center" class="titulocolumnas">Nombre Cliente</td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/opcci/simple/ingdet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
...
<?php if ($totalRows_ingcci > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td align="center" class="titulocolumnas">Ingresar Instrucci&oacute;n </td>
      <td align="center" class="titulocolumnas">Nro Operaci&oacute;n</td>
      <td align="center" class="titulocolumnas">Nro Operaci&oacute;n Relacionada</td>
      <td align="center" class="titulocolumnas">Rut Cliente</td>
      <td align="center" class="titulocolumnas">Nombre Cliente</td>
      <td align="center" class="titulocolumnas">Fecha Vencimiento</td>
      <td align="center" class="titulocolumnas">Moneda / Saldo Operaci&oacute;n</td>
    </tr>
    <?php do { ?>
    <tr valign="middle">
      <td align="center"><a href="ingdet3.php?recordID=<?php echo $row_ingcci['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" alt="" width="20" height="20" border="0"></a></td>
      <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingcci['nro_operacion_relacionada_car']); ?></span></td>
      <td align="center"><?php echo strtoupper($row_ingcci['nro_operacion_car']); ?></td>
      <td align="center"><?php echo strtoupper($row_ingcci['rut_cliente']); ?></td>
      <td align="left"><?php echo $row_ingcci['nombre_cliente']; ?></td>
      <td align="center"><?php echo $row_ingcci['fecha_vcto']; ?></td>
      <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingcci['moneda_operacion']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_ingcci['saldo_operacion'], 2, ',', '.'); ?></strong></td>
    </tr>

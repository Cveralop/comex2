...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET date_rec_doc_val=%s, estado_doc=%s, recibido_por=%s, nro_factura=%s WHERE id=%s",
  ...
  $updateGoTo = "../../../bmg/opcci/docvalo/acuresmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Acuse Recibo Valorados - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">ACUSE RECIBO  VALORADOS - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      Monto Documentos:</td>
      <td align="right"><span class="Estilo9"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong> </td>
    ...
    <tr valign="middle">
      ...
      <td align="center"><input name="text" type="text" class="etiqueta12" id="text" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield1">
        <input name="recibido_por" type="text" class="etiqueta12" id="recibido_por" value="<?php echo $_SESSION['login'];?>" size="32">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opcci/docvalo/acuresmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></td>
  </tr>
</table>

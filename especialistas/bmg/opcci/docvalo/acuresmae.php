...
$query_entdoc = sprintf("SELECT * FROM opcci WHERE nro_operacion = %s and estado_doc = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_entdoc, "text"),GetSQLValueString($colname1_entdoc, "text"),GetSQLValueString($colname2_entdoc, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/opcci/docvalo/acuresdet.php?recordID=<?php echo $row_entdoc['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></td>

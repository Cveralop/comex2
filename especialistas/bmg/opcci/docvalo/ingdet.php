...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET date_ent_doc_val=%s, estado_doc=%s, entregado_por=%s, nro_factura=%s WHERE id=%s",
  ...
  $updateGoTo = "../../../bmg/opcci/docvalo/ingmae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DetailRS1 = sprintf("SELECT * FROM opcci  WHERE id = $recordID",$colname_DetailRS1,$colname1_DetailRS1,$colname2_DetailRS1); //$colname_entdoc,$colname1_entdoc,$colname2_entdoc
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">DOCUMENTOS VALORADOS - DETALLE</td>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      Monto Documentos:</td>
      <td align="center"><span class="Estilo9"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong> </td>
      <td align="right">Tipo Negociaci&oacute;n:</td>
      <td align="center"><?php echo $row_DetailRS1['tipo_negociacion']; ?></td>
    </tr>
    <tr valign="middle">
      <td align="right">Nro Negociaci&oacute;n:</td>
      <td align="center"><?php echo $row_DetailRS1['numero_neg']; ?></td>
      <td align="right">Fecha Negociaci&oacute;n: </td>
      <td align="center"><?php echo $row_DetailRS1['fecha_neg']; ?></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center"><input name="text" type="text" disabled="disabled" class="etiqueta12" id="text" value="<?php echo date("d-m-Y"); ?>" size="12" maxlength="10">
        <span class="rojopequeno">(dd-mm-aaaa)
        <input name="date_ent_doc_val" type="hidden" class="etiqueta12" id="date_ent_doc_val" value="<?php echo date("Y-m-d H:i:s"); ?>" size="12" maxlength="10">
      </span></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield1">
        <input name="entregado_por" type="text" class="etiqueta12" value="<?php echo $_SESSION['login'];?>" size="32">
        <span class="textfieldRequiredMsg">Debe Colocar su Usuario (Se Recomienda Ingresar Nuevamente al Sistema).</span></span></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right"><a href="../../../bmg/opcci/docvalo/ingmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></td>
  </tr>
</table>

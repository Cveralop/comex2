...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, moneda_operacion, monto_operacion, sub_estado, date_preingreso, estado_visacion, mandato, ref_cliente, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
//var_dump($colname_DetailRS1); die();
?>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="subtitulopaguina">Pre-Ingreso Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="center"><span id="sprytextfield1">
        ...
        <span id="sprytextfield2"><span id="sprytextfield3"><span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span><span class="textfieldInvalidFormatMsg"> no v&aacute;lido.</span></span>
        </div>
        </span>
        </div>
      </span>        </div></td>
  ...
  Si</label>
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS1['estado_mandato']; ?>" size="30" maxlength="25" readonly="readonly"></td>
      <td align="right">Ref. Cliente:</td>
      <td align="center"><input name="ref_cliente" type="text" class="etiqueta12" id="ref_cliente" value="Sin Dato." size="50" maxlength="50"></td>
    </tr>
    <tr valign="middle">

...
$query_ingape = sprintf("SELECT * FROM cliente WHERE rut_cliente LIKE %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_ingape . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucci&oacute;n Apertura Carta de Cr&eacute;dito de Importaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<form name="form2" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucciones  Carta de Cr&eacute;dito de Importaci&oacute;n</span></td>
    </tr>
    <tr valign="middle">
...
<form name="form3" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucciones Pr&eacute;stamos (CCI)</span></td>
    </tr>
    <tr valign="middle">
      <td width="21%" align="right">Nro Operaci&oacute;n:
        </div></td>
      <td width="79%" align="left"><input name="nro_operacion_relacionada_car" type="text" class="etiqueta12" id="nro_operacion_relacionada_car" size="15" maxlength="7">
        <span class="rojopequeno">K000000</span></td>
    </tr>
    <tr valign="middle">
...
<form name="form4" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" bgcolor="#999999"><img src="../../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucciones Pr&eacute;stamos (CCI)</span></td>
    </tr>
    <tr>
      <td width="21%" align="right">Nro Operaci&oacute;n Relacionada:</td>
      <td width="79%" align="left"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="15" maxlength="7">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/opcci/preingreso/ingdet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/opcci/preingreso/ingdet2.php?recordID=<?php echo $row_ingvarios['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    ...
    <td align="center" class="titulocolumnas">Nro Operaci&oacute;n Relacionada</td>
    <td align="center" class="titulocolumnas">Rut Cliente
      </div></td>
    <td align="center" class="titulocolumnas">Nombre Cliente
      </div></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="ingdet3.php?recordID=<?php echo $row_opcci['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a>
      </div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_opcci['nro_operacion_relacionada_car']); ?></span>
      </div></td>
    ...
    <td align="right"><?php echo strtoupper($row_opcci['fecha_vcto']); ?></td>
    <td align="right"><span class="Estilo12"><?php echo strtoupper($row_opcci['moneda_operacion']); ?></span> <strong><?php echo number_format($row_opcci['saldo_operacion'], 2, ',', '.'); ?></strong>
      </div></td>
  </tr>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_opcci < $totalPages_opcci) { // Show if not last page ?>
      <a href="<?php printf("%s?pageNum_opcci=%d%s", $currentPage, $totalPages_opcci, $queryString_opcci); ?>">&Uacute;ltimo</a>
      <?php } // Show if not last page ?></td>
  </tr>
</table>
<br>
Registros del <strong><?php echo ($startRow_opcci + 1) ?></strong> al <strong><?php echo min($startRow_opcci + $maxRows_opcci, $totalRows_opcci) ?></strong> de un total de <strong><?php echo $totalRows_opcci ?></strong> <br>
<?php } // Show if recordset not empty ?>
<br>
...
<table width="95%" border="1"  align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Nro Operaci&oacute;n Relacionada</td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Moneda / Saldo Operaci&oacute;n</td>
  </tr>
  <?php do { ?>
  <tr>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_inglci['moneda_operacion']; ?></span><span class="respuestacolumna_azul"><?php echo number_format($row_inglci['saldo_operacion'], 2, ',', '.'); ?></span></td>
  </tr>

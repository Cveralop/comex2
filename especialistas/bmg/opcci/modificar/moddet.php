...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcci SET evento=%s, nro_operacion=%s, nro_operacion_relacionada=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s, campana_comex=%s, via_web=%s, ref_cliente=%s, nro_factura=%s WHERE id=%s",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcci WHERE id = $recordID",$colname_DetailRS1, $colname3_DetailRS1, $colname2_DetailRS1, $colname1_DetailRS1); //$colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion
...
No<br>
    ...
    <tr valign="middle">
      ...
      <td align="center">
        <input name="mandato" type="text" class="etiqueta12" id="mandato" value="<?php echo $row_DetailRS2['estado_mandato']; ?>" size="30" maxlength="25" readonly="readonly"></td>
      <td align="right">Ref. Cliente:</td>
      <td align="center"><input name="ref_cliente" type="text" class="etiqueta12" id="ref_cliente" value="<?php echo $row_DetailRS1['ref_cliente']; ?>" size="50" maxlength="50"></td>
    </tr>
    <tr valign="middle">

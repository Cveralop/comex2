...
if (isset($_GET['rut_cliente'])) {
  $colname2_impresion = $_GET['rut_cliente'];
}
$colname3_impresion = "1";
if (isset($_GET['evento'])) {
  $colname3_impresion = $_GET['evento'];
}
$colname_impresion = "1";
...
$query_impresion = sprintf("SELECT *, time(date_espe)as esp FROM opcci WHERE especialista_curse = %s and fecha_ingreso = %s and rut_cliente LIKE %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_impresion, "text"),GetSQLValueString($colname1_impresion, "text"),GetSQLValueString("%" . $colname2_impresion . "%", "text"),GetSQLValueString($colname3_impresion, "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr valign="middle">
      ...
      <td width="79%" align="left"><input name="especialista_curse" type="text" disabled="disabled" class="etiqueta12" id="especialista_curse" value="<?php echo $_SESSION['login'];?>" size="20" maxlength="20">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle" bgcolor="#999999">
    ...
    <td class="titulocolumnas">Moneda / Monto Operaci&oacute;n</td>
    <td class="titulocolumnas">Moneda / Monto Negociaci&oacute;n</td>
    <td class="titulocolumnas">Urgente</td>
  </tr>
  <?php do { ?>
  <tr valign="middle">
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"> <?php echo number_format($row_impresion['monto_documentos'], 2, ',', '.'); ?></strong></div>      </div></td>
  ...
  <tr valign="middle">
    ...
    <td align="right" bgcolor="#999999" class="titulocolumnas">Mandato:</td>
    <td colspan="2" align="center"><?php echo $row_impresion['mandato']; ?></td>
    </tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, nro_operacion, obs, especialista_curse, moneda_operacion, monto_operacion, tipo_operacion, date_preingreso, date_espe, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$recordID = $_GET['recordID'];
$query_DetailRS1 = sprintf("SELECT * FROM opcbi  WHERE id = $recordID", $colname_DetailRS1,$colname1_DetailRS1); //, $colname_ingvarios,$colname1_ingvarios
    ...
    <tr valign="baseline">
      ...
      <td align="center" valign="middle">        
        <select name="evento" class="etiqueta12" id="evento">
          ...
          <option value="Dev Comisiones.">Dev Comsiones</option>
        </select>
      </div></td>

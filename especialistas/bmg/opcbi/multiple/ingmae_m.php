...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_nrooperacion = sprintf("SELECT * FROM opcbi WHERE nro_operacion = %s", GetSQLValueString($colname_nrooperacion, "text"));
...
$queryString_ingvarios = sprintf("&totalRows_ingvarios=%d%s", $totalRows_nrooperacion, $queryString_ingvarios);
?>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Multiple Instrucci&oacute;n Cobranza de Importaci&oacute;n y OPI </span></td>
    </tr>
    <tr>
...
<form name="form2" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Ingreso Multiple Instrucciones Cobranza de Importaci&oacute;n y OPI</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Ingreso Operaciones </span>      </div></td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_nrooperacion['nro_operacion']); ?></span>        </div></td>

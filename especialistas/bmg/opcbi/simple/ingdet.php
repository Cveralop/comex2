...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbi (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, obs, especialista_curse, moneda_operacion, monto_operacion, tipo_operacion, date_preingreso, date_espe, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",

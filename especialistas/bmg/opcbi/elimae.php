...
$query_ingape = sprintf("SELECT * FROM opcbi WHERE rut_cliente LIKE %s and estado_visacion = %s and nro_operacion LIKE %s ORDER BY rut_cliente ASC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString($colname1_ingape, "text"),GetSQLValueString($colname2_ingape . "%", "text"));
...
$queryString_ingvarios = sprintf("&totalRows_ingvarios=%d%s",$totalRows_ingape ,$queryString_ingvarios); //$totalRows_ingvarios
?>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Anular Instrucci&oacute;n Cobranza de Importaci&oacute;n y OPI </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingape['nro_operacion']); ?></span></td>

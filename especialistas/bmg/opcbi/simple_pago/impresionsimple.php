...
$query_DetailRS1 = sprintf("SELECT opcbi.*,(usuarios.nombre)as ne FROM opcbi, usuarios WHERE especialista_curse = %s and (opcbi.especialista_curse = usuarios.usuario) ORDER BY opcbi.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle"><span class="Estilo9">COBRANZA EXTRANJERA DE IMPORTACION y OPI </span></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center" valign="middle"><?php if ($row_excepciones['dias'] > 0) { // Show if not first page ?>

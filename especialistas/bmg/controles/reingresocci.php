...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcci (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, nro_operacion, obs, especialista, especialista_curse, ejecutivo, moneda_operacion, monto_operacion, moneda_documentos, monto_documentos, despacho_doctos, sucursal, segmento, date_espe, estado_visacion, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  ...
  Si</label>
    ...
    No</label>
      ...
      <td align="center" valign="middle">
        <input name="moneda_documentos" type="text" class="etiqueta12" id="moneda_documentos" value="<?php echo $row_DetailRS1['moneda_documentos']; ?>" size="5" maxlength="3">
          <span class="rojopequeno">/</span>
          <input name="monto_documentos" type="text" class="etiqueta12" id="monto_documentos" value="<?php echo $row_DetailRS1['monto_documentos']; ?>" size="17" maxlength="15">
      </div></td>
    </tr>
    <tr valign="baseline">

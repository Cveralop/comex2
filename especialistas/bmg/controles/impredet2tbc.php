...
$colname_fuerahorario = "optbc";
if (isset($_GET['depto'])) {
  $colname_fuerahorario = $_GET['depto'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_fuerahorario = sprintf("SELECT * FROM fuerahorario_ni WHERE depto = %s", GetSQLValueString($colname_fuerahorario, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_excepciones = sprintf("SELECT * FROM excepciones WHERE especialista_curse = %s and excepcion = %s and estado_excepcion = %s and estado = %s ORDER BY especialista_curse DESC", GetSQLValueString($colname_excepciones, "text"),GetSQLValueString($colname1_excepciones, "text"),GetSQLValueString($colname2_excepciones, "text"),GetSQLValueString($colname3_excepciones, "text"));
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT optbc.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM optbc, usuarios WHERE especialista_curse = %s and (optbc.especialista_curse = usuarios.usuario) ORDER BY optbc.id desc ", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['rut_cliente']; ?></strong></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Nombre Cliente:</div></td>
    <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['nombre_cliente']; ?></strong></td>
  </tr>
  <tr>
  ...
  <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['nro_operacion']; ?></strong></div>
        </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['ne']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><strong><?php echo $row_DetailRS1['moneda_operacion']; ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></td>
  </tr>
  <tr>
    <td align="right" valign="middle">Urgente:</div></td>
    <td align="left" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['urgente']; ?></td>
  </tr>
</table>
<br>
  <br>
  ...
  <table width="95%" border="0" align="center">
    <tr>
      <td><span class="centrado"><span class="Estilo12"><?php echo $row_DetailRS1['ne']; ?></span><br>
      _____________________________________</span></td>
    </tr>
    <tr>

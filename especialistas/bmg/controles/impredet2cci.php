...
$fuerahorario = mysqli_query($comercioexterior, $query_limit_fuerahorario) or die(mysqli_error($comercioexterior));
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><strong><?php echo $row_DetailRS1['moneda_operacion']; ?>&nbsp;<?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></td>
    <td align="right" valign="middle">Moneda / Monto Documento:</div></td>
    <td align="center" valign="middle"><strong><?php echo $row_DetailRS1['moneda_documentos']; ?></strong>&nbsp; <strong><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong></div></td>
  </tr>
  <tr>

...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opcce SET estado=%s, sub_estado=%s, estado_visacion=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opcce  WHERE id = $recordID and estado = 'Reparada.'", $colname_reparos);
$DetailRS1 = mysqli_query($comercioexterior, $query_DetailRS1) or die(mysqli_error($comercioexterior));
$row_DetailRS1 = mysqli_fetch_assoc($DetailRS1);
$totalRows_DetailRS1 = mysqli_num_rows($DetailRS1);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle" nowrap><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"><span class="titulodetalle">Soluci&oacute;n Reparo o Devoluci&oacute;n Instrucci&oacute;n Cliente </div>
      </span></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle" nowrap>Especialista Cartera:</td>
      <td align="center" valign="middle">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle" nowrap>Ejecutivo:</td>
      <td align="center" valign="middle">
    ...
    <tr valign="baseline">
      <td align="right" valign="middle" nowrap>Detalle Reparo:</td>
    ...
    <tr valign="baseline">
      <td align="right" valign="middle" nowrap>Estado Reparo:</td>
      <td align="center" valign="middle">        
...
var sprytextarea2 = new Spry.Widget.ValidationTextarea("sprytextarea2", {minChars:0, maxChars:450, isRequired:false, validateOn:["blur"], counterId:"countsprytextarea2", counterType:"chars_remaining"});
//-->
</script>
</body>
</html><?php

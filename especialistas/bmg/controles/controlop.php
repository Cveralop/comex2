...
$maxRows_convenioweb = 10;
$pageNum_convenioweb = 0;
if (isset($_GET['pageNum_convenioweb'])) {
  $pageNum_convenioweb = $_GET['pageNum_convenioweb'];
}
$startRow_convenioweb = $pageNum_convenioweb * $maxRows_convenioweb;

$colname_convenioweb = "-1";
if (isset($_GET['especialista_curse'])) {
  $colname_convenioweb = $_GET['especialista_curse'];
}
$colname4_convenioweb = "-1";
if (isset($_GET['date_ini'])) {
  $colname4_convenioweb = $_GET['date_ini'];
}
$colname5_convenioweb = "-1";
if (isset($_GET['date_fin'])) {
  $colname5_convenioweb = $_GET['date_fin'];
}
$colname2_convenioweb = "-1";
if (isset($_GET['estado'])) {
  $colname2_convenioweb = $_GET['estado'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_convenioweb = sprintf("SELECT * FROM convenioweb WHERE especialista_curse = %s  and fecha_ingreso between %s and %s and estado LIKE %s ORDER BY id ASC", GetSQLValueString($colname_convenioweb, "text"),GetSQLValueString($colname4_convenioweb, "date"),GetSQLValueString($colname5_convenioweb, "date"),GetSQLValueString("%" . $colname2_convenioweb . "%", "text"));
$query_limit_convenioweb = sprintf("%s LIMIT %d, %d", $query_convenioweb, $startRow_convenioweb, $maxRows_convenioweb);
$convenioweb = mysqli_query($comercioexterior, $query_limit_convenioweb) or die(mysqli_error($comercioexterior));
$row_convenioweb = mysqli_fetch_assoc($convenioweb);

if (isset($_GET['totalRows_convenioweb'])) {
  $totalRows_convenioweb = $_GET['totalRows_convenioweb'];
} else {
  $all_convenioweb = mysqli_query($comercioexterior, $query_convenioweb);
  $totalRows_convenioweb = mysqli_num_rows($all_convenioweb);
}
$totalPages_convenioweb = ceil($totalRows_convenioweb/$maxRows_convenioweb)-1;
?>
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">BMG</td>
  </tr>
</table>
<br>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../bmg.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Enviar Operaci&oacute;n</span></div></td>
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a> </a><a href="envioacursecci.php?recordID=<?php echo $row_reparos['id']; ?>"><img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></div></td>
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_reparos['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="16" align="left"><span class="Estilo10"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21"></span><span class="Estilo5">Total Operaciones Enviadas a Curse&nbsp;<span class="tituloverde"><?php echo $totalRows_cbi ?></span> Cobranza Extranjera de Importaci&oacute;n y OPI</span></td>
  </tr>
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center"><span class="Estilo10"><span class="titulocolumnas">Enviar Operaci&oacute;n</span></span></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../espcomex/controles/untitled.php?recordID=<?php echo $row_cbi['id']; ?>"> </a><a href="envioacursecbi.php?recordID=<?php echo $row_cbi['id']; ?>"><img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
    ...
    <td align="center"><?php if ($row_cbi['estado'] <> $row_colores['cursada'] and $row_cbi['estado'] <> $row_colores['pendiente'] and $row_cbi['estado'] <> $row_colores['solucionado'] and $row_cbi['estado'] <> $row_colores['preingresada'] and $row_cbi['estado'] <> $row_colores['eliminada'] and $row_cbi['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" class="respuestacolumna_rojo"><?php echo $row_cbi['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Enviar Operaci&oacute;n </span></td>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio </td>
    <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso </td>
    <td align="center" valign="middle" class="titulocolumnas">Rut Cliente </td>
    <td align="center" valign="middle" class="titulocolumnas">Nombre Cliente </td>
  ...
  <?php do { ?>
    <tr>
      <td align="center" valign="middle"><a href="envioacursemec.php?recordID=<?php echo $row_meco['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
      ...
      <?php } // Show if not first page ?>      </div></td>
      <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_meco['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Enviar Operaci&oacute;n</div>
    </td>
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacursecce.php?recordID=<?php echo $row_cce['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></div></td>
    <td align="center" valign="middle" class="rojopequeno"><span class="respuestacolumna_rojo"><?php echo $row_cce['id']; ?></span>      </div></td>
    ...
    <td align="center" valign="middle"><?php if ($row_cce['estado'] <> $row_colores['cursada'] and $row_cce['estado'] <> $row_colores['pendiente'] and $row_cce['estado'] <> $row_colores['solucionado'] and $row_cce['estado'] <> $row_colores['preingresada'] and $row_cce['estado'] <> $row_colores['eliminada'] and $row_cce['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_cce['reparo_obs']; ?> </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulocolumnas">Enviar Operaci&oacute;n</div></td>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio 
      </div>
    </td>
    <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacursepre.php?recordID=<?php echo $row_pre['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></div></td>
    ...
    <td align="center" valign="middle"><?php if ($row_pre['estado'] <> $row_colores['cursada'] and $row_pre['estado'] <> $row_colores['pendiente'] and $row_pre['estado'] <> $row_colores['solucionado'] and $row_pre['estado'] <> $row_colores['preingresada'] and $row_pre['estado'] <> $row_colores['eliminada'] and $row_pre['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_pre['reparo_obs']; ?> </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulodetalle"><span class="titulocolumnas">Enviar Operaci&oacute;n </div>
    </span></td>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio 
      </div>
    </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center" valign="middle"><a href="envioacursecbe.php?recordID=<?php echo $row_cbe['id']; ?>"><img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></div></td>
    ...
    <td align="center" valign="middle"><?php if ($row_cbe['estado'] <> $row_colores['cursada'] and $row_cbe['estado'] <> $row_colores['pendiente'] and $row_cbe['estado'] <> $row_colores['solucionado'] and $row_cbe['estado'] <> $row_colores['preingresada'] and $row_cbe['estado'] <> $row_colores['eliminada'] and $row_cbe['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div> </td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_cbe['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacursecdpa.php?recordID=<?php echo $row_cdpa['id']; ?>"><img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></div></td>
    ...
    <td align="center" valign="middle"><?php if ($row_cdpa['estado'] <> $row_colores['cursada'] and $row_cdpa['estado'] <> $row_colores['pendiente'] and $row_cdpa['estado'] <> $row_colores['solucionado'] and $row_cdpa['estado'] <> $row_colores['preingresada'] and $row_cdpa['estado'] <> $row_colores['eliminada'] and $row_cdpa['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_cdpa['reparo_obs']; ?> </td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacurseste.php?recordID=<?php echo $row_ste['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
    ...
    <td align="center" valign="middle"><?php if ($row_ste['estado'] <> $row_colores['cursada'] and $row_ste['estado'] <> $row_colores['pendiente'] and $row_ste['estado'] <> $row_colores['solucionado'] and $row_ste['estado'] <> $row_colores['preingresada'] and $row_ste['estado'] <> $row_colores['eliminada'] and $row_ste['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_ste['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center" valign="middle"><span class="Estilo10"><span class="titulocolumnas">Enviar Operaci&oacute;n</span></span></td>
    <td align="center" valign="middle" class="titulocolumnas">Nro Folio </td>
    <td align="center" valign="middle" class="titulocolumnas">Fecha Ingreso </td>
    <td align="center" valign="middle" class="titulocolumnas">Rut Cliente</td>
    <td align="center" valign="middle" class="titulocolumnas">Nombre Cliente</td>
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacursebga.php?recordID=<?php echo $row_bga['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
    ...
    <td align="center" valign="middle"><?php if ($row_bga['estado'] <> $row_colores['cursada'] and $row_bga['estado'] <> $row_colores['pendiente'] and $row_bga['estado'] <> $row_colores['solucionado'] and $row_bga['estado'] <> $row_colores['preingresada'] and $row_bga['estado'] <> $row_colores['eliminada'] and $row_bga['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_bga['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr align="center" valign="middle" bgcolor="#999999">
    <td colspan="16" align="left"><span class="Estilo13"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"></span><span class="titulodetalle">Total Operaciones Enviadas a Curse </span><span class="tituloverde"><?php echo $totalRows_cex ?></span><span class="titulodetalle"> Otros Productos de Cambio</span></td>
  </tr>
  <tr align="center" valign="middle" bgcolor="#999999">
    <td align="center"><span class="titulocolumnas">Enviar Operaci&oacute;n </span></td>
    <td align="center" class="titulocolumnas">Nro Folio </td>
    <td align="center" class="titulocolumnas">Fecha Ingreso </td>
    <td align="center" class="titulocolumnas">Tipo Operaci&oacute;n </td>
    <td align="center" class="titulocolumnas">Rut Cliente </td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../espcomex/controles/untitled.php?recordID=<?php echo $row_cex['id']; ?>"> </a><a href="envioacursecex.php?recordID=<?php echo $row_cex['id']; ?>"><img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
    ...
    <td align="center"><?php if ($row_cex['estado'] <> $row_colores['cursada'] and $row_cex['estado'] <> $row_colores['pendiente'] and $row_cex['estado'] <> $row_colores['solucionado'] and $row_cex['estado'] <> $row_colores['preingresada'] and $row_cex['estado'] <> $row_colores['eliminada'] and $row_cex['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" class="respuestacolumna_rojo"><?php echo $row_cex['reparo_obs']; ?></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="envioacursetbc.php?recordID=<?php echo $row_tbc['id']; ?>"> <img src="../../../imagenes/ICONOS/archivo.JPG" width="20" height="20" border="0"></a></td>
    ...
    <td align="center" valign="middle"><?php if ($row_tbc['estado'] <> $row_colores['cursada'] and $row_tbc['estado'] <> $row_colores['pendiente'] and $row_tbc['estado'] <> $row_colores['solucionado'] and $row_tbc['estado'] <> $row_colores['preingresada'] and $row_tbc['estado'] <> $row_colores['eliminada'] and $row_tbc['estado'] <> $row_colores['rechazada']) { // Show if not first page ?>
      ...
      <?php } // Show if not first page ?>      </div></td>
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_tbc['reparo_obs']; ?></td>
...
<?php if ($totalRows_convenioweb > 0) { // Show if recordset not empty ?>
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        <td align="center" valign="middle"><?php echo $row_convenioweb['fecha_ingreso']; ?></td>
        <td align="center" valign="middle"><?php echo $row_convenioweb['rut_cliente']; ?></td>
        <td align="left" valign="middle"><?php echo $row_convenioweb['nombre_cliente']; ?></td>
        <td align="center" valign="middle"><?php echo $row_convenioweb['estado']; ?></td>
        <td align="left" valign="middle"><?php echo $row_convenioweb['obs_reparo']; ?></td>
      </tr>

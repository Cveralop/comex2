...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT opcce.*,(usuarios.nombre)as ne, time(date_espe)as esp FROM opcce, usuarios WHERE especialista_curse = %s and (opcce.especialista_curse = usuarios.usuario) ORDER BY opcce.id desc ", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><img src="../../../imagenes/JPEG/logo_carta.JPG" width="219" height="61" align="left"></div>      </div></td>
  </tr>
  <tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcex (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, moneda_operacion, monto_operacion, tipo_operacion, sub_estado, date_preingreso, estado_visacion, mandato, urgente, cantidad) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",

...
$query_ingape = sprintf("SELECT * FROM opcex WHERE rut_cliente LIKE '%%%s%%' and estado_visacion = '%s' ORDER BY rut_cliente ASC", $colname_ingape,$colname1_ingape);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_ingape['nro_folio']; ?></span>      </div></td>

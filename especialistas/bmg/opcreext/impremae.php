...
$query_impresion = sprintf("SELECT * FROM opcex WHERE especialista_curse = '%s' and fecha_ingreso = '%s' and rut_cliente = '%s' and evento = '%s' ORDER BY id DESC", $colname_impresion,$colname1_impresion,$colname2_impresion,$colname3_impresion);
    ...
    <tr>
      ...
      <td align="left" valign="middle">
        <select name="evento" class="etiqueta12" id="evento">
          ...
          <option value="Solucion Excecpion.">Solucion Excecpion</option>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo (isset($row_impresion['valuta']) ? $row_impresion['valuta']:""); ?></div></td>
  ...
  <tr>
    ...
    <td colspan="6" align="left" valign="middle"><?php echo $row_impresion['obs']; ?></td>

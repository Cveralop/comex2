...
$query_modificacion = sprintf("SELECT * FROM opcex WHERE rut_cliente = %s and estado_visacion = %s ORDER BY date_ingreso DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_modificacion['tipo_operacion']); ?></div></td>

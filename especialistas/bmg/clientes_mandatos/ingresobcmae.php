...
$ingreso_cliente = mysqli_query($basecomercial, $query_ingreso_cliente) or die(mysqli_error($basecomercial));
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="left"><?php //echo $row_ingreso_cliente['subgerente']; //No esta en la base de Datos Base Comercial?></td>
...
<table width="95%" border="0" align="center">
  <tr>
    <td align="right"><a href="clientes_mandatos.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Imagen3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen3" width="80" height="25" border="0"></a></td>
  </tr>
</table>
</body>
</html><?php

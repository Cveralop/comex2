...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE cliente SET rut_cliente=%s, nombre_cliente=%s, mod_por=%s, date2=%s WHERE id=%s",
                       GetSQLValueString($_POST['rut_cliente'], "text"),
                       GetSQLValueString($_POST['nombre_cliente'], "text"),
                       GetSQLValueString($_POST['mod_por'], "text"),
...
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_DetailRS1 = sprintf("SELECT * FROM cliente WHERE id = %s", $colname_DetailRS1);
...
$query_DetailRS1 = sprintf("SELECT * FROM cliente  WHERE id = $recordID"); //, $colname_modificar
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" onSubmit="MM_validateForm('rut_cliente','','R','nombre_cliente','','R','especialista','','R');return document.MM_returnValue">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="4" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Modificar Cliente</span></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      <td colspan="4" align="center">
        <input name="Enviar" type="submit" class="boton" value="Actualizar Cliente">
      </div></td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1">
  <input type="hidden" name="id" value="<?php echo $row_DetailRS1['id']; ?>">
  <input name="mod_por" type="hidden" id="mod_por" value="<?php echo $_SESSION['login'];?>">
  <input name="date2" type="hidden" id="date2" value="<?php echo date("Y-m-d H:i:s"); ?>">
</form>
<br>
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="bottom"><a href="../clientes_mandatos/modmae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image1" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html><?php

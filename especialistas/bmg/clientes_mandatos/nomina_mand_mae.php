...
$query_nominamandatos = sprintf("SELECT * FROM cliente WHERE fecha_ingreso = %s and estado_mandato = %s", GetSQLValueString($colname_nominamandatos, "date"),GetSQLValueString($colname1_nominamandatos, "text"));
$nominamandatos = mysqli_query($comercioexterior, $query_nominamandatos) or die(mysqli_error($comercioexterior));
...
<title>Nomina Mandatos - Maestro</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td align="left" class="Estilo3">NOMINA MANDATO - MAESTRO</td>
...
<br />
<form id="form1" name="form1" method="get" action="nomina_mand_det.php">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="titulo_menu">Nomina por fecha</span></td>
    </tr>
    <tr>
      <td width="22%" align="right" valign="middle">Fecha Ingreso Mandato:</td>
...
<input name="button" type="submit" class="boton" id="button" value="Confeccionar Nomina" />
      </label></td>
    </tr>
  </table>
</form>

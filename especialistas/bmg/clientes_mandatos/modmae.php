...
$colname_modificar = "xxx";
if (isset($_GET['rut_cliente'])) {
  $colname_modificar = $_GET['rut_cliente'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_modificar = sprintf("SELECT * FROM cliente WHERE rut_cliente LIKE %s and nombre_cliente LIKE %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_modificar . "%", "text"),GetSQLValueString($colname1_modificar . "%", "text"));
...
<title>Modificar Clientes - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="93%" align="left" valign="middle" class="Estilo3">MODIFICAR CLIENTES COMERCIO EXTERIOR - MAESTRO </td>
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Modificar Cliente</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <br>
  <tr valign="middle">
    <td><a href="moddet.php?recordID=<?php echo $row_modificar['id']; ?>"> <img src="../../../imagenes/ICONOS/update_2.jpg" width="18" height="18" border="0"></a></div></td>
    <td><?php echo $row_modificar['rut_cliente']; ?> </div></td>
    <td><?php echo $row_modificar['nombre_cliente']; ?> </td>
    <td><?php echo $row_modificar['especialista']; ?> </div></td>
  </tr>

...
$query_conrut = sprintf("SELECT * FROM opcce WHERE rut_cliente LIKE %s and nro_operacion LIKE %s ORDER BY id DESC", GetSQLValueString($colname_conrut . "%", "text"),GetSQLValueString($colname1_conrut . "%", "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../opcce.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#999999">
    <td align="center" valign="middle" class="titulo_menu"><span class="titulocolumnas">Ver Operaci&oacute;n </div>
    </span></td>
    ...
    <td align="center" valign="middle" class="titulocolumnas">Noneda / Monto Negociaci&oacute;n </div>
    </td>
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_conrut['fecha_curse']; ?></div></td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_conrut['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_conrut['monto_documentos'], 2, ',', '.'); ?></strong> </div></td>
      <td align="center" valign="middle"><?php echo $row_conrut['tipo_negociacion']; ?></div></td>
  </tr>

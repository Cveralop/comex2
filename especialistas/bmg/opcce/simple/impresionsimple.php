...
$query_DetailRS1 = sprintf("SELECT opcce.*,(usuarios.nombre)as ne FROM opcce, usuarios WHERE especialista_curse = %s and (opcce.especialista_curse = usuarios.usuario) ORDER BY opcce.id DESC", GetSQLValueString($colname_DetailRS1, "text"));

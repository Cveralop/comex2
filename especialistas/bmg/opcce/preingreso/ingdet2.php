...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcce (id, rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, nro_operacion, obs, especialista_curse, moneda_operacion, monto_operacion, sub_estado, date_preingreso, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
  ...
  Si</label>
    ...
    <tr valign="baseline">
      ...
      <span class="textfieldRequiredMsg">Si este valor esta en Blanco ingrese nuevamente a la aplicaci&oacute;n.</span></span><span id="sprytextfield1"><span class="textfieldRequiredMsg">e Colocar su Usuario (Se Recomienda Ingresar Nuevamente al Sistema).</span></span>        </div></td>

...
if (isset($_GET['nro_operacion_car'])) {
  $colname1_Recordset1 = $_GET['nro_operacion_car'];
}
$colname2_Recordset1 = "-1";
if (isset($_GET['nro_operacion_relacionada_car'])) {
  $colname2_Recordset1 = $_GET['nro_operacion_relacionada_car'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_Recordset1 = sprintf("SELECT * FROM carteraopera WHERE rut_cliente LIKE %s and nro_operacion_car LIKE %s and nro_operacion_relacionada_car LIKE %s ORDER BY fecha_vcto ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname1_Recordset1 . "%", "text"),GetSQLValueString("%" . $colname2_Recordset1 . "%", "text"));
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysqli_query($comercioexterior, $query_limit_Recordset1) or die(mysqli_error($comercioexterior));
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#FF0000" class="subtitulopaguina">BMG</td>
  </tr>
</table>
<br />
<form id="form1" name="form1" method="get" action="">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td align="left" valign="middle"><input name="nro_operacion_car" type="text" class="etiqueta12" id="nro_operacion_car" size="15" maxlength="7" />
        <span class="respuestacolumna_rojo"><span class="rojopequeno">(TIPO Operaciones F - L - B - J ) y K(solo contingente)</span></span></td>
    </tr>
    <tr>
      <td align="right" valign="middle">Nro Operacion Relacionada:</td>
      <td align="left" valign="middle"><input name="nro_operacion_relacionada_car" type="text" class="etiqueta12" id="nro_operacion_relacionada_car" size="15" maxlength="7" />
        <span class="respuestacolumna_rojo"><span class="rojopequeno">K(solo operaciones negociadas)</span></span></td>
    </tr>
    <tr>
...
<table width="95%" border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="informes.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Imagen3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen3" width="80" height="25" border="0" id="Imagen3" /></a></td>
  </tr>
</table>
<br />
  ...
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_Recordset1['nro_operacion_car']; ?></td>
        <td align="center" valign="middle"><?php echo $row_Recordset1['secuencia']; ?></td>
        <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_Recordset1['nro_operacion_relacionada_car']; ?></td>

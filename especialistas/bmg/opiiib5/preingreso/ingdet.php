...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO optbc (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, nro_operacion, obs, especialista_curse, moneda_operacion, monto_operacion, sub_estado, date_preingreso, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['monto_operacion'], "text"),

...
if (isset($_GET['nro_operacion'])) {
  $colname1_ingape = $_GET['nro_operacion'];
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingape = sprintf("SELECT * FROM optbc WHERE rut_cliente LIKE %s and nro_operacion LIKE %s ORDER BY date_ingreso DESC", GetSQLValueString("%" . $colname_ingape . "%", "text"),GetSQLValueString("%" . $colname1_ingape . "%", "text"));
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucci&oacute;n IIIB5</span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_ingape['nro_operacion']; ?> </td>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_ingape['moneda_operacion']; ?></span> <span class="respuestacolumna_azul"><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></span></td>
  </tr>

...
$query_opporcliente = sprintf("SELECT * FROM optbc WHERE rut_cliente = '%s' and fecha_curse LIKE '%%%s%%' and evento LIKE '%%%s%%' and estado LIKE '%%%s%%' ORDER BY id ASC", $colname_opporcliente,$colname1_opporcliente,$colname2_opporcliente,$colname3_opporcliente);
...
<table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td colspan="8" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo5">Total de&nbsp;&nbsp;<span class="Estilo12"><?php echo $totalRows_opporcliente ?></span> Operaciones </span></td>
  </tr>
  <tr bgcolor="#999999">

...
$query_modificacion = sprintf("SELECT * FROM optbc WHERE rut_cliente = %s and estado_visacion = %s ORDER BY date_ingreso DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    ...
    <td align="center" valign="middle" class="titulodetalle"><span class="titulocolumnas">Nro Operacion</span></td>
    <td align="center" valign="middle" class="titulodetalle"><span class="titulocolumnas">Fecha Ingreso
      </div>
    </span></td>
    <td align="center" valign="middle" class="titulodetalle"><span class="titulocolumnas">Evento
      </div>
    </span></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="respuestacolumna_rojo"><?php echo $row_modificacion['nro_operacion']; ?></td>

...
$query_clavebcos = sprintf("SELECT * FROM claves_banco WHERE nombre_banco LIKE %s and codigo_swift LIKE %s and pais LIKE %s ORDER BY nombre_banco ASC", GetSQLValueString($colname_clavebcos . "%", "text"),GetSQLValueString($colname1_clavebcos . "%", "text"),GetSQLValueString($colname2_clavebcos . "%", "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_clavebcos['ciudad']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_clavebcos['codigo_ciudad']; ?> </div></td>
    <td align="center" valign="middle"><?php echo $row_clavebcos['pais']; ?></div></td>
  </tr>

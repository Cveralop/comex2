...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf(
    "INSERT INTO oppre (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, obs, especialista_curse, moneda_operacion, monto_operacion, cuotas, nro_cuotas, vcto, tipocambio, destino_fondos, tasa_final, spread, tt, periodisidad, date_preingreso, date_espe, tipo_operacion, estado_visacion, mandato, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    GetSQLValueString($_POST['vcto'], "date"),
...
<body onLoad="MM_preloadImages('../../../../espcomex/imagenes/Botones/boton_volver_2.jpg','../../../../imagenes/Botones/boton_volver_2.jpg')">
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
      ...
      <tr valign="middle">
        ...
        <td align="right">Especilista Curse:</div>
        </td>
        <td align="center"><span id="sprytextfield1">
            ...
            <span class="textfieldRequiredMsg">Debe Colocar su Usuario (Se Recomienda Ingresar Nuevamente al Sistema).</span></span> </div>
        </td>
      </tr>
      <tr valign="middle">
      ...
      <tr valign="middle">
        ...
        <td align="center"><span id="sprytextfield2">
            ...
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span></span><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></td>
      ...
      <tr valign="middle">
        <td align="right">Credito en Cuotas:</td>
        <td align="center"><label>
        ...
        <td align="center"><span id="sprytextfield4">
            ...
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span><span class="textfieldMinValueMsg">El valor introducido es inferior al m�nimo permitido.</span><span class="textfieldMaxValueMsg">El valor introducido es superior al m�ximo permitido.</span></span><span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span><span class="textfieldMinValueMsg">El valor introducido es inferior al m&iacute;nimo permitido.</span><span class="textfieldMaxValueMsg">El valor introducido es superior al m&aacute;ximo permitido.</span></td>
      </tr>
      <tr valign="middle">
      ...
      <tr valign="middle">
        ...
        <td colspan="3" align="left"><span id="sprytextfield10"><span id="sprytextfield11">
              <label>
                <input name="vcto" type="text" class="etiqueta12" id="vcto" value="<?php echo date("Y-m-d"); ?>" size="12" maxlength="10">
              </label>
              <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no v�lido.</span></span><span class="textfieldRequiredMsg"><span class="rojopequeno">Se necesita un valor.</span></span><span class="rojopequeno"><span class="textfieldInvalidFormatMsg">Formato no v&aacute;lido.</span></span></span><span class="rojopequeno">(aaaa-mm-dd)</span></td>
      </tr>
  ...
  <table width="95%" border="0" align="center">
    <tr>
      <td align="right" valign="middle"><a href="../../../bmg/oppre/multiple/ingmae_m.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div>
      </td>
    </tr>
  </table>
  <script type="text/javascript">
    ...
    var sprytextfield11 = new Spry.Widget.ValidationTextField("sprytextfield11", "date", {
      validateOn: ["blur", "change"],
      format: "yyyy-mm-dd"
    });
  </script>

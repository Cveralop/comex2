...
if (isset($_GET['sub_estado'])) {
  $colname3_ingape = (get_magic_quotes_gpc()) ? $_GET['sub_estado'] : addslashes($_GET['sub_estado']);
}
$colname2_ingape = "1";
if (isset($_GET['nro_operacion'])) {
  $colname2_ingape = (get_magic_quotes_gpc()) ? $_GET['nro_operacion'] : addslashes($_GET['nro_operacion']);
}
$colname1_ingape = "Pendiente.";
if (isset($_GET['estado_visacion'])) {
  $colname1_ingape = (get_magic_quotes_gpc()) ? $_GET['estado_visacion'] : addslashes($_GET['estado_visacion']);
}
$colname_ingape = "zzz";
...
$query_ingape = sprintf("SELECT * FROM oppre WHERE rut_cliente LIKE '%%%s%%' and estado_visacion = '%s' and nro_operacion LIKE '%s%%' and sub_estado LIKE '%%%s%%' ORDER BY id DESC", $colname_ingape,$colname1_ingape,$colname2_ingape,$colname3_ingape);
...
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="middle" bgcolor="#999999">
      <td colspan="2" align="left"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Anular Instrucci&oacute;n Pr&eacute;stamos</span></td>
    </tr>
    <tr valign="middle">
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td align="center"><span class="titulocolumnas">Ingresar Apertura</span></div></td>
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../bmg/oppre/elidet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
    <td align="center"><span class="Estilo12"><?php echo strtoupper($row_ingape['nro_operacion']); ?></span></td>
    <td align="center"><?php echo $row_ingape['fecha_ingreso']; ?></td>
    <td align="center"><?php echo $row_ingape['evento']; ?></td>
    <td align="right"><span class="Estilo12"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
...
<table border="0" width="50%" align="center">
  <tr>
    <td width="23%" align="center"><?php if ($pageNum_ingape > 0) { // Show if not first page ?>
          <span class="Estilo15"><a href="<?php printf("%s?pageNum_ingape=%d%s", $currentPage, 0, $queryString_ingape); ?>">Primero</a>
    <?php } // Show if not first page ?>    </td>
    <td width="31%" align="center"><?php if ($pageNum_ingape > 0) { // Show if not first page ?>
          <span class="Estilo15"><a href="<?php printf("%s?pageNum_ingape=%d%s", $currentPage, max(0, $pageNum_ingape - 1), $queryString_ingape); ?>">Anterior</a>
    <?php } // Show if not first page ?>    </td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../bmg/oppre/oppre.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image6" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html>

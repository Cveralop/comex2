...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../bmg/oppre/oppre.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_impresion['id']; ?></span></td>
    <td align="center"><?php echo $row_impresion['date_espe']; ?></td>
    <td align="center"><?php echo strtoupper($row_impresion['rut_cliente']); ?></td>
    <td align="left"><?php echo strtoupper($row_impresion['nombre_cliente']); ?></td>
    <td align="center"><?php echo $row_impresion['evento']; ?> </div></td>
    <td align="center"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['nro_operacion']); ?></span> / <span class="respuestacolumna_rojo"><?php echo strtoupper($row_impresion['nro_operacion_relacionada']); ?></span>      </div></td>
  ...
  <tr valign="middle">
    <td rowspan="2" align="center" valign="top" bgcolor="#999999" class="titulocolumnas">Observaciones:</td>
  ...
  <tr valign="middle">
    <td align="right" valign="top" bgcolor="#999999" class="titulocolumnas">Mandato:</td>
    <td align="center" valign="top"><?php echo $row_impresion['mandato']; ?></td>
  </tr>

...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center" class="respuestacolumna_rojo"><?php echo $row_DetailRS1['nro_operacion']; ?> / <?php echo $row_DetailRS1['nro_operacion_relacionada']; ?></td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php //echo $row_DetailRS1['forward']; // no aparece en la base de datos?></td>
  </tr>
  <tr valign="middle">
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/oppre/consultas/consulta.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html><?php

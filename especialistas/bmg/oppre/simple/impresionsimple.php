...
$query_DetailRS1 = sprintf("SELECT oppre.*,(usuarios.nombre)as ne FROM oppre, usuarios WHERE especialista_curse = %s and (oppre.especialista_curse = usuarios.usuario) ORDER BY oppre.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/oppre/simple/ingmae.php"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="right">Nro Operacion Relacionada:</td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?></span></td>
  </tr>
</table>
<p align="center"><br>
  <br>

...
$queryString_ingcci = sprintf("&totalRows_ingcci=%d%s", $totalRows_ingvarios, $queryString_ingcci); //, $totalRows_ingcci No inicializada
...
$queryString_inglci = sprintf("&totalRows_inglci=%d%s",$totalRows_ingvarios, $queryString_inglci); //$totalRows_inglci No inicializada
?>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/oppre/simple/ingdet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../../bmg/oppre/simple/ingdet2.php?recordID=<?php echo $row_ingvarios['id']; ?>"> <img src="../../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>

...
$query_modificacion = sprintf("SELECT * FROM opbga WHERE rut_cliente = %s and estado_visacion = %s ORDER BY date_ingreso DESC", GetSQLValueString($colname_modificacion, "text"),GetSQLValueString($colname1_modificacion, "text"));

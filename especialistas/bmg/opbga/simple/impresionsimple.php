...
$query_DetailRS1 = sprintf("SELECT opbga.*,(usuarios.nombre)as ne FROM opbga, usuarios WHERE especialista_curse = %s and (opbga.especialista_curse = usuarios.usuario) ORDER BY opbga.id DESC", GetSQLValueString($colname_DetailRS1, "text"));

...
$query_opporcliente = sprintf("SELECT * FROM opbga WHERE rut_cliente = %s and fecha_curse LIKE %s and evento LIKE %s and estado LIKE %s ORDER BY id ASC", GetSQLValueString($colname_opporcliente, "text"),GetSQLValueString("%" . $colname1_opporcliente . "%", "text"),GetSQLValueString("%" . $colname2_opporcliente . "%", "text"),GetSQLValueString("%" . $colname3_opporcliente . "%", "text"));

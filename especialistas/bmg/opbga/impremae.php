...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><span class="respuestacolumna_rojo"><?php echo $row_impresion['id']; ?></div></td>
    <td align="center" valign="middle"><?php echo $row_impresion['date_espe']; ?></div></td>
    <td align="left" valign="middle"><?php echo strtoupper($row_impresion['rut_cliente']); ?></div></td>

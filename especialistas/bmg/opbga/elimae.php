...
$query_ingape = sprintf("SELECT * FROM opbga WHERE rut_cliente = %s and estado_visacion = %s ORDER BY rut_cliente ASC", GetSQLValueString($colname_ingape, "text"),GetSQLValueString($colname1_ingape, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="respuestacolumna_rojo"><?php echo $row_ingape['nro_folio']; ?></span>      </div></td>

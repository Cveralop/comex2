...
$query_entdoc = sprintf("SELECT * FROM opbga WHERE rut_cliente = %s and estado_boleta = %s and evento = %s ORDER BY id DESC", GetSQLValueString($colname_entdoc, "text"),GetSQLValueString($colname1_entdoc, "text"),GetSQLValueString($colname2_entdoc, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr align="center" valign="middle" bgcolor="#999999">
    ...
    <td align="center"><span class="Estilo8">Nro de Operaci&oacute;n</span></td>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center"><?php if ($pageNum_entdoc < $totalPages_entdoc) { // Show if not last page ?>
        <a href="<?php printf("%s?pageNum_entdoc=%d%s", $currentPage, $totalPages_entdoc, $queryString_entdoc); ?>">&Uacute;ltimo</a>
        <?php } // Show if not last page ?>
    </td>
  </tr>
</table>

...
$colname_ingste = "zzzxxx";
if (isset($_GET['nro_operacion'])) {
  $colname_ingste = (get_magic_quotes_gpc()) ? $_GET['nro_operacion'] : addslashes($_GET['nro_operacion']);
}
mysqli_select_db($comercioexterior, $database_comercioexterior);
$query_ingste = sprintf("SELECT * FROM opbga WHERE nro_operacion LIKE '%%%s%%' ORDER BY nro_operacion ASC", $colname_ingste);
...
$queryString_ingvarios = sprintf("&totalRows_ingvarios=%d%s",$totalRows_ingste, $queryString_ingvarios); // $totalRows_ingvarios
?>
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  ...
  <tr>
    <td align="left" valign="middle" class="Estilo4">CAMBIO - BOLETAS DE GARANTIA</td>
  </tr>
</table>
<br>
<form name="form1" method="get" action="">
  <table width="95%"  border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr bgcolor="#999999">
      <td colspan="2" align="left" valign="middle"><img src="../../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="Estilo7">Pre-Ingreso Instrucci&oacute;n Boleta de Garant&iacute;a </span></td>
    </tr>
    <tr>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr bgcolor="#999999">
    <td align="center" valign="middle"><span class="titulocolumnas">Ingresar Env&iacute;o Stand By </span>      </div></td>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="right" valign="middle"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_ingste['moneda_operacion']); ?></span>&nbsp; <strong class="respuestacolumna_azul"><?php echo number_format($row_ingste['monto_operacion'], 2, ',', '.'); ?></strong> </div></td>
  </tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO opcbe (rut_cliente, nombre_cliente, fecha_ingreso, date_ingreso, evento, estado, obs, especialista_curse, moneda_operacion, monto_operacion, sub_estado, date_preingreso, mandato, estado_visacion, urgente) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",

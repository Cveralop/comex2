...
$query_DetailRS1 = sprintf("SELECT opcbe.*,(usuarios.nombre)as ne FROM opcbe, usuarios WHERE especialista_curse = %s and (opcbe.especialista_curse = usuarios.usuario) ORDER BY opcbe.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
//$query_fuerahorario = sprintf("SELECT fuerahorario_bmg. *,(depto) as fuera_horario FROM fuerahorario_bmg WHERE depto = %s", GetSQLValueString($colname_fuerahorario, "text"));
...
<table width="95%"  border="0" align="center">
  ...
  <tr>
    ...
    <?php //} // Show if not first page ?></td> <?php //Revisar ?>
  </tr>
</table>
<br>
<br>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="Estilo12"><?php echo $row_DetailRS1['mandato']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>

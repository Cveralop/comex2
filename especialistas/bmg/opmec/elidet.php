...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "../../bmg/opmec/elimae.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DetailRS1 = sprintf("SELECT * FROM opmec WHERE id = $recordID", $colname_ingape);
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr valign="middle">
    <td width="94%" align="left" class="Estilo3">ANULAR INSTRUCCION - DETALLE </td>
    <td width="6%" rowspan="2" align="left" class="Estilo3"><img src="../../../imagenes/GIF/erde016.gif" width="43" height="43" align="right"></td>
  </tr>
  <tr valign="middle">
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr valign="baseline" bgcolor="#999999">
      <td colspan="4" align="left" valign="middle"><img src="../../../imagenes/GIF/notepad.gif" width="19" height="21" border="0"><span class="titulodetalle">Anular  Instrucci&oacute;n</div>
      </span></td>
    </tr>
    <tr valign="baseline">
  ...
  Si</label>
    ...
    <tr align="center" valign="baseline">
      <td colspan="4" align="center" valign="middle"><input type="submit" class="boton" value="Anular Instrucci&oacute;n"></td>
    </tr>
  </table>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../bmg/opmec/elimae.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>

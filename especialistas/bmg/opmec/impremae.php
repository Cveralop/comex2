...
$query_impresion = sprintf("SELECT * FROM opmec WHERE especialista_curse = '%s' and fecha_ingreso = '%s' and rut_cliente = '%s' and evento = '%s' ORDER BY id DESC", $colname_impresion,$colname1_impresion,$colname2_impresion,$colname3_impresion);
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../bmg/opmec/opmec.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    <td align="center" bgcolor="#999999" class="NegrillaCartaReparo"><span class="titulocolumnas">Observaciones:</span></td>

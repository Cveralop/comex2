...
$query_ingape = sprintf("SELECT * FROM opmec WHERE rut_cliente LIKE '%%%s%%' and estado_visacion = '%s' ORDER BY rut_cliente ASC", $colname_ingape,$colname1_ingape);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr valign="middle">
    <td align="center"><a href="../../bmg/opmec/elidet.php?recordID=<?php echo $row_ingape['id']; ?>"> <img src="../../../imagenes/ICONOS/ingreso_dato.jpg" width="20" height="20" border="0"></a></div></td>

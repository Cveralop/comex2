...
$query_DetailRS1 = sprintf("SELECT * FROM opmec  WHERE id = $recordID",$colname_DetailRS1); //$colname_conrut
...
<title>Consulta Operaciones MECO - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    <td width="22%" align="right">Nro Registro: </td>
    <td width="34%" align="center"><span class="nroregistro"><?php echo $row_DetailRS1['id']; ?> </span></td>
    <td width="19%" align="right">Rut Cliente:</td>
    <td width="25%" align="center"><?php echo strtoupper($row_DetailRS1['rut_cliente']); ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo strtoupper($row_DetailRS1['asignador']); ?> </td>
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo strtoupper($row_DetailRS1['especialista_curse']); ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?></span> <span class="rojopequeno">/</span> <strong class="respuestacolumna_azul"><?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>
  <tr valign="middle">
    <td align="right">Estado Operador: </td>
    <td align="center"><?php echo $row_DetailRS1['sub_estado']; ?> </td>
    <td align="right">Autorizador:</td>
    <td align="center"><?php echo strtoupper($row_DetailRS1['autorizador']); ?></td>
  </tr>
  <tr valign="middle">
    ...
    <td align="center"><?php echo $row_DetailRS1['date_espe']; ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left"><?php echo strtoupper($row_DetailRS1['reparo_obs']); ?> </td>
  </tr>
</table>
<br>
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opmec/consultas/consulta.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
</body>
</html><?php

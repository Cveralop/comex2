...
$query_DetailRS1 = sprintf("SELECT opmec.*,(usuarios.nombre)as ne FROM opmec, usuarios WHERE especialista_curse = %s and (opmec.especialista_curse = usuarios.usuario) ORDER BY opmec.id DESC", GetSQLValueString($colname_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../bmg/opmec/simple/ingmae.php"><img src="../../../../imagenes/Botones/boton_volver_1.jpg" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  ...
  <tr valign="middle">
    ...
    <td align="center" class="Estilo12"><span class="NegrillaCartaReparo"><?php echo $row_DetailRS1['mandato']; ?> / <?php echo $row_DetailRS1['impedido_operar']; ?> / <?php echo $row_DetailRS1['cliente_passport']; ?></span></td>
    <td align="right">Cantidad:</td>
    <td align="center" class="Estilo12"><?php echo $row_DetailRS1['cantidad']; ?></td>
  </tr>
</table>
<p align="center"><br>
  <br>

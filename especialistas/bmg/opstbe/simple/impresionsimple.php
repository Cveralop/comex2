...
$query_DetailRS1 = sprintf("SELECT opste.*,(usuarios.nombre)as ne FROM opste, usuarios WHERE especialista_curse = %s and (opste.especialista_curse = usuarios.usuario) ORDER BY opste.id DESC", GetSQLValueString($colname_DetailRS1, "text"));

...
$query_ingape = sprintf("SELECT * FROM opste WHERE rut_cliente LIKE '%%%s%%' and estado_visacion = '%s' ORDER BY rut_cliente ASC", $colname_ingape,$colname1_ingape);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="right" valign="middle"><span class="Estilo12"><?php echo strtoupper($row_ingape['moneda_operacion']); ?></span> <strong><?php echo number_format($row_ingape['monto_operacion'], 2, ',', '.'); ?></strong></div></td>

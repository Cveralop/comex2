...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opste SET evento=%s, obs=%s, moneda_operacion=%s, monto_operacion=%s, date_preingreso=%s, date_espe=%s, mandato=%s, urgente=%s WHERE id=%s",
...
$query_DetailRS1 = sprintf("SELECT * FROM opste  WHERE id = $recordID", $colname_modificacion,$colname1_modificacion,$colname2_modificacion,$colname3_modificacion);

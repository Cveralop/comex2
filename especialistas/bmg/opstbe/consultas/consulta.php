...
$query_conrut = sprintf("SELECT * FROM opste WHERE rut_cliente LIKE '%s%%' and evento LIKE '%%%s%%' ORDER BY id DESC", $colname_conrut,$colname1_conrut);
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td align="center" valign="middle"><a href="../../../bmg/opstbe/consultas/consultadet.php?recordID=<?php echo $row_conrut['id']; ?>"> <img src="../../../../imagenes/ICONOS/ver_registro_2.jpg" width="22" height="19" border="0"></a></div></td>

...
$query_opporcliente = sprintf("SELECT * FROM opste WHERE rut_cliente = '%s' and fecha_curse LIKE '%%%s%%' and evento LIKE '%%%s%%' and estado LIKE '%%%s%%' ORDER BY id ASC", $colname_opporcliente,$colname1_opporcliente,$colname2_opporcliente,$colname3_opporcliente);

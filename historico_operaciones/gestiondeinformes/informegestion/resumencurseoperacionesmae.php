...
$query_Recordset1 = sprintf("SELECT * FROM estadistica_resumen WHERE date_ingreso between %s and %s", GetSQLValueString($colname_Recordset1, "date"),GetSQLValueString($colname1_Recordset1, "date"));
...
<br />
<form action="resumencurseoperacionesmae.php" method="get" name="form2" id="form2">

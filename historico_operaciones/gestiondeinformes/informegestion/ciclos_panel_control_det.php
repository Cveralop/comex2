...
<table width="95%" border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle" bgcolor="#FF0000" class="titulopaguina">Ciclos Panel de Control</td>
  </tr>
  <tr>
...
<td colspan="9" align="left" valign="middle" class="titulocolumnas"><img src="../../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" /><span class="titulo_menu">Detalle Informe Panel de Control</span></td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="right" valign="middle"><?php echo number_format(($row_bei['monto']/100), 0, ',', '.'); ?></td>
    </tr>

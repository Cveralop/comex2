...
$colname_opcci = "Requerimiento.";
if (isset($_GET['evento'])) {
  $colname_opcci = $_GET['evento'];
}
mysqli_select_db($historico_goc, $database_historico_goc);
$query_opcci = sprintf("SELECT * FROM base_operaciones WHERE evento = %s ORDER BY date_ingreso ASC", GetSQLValueString($colname_opcci, "text"));
...
<title>Requerimientos - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center">
  <tr>
    ...
    <td align="center" valign="middle">Moneda Operacion</td>
    <td align="center" valign="middle"> Monto Operaci&oacute;n</td>
    <td align="center" valign="middle">Obs</td>

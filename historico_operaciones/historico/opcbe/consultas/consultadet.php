...
$query_DetailRS1 = sprintf("SELECT * FROM opcbe  WHERE id = $recordID", $colname_DetailRS1); //, $colname_conrut
...
<title>Consulta Operaciones CBE - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><?php echo $row_DetailRS1['operador']; ?></td>
  </tr>
  <tr>

...
$query_DetailRS1 = sprintf("SELECT * FROM optbc  WHERE id = $recordID", $colname_conrut);
...
<title>Consulta Operaciones CAMBIO - Detalle</title>
<style type="text/css">
<!--
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td width="34%" align="center" valign="middle"><span class="Estilo9"><?php echo $row_DetailRS1['id']; ?> </span></td>
  ...
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_DetailRS1['operador']); ?></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <td colspan="3" align="left" valign="middle"><span class="Estilo6"><?php echo strtoupper($row_DetailRS1['moneda_operacion']); ?></span> <span class="rojopequeno">/</span> <strong><?php echo number_format($row_DetailRS1['monto_operacion'], 2, ',', '.'); ?></strong></div></td>
  </tr>
  <tr valign="middle">
    ...
    <td align="center" valign="middle"><?php echo strtoupper($row_DetailRS1['autorizador']); ?></td>
  </tr>
  <tr valign="middle">

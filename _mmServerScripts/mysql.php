...
class mysqlConnection
{
	...
	function Open()
	{
		// if ($this->connectionId = mysql_connect($this->hostname, $this->username, $this->password) or die(mysqli_error()))
	...
	function GetColumnsOfTable($TableName)
	{
		...
		$result = mysql_query($query) or die("<ERRORS><ERROR Identification=\"" . mysql_errno() .
		   "\"><DESCRIPTION>" . mysql_errno() . " " . mysqli_error() . "</DESCRIPTION></ERROR></ERRORS>");

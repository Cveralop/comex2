...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td><div align="center"><span class="Estilo1">SUBIR ARCHIVOS NEGOCIACIONES DE EXPORTACIONES </span></div></td>
  </tr>
</table>
<br>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="subirnegexport.php" enctype="multipart/form-data" target="_blank">

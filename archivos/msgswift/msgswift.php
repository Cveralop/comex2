...
<html> 
<head> 
<title>Archivos Negociaciones de Exportaciones</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><div align="left"><span class="Estilo1">SUBIR  O VER ARCHIVOS SWIFT DE APERTURA DE L/C</span></div></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><div align="right"><a href="../../operaciones/principal.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="msgswift.php" enctype="multipart/form-data" target="_blank">
...
<?php
    ...
    $directorio="D:\\appserv\\www\\comex\\archivos\\msgswift\\"; 
...
{ 
if($file != "msgswift.php" AND $file != "erroracceso.php" AND $file != "." AND $file != "..") {
  {

...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><div align="left"><span class="Estilo1">SUBIR  O VER ARCHIVOS DE NEGOCIACIONES DE EXPORTACIONES</span></div></td>
...
<?php
    ...
    $directorio="D:\\appserv\\www\\comex\\archivos\\negexport\\"; 
...
{ 
if($file != "negexport.php" AND $file != "erroracceso.php" AND $file != "." AND $file != "..") {
  {

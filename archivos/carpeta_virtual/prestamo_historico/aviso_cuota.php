...
<html> 
<head> 
<title>Subir Avisos en Cuotas</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">SUBIR AVISOS EN CUOTAS</span></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../operaciones/oppre/prestamos.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="aviso_cuota.php" enctype="multipart/form-data" target="_blank">
...
{ 
if($file != "aviso_cuota.php" AND $file != "erroracceso.php" AND $file != "ver_aviso_cuota.php." AND $file != "..") {
  {

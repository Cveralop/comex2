...
<html> 
<head> 
<title>Carpeta Virtual Cambio</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">CARPETA VIRTUAL CAMBIO</span></td>
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../../../operaciones/opmec/meco.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image2" width="80" height="25" border="0"></a></td>
  </tr>
</table>
<br>
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="cambio.php" enctype="multipart/form-data" target="_blank">
...
<?php
    ...
    $directorio="D:\\appserv\\www\\comex\\archivos\\carpeta_virtual\\cambio\\"; 
...
{ 
if($file != "cambio.php" AND $file != "erroracceso.php" AND $file != "." AND $file != "..") {
  {

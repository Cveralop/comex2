...
$query_DetailRS1 = sprintf("SELECT * FROM opcci nolock WHERE estado_visacion = %s and rut_cliente LIKE %s and nro_operacion LIKE %s and asignador = %s and estado = %s ORDER BY id DESC", GetSQLValueString($colname_DetailRS1, "text"),GetSQLValueString($colname1_DetailRS1 . "%", "text"),GetSQLValueString("%" . $colname2_DetailRS1 . "%", "text"),GetSQLValueString($colname4_DetailRS1, "text"),GetSQLValueString($colname3_DetailRS1, "text"));
...
<table width="95%"  border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="../controlinterno.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image5" width="80" height="25" border="0"></a></div></td>
  </tr>
</table>
<br>
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr valign="middle" bgcolor="#999999">
    <td colspan="12" align="left"><span class="Estilo12"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21"> <span class="Estilo13">Hay <span class="Estilo16"><?php echo $totalRows_DetailRS1 ?></span> para visaci&oacute;n</span></span></td>
  </tr>
  <tr valign="middle" bgcolor="#999999">
  ...
  <tr valign="middle">
    ...
    <td align="center"><span class="Estilo5"><?php echo $row_DetailRS1['id']; ?></span></td>
    <td align="center"><?php echo strtoupper($row_DetailRS1['rut_cliente']); ?></div></td>
    ...
    <td align="center"><?php echo strtoupper($row_DetailRS1['nro_operacion_relacionada']); ?></td>
    ...
    <td align="right"><span class="respuestacolumna_rojo"><?php echo strtoupper($row_DetailRS1['moneda_documentos']); ?></span> <strong class="respuestacolumna_azul"><?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></strong></td>

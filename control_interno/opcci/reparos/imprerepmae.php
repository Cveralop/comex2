...
$query_cartareparo = sprintf("SELECT * FROM opcci nolock WHERE estado = %s ORDER BY date_visa DESC", GetSQLValueString($colname_cartareparo, "text"));
...
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  ...
  <tr valign="middle">
    ...
    <td align="center"><?php echo strtoupper($row_cartareparo['especialista_curse']); ?></div></td>
  </tr>

...
<body onLoad="MM_preloadImages('../../imagenes/Botones/boton_volver_2.jpg')">
  ...
  <form name="form1" method="get" action="">
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
      ...
      <tr>
        <td width="21%" align="right" valign="middle">Nombre Bancos:</div>
        </td>
  ...
  ?>
    <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
      ...
      <tr bgcolor="#999999">
        <td align="center" valign="middle" class="titulocolumnas">Codigfo Swift </div>
        </td>
      ...
      <?php do { ?>
        <tr>
          <td align="center" valign="middle"><?php echo $row_clavebcos['codigo_swift']; ?></div>
          </td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['recivir']; ?> </div>
          </td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['enviar']; ?></div>
          </td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['nombre_banco']; ?></td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['ciudad']; ?> </div>
          </td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['codigo_ciudad']; ?> </div>
          </td>
          <td align="center" valign="middle"><?php echo $row_clavebcos['pais']; ?></div>
          </td>
        </tr>
  ...
  <table width="95%" border="0" align="center">
    <tr>
      <td align="right" valign="middle"><a href="../controlinterno.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../imagenes/Botones/boton_volver_2.jpg',1)"><img src="../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Image3" width="80" height="25" border="0"></a></div>
      </td>
    </tr>
  </table>
</body>

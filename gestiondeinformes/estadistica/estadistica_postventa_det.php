...
$colname_estadistica_postventa = "-1";
...
<table width="95%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="84%" align="left" valign="middle" class="respuestacolumna_azul">
    <?php if($row_estadistica_postventa != 0) { ?>
    <?php echo $row_estadistica_postventa['fechainicio']; ?></td>
    <?php } ?>
  </tr>
  <tr>
    <td align="right" valign="middle">Fecha Hasta:</td>
    <td align="left" valign="middle" class="respuestacolumna_azul">
    <?php if($row_estadistica_postventa != 0) { ?>
    <?php echo $row_estadistica_postventa['fechatermino']; ?></td>
    <?php } ?>
  </tr>
</table>
<br />

...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">ESTADISTICA CUADRO DE MANDO OPERACIONES - MAESTRO</td>
...
<br />
<form id="form1" name="form1" method="get" action="estadistica_operaciones_det.php">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" bgcolor="#999999"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="subtitulopaguina">Cuadro Mando Operaciones</span></td>
    </tr>
    <tr>
      <td width="21%" align="right">Fecha Ingreso:</td>
      <td width="79%" align="left"><span class="respuestacolumna_rojo">Desde</span>
    ...
    <tr>
      <td colspan="2" align="center"><input name="button" type="submit" class="etiqueta12" id="button" value="Buscar" /></td>
    </tr>
  </table>
</form>
<br />

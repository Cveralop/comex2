...
<html> 
<head> 
<title>Subir Archivo OP Recibidas</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">SUBIR ARCHIVO OP RECIBIDAS</span></td>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="subiroprecibidas.php" enctype="multipart/form-data" target="_blank">

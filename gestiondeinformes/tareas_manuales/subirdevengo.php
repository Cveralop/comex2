...
<html> 
<head> 
<title>Subir Archivo Devengo</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">SUBIR ARCHIVO DEL DEVENGO</span></td>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="subirdevengo.php" enctype="multipart/form-data" target="_blank">
...
<?php
    ...
    $directorio="D:\\comercioexterior\\devengo\\"; 

...
<html> 
<head> 
<title>Subir Tipo de Cambio Cierre de Mes</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">SUBIR TIPO DE CAMBIO CIERRE DE MES</span></td>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="subirtipocambio.php" enctype="multipart/form-data" target="_blank">
...
<?php
    ...
    $directorio="D:\\comercioexterior\\tipocambio\\"; 

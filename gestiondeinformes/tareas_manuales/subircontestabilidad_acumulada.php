...
<html> 
<head> 
<title>Subir Archivo Contestabilidad Acumulada</title> 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%"><span class="Estilo1">SUBIR ARCHIVO CONTESTABILIDAD ACUMULADA</span></td>
...
<table width="95%"  border="1" align="center" bordercolor="#000000">
  <tr>
    <td><form name="archivos" method="post" action="subircontestabilidad_acumulada.php" enctype="multipart/form-data" target="_blank">
...
<?php
    ...
    $directorio="D:\\comercioexterior\\contestabilidad_acumulada\\"; 

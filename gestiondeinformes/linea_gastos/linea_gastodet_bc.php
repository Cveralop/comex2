...
$query_bei = sprintf("SELECT producto, min(date_ingreso)as fechainicio, max(date_ingreso)as fechatermino, evento, segmento_comercial, count(evento)as cantidad, tiempo_evento FROM base_operaciones nolock WHERE date_ingreso between %s and %s and tiempo_evento > %s and segmento_comercial_bc = 'Si' GROUP BY producto, evento ORDER BY producto, segmento_comercial DESC ", GetSQLValueString($colname1_bei, "date"),GetSQLValueString($colname2_bei, "date"),GetSQLValueString($colname3_bei, "int"));
...
<title>Liena de Gastos Banca Comercial - Detalle</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%" border="0" align="center">
  <tr>
    <td colspan="2" align="center" valign="middle" bgcolor="#FF0000" class="titulopaguina">LINEA DE GASTOS BANCA COMERCIAL</td>
  </tr>
  <tr>
    <td width="16%" align="right" valign="middle">Fecha Desde:</td>
    <td width="84%" align="left" valign="middle">
    <?php if($row_bei != 0) { ?>
    <?php echo $row_bei['fechainicio']; ?></td>
    <?php } ?>
  </tr>
  <tr>
...
<?php if($row_bei != 0) { ?>
<?php echo $row_bei['fechatermino']; ?></td>
<?php } ?>
  </tr>
</table>
<br />
<table width="95%" border="0" align="center">
  <tr>
    <td align="right" valign="middle"><a href="linea_gastomae_bc.php"><img src="../../imagenes/Botones/boton_volver_1.jpg" alt="Volver" name="Imagen1" width="80" height="25" border="0" id="Imagen1" /></a></td>
  </tr>
</table>
<br />
<table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
  <tr>
<td colspan="6" align="left" valign="middle" class="titulocolumnas"><img src="../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" /><span class="titulo_menu">Linea Gastos Banca Comercial</span></td>
  </tr>
  <tr>
    ...
    <td width="15%" align="center" valign="middle" class="titulocolumnas">Segmento</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="left" valign="middle"><?php echo $row_bei['segmento_comercial']; ?></td>

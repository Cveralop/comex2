...
<title>Linea de Gastos Pyme - Maestro</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" class="Estilo3">LINES DE GASTOS PYME - MAESTRO</td>
...
<br />
<form id="form1" name="form1" method="get" action="linea_gastodet_pyme.php">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999"><img src="../../imagenes/GIF/notepad.gif" width="19" height="21" /><span class="titulo_menu">Linea de Gastos Pyme</span></td>
    </tr>
    <tr>

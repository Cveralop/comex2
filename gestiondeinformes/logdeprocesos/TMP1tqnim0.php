...
$query_logstareas = "SELECT *,timestampdiff(minute,fecha_hora_inicio,fecha_hora_termino)as tiempo FROM logs_tareas_manuales nolock WHERE 1 ORDER BY fecha_hora_inicio DESC";
$query_limit_logstareas = sprintf("%s LIMIT %d, %d", $query_logstareas, $startRow_logstareas, $maxRows_logstareas);
$logstareas = mysqli_query($comercioexterior, $query_limit_logstareas) or die(mysqli_error());
...
<script> 
var segundos=1200
var direccion='http://pdpto38:8303/comex/gestiondeinformes/logdeprocesos/logsprocesosmanuales.php' 
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000" class="Estilo1">LOG REGISTRO TAREAS MANUALES</td>

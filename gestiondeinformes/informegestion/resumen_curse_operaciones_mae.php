...
$query_Recordset1 = sprintf("SELECT * FROM estadistica_resumen nolock WHERE date_curse between %s and %s", GetSQLValueString($colname_Recordset1, "date"),GetSQLValueString($colname1_Recordset1, "date"));
...
<title>Resumen Producto v/s Evento - Maestro</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="93%" align="left" valign="middle" bgcolor="#FF0000"><span class="Estilo1">RESUMEN PRODUCTO V/S EVENTO - MAESTRO</span></td>
...
<br />
<form action="resumen_curse_operaciones_det.php" method="get" name="form2" id="form2">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" valign="middle" bgcolor="#999999" class="titulodetalle"><img src="../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0" />Operaciones Ingresadas</td>
    </tr>
    <tr>

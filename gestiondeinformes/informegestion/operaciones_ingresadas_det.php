...
$query_DetailRS1 = sprintf("SELECT * FROM base_operaciones nolock WHERE date_ingreso between %s and %s ORDER BY date_ingreso ASC", GetSQLValueString($colname2_DetailRS1, "date"),GetSQLValueString($colname3_DetailRS1, "date"));
...
<table width="95%" border="1" align="center">
  <tr>
    ...
    <td align="center" valign="middle">Item Hora  FIE</td>
    <td align="center" valign="middle">Item Hora FV</td>
    <td align="center" valign="middle">Item Hora FA</td>
    <td align="center" valign="middle">Item Hora FO</td>
    <td align="center" valign="middle">Item Hora FS</td>
    <td align="center" valign="middle">Minutos Entre Ing Espe / Visacion</td>
    <td align="center" valign="middle"> Minutos Entre Visacion / Asignacion</td>
    <td align="center" valign="middle">Minutos Entre Asignacion / Alta Operador</td>
    <td align="center" valign="middle">Minutos Entre Alta Operador / Alta Supervisor</td>
    ...
    <td align="center" valign="middle">Seg Com BEI</td>
    <td align="center" valign="middle">Seg Com BC</td>
    <td align="center" valign="middle">Seg Com BMG</td>
  </tr>
  <?php if ($row_DetailRS1 != 0) { ?>   
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><?php echo $row_DetailRS1['nro_cuotas']; ?></td>
      ...
      <td align="center" valign="middle"><?php echo $row_DetailRS1['moneda_documentos']; ?> <?php echo number_format($row_DetailRS1['monto_documentos'], 2, ',', '.'); ?></td>
      ...
      <td align="center" valign="middle"><?php echo $row_DetailRS1['cde']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['cdv']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['cda']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['cdo']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['cds']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['dif_espe_visa']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['dif_visa_asig']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['dif_asig_oper']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['dif_oper_supe']; ?></td>
      ...
      <td align="center" valign="middle"><?php echo $row_DetailRS1['segmento_comercial_bei']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['segmento_comercial_bc']; ?></td>
      <td align="center" valign="middle"><?php echo $row_DetailRS1['segmento_comercial_bmg']; ?></td>
    </tr>

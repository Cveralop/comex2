...
<title>Trazabilidad Detalle Operaciones - Maestro</title>
<style type="text/css">
<!--
...
<table width="95%"  border="1" align="center" bordercolor="#FF0000" bgcolor="#FF0000">
  <tr>
    <td width="96%" align="left" valign="middle" class="Estilo3">TRAZABILIDAD DETALLE OPERACIONES  - MAESTRO</td>
...
<br />
<form id="form1" name="form1" method="get" action="trazabilidad_operaciones_det.php">
  <table width="95%" border="1" align="center" bordercolor="#666666" bgcolor="#CCCCCC">
    <tr>
      <td colspan="2" align="left" bgcolor="#999999"><span class="titulodetalle"><img src="../../imagenes/GIF/notepad.gif" alt="" width="19" height="21" border="0" /></span><span class="titulodetalle">Trasabilidad Detalle Operaciones</span></td>
    </tr>
    <tr>
      <td width="18%" align="right" valign="middle">Fecha Ingreso:</td>
      <td width="82%" align="left" valign="middle"><span class="respuestacolumna_rojo">Desde</span><label>
